...
class AccessRequestEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AccessRequestEntity($this->_client, $opts);
    }

    /**
     * @param AccessRequest|array $args AccessRequest data (assoc-array) to store.
     */
    ...
    /**
     * @return AccessRequest|array The current AccessRequest data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AccessRequest fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AccessRequest fields).
     */
    ...
    /**
     * Remove an AccessRequest matching the given criteria.
     *
     * @param AccessRequestRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AccessRequestRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccessRequest|array The removed AccessRequest as an assoc-array at the
