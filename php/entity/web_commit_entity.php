...
class WebCommitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WebCommitEntity($this->_client, $opts);
    }

    /**
     * @param WebCommit|array $args WebCommit data (assoc-array) to store.
     */
    ...
    /**
     * @return WebCommit|array The current WebCommit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebCommit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebCommit fields).
     */
    ...
    /**
     * Load a single WebCommit.
     *
     * @param WebCommitLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebCommitLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebCommit|array The loaded WebCommit as an assoc-array at the
