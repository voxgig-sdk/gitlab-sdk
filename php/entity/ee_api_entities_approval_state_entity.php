...
class EeApiEntitiesApprovalStateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ee_api_entities_approval_state";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EeApiEntitiesApprovalStateEntity($this->_client, $opts);
    }

    /**
     * @param EeApiEntitiesApprovalState|array $args EeApiEntitiesApprovalState data (assoc-array) to store.
     */
    ...
    /**
     * @return EeApiEntitiesApprovalState|array The current EeApiEntitiesApprovalState data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EeApiEntitiesApprovalState fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EeApiEntitiesApprovalState fields).
     */
    ...
    /**
     * Create a new EeApiEntitiesApprovalState.
     *
     * @param EeApiEntitiesApprovalStateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EeApiEntitiesApprovalStateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EeApiEntitiesApprovalState|array The created EeApiEntitiesApprovalState as an assoc-array at the
