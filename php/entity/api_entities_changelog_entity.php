...
class ApiEntitiesChangelogEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_changelog";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesChangelogEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesChangelog|array $args ApiEntitiesChangelog data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesChangelog|array The current ApiEntitiesChangelog data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesChangelog fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesChangelog fields).
     */
    ...
    /**
     * Load a single ApiEntitiesChangelog.
     *
     * @param ApiEntitiesChangelogLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesChangelogLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesChangelog|array The loaded ApiEntitiesChangelog as an assoc-array at the
