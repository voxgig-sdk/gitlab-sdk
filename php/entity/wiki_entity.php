...
class WikiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WikiEntity($this->_client, $opts);
    }

    /**
     * @param Wiki|array $args Wiki data (assoc-array) to store.
     */
    ...
    /**
     * @return Wiki|array The current Wiki data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Wiki fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Wiki fields).
     */
    ...
    /**
     * Remove an Wiki matching the given criteria.
     *
     * @param WikiRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; WikiRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Wiki|array The removed Wiki as an assoc-array at the
