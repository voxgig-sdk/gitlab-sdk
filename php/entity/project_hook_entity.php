...
class ProjectHookEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectHookEntity($this->_client, $opts);
    }

    /**
     * @param ProjectHook|array $args ProjectHook data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectHook|array The current ProjectHook data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectHook fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectHook fields).
     */
    ...
    /**
     * Remove an ProjectHook matching the given criteria.
     *
     * @param ProjectHookRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ProjectHookRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectHook|array The removed ProjectHook as an assoc-array at the
