...
class FeatureFlagsUserListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "feature_flags_user_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new FeatureFlagsUserListEntity($this->_client, $opts);
    }

    /**
     * @param FeatureFlagsUserList|array $args FeatureFlagsUserList data (assoc-array) to store.
     */
    ...
    /**
     * @return FeatureFlagsUserList|array The current FeatureFlagsUserList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FeatureFlagsUserList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FeatureFlagsUserList fields).
     */
    ...
    /**
     * Remove an FeatureFlagsUserList matching the given criteria.
     *
     * @param FeatureFlagsUserListRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; FeatureFlagsUserListRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FeatureFlagsUserList|array The removed FeatureFlagsUserList as an assoc-array at the
