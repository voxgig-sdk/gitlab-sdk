...
class PersonalAccessTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "personal_access_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PersonalAccessTokenEntity($this->_client, $opts);
    }

    /**
     * @param PersonalAccessToken|array $args PersonalAccessToken data (assoc-array) to store.
     */
    ...
    /**
     * @return PersonalAccessToken|array The current PersonalAccessToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PersonalAccessToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PersonalAccessToken fields).
     */
    ...
    /**
     * Remove an PersonalAccessToken matching the given criteria.
     *
     * @param PersonalAccessTokenRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PersonalAccessTokenRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PersonalAccessToken|array The removed PersonalAccessToken as an assoc-array at the
