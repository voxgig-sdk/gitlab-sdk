...
class ProjectImportEntityEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "project_import_entity";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ProjectImportEntityEntity($this->_client, $opts);
    }

    /**
     * @param ProjectImportEntity|array $args ProjectImportEntity data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectImportEntity|array The current ProjectImportEntity data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectImportEntity fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectImportEntity fields).
     */
    ...
    /**
     * Create a new ProjectImportEntity.
     *
     * @param ProjectImportEntityCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectImportEntityCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectImportEntity|array The created ProjectImportEntity as an assoc-array at the
