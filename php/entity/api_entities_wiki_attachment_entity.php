...
class ApiEntitiesWikiAttachmentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_wiki_attachment";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesWikiAttachmentEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesWikiAttachment|array $args ApiEntitiesWikiAttachment data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesWikiAttachment|array The current ApiEntitiesWikiAttachment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesWikiAttachment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesWikiAttachment fields).
     */
    ...
    /**
     * Create a new ApiEntitiesWikiAttachment.
     *
     * @param ApiEntitiesWikiAttachmentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesWikiAttachmentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesWikiAttachment|array The created ApiEntitiesWikiAttachment as an assoc-array at the
