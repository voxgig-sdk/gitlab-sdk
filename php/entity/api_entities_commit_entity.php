...
// Gitlab SDK ApiEntitiesCommit entity
...
class ApiEntitiesCommitEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_commit";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCommitEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCommit|array $args ApiEntitiesCommit data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCommit|array The current ApiEntitiesCommit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCommit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCommit fields).
     */
    ...
    /**
     * List ApiEntitiesCommit items matching the given filter.
     *
     * @param ApiEntitiesCommitListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesCommit fields) as an assoc-array; ApiEntitiesCommitListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCommit[]|array A list of ApiEntitiesCommit items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesCommit.
     *
     * @param ApiEntitiesCommitCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCommitCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCommit|array The created ApiEntitiesCommit as an assoc-array at the
