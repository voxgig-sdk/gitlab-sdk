...
class SlackEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SlackEntity($this->_client, $opts);
    }

    /**
     * @param Slack|array $args Slack data (assoc-array) to store.
     */
    ...
    /**
     * @return Slack|array The current Slack data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Slack fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Slack fields).
     */
     ...
     * Create a new Slack.
     *
     * @param SlackCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SlackCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Slack|array The created Slack as an assoc-array at the
