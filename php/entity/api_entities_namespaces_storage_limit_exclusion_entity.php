...
class ApiEntitiesNamespacesStorageLimitExclusionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_namespaces_storage_limit_exclusion";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesNamespacesStorageLimitExclusionEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesNamespacesStorageLimitExclusion|array $args ApiEntitiesNamespacesStorageLimitExclusion data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesNamespacesStorageLimitExclusion|array The current ApiEntitiesNamespacesStorageLimitExclusion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesNamespacesStorageLimitExclusion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesNamespacesStorageLimitExclusion fields).
     */
    ...
    /**
     * Load a single ApiEntitiesNamespacesStorageLimitExclusion.
     *
     * @param ApiEntitiesNamespacesStorageLimitExclusionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesNamespacesStorageLimitExclusionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesNamespacesStorageLimitExclusion|array The loaded ApiEntitiesNamespacesStorageLimitExclusion as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesNamespacesStorageLimitExclusion.
     *
     * @param ApiEntitiesNamespacesStorageLimitExclusionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesNamespacesStorageLimitExclusionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesNamespacesStorageLimitExclusion|array The created ApiEntitiesNamespacesStorageLimitExclusion as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
