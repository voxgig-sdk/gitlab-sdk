...
class ApiEntitiesSuggestionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_suggestion";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesSuggestionEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesSuggestion|array $args ApiEntitiesSuggestion data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesSuggestion|array The current ApiEntitiesSuggestion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesSuggestion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesSuggestion fields).
     */
    ...
    /**
     * Update an existing ApiEntitiesSuggestion.
     *
     * @param ApiEntitiesSuggestionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesSuggestionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesSuggestion|array The updated ApiEntitiesSuggestion as an assoc-array at the
