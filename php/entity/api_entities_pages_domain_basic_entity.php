...
class ApiEntitiesPagesDomainBasicEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_pages_domain_basic";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPagesDomainBasicEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPagesDomainBasic|array $args ApiEntitiesPagesDomainBasic data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPagesDomainBasic|array The current ApiEntitiesPagesDomainBasic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPagesDomainBasic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPagesDomainBasic fields).
     */
    ...
    /**
     * Load a single ApiEntitiesPagesDomainBasic.
     *
     * @param ApiEntitiesPagesDomainBasicLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesPagesDomainBasicLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPagesDomainBasic|array The loaded ApiEntitiesPagesDomainBasic as an assoc-array at the
