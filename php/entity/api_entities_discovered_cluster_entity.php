...
class ApiEntitiesDiscoveredClusterEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_discovered_cluster";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesDiscoveredClusterEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesDiscoveredCluster|array $args ApiEntitiesDiscoveredCluster data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesDiscoveredCluster|array The current ApiEntitiesDiscoveredCluster data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesDiscoveredCluster fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesDiscoveredCluster fields).
     */
    ...
    /**
     * Load a single ApiEntitiesDiscoveredCluster.
     *
     * @param ApiEntitiesDiscoveredClusterLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesDiscoveredClusterLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDiscoveredCluster|array The loaded ApiEntitiesDiscoveredCluster as an assoc-array at the
