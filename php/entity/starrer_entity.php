...
class StarrerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StarrerEntity($this->_client, $opts);
    }

    /**
     * @param Starrer|array $args Starrer data (assoc-array) to store.
     */
    ...
    /**
     * @return Starrer|array The current Starrer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Starrer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Starrer fields).
     */
    ...
    /**
     * List Starrer items matching the given filter.
     *
     * @param StarrerListMatch|array|null $reqmatch Match filter (any subset
     *   of Starrer fields) as an assoc-array; StarrerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Starrer[]|array A list of Starrer items as assoc-arrays at
