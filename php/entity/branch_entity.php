...
class BranchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BranchEntity($this->_client, $opts);
    }

    /**
     * @param Branch|array $args Branch data (assoc-array) to store.
     */
    ...
    /**
     * @return Branch|array The current Branch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Branch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Branch fields).
     */
    ...
    /**
     * Remove an Branch matching the given criteria.
     *
     * @param BranchRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BranchRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Branch|array The removed Branch as an assoc-array at the
