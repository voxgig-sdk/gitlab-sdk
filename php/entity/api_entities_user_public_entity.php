...
class ApiEntitiesUserPublicEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_user_public";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesUserPublicEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesUserPublic|array $args ApiEntitiesUserPublic data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesUserPublic|array The current ApiEntitiesUserPublic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesUserPublic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesUserPublic fields).
     */
    ...
    /**
     * List ApiEntitiesUserPublic items matching the given filter.
     *
     * @param ApiEntitiesUserPublicListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesUserPublic fields) as an assoc-array; ApiEntitiesUserPublicListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesUserPublic[]|array A list of ApiEntitiesUserPublic items as assoc-arrays at
