...
class ApiEntitiesApplicationWithSecretEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_application_with_secret";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesApplicationWithSecretEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesApplicationWithSecret|array $args ApiEntitiesApplicationWithSecret data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesApplicationWithSecret|array The current ApiEntitiesApplicationWithSecret data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesApplicationWithSecret fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesApplicationWithSecret fields).
     */
    ...
    /**
     * Create a new ApiEntitiesApplicationWithSecret.
     *
     * @param ApiEntitiesApplicationWithSecretCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesApplicationWithSecretCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesApplicationWithSecret|array The created ApiEntitiesApplicationWithSecret as an assoc-array at the
