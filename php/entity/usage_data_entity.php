...
class UsageDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UsageDataEntity($this->_client, $opts);
    }

    /**
     * @param UsageData|array $args UsageData data (assoc-array) to store.
     */
    ...
    /**
     * @return UsageData|array The current UsageData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UsageData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UsageData fields).
     */
    ...
    /**
     * Load a single UsageData.
     *
     * @param UsageDataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UsageDataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UsageData|array The loaded UsageData as an assoc-array at the
    ...
    /**
     * Create a new UsageData.
     *
     * @param UsageDataCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UsageDataCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UsageData|array The created UsageData as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
