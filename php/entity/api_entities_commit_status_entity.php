...
// Gitlab SDK ApiEntitiesCommitStatus entity
...
class ApiEntitiesCommitStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_commit_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCommitStatusEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCommitStatus|array $args ApiEntitiesCommitStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCommitStatus|array The current ApiEntitiesCommitStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCommitStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCommitStatus fields).
     */
    ...
    /**
     * List ApiEntitiesCommitStatus items matching the given filter.
     *
     * @param ApiEntitiesCommitStatusListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesCommitStatus fields) as an assoc-array; ApiEntitiesCommitStatusListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCommitStatus[]|array A list of ApiEntitiesCommitStatus items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesCommitStatus.
     *
     * @param ApiEntitiesCommitStatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCommitStatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCommitStatus|array The created ApiEntitiesCommitStatus as an assoc-array at the
