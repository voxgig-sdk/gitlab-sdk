...
class ProjectSnippetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectSnippetEntity($this->_client, $opts);
    }

    /**
     * @param ProjectSnippet|array $args ProjectSnippet data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectSnippet|array The current ProjectSnippet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectSnippet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectSnippet fields).
     */
    ...
    /**
     * Remove an ProjectSnippet matching the given criteria.
     *
     * @param ProjectSnippetRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ProjectSnippetRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectSnippet|array The removed ProjectSnippet as an assoc-array at the
