...
class ProjectEntityEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectEntityEntity($this->_client, $opts);
    }

    /**
     * @param ProjectEntity|array $args ProjectEntity data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectEntity|array The current ProjectEntity data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectEntity fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectEntity fields).
     */
     ...
     *
     * @param ProjectEntityCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectEntityCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectEntity|array The created ProjectEntity as an assoc-array at the
