...
class ApiEntitiesContributorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_contributor";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesContributorEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesContributor|array $args ApiEntitiesContributor data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesContributor|array The current ApiEntitiesContributor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesContributor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesContributor fields).
     */
    ...
    /**
     * Load a single ApiEntitiesContributor.
     *
     * @param ApiEntitiesContributorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesContributorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesContributor|array The loaded ApiEntitiesContributor as an assoc-array at the
