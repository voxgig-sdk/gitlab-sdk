...
class ApiEntitiesTreeObjectEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_tree_object";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesTreeObjectEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesTreeObject|array $args ApiEntitiesTreeObject data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesTreeObject|array The current ApiEntitiesTreeObject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesTreeObject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesTreeObject fields).
     */
    ...
    /**
     * Load a single ApiEntitiesTreeObject.
     *
     * @param ApiEntitiesTreeObjectLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesTreeObjectLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTreeObject|array The loaded ApiEntitiesTreeObject as an assoc-array at the
