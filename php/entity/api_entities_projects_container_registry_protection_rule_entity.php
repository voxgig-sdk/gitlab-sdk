...
// Gitlab SDK ApiEntitiesProjectsContainerRegistryProtectionRule entity
...
class ApiEntitiesProjectsContainerRegistryProtectionRuleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_projects_container_registry_protection_rule";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesProjectsContainerRegistryProtectionRuleEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesProjectsContainerRegistryProtectionRule|array $args ApiEntitiesProjectsContainerRegistryProtectionRule data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesProjectsContainerRegistryProtectionRule|array The current ApiEntitiesProjectsContainerRegistryProtectionRule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesProjectsContainerRegistryProtectionRule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesProjectsContainerRegistryProtectionRule fields).
     */
    ...
    /**
     * List ApiEntitiesProjectsContainerRegistryProtectionRule items matching the given filter.
     *
     * @param ApiEntitiesProjectsContainerRegistryProtectionRuleListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesProjectsContainerRegistryProtectionRule fields) as an assoc-array; ApiEntitiesProjectsContainerRegistryProtectionRuleListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectsContainerRegistryProtectionRule[]|array A list of ApiEntitiesProjectsContainerRegistryProtectionRule items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesProjectsContainerRegistryProtectionRule.
     *
     * @param ApiEntitiesProjectsContainerRegistryProtectionRuleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProjectsContainerRegistryProtectionRuleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectsContainerRegistryProtectionRule|array The created ApiEntitiesProjectsContainerRegistryProtectionRule as an assoc-array at the
    ...
    /**
     * Update an existing ApiEntitiesProjectsContainerRegistryProtectionRule.
     *
     * @param ApiEntitiesProjectsContainerRegistryProtectionRuleUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProjectsContainerRegistryProtectionRuleUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectsContainerRegistryProtectionRule|array The updated ApiEntitiesProjectsContainerRegistryProtectionRule as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
