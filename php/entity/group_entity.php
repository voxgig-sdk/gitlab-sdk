...
class GroupEntity
{
     ...
     *
     * @param GroupRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; GroupRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Group|array The removed Group as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
