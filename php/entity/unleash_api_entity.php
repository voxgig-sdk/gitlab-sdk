...
class UnleashApiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UnleashApiEntity($this->_client, $opts);
    }

    /**
     * @param UnleashApi|array $args UnleashApi data (assoc-array) to store.
     */
    ...
    /**
     * @return UnleashApi|array The current UnleashApi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UnleashApi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UnleashApi fields).
     */
    ...
    /**
     * Load a single UnleashApi.
     *
     * @param UnleashApiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UnleashApiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UnleashApi|array The loaded UnleashApi as an assoc-array at the
