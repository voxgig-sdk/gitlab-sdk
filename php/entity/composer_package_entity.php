...
class ComposerPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ComposerPackageEntity($this->_client, $opts);
    }

    /**
     * @param ComposerPackage|array $args ComposerPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return ComposerPackage|array The current ComposerPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ComposerPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ComposerPackage fields).
     */
    ...
    /**
     * Load a single ComposerPackage.
     *
     * @param ComposerPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ComposerPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ComposerPackage|array The loaded ComposerPackage as an assoc-array at the
