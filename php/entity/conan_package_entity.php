...
// Gitlab SDK ConanPackage entity
...
class ConanPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConanPackageEntity($this->_client, $opts);
    }

    /**
     * @param ConanPackage|array $args ConanPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return ConanPackage|array The current ConanPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConanPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConanPackage fields).
     */
    ...
    /**
     * Load a single ConanPackage.
     *
     * @param ConanPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConanPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConanPackage|array The loaded ConanPackage as an assoc-array at the
    ...
    /**
     * Update an existing ConanPackage.
     *
     * @param ConanPackageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConanPackageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConanPackage|array The updated ConanPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ConanPackage matching the given criteria.
     *
     * @param ConanPackageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ConanPackageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConanPackage|array The removed ConanPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
