...
class NamespaceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NamespaceEntity($this->_client, $opts);
    }

    /**
     * @param Namespace|array $args Namespace data (assoc-array) to store.
     */
    ...
    /**
     * @return Namespace|array The current Namespace data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Namespace fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Namespace fields).
     */
    ...
    /**
     * Remove an Namespace matching the given criteria.
     *
     * @param NamespaceRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; NamespaceRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Namespace|array The removed Namespace as an assoc-array at the
