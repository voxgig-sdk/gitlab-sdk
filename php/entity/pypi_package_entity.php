...
class PypiPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PypiPackageEntity($this->_client, $opts);
    }

    /**
     * @param PypiPackage|array $args PypiPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return PypiPackage|array The current PypiPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PypiPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PypiPackage fields).
     */
    ...
    /**
     * Load a single PypiPackage.
     *
     * @param PypiPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PypiPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PypiPackage|array The loaded PypiPackage as an assoc-array at the
    ...
    /**
     * Create a new PypiPackage.
     *
     * @param PypiPackageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PypiPackageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PypiPackage|array The created PypiPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
