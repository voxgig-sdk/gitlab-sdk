...
// Gitlab SDK ApiEntitiesMember entity
...
class ApiEntitiesMemberEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_member";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesMemberEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesMember|array $args ApiEntitiesMember data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesMember|array The current ApiEntitiesMember data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesMember fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesMember fields).
     */
    ...
    /**
     * Load a single ApiEntitiesMember.
     *
     * @param ApiEntitiesMemberLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesMemberLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMember|array The loaded ApiEntitiesMember as an assoc-array at the
    ...
    /**
     * List ApiEntitiesMember items matching the given filter.
     *
     * @param ApiEntitiesMemberListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesMember fields) as an assoc-array; ApiEntitiesMemberListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMember[]|array A list of ApiEntitiesMember items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesMember.
     *
     * @param ApiEntitiesMemberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesMemberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMember|array The created ApiEntitiesMember as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesMember.
     *
     * @param ApiEntitiesMemberUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesMemberUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMember|array The updated ApiEntitiesMember as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ApiEntitiesMember matching the given criteria.
     *
     * @param ApiEntitiesMemberRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ApiEntitiesMemberRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMember|array The removed ApiEntitiesMember as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
