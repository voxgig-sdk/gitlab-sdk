...
class ProjectAvatarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectAvatarEntity($this->_client, $opts);
    }

    /**
     * @param ProjectAvatar|array $args ProjectAvatar data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectAvatar|array The current ProjectAvatar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectAvatar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectAvatar fields).
     */
    ...
    /**
     * Load a single ProjectAvatar.
     *
     * @param ProjectAvatarLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectAvatarLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectAvatar|array The loaded ProjectAvatar as an assoc-array at the
