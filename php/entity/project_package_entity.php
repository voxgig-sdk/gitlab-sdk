...
class ProjectPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectPackageEntity($this->_client, $opts);
    }

    /**
     * @param ProjectPackage|array $args ProjectPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectPackage|array The current ProjectPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectPackage fields).
     */
    ...
    /**
     * Remove an ProjectPackage matching the given criteria.
     *
     * @param ProjectPackageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ProjectPackageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectPackage|array The removed ProjectPackage as an assoc-array at the
