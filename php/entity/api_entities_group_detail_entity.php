...
class ApiEntitiesGroupDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_group_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesGroupDetailEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesGroupDetail|array $args ApiEntitiesGroupDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesGroupDetail|array The current ApiEntitiesGroupDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesGroupDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesGroupDetail fields).
     */
    ...
    /**
     * Load a single ApiEntitiesGroupDetail.
     *
     * @param ApiEntitiesGroupDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesGroupDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesGroupDetail|array The loaded ApiEntitiesGroupDetail as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesGroupDetail.
     *
     * @param ApiEntitiesGroupDetailCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesGroupDetailCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesGroupDetail|array The created ApiEntitiesGroupDetail as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
