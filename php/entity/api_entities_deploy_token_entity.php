...
// Gitlab SDK ApiEntitiesDeployToken entity
...
class ApiEntitiesDeployTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_deploy_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesDeployTokenEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesDeployToken|array $args ApiEntitiesDeployToken data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesDeployToken|array The current ApiEntitiesDeployToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesDeployToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesDeployToken fields).
     */
    ...
    /**
     * Load a single ApiEntitiesDeployToken.
     *
     * @param ApiEntitiesDeployTokenLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesDeployTokenLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployToken|array The loaded ApiEntitiesDeployToken as an assoc-array at the
    ...
    /**
     * List ApiEntitiesDeployToken items matching the given filter.
     *
     * @param ApiEntitiesDeployTokenListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesDeployToken fields) as an assoc-array; ApiEntitiesDeployTokenListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployToken[]|array A list of ApiEntitiesDeployToken items as assoc-arrays at
