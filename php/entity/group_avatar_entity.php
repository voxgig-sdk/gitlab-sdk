...
class GroupAvatarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GroupAvatarEntity($this->_client, $opts);
    }

    /**
     * @param GroupAvatar|array $args GroupAvatar data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupAvatar|array The current GroupAvatar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupAvatar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupAvatar fields).
     */
    ...
    /**
     * Load a single GroupAvatar.
     *
     * @param GroupAvatarLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GroupAvatarLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupAvatar|array The loaded GroupAvatar as an assoc-array at the
