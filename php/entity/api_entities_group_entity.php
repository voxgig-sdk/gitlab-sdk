...
class ApiEntitiesGroupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesGroupEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesGroup|array $args ApiEntitiesGroup data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesGroup|array The current ApiEntitiesGroup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesGroup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesGroup fields).
     */
     ...
     *
     * @param ApiEntitiesGroupLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesGroupLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesGroup|array The loaded ApiEntitiesGroup as an assoc-array at the
     ...
     *
     * @param ApiEntitiesGroupListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesGroup fields) as an assoc-array; ApiEntitiesGroupListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesGroup[]|array A list of ApiEntitiesGroup items as assoc-arrays at
     ...
     *
     * @param ApiEntitiesGroupCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesGroupCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesGroup|array The created ApiEntitiesGroup as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
     ...
     *
     * @param ApiEntitiesGroupUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesGroupUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesGroup|array The updated ApiEntitiesGroup as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
