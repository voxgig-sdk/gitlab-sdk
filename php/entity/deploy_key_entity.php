...
class DeployKeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeployKeyEntity($this->_client, $opts);
    }

    /**
     * @param DeployKey|array $args DeployKey data (assoc-array) to store.
     */
    ...
    /**
     * @return DeployKey|array The current DeployKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeployKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeployKey fields).
     */
    ...
    /**
     * Remove an DeployKey matching the given criteria.
     *
     * @param DeployKeyRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DeployKeyRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeployKey|array The removed DeployKey as an assoc-array at the
