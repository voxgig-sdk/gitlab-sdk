...
class MigrationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MigrationEntity($this->_client, $opts);
    }

    /**
     * @param Migration|array $args Migration data (assoc-array) to store.
     */
    ...
    /**
     * @return Migration|array The current Migration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Migration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Migration fields).
     */
     ...
     *
     * @param MigrationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MigrationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Migration|array The created Migration as an assoc-array at the
