...
// Gitlab SDK ProjectExport entity
...
class ProjectExportEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectExportEntity($this->_client, $opts);
    }

    /**
     * @param ProjectExport|array $args ProjectExport data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectExport|array The current ProjectExport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectExport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectExport fields).
     */
    ...
    /**
     * Load a single ProjectExport.
     *
     * @param ProjectExportLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectExportLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectExport|array The loaded ProjectExport as an assoc-array at the
    ...
    /**
     * Create a new ProjectExport.
     *
     * @param ProjectExportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectExportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectExport|array The created ProjectExport as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
