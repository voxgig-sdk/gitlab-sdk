...
class ApiEntitiesTemplatesListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_templates_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesTemplatesListEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesTemplatesList|array $args ApiEntitiesTemplatesList data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesTemplatesList|array The current ApiEntitiesTemplatesList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesTemplatesList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesTemplatesList fields).
     */
    ...
    /**
     * Load a single ApiEntitiesTemplatesList.
     *
     * @param ApiEntitiesTemplatesListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesTemplatesListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTemplatesList|array The loaded ApiEntitiesTemplatesList as an assoc-array at the
