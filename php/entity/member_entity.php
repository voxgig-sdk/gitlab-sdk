...
class MemberEntity
{
     ...
     *
     * @param MemberUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MemberUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Member|array The updated Member as an assoc-array at the
     ...
     *
     * @param MemberRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MemberRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Member|array The removed Member as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
