...
class ComposerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ComposerEntity($this->_client, $opts);
    }

    /**
     * @param Composer|array $args Composer data (assoc-array) to store.
     */
    ...
    /**
     * @return Composer|array The current Composer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Composer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Composer fields).
     */
     ...
     *
     * @param ComposerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ComposerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Composer|array The created Composer as an assoc-array at the
