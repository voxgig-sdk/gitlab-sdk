...
// Gitlab SDK ApiEntitiesHook entity
...
class ApiEntitiesHookEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesHookEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesHook|array $args ApiEntitiesHook data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesHook|array The current ApiEntitiesHook data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesHook fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesHook fields).
     */
    ...
    /**
     * Load a single ApiEntitiesHook.
     *
     * @param ApiEntitiesHookLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesHookLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesHook|array The loaded ApiEntitiesHook as an assoc-array at the
    ...
    /**
     * List ApiEntitiesHook items matching the given filter.
     *
     * @param ApiEntitiesHookListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesHook fields) as an assoc-array; ApiEntitiesHookListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesHook[]|array A list of ApiEntitiesHook items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesHook.
     *
     * @param ApiEntitiesHookCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesHookCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesHook|array The created ApiEntitiesHook as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesHook.
     *
     * @param ApiEntitiesHookUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesHookUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesHook|array The updated ApiEntitiesHook as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
