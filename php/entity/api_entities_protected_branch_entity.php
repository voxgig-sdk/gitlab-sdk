...
// Gitlab SDK ApiEntitiesProtectedBranch entity
...
class ApiEntitiesProtectedBranchEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_protected_branch";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesProtectedBranchEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesProtectedBranch|array $args ApiEntitiesProtectedBranch data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesProtectedBranch|array The current ApiEntitiesProtectedBranch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesProtectedBranch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesProtectedBranch fields).
     */
    ...
    /**
     * Load a single ApiEntitiesProtectedBranch.
     *
     * @param ApiEntitiesProtectedBranchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesProtectedBranchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProtectedBranch|array The loaded ApiEntitiesProtectedBranch as an assoc-array at the
    ...
    /**
     * List ApiEntitiesProtectedBranch items matching the given filter.
     *
     * @param ApiEntitiesProtectedBranchListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesProtectedBranch fields) as an assoc-array; ApiEntitiesProtectedBranchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProtectedBranch[]|array A list of ApiEntitiesProtectedBranch items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesProtectedBranch.
     *
     * @param ApiEntitiesProtectedBranchCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProtectedBranchCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProtectedBranch|array The created ApiEntitiesProtectedBranch as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesProtectedBranch.
     *
     * @param ApiEntitiesProtectedBranchUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProtectedBranchUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProtectedBranch|array The updated ApiEntitiesProtectedBranch as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
