...
// Gitlab SDK ApiEntitiesClusterProject entity
...
class ApiEntitiesClusterProjectEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_cluster_project";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesClusterProjectEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesClusterProject|array $args ApiEntitiesClusterProject data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesClusterProject|array The current ApiEntitiesClusterProject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesClusterProject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesClusterProject fields).
     */
    ...
    /**
     * Load a single ApiEntitiesClusterProject.
     *
     * @param ApiEntitiesClusterProjectLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesClusterProjectLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClusterProject|array The loaded ApiEntitiesClusterProject as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesClusterProject.
     *
     * @param ApiEntitiesClusterProjectCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesClusterProjectCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClusterProject|array The created ApiEntitiesClusterProject as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesClusterProject.
     *
     * @param ApiEntitiesClusterProjectUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesClusterProjectUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClusterProject|array The updated ApiEntitiesClusterProject as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
