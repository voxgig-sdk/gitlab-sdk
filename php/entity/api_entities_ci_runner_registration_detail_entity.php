...
class ApiEntitiesCiRunnerRegistrationDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_runner_registration_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiRunnerRegistrationDetailEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiRunnerRegistrationDetail|array $args ApiEntitiesCiRunnerRegistrationDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiRunnerRegistrationDetail|array The current ApiEntitiesCiRunnerRegistrationDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiRunnerRegistrationDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiRunnerRegistrationDetail fields).
     */
    ...
    /**
     * Create a new ApiEntitiesCiRunnerRegistrationDetail.
     *
     * @param ApiEntitiesCiRunnerRegistrationDetailCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCiRunnerRegistrationDetailCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiRunnerRegistrationDetail|array The created ApiEntitiesCiRunnerRegistrationDetail as an assoc-array at the
