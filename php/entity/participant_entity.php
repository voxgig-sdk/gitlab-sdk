...
class ParticipantEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ParticipantEntity($this->_client, $opts);
    }

    /**
     * @param Participant|array $args Participant data (assoc-array) to store.
     */
    ...
    /**
     * @return Participant|array The current Participant data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Participant fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Participant fields).
     */
    ...
    /**
     * List Participant items matching the given filter.
     *
     * @param ParticipantListMatch|array|null $reqmatch Match filter (any subset
     *   of Participant fields) as an assoc-array; ParticipantListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Participant[]|array A list of Participant items as assoc-arrays at
