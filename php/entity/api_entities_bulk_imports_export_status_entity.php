...
class ApiEntitiesBulkImportsExportStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_bulk_imports_export_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesBulkImportsExportStatusEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesBulkImportsExportStatus|array $args ApiEntitiesBulkImportsExportStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesBulkImportsExportStatus|array The current ApiEntitiesBulkImportsExportStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesBulkImportsExportStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesBulkImportsExportStatus fields).
     */
    ...
    /**
     * List ApiEntitiesBulkImportsExportStatus items matching the given filter.
     *
     * @param ApiEntitiesBulkImportsExportStatusListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesBulkImportsExportStatus fields) as an assoc-array; ApiEntitiesBulkImportsExportStatusListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesBulkImportsExportStatus[]|array A list of ApiEntitiesBulkImportsExportStatus items as assoc-arrays at
