...
class ApiEntitiesCommitNoteEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_commit_note";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCommitNoteEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCommitNote|array $args ApiEntitiesCommitNote data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCommitNote|array The current ApiEntitiesCommitNote data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCommitNote fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCommitNote fields).
     */
    ...
    /**
     * List ApiEntitiesCommitNote items matching the given filter.
     *
     * @param ApiEntitiesCommitNoteListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesCommitNote fields) as an assoc-array; ApiEntitiesCommitNoteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCommitNote[]|array A list of ApiEntitiesCommitNote items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesCommitNote.
     *
     * @param ApiEntitiesCommitNoteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCommitNoteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCommitNote|array The created ApiEntitiesCommitNote as an assoc-array at the
