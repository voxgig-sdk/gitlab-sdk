...
class ApiEntitiesNugetPackagesVersionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_nuget_packages_version";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesNugetPackagesVersionEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesNugetPackagesVersion|array $args ApiEntitiesNugetPackagesVersion data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesNugetPackagesVersion|array The current ApiEntitiesNugetPackagesVersion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesNugetPackagesVersion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesNugetPackagesVersion fields).
     */
    ...
    /**
     * List ApiEntitiesNugetPackagesVersion items matching the given filter.
     *
     * @param ApiEntitiesNugetPackagesVersionListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesNugetPackagesVersion fields) as an assoc-array; ApiEntitiesNugetPackagesVersionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesNugetPackagesVersion[]|array A list of ApiEntitiesNugetPackagesVersion items as assoc-arrays at
