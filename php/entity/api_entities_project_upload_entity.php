...
class ApiEntitiesProjectUploadEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_project_upload";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesProjectUploadEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesProjectUpload|array $args ApiEntitiesProjectUpload data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesProjectUpload|array The current ApiEntitiesProjectUpload data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesProjectUpload fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesProjectUpload fields).
     */
    ...
    /**
     * Create a new ApiEntitiesProjectUpload.
     *
     * @param ApiEntitiesProjectUploadCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProjectUploadCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectUpload|array The created ApiEntitiesProjectUpload as an assoc-array at the
