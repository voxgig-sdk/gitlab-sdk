...
class DebianDistributionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "debian_distribution";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DebianDistributionEntity($this->_client, $opts);
    }

    /**
     * @param DebianDistribution|array $args DebianDistribution data (assoc-array) to store.
     */
    ...
    /**
     * @return DebianDistribution|array The current DebianDistribution data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DebianDistribution fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DebianDistribution fields).
     */
    ...
    /**
     * Remove an DebianDistribution matching the given criteria.
     *
     * @param DebianDistributionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DebianDistributionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DebianDistribution|array The removed DebianDistribution as an assoc-array at the
