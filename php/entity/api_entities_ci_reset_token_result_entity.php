...
class ApiEntitiesCiResetTokenResultEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_reset_token_result";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiResetTokenResultEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiResetTokenResult|array $args ApiEntitiesCiResetTokenResult data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiResetTokenResult|array The current ApiEntitiesCiResetTokenResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiResetTokenResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiResetTokenResult fields).
     */
    ...
    /**
     * Create a new ApiEntitiesCiResetTokenResult.
     *
     * @param ApiEntitiesCiResetTokenResultCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCiResetTokenResultCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiResetTokenResult|array The created ApiEntitiesCiResetTokenResult as an assoc-array at the
