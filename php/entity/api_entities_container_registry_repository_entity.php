...
// Gitlab SDK ApiEntitiesContainerRegistryRepository entity
...
class ApiEntitiesContainerRegistryRepositoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_container_registry_repository";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesContainerRegistryRepositoryEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesContainerRegistryRepository|array $args ApiEntitiesContainerRegistryRepository data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesContainerRegistryRepository|array The current ApiEntitiesContainerRegistryRepository data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesContainerRegistryRepository fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesContainerRegistryRepository fields).
     */
    ...
    /**
     * Load a single ApiEntitiesContainerRegistryRepository.
     *
     * @param ApiEntitiesContainerRegistryRepositoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesContainerRegistryRepositoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesContainerRegistryRepository|array The loaded ApiEntitiesContainerRegistryRepository as an assoc-array at the
    ...
    /**
     * List ApiEntitiesContainerRegistryRepository items matching the given filter.
     *
     * @param ApiEntitiesContainerRegistryRepositoryListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesContainerRegistryRepository fields) as an assoc-array; ApiEntitiesContainerRegistryRepositoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesContainerRegistryRepository[]|array A list of ApiEntitiesContainerRegistryRepository items as assoc-arrays at
