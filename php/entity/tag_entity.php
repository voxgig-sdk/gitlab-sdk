...
class TagEntity
{
    ...
    /**
     * Remove an Tag matching the given criteria.
     *
     * @param TagRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; TagRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tag|array The removed Tag as an assoc-array at the
