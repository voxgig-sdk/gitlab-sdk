...
// Gitlab SDK MlModelRegistry entity
...
class MlModelRegistryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MlModelRegistryEntity($this->_client, $opts);
    }

    /**
     * @param MlModelRegistry|array $args MlModelRegistry data (assoc-array) to store.
     */
    ...
    /**
     * @return MlModelRegistry|array The current MlModelRegistry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MlModelRegistry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MlModelRegistry fields).
     */
    ...
    /**
     * Load a single MlModelRegistry.
     *
     * @param MlModelRegistryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MlModelRegistryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MlModelRegistry|array The loaded MlModelRegistry as an assoc-array at the
    ...
    /**
     * Update an existing MlModelRegistry.
     *
     * @param MlModelRegistryUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MlModelRegistryUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MlModelRegistry|array The updated MlModelRegistry as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
