...
// Gitlab SDK ApiEntitiesPagesDomain entity
...
class ApiEntitiesPagesDomainEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_pages_domain";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPagesDomainEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPagesDomain|array $args ApiEntitiesPagesDomain data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPagesDomain|array The current ApiEntitiesPagesDomain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPagesDomain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPagesDomain fields).
     */
    ...
    /**
     * Load a single ApiEntitiesPagesDomain.
     *
     * @param ApiEntitiesPagesDomainLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesPagesDomainLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPagesDomain|array The loaded ApiEntitiesPagesDomain as an assoc-array at the
    ...
    /**
     * List ApiEntitiesPagesDomain items matching the given filter.
     *
     * @param ApiEntitiesPagesDomainListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesPagesDomain fields) as an assoc-array; ApiEntitiesPagesDomainListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPagesDomain[]|array A list of ApiEntitiesPagesDomain items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesPagesDomain.
     *
     * @param ApiEntitiesPagesDomainCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesPagesDomainCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPagesDomain|array The created ApiEntitiesPagesDomain as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesPagesDomain.
     *
     * @param ApiEntitiesPagesDomainUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesPagesDomainUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPagesDomain|array The updated ApiEntitiesPagesDomain as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
