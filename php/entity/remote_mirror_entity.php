...
class RemoteMirrorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RemoteMirrorEntity($this->_client, $opts);
    }

    /**
     * @param RemoteMirror|array $args RemoteMirror data (assoc-array) to store.
     */
    ...
    /**
     * @return RemoteMirror|array The current RemoteMirror data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RemoteMirror fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RemoteMirror fields).
     */
    ...
    /**
     * Load a single RemoteMirror.
     *
     * @param RemoteMirrorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RemoteMirrorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RemoteMirror|array The loaded RemoteMirror as an assoc-array at the
    ...
    /**
     * Remove an RemoteMirror matching the given criteria.
     *
     * @param RemoteMirrorRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; RemoteMirrorRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RemoteMirror|array The removed RemoteMirror as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
