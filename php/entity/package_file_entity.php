...
class PackageFileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PackageFileEntity($this->_client, $opts);
    }

    /**
     * @param PackageFile|array $args PackageFile data (assoc-array) to store.
     */
    ...
    /**
     * @return PackageFile|array The current PackageFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PackageFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PackageFile fields).
     */
    ...
    /**
     * Load a single PackageFile.
     *
     * @param PackageFileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PackageFileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PackageFile|array The loaded PackageFile as an assoc-array at the
    ...
    /**
     * Remove an PackageFile matching the given criteria.
     *
     * @param PackageFileRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PackageFileRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PackageFile|array The removed PackageFile as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
