...
class ApiEntitiesCiPipelineEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_pipeline";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiPipelineEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiPipeline|array $args ApiEntitiesCiPipeline data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiPipeline|array The current ApiEntitiesCiPipeline data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiPipeline fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiPipeline fields).
     */
    ...
    /**
     * Create a new ApiEntitiesCiPipeline.
     *
     * @param ApiEntitiesCiPipelineCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCiPipelineCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiPipeline|array The created ApiEntitiesCiPipeline as an assoc-array at the
