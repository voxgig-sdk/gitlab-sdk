...
class ApiEntitiesWikiPageBasicEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_wiki_page_basic";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesWikiPageBasicEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesWikiPageBasic|array $args ApiEntitiesWikiPageBasic data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesWikiPageBasic|array The current ApiEntitiesWikiPageBasic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesWikiPageBasic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesWikiPageBasic fields).
     */
    ...
    /**
     * List ApiEntitiesWikiPageBasic items matching the given filter.
     *
     * @param ApiEntitiesWikiPageBasicListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesWikiPageBasic fields) as an assoc-array; ApiEntitiesWikiPageBasicListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesWikiPageBasic[]|array A list of ApiEntitiesWikiPageBasic items as assoc-arrays at
