...
// Gitlab SDK ApiEntitiesAccessRequester entity
...
class ApiEntitiesAccessRequesterEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_access_requester";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesAccessRequesterEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesAccessRequester|array $args ApiEntitiesAccessRequester data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesAccessRequester|array The current ApiEntitiesAccessRequester data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesAccessRequester fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesAccessRequester fields).
     */
    ...
    /**
     * List ApiEntitiesAccessRequester items matching the given filter.
     *
     * @param ApiEntitiesAccessRequesterListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesAccessRequester fields) as an assoc-array; ApiEntitiesAccessRequesterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesAccessRequester[]|array A list of ApiEntitiesAccessRequester items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesAccessRequester.
     *
     * @param ApiEntitiesAccessRequesterCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesAccessRequesterCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesAccessRequester|array The created ApiEntitiesAccessRequester as an assoc-array at the
    ...
    /**
     * Update an existing ApiEntitiesAccessRequester.
     *
     * @param ApiEntitiesAccessRequesterUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesAccessRequesterUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesAccessRequester|array The updated ApiEntitiesAccessRequester as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
