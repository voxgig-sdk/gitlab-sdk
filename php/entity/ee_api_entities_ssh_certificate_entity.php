...
class EeApiEntitiesSshCertificateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ee_api_entities_ssh_certificate";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EeApiEntitiesSshCertificateEntity($this->_client, $opts);
    }

    /**
     * @param EeApiEntitiesSshCertificate|array $args EeApiEntitiesSshCertificate data (assoc-array) to store.
     */
    ...
    /**
     * @return EeApiEntitiesSshCertificate|array The current EeApiEntitiesSshCertificate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EeApiEntitiesSshCertificate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EeApiEntitiesSshCertificate fields).
     */
    ...
    /**
     * List EeApiEntitiesSshCertificate items matching the given filter.
     *
     * @param EeApiEntitiesSshCertificateListMatch|array|null $reqmatch Match filter (any subset
     *   of EeApiEntitiesSshCertificate fields) as an assoc-array; EeApiEntitiesSshCertificateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EeApiEntitiesSshCertificate[]|array A list of EeApiEntitiesSshCertificate items as assoc-arrays at
    ...
    /**
     * Create a new EeApiEntitiesSshCertificate.
     *
     * @param EeApiEntitiesSshCertificateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EeApiEntitiesSshCertificateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EeApiEntitiesSshCertificate|array The created EeApiEntitiesSshCertificate as an assoc-array at the
