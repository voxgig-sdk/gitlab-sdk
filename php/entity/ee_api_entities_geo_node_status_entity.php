...
class EeApiEntitiesGeoNodeStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ee_api_entities_geo_node_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EeApiEntitiesGeoNodeStatusEntity($this->_client, $opts);
    }

    /**
     * @param EeApiEntitiesGeoNodeStatus|array $args EeApiEntitiesGeoNodeStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return EeApiEntitiesGeoNodeStatus|array The current EeApiEntitiesGeoNodeStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EeApiEntitiesGeoNodeStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EeApiEntitiesGeoNodeStatus fields).
     */
    ...
    /**
     * Create a new EeApiEntitiesGeoNodeStatus.
     *
     * @param EeApiEntitiesGeoNodeStatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EeApiEntitiesGeoNodeStatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EeApiEntitiesGeoNodeStatus|array The created EeApiEntitiesGeoNodeStatus as an assoc-array at the
