...
class ContainerRegistryEventEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "container_registry_event";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ContainerRegistryEventEntity($this->_client, $opts);
    }

    /**
     * @param ContainerRegistryEvent|array $args ContainerRegistryEvent data (assoc-array) to store.
     */
    ...
    /**
     * @return ContainerRegistryEvent|array The current ContainerRegistryEvent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContainerRegistryEvent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContainerRegistryEvent fields).
     */
    ...
    /**
     * Create a new ContainerRegistryEvent.
     *
     * @param ContainerRegistryEventCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ContainerRegistryEventCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContainerRegistryEvent|array The created ContainerRegistryEvent as an assoc-array at the
