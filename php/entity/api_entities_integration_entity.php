...
class ApiEntitiesIntegrationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_integration";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesIntegrationEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesIntegration|array $args ApiEntitiesIntegration data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesIntegration|array The current ApiEntitiesIntegration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesIntegration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesIntegration fields).
     */
    ...
    /**
     * Load a single ApiEntitiesIntegration.
     *
     * @param ApiEntitiesIntegrationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesIntegrationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesIntegration|array The loaded ApiEntitiesIntegration as an assoc-array at the
