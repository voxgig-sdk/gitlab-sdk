...
class ApiEntitiesResourceAccessTokenWithTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_resource_access_token_with_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesResourceAccessTokenWithTokenEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesResourceAccessTokenWithToken|array $args ApiEntitiesResourceAccessTokenWithToken data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesResourceAccessTokenWithToken|array The current ApiEntitiesResourceAccessTokenWithToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesResourceAccessTokenWithToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesResourceAccessTokenWithToken fields).
     */
    ...
    /**
     * Create a new ApiEntitiesResourceAccessTokenWithToken.
     *
     * @param ApiEntitiesResourceAccessTokenWithTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesResourceAccessTokenWithTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesResourceAccessTokenWithToken|array The created ApiEntitiesResourceAccessTokenWithToken as an assoc-array at the
