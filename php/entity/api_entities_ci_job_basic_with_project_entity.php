...
class ApiEntitiesCiJobBasicWithProjectEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_job_basic_with_project";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiJobBasicWithProjectEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiJobBasicWithProject|array $args ApiEntitiesCiJobBasicWithProject data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiJobBasicWithProject|array The current ApiEntitiesCiJobBasicWithProject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiJobBasicWithProject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiJobBasicWithProject fields).
     */
    ...
    /**
     * Load a single ApiEntitiesCiJobBasicWithProject.
     *
     * @param ApiEntitiesCiJobBasicWithProjectLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesCiJobBasicWithProjectLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiJobBasicWithProject|array The loaded ApiEntitiesCiJobBasicWithProject as an assoc-array at the
