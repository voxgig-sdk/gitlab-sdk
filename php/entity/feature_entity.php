...
class FeatureEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FeatureEntity($this->_client, $opts);
    }

    /**
     * @param Feature|array $args Feature data (assoc-array) to store.
     */
    ...
    /**
     * @return Feature|array The current Feature data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Feature fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Feature fields).
     */
    ...
    /**
     * Remove an Feature matching the given criteria.
     *
     * @param FeatureRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; FeatureRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Feature|array The removed Feature as an assoc-array at the
