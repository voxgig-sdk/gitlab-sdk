...
class ApiEntitiesBasicProjectDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_basic_project_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesBasicProjectDetailEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesBasicProjectDetail|array $args ApiEntitiesBasicProjectDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesBasicProjectDetail|array The current ApiEntitiesBasicProjectDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesBasicProjectDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesBasicProjectDetail fields).
     */
    ...
    /**
     * List ApiEntitiesBasicProjectDetail items matching the given filter.
     *
     * @param ApiEntitiesBasicProjectDetailListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesBasicProjectDetail fields) as an assoc-array; ApiEntitiesBasicProjectDetailListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesBasicProjectDetail[]|array A list of ApiEntitiesBasicProjectDetail items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesBasicProjectDetail.
     *
     * @param ApiEntitiesBasicProjectDetailCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesBasicProjectDetailCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesBasicProjectDetail|array The created ApiEntitiesBasicProjectDetail as an assoc-array at the
