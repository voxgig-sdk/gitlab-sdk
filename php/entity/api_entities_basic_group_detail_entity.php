...
class ApiEntitiesBasicGroupDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_basic_group_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesBasicGroupDetailEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesBasicGroupDetail|array $args ApiEntitiesBasicGroupDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesBasicGroupDetail|array The current ApiEntitiesBasicGroupDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesBasicGroupDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesBasicGroupDetail fields).
     */
    ...
    /**
     * Create a new ApiEntitiesBasicGroupDetail.
     *
     * @param ApiEntitiesBasicGroupDetailCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesBasicGroupDetailCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesBasicGroupDetail|array The created ApiEntitiesBasicGroupDetail as an assoc-array at the
