...
class TestReportSummaryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "test_report_summary";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new TestReportSummaryEntity($this->_client, $opts);
    }

    /**
     * @param TestReportSummary|array $args TestReportSummary data (assoc-array) to store.
     */
    ...
    /**
     * @return TestReportSummary|array The current TestReportSummary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TestReportSummary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TestReportSummary fields).
     */
    ...
    /**
     * Load a single TestReportSummary.
     *
     * @param TestReportSummaryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TestReportSummaryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TestReportSummary|array The loaded TestReportSummary as an assoc-array at the
