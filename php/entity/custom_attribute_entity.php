...
class CustomAttributeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CustomAttributeEntity($this->_client, $opts);
    }

    /**
     * @param CustomAttribute|array $args CustomAttribute data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomAttribute|array The current CustomAttribute data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomAttribute fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomAttribute fields).
     */
    ...
    /**
     * Load a single CustomAttribute.
     *
     * @param CustomAttributeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomAttributeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomAttribute|array The loaded CustomAttribute as an assoc-array at the
