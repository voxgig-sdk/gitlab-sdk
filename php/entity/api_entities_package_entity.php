...
// Gitlab SDK ApiEntitiesPackage entity
...
class ApiEntitiesPackageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_package";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPackageEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPackage|array $args ApiEntitiesPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPackage|array The current ApiEntitiesPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPackage fields).
     */
    ...
    /**
     * Load a single ApiEntitiesPackage.
     *
     * @param ApiEntitiesPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPackage|array The loaded ApiEntitiesPackage as an assoc-array at the
    ...
    /**
     * List ApiEntitiesPackage items matching the given filter.
     *
     * @param ApiEntitiesPackageListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesPackage fields) as an assoc-array; ApiEntitiesPackageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPackage[]|array A list of ApiEntitiesPackage items as assoc-arrays at
