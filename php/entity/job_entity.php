...
class JobEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new JobEntity($this->_client, $opts);
    }

    /**
     * @param Job|array $args Job data (assoc-array) to store.
     */
    ...
    /**
     * @return Job|array The current Job data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Job fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Job fields).
     */
     ...
     * Load a single Job.
     *
     * @param JobLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed JobLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Job|array The loaded Job as an assoc-array at the
     ...
     * Create a new Job.
     *
     * @param JobCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed JobCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Job|array The created Job as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
     ...
     *
     * @param JobUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed JobUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Job|array The updated Job as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
