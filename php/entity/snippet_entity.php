...
class SnippetEntity
{
     ...
     *
     * @param SnippetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SnippetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Snippet|array The loaded Snippet as an assoc-array at the
