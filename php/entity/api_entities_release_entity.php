...
// Gitlab SDK ApiEntitiesRelease entity
...
class ApiEntitiesReleaseEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_release";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesReleaseEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesRelease|array $args ApiEntitiesRelease data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesRelease|array The current ApiEntitiesRelease data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesRelease fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesRelease fields).
     */
    ...
    /**
     * Load a single ApiEntitiesRelease.
     *
     * @param ApiEntitiesReleaseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesReleaseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRelease|array The loaded ApiEntitiesRelease as an assoc-array at the
    ...
    /**
     * List ApiEntitiesRelease items matching the given filter.
     *
     * @param ApiEntitiesReleaseListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesRelease fields) as an assoc-array; ApiEntitiesReleaseListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRelease[]|array A list of ApiEntitiesRelease items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesRelease.
     *
     * @param ApiEntitiesReleaseCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesReleaseCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRelease|array The created ApiEntitiesRelease as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesRelease.
     *
     * @param ApiEntitiesReleaseUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesReleaseUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRelease|array The updated ApiEntitiesRelease as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
