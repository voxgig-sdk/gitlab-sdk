...
class EnvironmentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EnvironmentEntity($this->_client, $opts);
    }

    /**
     * @param Environment|array $args Environment data (assoc-array) to store.
     */
    ...
    /**
     * @return Environment|array The current Environment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Environment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Environment fields).
     */
     ...
     *
     * @param EnvironmentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnvironmentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Environment|array The created Environment as an assoc-array at the
    ...
    /**
     * Remove an Environment matching the given criteria.
     *
     * @param EnvironmentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; EnvironmentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Environment|array The removed Environment as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
