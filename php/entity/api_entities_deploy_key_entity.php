...
// Gitlab SDK ApiEntitiesDeployKey entity
...
class ApiEntitiesDeployKeyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_deploy_key";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesDeployKeyEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesDeployKey|array $args ApiEntitiesDeployKey data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesDeployKey|array The current ApiEntitiesDeployKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesDeployKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesDeployKey fields).
     */
    ...
    /**
     * List ApiEntitiesDeployKey items matching the given filter.
     *
     * @param ApiEntitiesDeployKeyListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesDeployKey fields) as an assoc-array; ApiEntitiesDeployKeyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployKey[]|array A list of ApiEntitiesDeployKey items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesDeployKey.
     *
     * @param ApiEntitiesDeployKeyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesDeployKeyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployKey|array The created ApiEntitiesDeployKey as an assoc-array at the
    ...
    /**
     * Update an existing ApiEntitiesDeployKey.
     *
     * @param ApiEntitiesDeployKeyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesDeployKeyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployKey|array The updated ApiEntitiesDeployKey as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
