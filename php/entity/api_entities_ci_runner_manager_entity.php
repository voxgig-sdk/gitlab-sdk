...
class ApiEntitiesCiRunnerManagerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_runner_manager";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiRunnerManagerEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiRunnerManager|array $args ApiEntitiesCiRunnerManager data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiRunnerManager|array The current ApiEntitiesCiRunnerManager data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiRunnerManager fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiRunnerManager fields).
     */
    ...
    /**
     * Load a single ApiEntitiesCiRunnerManager.
     *
     * @param ApiEntitiesCiRunnerManagerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesCiRunnerManagerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiRunnerManager|array The loaded ApiEntitiesCiRunnerManager as an assoc-array at the
