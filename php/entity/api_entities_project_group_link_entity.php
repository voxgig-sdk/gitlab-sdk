...
class ApiEntitiesProjectGroupLinkEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_project_group_link";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesProjectGroupLinkEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesProjectGroupLink|array $args ApiEntitiesProjectGroupLink data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesProjectGroupLink|array The current ApiEntitiesProjectGroupLink data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesProjectGroupLink fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesProjectGroupLink fields).
     */
    ...
    /**
     * Create a new ApiEntitiesProjectGroupLink.
     *
     * @param ApiEntitiesProjectGroupLinkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProjectGroupLinkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectGroupLink|array The created ApiEntitiesProjectGroupLink as an assoc-array at the
