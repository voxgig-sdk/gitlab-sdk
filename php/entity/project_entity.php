...
class ProjectEntityClient
{
     ...
     *
     * @param ProjectCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Project|array The created Project as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
     ...
     *
     * @param ProjectUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Project|array The updated Project as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
     ...
     *
     * @param ProjectRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ProjectRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Project|array The removed Project as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
