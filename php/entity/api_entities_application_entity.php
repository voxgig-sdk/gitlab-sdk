...
class ApiEntitiesApplicationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_application";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesApplicationEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesApplication|array $args ApiEntitiesApplication data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesApplication|array The current ApiEntitiesApplication data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesApplication fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesApplication fields).
     */
    ...
    /**
     * List ApiEntitiesApplication items matching the given filter.
     *
     * @param ApiEntitiesApplicationListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesApplication fields) as an assoc-array; ApiEntitiesApplicationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesApplication[]|array A list of ApiEntitiesApplication items as assoc-arrays at
