...
class DebianEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DebianEntity($this->_client, $opts);
    }

    /**
     * @param Debian|array $args Debian data (assoc-array) to store.
     */
    ...
    /**
     * @return Debian|array The current Debian data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Debian fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Debian fields).
     */
    ...
    /**
     * Update an existing Debian.
     *
     * @param DebianUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DebianUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Debian|array The updated Debian as an assoc-array at the
