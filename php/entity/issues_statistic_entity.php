...
class IssuesStatisticEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IssuesStatisticEntity($this->_client, $opts);
    }

    /**
     * @param IssuesStatistic|array $args IssuesStatistic data (assoc-array) to store.
     */
    ...
    /**
     * @return IssuesStatistic|array The current IssuesStatistic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IssuesStatistic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IssuesStatistic fields).
     */
    ...
    /**
     * Load a single IssuesStatistic.
     *
     * @param IssuesStatisticLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IssuesStatisticLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IssuesStatistic|array The loaded IssuesStatistic as an assoc-array at the
