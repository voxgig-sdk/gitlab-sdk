...
class ApiEntitiesGitlabSubscriptionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_gitlab_subscription";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesGitlabSubscriptionEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesGitlabSubscription|array $args ApiEntitiesGitlabSubscription data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesGitlabSubscription|array The current ApiEntitiesGitlabSubscription data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesGitlabSubscription fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesGitlabSubscription fields).
     */
    ...
    /**
     * Load a single ApiEntitiesGitlabSubscription.
     *
     * @param ApiEntitiesGitlabSubscriptionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesGitlabSubscriptionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesGitlabSubscription|array The loaded ApiEntitiesGitlabSubscription as an assoc-array at the
