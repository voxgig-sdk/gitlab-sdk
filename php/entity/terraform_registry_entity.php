...
// Gitlab SDK TerraformRegistry entity
...
class TerraformRegistryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TerraformRegistryEntity($this->_client, $opts);
    }

    /**
     * @param TerraformRegistry|array $args TerraformRegistry data (assoc-array) to store.
     */
    ...
    /**
     * @return TerraformRegistry|array The current TerraformRegistry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TerraformRegistry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TerraformRegistry fields).
     */
    ...
    /**
     * Load a single TerraformRegistry.
     *
     * @param TerraformRegistryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TerraformRegistryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TerraformRegistry|array The loaded TerraformRegistry as an assoc-array at the
    ...
    /**
     * Update an existing TerraformRegistry.
     *
     * @param TerraformRegistryUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TerraformRegistryUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TerraformRegistry|array The updated TerraformRegistry as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
