...
class GroupExportEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GroupExportEntity($this->_client, $opts);
    }

    /**
     * @param GroupExport|array $args GroupExport data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupExport|array The current GroupExport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupExport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupExport fields).
     */
    ...
    /**
     * Load a single GroupExport.
     *
     * @param GroupExportLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GroupExportLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupExport|array The loaded GroupExport as an assoc-array at the
    ...
    /**
     * Create a new GroupExport.
     *
     * @param GroupExportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GroupExportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupExport|array The created GroupExport as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
