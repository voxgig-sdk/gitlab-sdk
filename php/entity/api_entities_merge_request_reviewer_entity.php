...
class ApiEntitiesMergeRequestReviewerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_merge_request_reviewer";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesMergeRequestReviewerEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesMergeRequestReviewer|array $args ApiEntitiesMergeRequestReviewer data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesMergeRequestReviewer|array The current ApiEntitiesMergeRequestReviewer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesMergeRequestReviewer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesMergeRequestReviewer fields).
     */
    ...
    /**
     * Load a single ApiEntitiesMergeRequestReviewer.
     *
     * @param ApiEntitiesMergeRequestReviewerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesMergeRequestReviewerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMergeRequestReviewer|array The loaded ApiEntitiesMergeRequestReviewer as an assoc-array at the
