...
class EeApiEntitiesBillableMembershipEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ee_api_entities_billable_membership";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EeApiEntitiesBillableMembershipEntity($this->_client, $opts);
    }

    /**
     * @param EeApiEntitiesBillableMembership|array $args EeApiEntitiesBillableMembership data (assoc-array) to store.
     */
    ...
    /**
     * @return EeApiEntitiesBillableMembership|array The current EeApiEntitiesBillableMembership data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EeApiEntitiesBillableMembership fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EeApiEntitiesBillableMembership fields).
     */
    ...
    /**
     * Load a single EeApiEntitiesBillableMembership.
     *
     * @param EeApiEntitiesBillableMembershipLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EeApiEntitiesBillableMembershipLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EeApiEntitiesBillableMembership|array The loaded EeApiEntitiesBillableMembership as an assoc-array at the
