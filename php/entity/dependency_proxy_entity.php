...
class DependencyProxyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DependencyProxyEntity($this->_client, $opts);
    }

    /**
     * @param DependencyProxy|array $args DependencyProxy data (assoc-array) to store.
     */
    ...
    /**
     * @return DependencyProxy|array The current DependencyProxy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependencyProxy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependencyProxy fields).
     */
    ...
    /**
     * Remove an DependencyProxy matching the given criteria.
     *
     * @param DependencyProxyRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DependencyProxyRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependencyProxy|array The removed DependencyProxy as an assoc-array at the
