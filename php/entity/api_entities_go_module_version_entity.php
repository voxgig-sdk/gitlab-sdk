...
class ApiEntitiesGoModuleVersionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_go_module_version";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesGoModuleVersionEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesGoModuleVersion|array $args ApiEntitiesGoModuleVersion data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesGoModuleVersion|array The current ApiEntitiesGoModuleVersion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesGoModuleVersion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesGoModuleVersion fields).
     */
    ...
    /**
     * Load a single ApiEntitiesGoModuleVersion.
     *
     * @param ApiEntitiesGoModuleVersionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesGoModuleVersionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesGoModuleVersion|array The loaded ApiEntitiesGoModuleVersion as an assoc-array at the
