...
class ApiEntitiesDeploymentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_deployment";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesDeploymentEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesDeployment|array $args ApiEntitiesDeployment data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesDeployment|array The current ApiEntitiesDeployment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesDeployment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesDeployment fields).
     */
    ...
    /**
     * List ApiEntitiesDeployment items matching the given filter.
     *
     * @param ApiEntitiesDeploymentListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesDeployment fields) as an assoc-array; ApiEntitiesDeploymentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployment[]|array A list of ApiEntitiesDeployment items as assoc-arrays at
