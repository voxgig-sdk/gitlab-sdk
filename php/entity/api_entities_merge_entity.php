...
class ApiEntitiesMergeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesMergeEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesMerge|array $args ApiEntitiesMerge data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesMerge|array The current ApiEntitiesMerge data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesMerge fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesMerge fields).
     */
    ...
    /**
     * Load a single ApiEntitiesMerge.
     *
     * @param ApiEntitiesMergeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesMergeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMerge|array The loaded ApiEntitiesMerge as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesMerge.
     *
     * @param ApiEntitiesMergeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesMergeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMerge|array The created ApiEntitiesMerge as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesMerge.
     *
     * @param ApiEntitiesMergeUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesMergeUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMerge|array The updated ApiEntitiesMerge as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
