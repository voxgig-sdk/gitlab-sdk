...
// Gitlab SDK ApiEntitiesProjectSnippet entity
...
class ApiEntitiesProjectSnippetEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_project_snippet";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesProjectSnippetEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesProjectSnippet|array $args ApiEntitiesProjectSnippet data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesProjectSnippet|array The current ApiEntitiesProjectSnippet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesProjectSnippet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesProjectSnippet fields).
     */
    ...
    /**
     * Load a single ApiEntitiesProjectSnippet.
     *
     * @param ApiEntitiesProjectSnippetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesProjectSnippetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectSnippet|array The loaded ApiEntitiesProjectSnippet as an assoc-array at the
    ...
    /**
     * List ApiEntitiesProjectSnippet items matching the given filter.
     *
     * @param ApiEntitiesProjectSnippetListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesProjectSnippet fields) as an assoc-array; ApiEntitiesProjectSnippetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectSnippet[]|array A list of ApiEntitiesProjectSnippet items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesProjectSnippet.
     *
     * @param ApiEntitiesProjectSnippetCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProjectSnippetCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectSnippet|array The created ApiEntitiesProjectSnippet as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesProjectSnippet.
     *
     * @param ApiEntitiesProjectSnippetUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProjectSnippetUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectSnippet|array The updated ApiEntitiesProjectSnippet as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
