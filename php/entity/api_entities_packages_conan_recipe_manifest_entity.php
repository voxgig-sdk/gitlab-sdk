...
class ApiEntitiesPackagesConanRecipeManifestEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_packages_conan_recipe_manifest";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPackagesConanRecipeManifestEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPackagesConanRecipeManifest|array $args ApiEntitiesPackagesConanRecipeManifest data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPackagesConanRecipeManifest|array The current ApiEntitiesPackagesConanRecipeManifest data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPackagesConanRecipeManifest fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPackagesConanRecipeManifest fields).
     */
    ...
    /**
     * Load a single ApiEntitiesPackagesConanRecipeManifest.
     *
     * @param ApiEntitiesPackagesConanRecipeManifestLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesPackagesConanRecipeManifestLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPackagesConanRecipeManifest|array The loaded ApiEntitiesPackagesConanRecipeManifest as an assoc-array at the
