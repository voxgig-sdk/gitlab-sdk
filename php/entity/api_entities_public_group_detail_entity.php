...
class ApiEntitiesPublicGroupDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_public_group_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPublicGroupDetailEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPublicGroupDetail|array $args ApiEntitiesPublicGroupDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPublicGroupDetail|array The current ApiEntitiesPublicGroupDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPublicGroupDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPublicGroupDetail fields).
     */
    ...
    /**
     * List ApiEntitiesPublicGroupDetail items matching the given filter.
     *
     * @param ApiEntitiesPublicGroupDetailListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesPublicGroupDetail fields) as an assoc-array; ApiEntitiesPublicGroupDetailListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPublicGroupDetail[]|array A list of ApiEntitiesPublicGroupDetail items as assoc-arrays at
