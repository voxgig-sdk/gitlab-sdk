...
class ApiEntitiesRelationImportTrackerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_relation_import_tracker";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesRelationImportTrackerEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesRelationImportTracker|array $args ApiEntitiesRelationImportTracker data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesRelationImportTracker|array The current ApiEntitiesRelationImportTracker data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesRelationImportTracker fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesRelationImportTracker fields).
     */
    ...
    /**
     * Create a new ApiEntitiesRelationImportTracker.
     *
     * @param ApiEntitiesRelationImportTrackerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesRelationImportTrackerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRelationImportTracker|array The created ApiEntitiesRelationImportTracker as an assoc-array at the
