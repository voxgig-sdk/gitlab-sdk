...
// Gitlab SDK ApiEntitiesFeature entity
...
class ApiEntitiesFeatureEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_feature";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesFeatureEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesFeature|array $args ApiEntitiesFeature data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesFeature|array The current ApiEntitiesFeature data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesFeature fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesFeature fields).
     */
    ...
    /**
     * List ApiEntitiesFeature items matching the given filter.
     *
     * @param ApiEntitiesFeatureListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesFeature fields) as an assoc-array; ApiEntitiesFeatureListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFeature[]|array A list of ApiEntitiesFeature items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesFeature.
     *
     * @param ApiEntitiesFeatureCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesFeatureCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFeature|array The created ApiEntitiesFeature as an assoc-array at the
