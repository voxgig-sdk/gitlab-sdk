...
class ClusterAgentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ClusterAgentEntity($this->_client, $opts);
    }

    /**
     * @param ClusterAgent|array $args ClusterAgent data (assoc-array) to store.
     */
    ...
    /**
     * @return ClusterAgent|array The current ClusterAgent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ClusterAgent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ClusterAgent fields).
     */
    ...
    /**
     * Remove an ClusterAgent matching the given criteria.
     *
     * @param ClusterAgentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ClusterAgentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ClusterAgent|array The removed ClusterAgent as an assoc-array at the
