...
class ClusterEntity
{
    ...
    /**
     * Remove an Cluster matching the given criteria.
     *
     * @param ClusterRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ClusterRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cluster|array The removed Cluster as an assoc-array at the
