...
class ApiEntitiesPackagePipelineEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_package_pipeline";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPackagePipelineEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPackagePipeline|array $args ApiEntitiesPackagePipeline data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPackagePipeline|array The current ApiEntitiesPackagePipeline data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPackagePipeline fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPackagePipeline fields).
     */
    ...
    /**
     * Load a single ApiEntitiesPackagePipeline.
     *
     * @param ApiEntitiesPackagePipelineLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesPackagePipelineLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPackagePipeline|array The loaded ApiEntitiesPackagePipeline as an assoc-array at the
