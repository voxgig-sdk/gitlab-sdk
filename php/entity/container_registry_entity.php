...
class ContainerRegistryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ContainerRegistryEntity($this->_client, $opts);
    }

    /**
     * @param ContainerRegistry|array $args ContainerRegistry data (assoc-array) to store.
     */
    ...
    /**
     * @return ContainerRegistry|array The current ContainerRegistry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContainerRegistry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContainerRegistry fields).
     */
    ...
    /**
     * Remove an ContainerRegistry matching the given criteria.
     *
     * @param ContainerRegistryRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ContainerRegistryRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContainerRegistry|array The removed ContainerRegistry as an assoc-array at the
