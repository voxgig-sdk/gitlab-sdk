...
class ApiEntitiesPackageFileEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_package_file";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPackageFileEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPackageFile|array $args ApiEntitiesPackageFile data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPackageFile|array The current ApiEntitiesPackageFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPackageFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPackageFile fields).
     */
    ...
    /**
     * List ApiEntitiesPackageFile items matching the given filter.
     *
     * @param ApiEntitiesPackageFileListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesPackageFile fields) as an assoc-array; ApiEntitiesPackageFileListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPackageFile[]|array A list of ApiEntitiesPackageFile items as assoc-arrays at
