...
class GoProxyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GoProxyEntity($this->_client, $opts);
    }

    /**
     * @param GoProxy|array $args GoProxy data (assoc-array) to store.
     */
    ...
    /**
     * @return GoProxy|array The current GoProxy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GoProxy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GoProxy fields).
     */
    ...
    /**
     * Load a single GoProxy.
     *
     * @param GoProxyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GoProxyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GoProxy|array The loaded GoProxy as an assoc-array at the
