...
class ApiEntitiesNpmPackageTagEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_npm_package_tag";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesNpmPackageTagEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesNpmPackageTag|array $args ApiEntitiesNpmPackageTag data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesNpmPackageTag|array The current ApiEntitiesNpmPackageTag data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesNpmPackageTag fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesNpmPackageTag fields).
     */
    ...
    /**
     * Load a single ApiEntitiesNpmPackageTag.
     *
     * @param ApiEntitiesNpmPackageTagLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesNpmPackageTagLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesNpmPackageTag|array The loaded ApiEntitiesNpmPackageTag as an assoc-array at the
