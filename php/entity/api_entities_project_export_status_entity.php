...
class ApiEntitiesProjectExportStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_project_export_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesProjectExportStatusEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesProjectExportStatus|array $args ApiEntitiesProjectExportStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesProjectExportStatus|array The current ApiEntitiesProjectExportStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesProjectExportStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesProjectExportStatus fields).
     */
    ...
    /**
     * Load a single ApiEntitiesProjectExportStatus.
     *
     * @param ApiEntitiesProjectExportStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesProjectExportStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectExportStatus|array The loaded ApiEntitiesProjectExportStatus as an assoc-array at the
