...
class ApiEntitiesErrorTrackingProjectSettingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_error_tracking_project_setting";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesErrorTrackingProjectSettingEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesErrorTrackingProjectSetting|array $args ApiEntitiesErrorTrackingProjectSetting data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesErrorTrackingProjectSetting|array The current ApiEntitiesErrorTrackingProjectSetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesErrorTrackingProjectSetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesErrorTrackingProjectSetting fields).
     */
    ...
    /**
     * Load a single ApiEntitiesErrorTrackingProjectSetting.
     *
     * @param ApiEntitiesErrorTrackingProjectSettingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesErrorTrackingProjectSettingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesErrorTrackingProjectSetting|array The loaded ApiEntitiesErrorTrackingProjectSetting as an assoc-array at the
    ...
    /**
     * Update an existing ApiEntitiesErrorTrackingProjectSetting.
     *
     * @param ApiEntitiesErrorTrackingProjectSettingUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesErrorTrackingProjectSettingUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesErrorTrackingProjectSetting|array The updated ApiEntitiesErrorTrackingProjectSetting as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
