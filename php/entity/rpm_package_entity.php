...
class RpmPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RpmPackageEntity($this->_client, $opts);
    }

    /**
     * @param RpmPackage|array $args RpmPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return RpmPackage|array The current RpmPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RpmPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RpmPackage fields).
     */
    ...
    /**
     * Load a single RpmPackage.
     *
     * @param RpmPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RpmPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RpmPackage|array The loaded RpmPackage as an assoc-array at the
    ...
    /**
     * Create a new RpmPackage.
     *
     * @param RpmPackageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RpmPackageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RpmPackage|array The created RpmPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
