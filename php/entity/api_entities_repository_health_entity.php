...
class ApiEntitiesRepositoryHealthEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_repository_health";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesRepositoryHealthEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesRepositoryHealth|array $args ApiEntitiesRepositoryHealth data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesRepositoryHealth|array The current ApiEntitiesRepositoryHealth data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesRepositoryHealth fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesRepositoryHealth fields).
     */
    ...
    /**
     * Load a single ApiEntitiesRepositoryHealth.
     *
     * @param ApiEntitiesRepositoryHealthLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesRepositoryHealthLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRepositoryHealth|array The loaded ApiEntitiesRepositoryHealth as an assoc-array at the
