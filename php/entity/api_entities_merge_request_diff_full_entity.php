...
class ApiEntitiesMergeRequestDiffFullEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_merge_request_diff_full";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesMergeRequestDiffFullEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesMergeRequestDiffFull|array $args ApiEntitiesMergeRequestDiffFull data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesMergeRequestDiffFull|array The current ApiEntitiesMergeRequestDiffFull data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesMergeRequestDiffFull fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesMergeRequestDiffFull fields).
     */
    ...
    /**
     * Load a single ApiEntitiesMergeRequestDiffFull.
     *
     * @param ApiEntitiesMergeRequestDiffFullLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesMergeRequestDiffFullLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMergeRequestDiffFull|array The loaded ApiEntitiesMergeRequestDiffFull as an assoc-array at the
