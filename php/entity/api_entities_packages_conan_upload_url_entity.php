...
class ApiEntitiesPackagesConanUploadUrlEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_packages_conan_upload_url";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPackagesConanUploadUrlEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPackagesConanUploadUrl|array $args ApiEntitiesPackagesConanUploadUrl data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPackagesConanUploadUrl|array The current ApiEntitiesPackagesConanUploadUrl data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPackagesConanUploadUrl fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPackagesConanUploadUrl fields).
     */
    ...
    /**
     * Create a new ApiEntitiesPackagesConanUploadUrl.
     *
     * @param ApiEntitiesPackagesConanUploadUrlCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesPackagesConanUploadUrlCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPackagesConanUploadUrl|array The created ApiEntitiesPackagesConanUploadUrl as an assoc-array at the
