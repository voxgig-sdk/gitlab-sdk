...
class ApiEntitiesMarkdownUploadAdminEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_markdown_upload_admin";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesMarkdownUploadAdminEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesMarkdownUploadAdmin|array $args ApiEntitiesMarkdownUploadAdmin data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesMarkdownUploadAdmin|array The current ApiEntitiesMarkdownUploadAdmin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesMarkdownUploadAdmin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesMarkdownUploadAdmin fields).
     */
    ...
    /**
     * List ApiEntitiesMarkdownUploadAdmin items matching the given filter.
     *
     * @param ApiEntitiesMarkdownUploadAdminListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesMarkdownUploadAdmin fields) as an assoc-array; ApiEntitiesMarkdownUploadAdminListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMarkdownUploadAdmin[]|array A list of ApiEntitiesMarkdownUploadAdmin items as assoc-arrays at
