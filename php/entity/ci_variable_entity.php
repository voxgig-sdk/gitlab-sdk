...
class CiVariableEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CiVariableEntity($this->_client, $opts);
    }

    /**
     * @param CiVariable|array $args CiVariable data (assoc-array) to store.
     */
    ...
    /**
     * @return CiVariable|array The current CiVariable data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CiVariable fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CiVariable fields).
     */
    ...
    /**
     * Remove an CiVariable matching the given criteria.
     *
     * @param CiVariableRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CiVariableRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CiVariable|array The removed CiVariable as an assoc-array at the
