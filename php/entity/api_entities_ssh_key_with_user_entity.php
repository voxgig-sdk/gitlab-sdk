...
class ApiEntitiesSshKeyWithUserEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ssh_key_with_user";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesSshKeyWithUserEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesSshKeyWithUser|array $args ApiEntitiesSshKeyWithUser data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesSshKeyWithUser|array The current ApiEntitiesSshKeyWithUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesSshKeyWithUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesSshKeyWithUser fields).
     */
    ...
    /**
     * Load a single ApiEntitiesSshKeyWithUser.
     *
     * @param ApiEntitiesSshKeyWithUserLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesSshKeyWithUserLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesSshKeyWithUser|array The loaded ApiEntitiesSshKeyWithUser as an assoc-array at the
