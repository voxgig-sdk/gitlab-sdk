...
class ReleaseLinkEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReleaseLinkEntity($this->_client, $opts);
    }

    /**
     * @param ReleaseLink|array $args ReleaseLink data (assoc-array) to store.
     */
    ...
    /**
     * @return ReleaseLink|array The current ReleaseLink data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReleaseLink fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReleaseLink fields).
     */
    ...
    /**
     * Remove an ReleaseLink matching the given criteria.
     *
     * @param ReleaseLinkRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ReleaseLinkRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReleaseLink|array The removed ReleaseLink as an assoc-array at the
