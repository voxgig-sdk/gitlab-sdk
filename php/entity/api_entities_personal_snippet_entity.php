...
// Gitlab SDK ApiEntitiesPersonalSnippet entity
...
class ApiEntitiesPersonalSnippetEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_personal_snippet";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPersonalSnippetEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPersonalSnippet|array $args ApiEntitiesPersonalSnippet data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPersonalSnippet|array The current ApiEntitiesPersonalSnippet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPersonalSnippet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPersonalSnippet fields).
     */
    ...
    /**
     * Load a single ApiEntitiesPersonalSnippet.
     *
     * @param ApiEntitiesPersonalSnippetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesPersonalSnippetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPersonalSnippet|array The loaded ApiEntitiesPersonalSnippet as an assoc-array at the
    ...
    /**
     * List ApiEntitiesPersonalSnippet items matching the given filter.
     *
     * @param ApiEntitiesPersonalSnippetListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesPersonalSnippet fields) as an assoc-array; ApiEntitiesPersonalSnippetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPersonalSnippet[]|array A list of ApiEntitiesPersonalSnippet items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesPersonalSnippet.
     *
     * @param ApiEntitiesPersonalSnippetCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesPersonalSnippetCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPersonalSnippet|array The created ApiEntitiesPersonalSnippet as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesPersonalSnippet.
     *
     * @param ApiEntitiesPersonalSnippetUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesPersonalSnippetUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPersonalSnippet|array The updated ApiEntitiesPersonalSnippet as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
