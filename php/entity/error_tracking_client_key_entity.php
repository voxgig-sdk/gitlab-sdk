...
class ErrorTrackingClientKeyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "error_tracking_client_key";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ErrorTrackingClientKeyEntity($this->_client, $opts);
    }

    /**
     * @param ErrorTrackingClientKey|array $args ErrorTrackingClientKey data (assoc-array) to store.
     */
    ...
    /**
     * @return ErrorTrackingClientKey|array The current ErrorTrackingClientKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ErrorTrackingClientKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ErrorTrackingClientKey fields).
     */
    ...
    /**
     * Remove an ErrorTrackingClientKey matching the given criteria.
     *
     * @param ErrorTrackingClientKeyRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ErrorTrackingClientKeyRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ErrorTrackingClientKey|array The removed ErrorTrackingClientKey as an assoc-array at the
