...
// Gitlab SDK ApiEntitiesTrigger entity
...
class ApiEntitiesTriggerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_trigger";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesTriggerEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesTrigger|array $args ApiEntitiesTrigger data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesTrigger|array The current ApiEntitiesTrigger data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesTrigger fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesTrigger fields).
     */
    ...
    /**
     * Load a single ApiEntitiesTrigger.
     *
     * @param ApiEntitiesTriggerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesTriggerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTrigger|array The loaded ApiEntitiesTrigger as an assoc-array at the
    ...
    /**
     * List ApiEntitiesTrigger items matching the given filter.
     *
     * @param ApiEntitiesTriggerListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesTrigger fields) as an assoc-array; ApiEntitiesTriggerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTrigger[]|array A list of ApiEntitiesTrigger items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesTrigger.
     *
     * @param ApiEntitiesTriggerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesTriggerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTrigger|array The created ApiEntitiesTrigger as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesTrigger.
     *
     * @param ApiEntitiesTriggerUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesTriggerUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTrigger|array The updated ApiEntitiesTrigger as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
