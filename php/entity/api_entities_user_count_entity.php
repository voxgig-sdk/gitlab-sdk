...
class ApiEntitiesUserCountEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_user_count";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesUserCountEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesUserCount|array $args ApiEntitiesUserCount data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesUserCount|array The current ApiEntitiesUserCount data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesUserCount fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesUserCount fields).
     */
    ...
    /**
     * Load a single ApiEntitiesUserCount.
     *
     * @param ApiEntitiesUserCountLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesUserCountLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesUserCount|array The loaded ApiEntitiesUserCount as an assoc-array at the
