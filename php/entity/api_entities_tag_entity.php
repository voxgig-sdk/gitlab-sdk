...
// Gitlab SDK ApiEntitiesTag entity
...
class ApiEntitiesTagEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesTagEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesTag|array $args ApiEntitiesTag data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesTag|array The current ApiEntitiesTag data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesTag fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesTag fields).
     */
    ...
    /**
     * Load a single ApiEntitiesTag.
     *
     * @param ApiEntitiesTagLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesTagLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTag|array The loaded ApiEntitiesTag as an assoc-array at the
    ...
    /**
     * List ApiEntitiesTag items matching the given filter.
     *
     * @param ApiEntitiesTagListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesTag fields) as an assoc-array; ApiEntitiesTagListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTag[]|array A list of ApiEntitiesTag items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesTag.
     *
     * @param ApiEntitiesTagCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesTagCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTag|array The created ApiEntitiesTag as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
