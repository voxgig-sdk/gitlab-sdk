...
class ApiEntitiesDeployTokenWithTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_deploy_token_with_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesDeployTokenWithTokenEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesDeployTokenWithToken|array $args ApiEntitiesDeployTokenWithToken data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesDeployTokenWithToken|array The current ApiEntitiesDeployTokenWithToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesDeployTokenWithToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesDeployTokenWithToken fields).
     */
    ...
    /**
     * Create a new ApiEntitiesDeployTokenWithToken.
     *
     * @param ApiEntitiesDeployTokenWithTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesDeployTokenWithTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployTokenWithToken|array The created ApiEntitiesDeployTokenWithToken as an assoc-array at the
