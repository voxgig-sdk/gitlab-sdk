...
class SecureFileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SecureFileEntity($this->_client, $opts);
    }

    /**
     * @param SecureFile|array $args SecureFile data (assoc-array) to store.
     */
    ...
    /**
     * @return SecureFile|array The current SecureFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SecureFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SecureFile fields).
     */
    ...
    /**
     * Load a single SecureFile.
     *
     * @param SecureFileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SecureFileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecureFile|array The loaded SecureFile as an assoc-array at the
    ...
    /**
     * Remove an SecureFile matching the given criteria.
     *
     * @param SecureFileRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SecureFileRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecureFile|array The removed SecureFile as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
