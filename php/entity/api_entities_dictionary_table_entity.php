...
class ApiEntitiesDictionaryTableEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_dictionary_table";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesDictionaryTableEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesDictionaryTable|array $args ApiEntitiesDictionaryTable data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesDictionaryTable|array The current ApiEntitiesDictionaryTable data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesDictionaryTable fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesDictionaryTable fields).
     */
    ...
    /**
     * Load a single ApiEntitiesDictionaryTable.
     *
     * @param ApiEntitiesDictionaryTableLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesDictionaryTableLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDictionaryTable|array The loaded ApiEntitiesDictionaryTable as an assoc-array at the
