...
// Gitlab SDK GenericPackage entity
...
class GenericPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GenericPackageEntity($this->_client, $opts);
    }

    /**
     * @param GenericPackage|array $args GenericPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return GenericPackage|array The current GenericPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GenericPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GenericPackage fields).
     */
    ...
    /**
     * Load a single GenericPackage.
     *
     * @param GenericPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GenericPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GenericPackage|array The loaded GenericPackage as an assoc-array at the
    ...
    /**
     * Update an existing GenericPackage.
     *
     * @param GenericPackageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GenericPackageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GenericPackage|array The updated GenericPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
