...
class ApiEntitiesCiLintResultEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_lint_result";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiLintResultEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiLintResult|array $args ApiEntitiesCiLintResult data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiLintResult|array The current ApiEntitiesCiLintResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiLintResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiLintResult fields).
     */
    ...
    /**
     * List ApiEntitiesCiLintResult items matching the given filter.
     *
     * @param ApiEntitiesCiLintResultListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesCiLintResult fields) as an assoc-array; ApiEntitiesCiLintResultListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiLintResult[]|array A list of ApiEntitiesCiLintResult items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesCiLintResult.
     *
     * @param ApiEntitiesCiLintResultCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCiLintResultCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiLintResult|array The created ApiEntitiesCiLintResult as an assoc-array at the
