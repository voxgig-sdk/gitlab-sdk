...
class ApiEntitiesBasicSuccessEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_basic_success";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesBasicSuccessEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesBasicSuccess|array $args ApiEntitiesBasicSuccess data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesBasicSuccess|array The current ApiEntitiesBasicSuccess data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesBasicSuccess fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesBasicSuccess fields).
     */
    ...
    /**
     * Create a new ApiEntitiesBasicSuccess.
     *
     * @param ApiEntitiesBasicSuccessCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesBasicSuccessCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesBasicSuccess|array The created ApiEntitiesBasicSuccess as an assoc-array at the
