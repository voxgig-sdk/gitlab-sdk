...
class InvitationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InvitationEntity($this->_client, $opts);
    }

    /**
     * @param Invitation|array $args Invitation data (assoc-array) to store.
     */
    ...
    /**
     * @return Invitation|array The current Invitation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Invitation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Invitation fields).
     */
    ...
    /**
     * Remove an Invitation matching the given criteria.
     *
     * @param InvitationRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; InvitationRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Invitation|array The removed Invitation as an assoc-array at the
