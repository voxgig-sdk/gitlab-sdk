...
class PypiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PypiEntity($this->_client, $opts);
    }

    /**
     * @param Pypi|array $args Pypi data (assoc-array) to store.
     */
    ...
    /**
     * @return Pypi|array The current Pypi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Pypi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Pypi fields).
     */
     ...
     * Create a new Pypi.
     *
     * @param PypiCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PypiCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pypi|array The created Pypi as an assoc-array at the
