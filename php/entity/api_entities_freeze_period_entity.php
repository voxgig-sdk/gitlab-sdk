...
// Gitlab SDK ApiEntitiesFreezePeriod entity
...
class ApiEntitiesFreezePeriodEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_freeze_period";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesFreezePeriodEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesFreezePeriod|array $args ApiEntitiesFreezePeriod data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesFreezePeriod|array The current ApiEntitiesFreezePeriod data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesFreezePeriod fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesFreezePeriod fields).
     */
    ...
    /**
     * Load a single ApiEntitiesFreezePeriod.
     *
     * @param ApiEntitiesFreezePeriodLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesFreezePeriodLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFreezePeriod|array The loaded ApiEntitiesFreezePeriod as an assoc-array at the
    ...
    /**
     * List ApiEntitiesFreezePeriod items matching the given filter.
     *
     * @param ApiEntitiesFreezePeriodListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesFreezePeriod fields) as an assoc-array; ApiEntitiesFreezePeriodListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFreezePeriod[]|array A list of ApiEntitiesFreezePeriod items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesFreezePeriod.
     *
     * @param ApiEntitiesFreezePeriodCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesFreezePeriodCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFreezePeriod|array The created ApiEntitiesFreezePeriod as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesFreezePeriod.
     *
     * @param ApiEntitiesFreezePeriodUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesFreezePeriodUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFreezePeriod|array The updated ApiEntitiesFreezePeriod as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
