...
class RunnerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RunnerEntity($this->_client, $opts);
    }

    /**
     * @param Runner|array $args Runner data (assoc-array) to store.
     */
    ...
    /**
     * @return Runner|array The current Runner data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Runner fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Runner fields).
     */
     ...
     * Create a new Runner.
     *
     * @param RunnerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RunnerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Runner|array The created Runner as an assoc-array at the
    ...
    /**
     * Remove an Runner matching the given criteria.
     *
     * @param RunnerRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; RunnerRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Runner|array The removed Runner as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
