...
class ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_personal_access_token_with_last_used_ip";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPersonalAccessTokenWithLastUsedIp|array $args ApiEntitiesPersonalAccessTokenWithLastUsedIp data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPersonalAccessTokenWithLastUsedIp|array The current ApiEntitiesPersonalAccessTokenWithLastUsedIp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPersonalAccessTokenWithLastUsedIp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPersonalAccessTokenWithLastUsedIp fields).
     */
    ...
    /**
     * Load a single ApiEntitiesPersonalAccessTokenWithLastUsedIp.
     *
     * @param ApiEntitiesPersonalAccessTokenWithLastUsedIpLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesPersonalAccessTokenWithLastUsedIpLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPersonalAccessTokenWithLastUsedIp|array The loaded ApiEntitiesPersonalAccessTokenWithLastUsedIp as an assoc-array at the
    ...
    /**
     * List ApiEntitiesPersonalAccessTokenWithLastUsedIp items matching the given filter.
     *
     * @param ApiEntitiesPersonalAccessTokenWithLastUsedIpListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesPersonalAccessTokenWithLastUsedIp fields) as an assoc-array; ApiEntitiesPersonalAccessTokenWithLastUsedIpListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPersonalAccessTokenWithLastUsedIp[]|array A list of ApiEntitiesPersonalAccessTokenWithLastUsedIp items as assoc-arrays at
