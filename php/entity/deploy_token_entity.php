...
class DeployTokenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeployTokenEntity($this->_client, $opts);
    }

    /**
     * @param DeployToken|array $args DeployToken data (assoc-array) to store.
     */
    ...
    /**
     * @return DeployToken|array The current DeployToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeployToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeployToken fields).
     */
    ...
    /**
     * Remove an DeployToken matching the given criteria.
     *
     * @param DeployTokenRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DeployTokenRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeployToken|array The removed DeployToken as an assoc-array at the
