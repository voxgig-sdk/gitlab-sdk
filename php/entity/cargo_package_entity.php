...
class CargoPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CargoPackageEntity($this->_client, $opts);
    }

    /**
     * @param CargoPackage|array $args CargoPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return CargoPackage|array The current CargoPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CargoPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CargoPackage fields).
     */
    ...
    /**
     * Load a single CargoPackage.
     *
     * @param CargoPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CargoPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CargoPackage|array The loaded CargoPackage as an assoc-array at the
