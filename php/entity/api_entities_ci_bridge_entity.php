...
class ApiEntitiesCiBridgeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_bridge";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiBridgeEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiBridge|array $args ApiEntitiesCiBridge data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiBridge|array The current ApiEntitiesCiBridge data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiBridge fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiBridge fields).
     */
    ...
    /**
     * List ApiEntitiesCiBridge items matching the given filter.
     *
     * @param ApiEntitiesCiBridgeListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesCiBridge fields) as an assoc-array; ApiEntitiesCiBridgeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiBridge[]|array A list of ApiEntitiesCiBridge items as assoc-arrays at
