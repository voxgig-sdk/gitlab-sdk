...
class ApiEntitiesUserAgentDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_user_agent_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesUserAgentDetailEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesUserAgentDetail|array $args ApiEntitiesUserAgentDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesUserAgentDetail|array The current ApiEntitiesUserAgentDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesUserAgentDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesUserAgentDetail fields).
     */
    ...
    /**
     * Load a single ApiEntitiesUserAgentDetail.
     *
     * @param ApiEntitiesUserAgentDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesUserAgentDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesUserAgentDetail|array The loaded ApiEntitiesUserAgentDetail as an assoc-array at the
