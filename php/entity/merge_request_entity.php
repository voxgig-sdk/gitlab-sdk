...
// Gitlab SDK MergeRequest entity
...
class MergeRequestEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MergeRequestEntity($this->_client, $opts);
    }

    /**
     * @param MergeRequest|array $args MergeRequest data (assoc-array) to store.
     */
    ...
    /**
     * @return MergeRequest|array The current MergeRequest data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MergeRequest fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MergeRequest fields).
     */
    ...
    /**
     * Load a single MergeRequest.
     *
     * @param MergeRequestLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MergeRequestLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MergeRequest|array The loaded MergeRequest as an assoc-array at the
    ...
    /**
     * Update an existing MergeRequest.
     *
     * @param MergeRequestUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MergeRequestUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MergeRequest|array The updated MergeRequest as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an MergeRequest matching the given criteria.
     *
     * @param MergeRequestRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MergeRequestRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MergeRequest|array The removed MergeRequest as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
