...
class ApiEntitiesCiCatalogResourcesVersionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_catalog_resources_version";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiCatalogResourcesVersionEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiCatalogResourcesVersion|array $args ApiEntitiesCiCatalogResourcesVersion data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiCatalogResourcesVersion|array The current ApiEntitiesCiCatalogResourcesVersion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiCatalogResourcesVersion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiCatalogResourcesVersion fields).
     */
    ...
    /**
     * Create a new ApiEntitiesCiCatalogResourcesVersion.
     *
     * @param ApiEntitiesCiCatalogResourcesVersionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCiCatalogResourcesVersionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiCatalogResourcesVersion|array The created ApiEntitiesCiCatalogResourcesVersion as an assoc-array at the
