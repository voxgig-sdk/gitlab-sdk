...
class FreezePeriodEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FreezePeriodEntity($this->_client, $opts);
    }

    /**
     * @param FreezePeriod|array $args FreezePeriod data (assoc-array) to store.
     */
    ...
    /**
     * @return FreezePeriod|array The current FreezePeriod data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FreezePeriod fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FreezePeriod fields).
     */
    ...
    /**
     * Remove an FreezePeriod matching the given criteria.
     *
     * @param FreezePeriodRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; FreezePeriodRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FreezePeriod|array The removed FreezePeriod as an assoc-array at the
