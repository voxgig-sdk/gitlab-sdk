...
// Gitlab SDK ApiEntitiesMetricImage entity
...
class ApiEntitiesMetricImageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_metric_image";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesMetricImageEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesMetricImage|array $args ApiEntitiesMetricImage data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesMetricImage|array The current ApiEntitiesMetricImage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesMetricImage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesMetricImage fields).
     */
    ...
    /**
     * List ApiEntitiesMetricImage items matching the given filter.
     *
     * @param ApiEntitiesMetricImageListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesMetricImage fields) as an assoc-array; ApiEntitiesMetricImageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMetricImage[]|array A list of ApiEntitiesMetricImage items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesMetricImage.
     *
     * @param ApiEntitiesMetricImageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesMetricImageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMetricImage|array The created ApiEntitiesMetricImage as an assoc-array at the
    ...
    /**
     * Update an existing ApiEntitiesMetricImage.
     *
     * @param ApiEntitiesMetricImageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesMetricImageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMetricImage|array The updated ApiEntitiesMetricImage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
