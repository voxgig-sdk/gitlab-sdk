...
class ConanEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConanEntity($this->_client, $opts);
    }

    /**
     * @param Conan|array $args Conan data (assoc-array) to store.
     */
    ...
    /**
     * @return Conan|array The current Conan data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Conan fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Conan fields).
     */
    ...
    /**
     * Remove an Conan matching the given criteria.
     *
     * @param ConanRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ConanRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conan|array The removed Conan as an assoc-array at the
