...
class ReleaseEntity
{
     ...
     *
     * @param ReleaseRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ReleaseRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Release|array The removed Release as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
