...
class ApiEntitiesMrNoteEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_mr_note";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesMrNoteEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesMrNote|array $args ApiEntitiesMrNote data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesMrNote|array The current ApiEntitiesMrNote data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesMrNote fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesMrNote fields).
     */
    ...
    /**
     * Load a single ApiEntitiesMrNote.
     *
     * @param ApiEntitiesMrNoteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesMrNoteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMrNote|array The loaded ApiEntitiesMrNote as an assoc-array at the
