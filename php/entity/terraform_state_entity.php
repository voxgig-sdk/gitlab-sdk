...
// Gitlab SDK TerraformState entity
...
class TerraformStateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TerraformStateEntity($this->_client, $opts);
    }

    /**
     * @param TerraformState|array $args TerraformState data (assoc-array) to store.
     */
    ...
    /**
     * @return TerraformState|array The current TerraformState data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TerraformState fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TerraformState fields).
     */
    ...
    /**
     * Load a single TerraformState.
     *
     * @param TerraformStateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TerraformStateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TerraformState|array The loaded TerraformState as an assoc-array at the
    ...
    /**
     * Create a new TerraformState.
     *
     * @param TerraformStateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TerraformStateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TerraformState|array The created TerraformState as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an TerraformState matching the given criteria.
     *
     * @param TerraformStateRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; TerraformStateRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TerraformState|array The removed TerraformState as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
