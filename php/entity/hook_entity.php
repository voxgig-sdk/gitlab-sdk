...
class HookEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HookEntity($this->_client, $opts);
    }

    /**
     * @param Hook|array $args Hook data (assoc-array) to store.
     */
    ...
    /**
     * @return Hook|array The current Hook data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Hook fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Hook fields).
     */
     ...
     * Create a new Hook.
     *
     * @param HookCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HookCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hook|array The created Hook as an assoc-array at the
     ...
     *
     * @param HookUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HookUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hook|array The updated Hook as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Hook matching the given criteria.
     *
     * @param HookRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; HookRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hook|array The removed Hook as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
