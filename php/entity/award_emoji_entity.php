...
class AwardEmojiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AwardEmojiEntity($this->_client, $opts);
    }

    /**
     * @param AwardEmoji|array $args AwardEmoji data (assoc-array) to store.
     */
    ...
    /**
     * @return AwardEmoji|array The current AwardEmoji data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AwardEmoji fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AwardEmoji fields).
     */
    ...
    /**
     * Remove an AwardEmoji matching the given criteria.
     *
     * @param AwardEmojiRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AwardEmojiRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AwardEmoji|array The removed AwardEmoji as an assoc-array at the
