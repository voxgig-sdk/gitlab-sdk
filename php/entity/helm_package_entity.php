...
class HelmPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HelmPackageEntity($this->_client, $opts);
    }

    /**
     * @param HelmPackage|array $args HelmPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return HelmPackage|array The current HelmPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of HelmPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of HelmPackage fields).
     */
    ...
    /**
     * Load a single HelmPackage.
     *
     * @param HelmPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HelmPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HelmPackage|array The loaded HelmPackage as an assoc-array at the
    ...
    /**
     * Create a new HelmPackage.
     *
     * @param HelmPackageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HelmPackageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HelmPackage|array The created HelmPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
