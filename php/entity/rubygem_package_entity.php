...
// Gitlab SDK RubygemPackage entity
...
class RubygemPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RubygemPackageEntity($this->_client, $opts);
    }

    /**
     * @param RubygemPackage|array $args RubygemPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return RubygemPackage|array The current RubygemPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RubygemPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RubygemPackage fields).
     */
    ...
    /**
     * Load a single RubygemPackage.
     *
     * @param RubygemPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RubygemPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RubygemPackage|array The loaded RubygemPackage as an assoc-array at the
    ...
    /**
     * Create a new RubygemPackage.
     *
     * @param RubygemPackageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RubygemPackageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RubygemPackage|array The created RubygemPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
