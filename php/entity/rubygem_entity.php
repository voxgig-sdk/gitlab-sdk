...
class RubygemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RubygemEntity($this->_client, $opts);
    }

    /**
     * @param Rubygem|array $args Rubygem data (assoc-array) to store.
     */
    ...
    /**
     * @return Rubygem|array The current Rubygem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Rubygem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Rubygem fields).
     */
    ...
    /**
     * Load a single Rubygem.
     *
     * @param RubygemLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RubygemLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rubygem|array The loaded Rubygem as an assoc-array at the
