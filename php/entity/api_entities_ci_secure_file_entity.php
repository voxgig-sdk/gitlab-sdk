...
class ApiEntitiesCiSecureFileEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_secure_file";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiSecureFileEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiSecureFile|array $args ApiEntitiesCiSecureFile data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiSecureFile|array The current ApiEntitiesCiSecureFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiSecureFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiSecureFile fields).
     */
    ...
    /**
     * Load a single ApiEntitiesCiSecureFile.
     *
     * @param ApiEntitiesCiSecureFileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesCiSecureFileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiSecureFile|array The loaded ApiEntitiesCiSecureFile as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesCiSecureFile.
     *
     * @param ApiEntitiesCiSecureFileCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCiSecureFileCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiSecureFile|array The created ApiEntitiesCiSecureFile as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
