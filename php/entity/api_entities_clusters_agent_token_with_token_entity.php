...
class ApiEntitiesClustersAgentTokenWithTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_clusters_agent_token_with_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesClustersAgentTokenWithTokenEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesClustersAgentTokenWithToken|array $args ApiEntitiesClustersAgentTokenWithToken data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesClustersAgentTokenWithToken|array The current ApiEntitiesClustersAgentTokenWithToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesClustersAgentTokenWithToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesClustersAgentTokenWithToken fields).
     */
    ...
    /**
     * Create a new ApiEntitiesClustersAgentTokenWithToken.
     *
     * @param ApiEntitiesClustersAgentTokenWithTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesClustersAgentTokenWithTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClustersAgentTokenWithToken|array The created ApiEntitiesClustersAgentTokenWithToken as an assoc-array at the
