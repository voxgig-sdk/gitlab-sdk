...
class ApiEntitiesSystemBroadcastMessageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_system_broadcast_message";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesSystemBroadcastMessageEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesSystemBroadcastMessage|array $args ApiEntitiesSystemBroadcastMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesSystemBroadcastMessage|array The current ApiEntitiesSystemBroadcastMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesSystemBroadcastMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesSystemBroadcastMessage fields).
     */
     ...
     *
     * @param ApiEntitiesSystemBroadcastMessageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesSystemBroadcastMessageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesSystemBroadcastMessage|array The loaded ApiEntitiesSystemBroadcastMessage as an assoc-array at the
     ...
     *
     * @param ApiEntitiesSystemBroadcastMessageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesSystemBroadcastMessageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesSystemBroadcastMessage|array The created ApiEntitiesSystemBroadcastMessage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
     ...
     *
     * @param ApiEntitiesSystemBroadcastMessageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesSystemBroadcastMessageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesSystemBroadcastMessage|array The updated ApiEntitiesSystemBroadcastMessage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
     ...
     *
     * @param ApiEntitiesSystemBroadcastMessageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ApiEntitiesSystemBroadcastMessageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesSystemBroadcastMessage|array The removed ApiEntitiesSystemBroadcastMessage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
