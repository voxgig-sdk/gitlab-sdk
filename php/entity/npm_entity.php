...
class NpmEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NpmEntity($this->_client, $opts);
    }

    /**
     * @param Npm|array $args Npm data (assoc-array) to store.
     */
    ...
    /**
     * @return Npm|array The current Npm data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Npm fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Npm fields).
     */
    ...
    /**
     * Update an existing Npm.
     *
     * @param NpmUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NpmUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Npm|array The updated Npm as an assoc-array at the
