...
class ApiEntitiesClustersAgentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_clusters_agent";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesClustersAgentEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesClustersAgent|array $args ApiEntitiesClustersAgent data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesClustersAgent|array The current ApiEntitiesClustersAgent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesClustersAgent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesClustersAgent fields).
     */
    ...
    /**
     * Load a single ApiEntitiesClustersAgent.
     *
     * @param ApiEntitiesClustersAgentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesClustersAgentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClustersAgent|array The loaded ApiEntitiesClustersAgent as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesClustersAgent.
     *
     * @param ApiEntitiesClustersAgentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesClustersAgentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClustersAgent|array The created ApiEntitiesClustersAgent as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
