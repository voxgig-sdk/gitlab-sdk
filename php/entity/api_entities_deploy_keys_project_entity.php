...
// Gitlab SDK ApiEntitiesDeployKeysProject entity
...
class ApiEntitiesDeployKeysProjectEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_deploy_keys_project";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesDeployKeysProjectEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesDeployKeysProject|array $args ApiEntitiesDeployKeysProject data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesDeployKeysProject|array The current ApiEntitiesDeployKeysProject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesDeployKeysProject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesDeployKeysProject fields).
     */
    ...
    /**
     * Load a single ApiEntitiesDeployKeysProject.
     *
     * @param ApiEntitiesDeployKeysProjectLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesDeployKeysProjectLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployKeysProject|array The loaded ApiEntitiesDeployKeysProject as an assoc-array at the
    ...
    /**
     * List ApiEntitiesDeployKeysProject items matching the given filter.
     *
     * @param ApiEntitiesDeployKeysProjectListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesDeployKeysProject fields) as an assoc-array; ApiEntitiesDeployKeysProjectListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployKeysProject[]|array A list of ApiEntitiesDeployKeysProject items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesDeployKeysProject.
     *
     * @param ApiEntitiesDeployKeysProjectCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesDeployKeysProjectCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeployKeysProject|array The created ApiEntitiesDeployKeysProject as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
