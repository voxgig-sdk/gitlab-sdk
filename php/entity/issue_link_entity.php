...
class IssueLinkEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IssueLinkEntity($this->_client, $opts);
    }

    /**
     * @param IssueLink|array $args IssueLink data (assoc-array) to store.
     */
    ...
    /**
     * @return IssueLink|array The current IssueLink data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IssueLink fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IssueLink fields).
     */
    ...
    /**
     * Remove an IssueLink matching the given criteria.
     *
     * @param IssueLinkRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; IssueLinkRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IssueLink|array The removed IssueLink as an assoc-array at the
