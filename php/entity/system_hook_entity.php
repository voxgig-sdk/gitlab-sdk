...
class SystemHookEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SystemHookEntity($this->_client, $opts);
    }

    /**
     * @param SystemHook|array $args SystemHook data (assoc-array) to store.
     */
    ...
    /**
     * @return SystemHook|array The current SystemHook data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SystemHook fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SystemHook fields).
     */
    ...
    /**
     * Remove an SystemHook matching the given criteria.
     *
     * @param SystemHookRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SystemHookRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SystemHook|array The removed SystemHook as an assoc-array at the
