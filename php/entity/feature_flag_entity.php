...
class FeatureFlagEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FeatureFlagEntity($this->_client, $opts);
    }

    /**
     * @param FeatureFlag|array $args FeatureFlag data (assoc-array) to store.
     */
    ...
    /**
     * @return FeatureFlag|array The current FeatureFlag data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FeatureFlag fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FeatureFlag fields).
     */
    ...
    /**
     * Load a single FeatureFlag.
     *
     * @param FeatureFlagLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FeatureFlagLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FeatureFlag|array The loaded FeatureFlag as an assoc-array at the
     ...
     *
     * @param FeatureFlagCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FeatureFlagCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FeatureFlag|array The created FeatureFlag as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an FeatureFlag matching the given criteria.
     *
     * @param FeatureFlagRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; FeatureFlagRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FeatureFlag|array The removed FeatureFlag as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
