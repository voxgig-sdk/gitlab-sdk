...
class ApiEntitiesPlanLimitEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_plan_limit";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPlanLimitEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPlanLimit|array $args ApiEntitiesPlanLimit data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPlanLimit|array The current ApiEntitiesPlanLimit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPlanLimit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPlanLimit fields).
     */
    ...
    /**
     * Load a single ApiEntitiesPlanLimit.
     *
     * @param ApiEntitiesPlanLimitLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesPlanLimitLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPlanLimit|array The loaded ApiEntitiesPlanLimit as an assoc-array at the
    ...
    /**
     * Update an existing ApiEntitiesPlanLimit.
     *
     * @param ApiEntitiesPlanLimitUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesPlanLimitUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPlanLimit|array The updated ApiEntitiesPlanLimit as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
