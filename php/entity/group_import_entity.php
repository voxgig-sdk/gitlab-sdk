...
class GroupImportEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GroupImportEntity($this->_client, $opts);
    }

    /**
     * @param GroupImport|array $args GroupImport data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupImport|array The current GroupImport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupImport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupImport fields).
     */
    ...
    /**
     * Create a new GroupImport.
     *
     * @param GroupImportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GroupImportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupImport|array The created GroupImport as an assoc-array at the
