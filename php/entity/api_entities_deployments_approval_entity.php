...
class ApiEntitiesDeploymentsApprovalEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_deployments_approval";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesDeploymentsApprovalEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesDeploymentsApproval|array $args ApiEntitiesDeploymentsApproval data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesDeploymentsApproval|array The current ApiEntitiesDeploymentsApproval data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesDeploymentsApproval fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesDeploymentsApproval fields).
     */
    ...
    /**
     * Create a new ApiEntitiesDeploymentsApproval.
     *
     * @param ApiEntitiesDeploymentsApprovalCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesDeploymentsApprovalCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesDeploymentsApproval|array The created ApiEntitiesDeploymentsApproval as an assoc-array at the
