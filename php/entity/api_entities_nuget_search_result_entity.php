...
class ApiEntitiesNugetSearchResultEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_nuget_search_result";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesNugetSearchResultEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesNugetSearchResult|array $args ApiEntitiesNugetSearchResult data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesNugetSearchResult|array The current ApiEntitiesNugetSearchResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesNugetSearchResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesNugetSearchResult fields).
     */
    ...
    /**
     * List ApiEntitiesNugetSearchResult items matching the given filter.
     *
     * @param ApiEntitiesNugetSearchResultListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesNugetSearchResult fields) as an assoc-array; ApiEntitiesNugetSearchResultListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesNugetSearchResult[]|array A list of ApiEntitiesNugetSearchResult items as assoc-arrays at
