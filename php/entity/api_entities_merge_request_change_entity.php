...
class ApiEntitiesMergeRequestChangeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_merge_request_change";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesMergeRequestChangeEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesMergeRequestChange|array $args ApiEntitiesMergeRequestChange data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesMergeRequestChange|array The current ApiEntitiesMergeRequestChange data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesMergeRequestChange fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesMergeRequestChange fields).
     */
    ...
    /**
     * Load a single ApiEntitiesMergeRequestChange.
     *
     * @param ApiEntitiesMergeRequestChangeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesMergeRequestChangeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMergeRequestChange|array The loaded ApiEntitiesMergeRequestChange as an assoc-array at the
