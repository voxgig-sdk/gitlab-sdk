...
// Gitlab SDK ApiEntitiesProjectHook entity
...
class ApiEntitiesProjectHookEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_project_hook";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesProjectHookEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesProjectHook|array $args ApiEntitiesProjectHook data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesProjectHook|array The current ApiEntitiesProjectHook data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesProjectHook fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesProjectHook fields).
     */
    ...
    /**
     * Load a single ApiEntitiesProjectHook.
     *
     * @param ApiEntitiesProjectHookLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesProjectHookLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectHook|array The loaded ApiEntitiesProjectHook as an assoc-array at the
    ...
    /**
     * List ApiEntitiesProjectHook items matching the given filter.
     *
     * @param ApiEntitiesProjectHookListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesProjectHook fields) as an assoc-array; ApiEntitiesProjectHookListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectHook[]|array A list of ApiEntitiesProjectHook items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesProjectHook.
     *
     * @param ApiEntitiesProjectHookCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProjectHookCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectHook|array The created ApiEntitiesProjectHook as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesProjectHook.
     *
     * @param ApiEntitiesProjectHookUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProjectHookUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectHook|array The updated ApiEntitiesProjectHook as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
