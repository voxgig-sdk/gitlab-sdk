...
class ApiEntitiesAvatarEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_avatar";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesAvatarEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesAvatar|array $args ApiEntitiesAvatar data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesAvatar|array The current ApiEntitiesAvatar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesAvatar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesAvatar fields).
     */
    ...
    /**
     * Load a single ApiEntitiesAvatar.
     *
     * @param ApiEntitiesAvatarLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesAvatarLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesAvatar|array The loaded ApiEntitiesAvatar as an assoc-array at the
