...
class ApiEntitiesNpmPackageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_npm_package";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesNpmPackageEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesNpmPackage|array $args ApiEntitiesNpmPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesNpmPackage|array The current ApiEntitiesNpmPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesNpmPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesNpmPackage fields).
     */
    ...
    /**
     * Load a single ApiEntitiesNpmPackage.
     *
     * @param ApiEntitiesNpmPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesNpmPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesNpmPackage|array The loaded ApiEntitiesNpmPackage as an assoc-array at the
