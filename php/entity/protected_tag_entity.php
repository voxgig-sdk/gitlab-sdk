...
class ProtectedTagEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProtectedTagEntity($this->_client, $opts);
    }

    /**
     * @param ProtectedTag|array $args ProtectedTag data (assoc-array) to store.
     */
    ...
    /**
     * @return ProtectedTag|array The current ProtectedTag data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProtectedTag fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProtectedTag fields).
     */
    ...
    /**
     * Remove an ProtectedTag matching the given criteria.
     *
     * @param ProtectedTagRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ProtectedTagRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProtectedTag|array The removed ProtectedTag as an assoc-array at the
