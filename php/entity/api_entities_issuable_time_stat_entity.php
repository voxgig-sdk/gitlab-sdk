...
class ApiEntitiesIssuableTimeStatEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_issuable_time_stat";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesIssuableTimeStatEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesIssuableTimeStat|array $args ApiEntitiesIssuableTimeStat data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesIssuableTimeStat|array The current ApiEntitiesIssuableTimeStat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesIssuableTimeStat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesIssuableTimeStat fields).
     */
    ...
    /**
     * Load a single ApiEntitiesIssuableTimeStat.
     *
     * @param ApiEntitiesIssuableTimeStatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesIssuableTimeStatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesIssuableTimeStat|array The loaded ApiEntitiesIssuableTimeStat as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesIssuableTimeStat.
     *
     * @param ApiEntitiesIssuableTimeStatCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesIssuableTimeStatCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesIssuableTimeStat|array The created ApiEntitiesIssuableTimeStat as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
