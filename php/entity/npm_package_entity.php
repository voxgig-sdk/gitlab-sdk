...
class NpmPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NpmPackageEntity($this->_client, $opts);
    }

    /**
     * @param NpmPackage|array $args NpmPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return NpmPackage|array The current NpmPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NpmPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NpmPackage fields).
     */
    ...
    /**
     * Load a single NpmPackage.
     *
     * @param NpmPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NpmPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NpmPackage|array The loaded NpmPackage as an assoc-array at the
    ...
    /**
     * Create a new NpmPackage.
     *
     * @param NpmPackageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NpmPackageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NpmPackage|array The created NpmPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing NpmPackage.
     *
     * @param NpmPackageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NpmPackageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NpmPackage|array The updated NpmPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an NpmPackage matching the given criteria.
     *
     * @param NpmPackageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; NpmPackageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NpmPackage|array The removed NpmPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
