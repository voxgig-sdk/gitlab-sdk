...
// Gitlab SDK ApiEntitiesFeatureFlagUserList entity
...
class ApiEntitiesFeatureFlagUserListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_feature_flag_user_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesFeatureFlagUserListEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesFeatureFlagUserList|array $args ApiEntitiesFeatureFlagUserList data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesFeatureFlagUserList|array The current ApiEntitiesFeatureFlagUserList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesFeatureFlagUserList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesFeatureFlagUserList fields).
     */
    ...
    /**
     * Load a single ApiEntitiesFeatureFlagUserList.
     *
     * @param ApiEntitiesFeatureFlagUserListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesFeatureFlagUserListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFeatureFlagUserList|array The loaded ApiEntitiesFeatureFlagUserList as an assoc-array at the
    ...
    /**
     * List ApiEntitiesFeatureFlagUserList items matching the given filter.
     *
     * @param ApiEntitiesFeatureFlagUserListListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesFeatureFlagUserList fields) as an assoc-array; ApiEntitiesFeatureFlagUserListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFeatureFlagUserList[]|array A list of ApiEntitiesFeatureFlagUserList items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesFeatureFlagUserList.
     *
     * @param ApiEntitiesFeatureFlagUserListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesFeatureFlagUserListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFeatureFlagUserList|array The created ApiEntitiesFeatureFlagUserList as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesFeatureFlagUserList.
     *
     * @param ApiEntitiesFeatureFlagUserListUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesFeatureFlagUserListUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesFeatureFlagUserList|array The updated ApiEntitiesFeatureFlagUserList as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
