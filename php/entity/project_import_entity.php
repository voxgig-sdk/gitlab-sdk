...
class ProjectImportEntityClient
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectImportEntityClient($this->_client, $opts);
    }

    /**
     * @param ProjectImport|array $args ProjectImport data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectImport|array The current ProjectImport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectImport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectImport fields).
     */
    ...
    /**
     * Create a new ProjectImport.
     *
     * @param ProjectImportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectImportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectImport|array The created ProjectImport as an assoc-array at the
