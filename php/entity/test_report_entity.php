...
class TestReportEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TestReportEntity($this->_client, $opts);
    }

    /**
     * @param TestReport|array $args TestReport data (assoc-array) to store.
     */
    ...
    /**
     * @return TestReport|array The current TestReport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TestReport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TestReport fields).
     */
    ...
    /**
     * List TestReport items matching the given filter.
     *
     * @param TestReportListMatch|array|null $reqmatch Match filter (any subset
     *   of TestReport fields) as an assoc-array; TestReportListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TestReport[]|array A list of TestReport items as assoc-arrays at
