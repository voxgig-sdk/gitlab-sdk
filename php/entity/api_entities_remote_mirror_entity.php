...
// Gitlab SDK ApiEntitiesRemoteMirror entity
...
class ApiEntitiesRemoteMirrorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_remote_mirror";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesRemoteMirrorEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesRemoteMirror|array $args ApiEntitiesRemoteMirror data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesRemoteMirror|array The current ApiEntitiesRemoteMirror data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesRemoteMirror fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesRemoteMirror fields).
     */
    ...
    /**
     * Load a single ApiEntitiesRemoteMirror.
     *
     * @param ApiEntitiesRemoteMirrorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesRemoteMirrorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRemoteMirror|array The loaded ApiEntitiesRemoteMirror as an assoc-array at the
    ...
    /**
     * List ApiEntitiesRemoteMirror items matching the given filter.
     *
     * @param ApiEntitiesRemoteMirrorListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesRemoteMirror fields) as an assoc-array; ApiEntitiesRemoteMirrorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRemoteMirror[]|array A list of ApiEntitiesRemoteMirror items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesRemoteMirror.
     *
     * @param ApiEntitiesRemoteMirrorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesRemoteMirrorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRemoteMirror|array The created ApiEntitiesRemoteMirror as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesRemoteMirror.
     *
     * @param ApiEntitiesRemoteMirrorUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesRemoteMirrorUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRemoteMirror|array The updated ApiEntitiesRemoteMirror as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
