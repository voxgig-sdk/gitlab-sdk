...
class ApiEntitiesTagSignatureEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_tag_signature";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesTagSignatureEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesTagSignature|array $args ApiEntitiesTagSignature data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesTagSignature|array The current ApiEntitiesTagSignature data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesTagSignature fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesTagSignature fields).
     */
    ...
    /**
     * Load a single ApiEntitiesTagSignature.
     *
     * @param ApiEntitiesTagSignatureLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesTagSignatureLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesTagSignature|array The loaded ApiEntitiesTagSignature as an assoc-array at the
