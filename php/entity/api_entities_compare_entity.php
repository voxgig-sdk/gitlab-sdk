...
class ApiEntitiesCompareEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_compare";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCompareEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCompare|array $args ApiEntitiesCompare data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCompare|array The current ApiEntitiesCompare data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCompare fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCompare fields).
     */
    ...
    /**
     * List ApiEntitiesCompare items matching the given filter.
     *
     * @param ApiEntitiesCompareListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesCompare fields) as an assoc-array; ApiEntitiesCompareListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCompare[]|array A list of ApiEntitiesCompare items as assoc-arrays at
