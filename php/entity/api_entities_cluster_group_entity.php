...
// Gitlab SDK ApiEntitiesClusterGroup entity
...
class ApiEntitiesClusterGroupEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_cluster_group";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesClusterGroupEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesClusterGroup|array $args ApiEntitiesClusterGroup data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesClusterGroup|array The current ApiEntitiesClusterGroup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesClusterGroup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesClusterGroup fields).
     */
    ...
    /**
     * Load a single ApiEntitiesClusterGroup.
     *
     * @param ApiEntitiesClusterGroupLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesClusterGroupLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClusterGroup|array The loaded ApiEntitiesClusterGroup as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesClusterGroup.
     *
     * @param ApiEntitiesClusterGroupCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesClusterGroupCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClusterGroup|array The created ApiEntitiesClusterGroup as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesClusterGroup.
     *
     * @param ApiEntitiesClusterGroupUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesClusterGroupUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClusterGroup|array The updated ApiEntitiesClusterGroup as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
