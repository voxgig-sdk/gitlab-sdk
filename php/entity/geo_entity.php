...
class GeoEntity
{
     ...
     * Create a new Geo.
     *
     * @param GeoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GeoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Geo|array The created Geo as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
