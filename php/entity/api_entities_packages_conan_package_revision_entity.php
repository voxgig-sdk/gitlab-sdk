...
class ApiEntitiesPackagesConanPackageRevisionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_packages_conan_package_revision";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesPackagesConanPackageRevisionEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesPackagesConanPackageRevision|array $args ApiEntitiesPackagesConanPackageRevision data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesPackagesConanPackageRevision|array The current ApiEntitiesPackagesConanPackageRevision data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesPackagesConanPackageRevision fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesPackagesConanPackageRevision fields).
     */
    ...
    /**
     * List ApiEntitiesPackagesConanPackageRevision items matching the given filter.
     *
     * @param ApiEntitiesPackagesConanPackageRevisionListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesPackagesConanPackageRevision fields) as an assoc-array; ApiEntitiesPackagesConanPackageRevisionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesPackagesConanPackageRevision[]|array A list of ApiEntitiesPackagesConanPackageRevision items as assoc-arrays at
