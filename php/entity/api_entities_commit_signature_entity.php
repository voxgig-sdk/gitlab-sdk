...
class ApiEntitiesCommitSignatureEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_commit_signature";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCommitSignatureEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCommitSignature|array $args ApiEntitiesCommitSignature data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCommitSignature|array The current ApiEntitiesCommitSignature data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCommitSignature fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCommitSignature fields).
     */
    ...
    /**
     * Load a single ApiEntitiesCommitSignature.
     *
     * @param ApiEntitiesCommitSignatureLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesCommitSignatureLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCommitSignature|array The loaded ApiEntitiesCommitSignature as an assoc-array at the
