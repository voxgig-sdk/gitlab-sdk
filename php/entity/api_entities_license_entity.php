...
class ApiEntitiesLicenseEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_license";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesLicenseEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesLicense|array $args ApiEntitiesLicense data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesLicense|array The current ApiEntitiesLicense data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesLicense fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesLicense fields).
     */
