...
// Gitlab SDK ApiEntitiesNamespace entity
...
class ApiEntitiesNamespaceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_namespace";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesNamespaceEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesNamespace|array $args ApiEntitiesNamespace data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesNamespace|array The current ApiEntitiesNamespace data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesNamespace fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesNamespace fields).
     */
    ...
    /**
     * Load a single ApiEntitiesNamespace.
     *
     * @param ApiEntitiesNamespaceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesNamespaceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesNamespace|array The loaded ApiEntitiesNamespace as an assoc-array at the
    ...
    /**
     * List ApiEntitiesNamespace items matching the given filter.
     *
     * @param ApiEntitiesNamespaceListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesNamespace fields) as an assoc-array; ApiEntitiesNamespaceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesNamespace[]|array A list of ApiEntitiesNamespace items as assoc-arrays at
    ...
    /**
     * Update an existing ApiEntitiesNamespace.
     *
     * @param ApiEntitiesNamespaceUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesNamespaceUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesNamespace|array The updated ApiEntitiesNamespace as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
