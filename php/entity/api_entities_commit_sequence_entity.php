...
class ApiEntitiesCommitSequenceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_commit_sequence";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCommitSequenceEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCommitSequence|array $args ApiEntitiesCommitSequence data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCommitSequence|array The current ApiEntitiesCommitSequence data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCommitSequence fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCommitSequence fields).
     */
    ...
    /**
     * Load a single ApiEntitiesCommitSequence.
     *
     * @param ApiEntitiesCommitSequenceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesCommitSequenceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCommitSequence|array The loaded ApiEntitiesCommitSequence as an assoc-array at the
