...
class DebianPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DebianPackageEntity($this->_client, $opts);
    }

    /**
     * @param DebianPackage|array $args DebianPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return DebianPackage|array The current DebianPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DebianPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DebianPackage fields).
     */
    ...
    /**
     * Load a single DebianPackage.
     *
     * @param DebianPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DebianPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DebianPackage|array The loaded DebianPackage as an assoc-array at the
     ...
     *
     * @param DebianPackageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DebianPackageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DebianPackage|array The updated DebianPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
