...
class RpmEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RpmEntity($this->_client, $opts);
    }

    /**
     * @param Rpm|array $args Rpm data (assoc-array) to store.
     */
    ...
    /**
     * @return Rpm|array The current Rpm data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Rpm fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Rpm fields).
     */
     ...
     * Create a new Rpm.
     *
     * @param RpmCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RpmCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rpm|array The created Rpm as an assoc-array at the
