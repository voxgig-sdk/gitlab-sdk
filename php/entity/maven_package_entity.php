...
// Gitlab SDK MavenPackage entity
...
class MavenPackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MavenPackageEntity($this->_client, $opts);
    }

    /**
     * @param MavenPackage|array $args MavenPackage data (assoc-array) to store.
     */
    ...
    /**
     * @return MavenPackage|array The current MavenPackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MavenPackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MavenPackage fields).
     */
    ...
    /**
     * Load a single MavenPackage.
     *
     * @param MavenPackageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MavenPackageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MavenPackage|array The loaded MavenPackage as an assoc-array at the
    ...
    /**
     * Update an existing MavenPackage.
     *
     * @param MavenPackageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MavenPackageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MavenPackage|array The updated MavenPackage as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
