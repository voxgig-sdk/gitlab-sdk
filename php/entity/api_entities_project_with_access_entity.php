...
class ApiEntitiesProjectWithAccessEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_project_with_access";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesProjectWithAccessEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesProjectWithAccess|array $args ApiEntitiesProjectWithAccess data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesProjectWithAccess|array The current ApiEntitiesProjectWithAccess data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesProjectWithAccess fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesProjectWithAccess fields).
     */
    ...
    /**
     * Load a single ApiEntitiesProjectWithAccess.
     *
     * @param ApiEntitiesProjectWithAccessLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesProjectWithAccessLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectWithAccess|array The loaded ApiEntitiesProjectWithAccess as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesProjectWithAccess.
     *
     * @param ApiEntitiesProjectWithAccessCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesProjectWithAccessCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectWithAccess|array The created ApiEntitiesProjectWithAccess as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
