...
class ApiEntitiesBasicBadgeDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_basic_badge_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesBasicBadgeDetailEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesBasicBadgeDetail|array $args ApiEntitiesBasicBadgeDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesBasicBadgeDetail|array The current ApiEntitiesBasicBadgeDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesBasicBadgeDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesBasicBadgeDetail fields).
     */
    ...
    /**
     * Load a single ApiEntitiesBasicBadgeDetail.
     *
     * @param ApiEntitiesBasicBadgeDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesBasicBadgeDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesBasicBadgeDetail|array The loaded ApiEntitiesBasicBadgeDetail as an assoc-array at the
