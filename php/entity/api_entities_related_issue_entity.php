...
class ApiEntitiesRelatedIssueEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_related_issue";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesRelatedIssueEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesRelatedIssue|array $args ApiEntitiesRelatedIssue data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesRelatedIssue|array The current ApiEntitiesRelatedIssue data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesRelatedIssue fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesRelatedIssue fields).
     */
    ...
    /**
     * List ApiEntitiesRelatedIssue items matching the given filter.
     *
     * @param ApiEntitiesRelatedIssueListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesRelatedIssue fields) as an assoc-array; ApiEntitiesRelatedIssueListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesRelatedIssue[]|array A list of ApiEntitiesRelatedIssue items as assoc-arrays at
