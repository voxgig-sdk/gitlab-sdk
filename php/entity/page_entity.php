...
class PageEntity
{
     ...
     *
     * @param PageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Page|array The removed Page as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
