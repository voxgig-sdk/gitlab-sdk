...
class ApiEntitiesCiRunnerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_ci_runner";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesCiRunnerEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesCiRunner|array $args ApiEntitiesCiRunner data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesCiRunner|array The current ApiEntitiesCiRunner data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesCiRunner fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesCiRunner fields).
     */
    ...
    /**
     * Load a single ApiEntitiesCiRunner.
     *
     * @param ApiEntitiesCiRunnerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesCiRunnerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiRunner|array The loaded ApiEntitiesCiRunner as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesCiRunner.
     *
     * @param ApiEntitiesCiRunnerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesCiRunnerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesCiRunner|array The created ApiEntitiesCiRunner as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
