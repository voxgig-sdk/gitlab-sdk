...
class ApiEntitiesBasicRefEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_basic_ref";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesBasicRefEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesBasicRef|array $args ApiEntitiesBasicRef data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesBasicRef|array The current ApiEntitiesBasicRef data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesBasicRef fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesBasicRef fields).
     */
    ...
    /**
     * List ApiEntitiesBasicRef items matching the given filter.
     *
     * @param ApiEntitiesBasicRefListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesBasicRef fields) as an assoc-array; ApiEntitiesBasicRefListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesBasicRef[]|array A list of ApiEntitiesBasicRef items as assoc-arrays at
