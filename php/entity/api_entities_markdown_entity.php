...
class ApiEntitiesMarkdownEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_markdown";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesMarkdownEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesMarkdown|array $args ApiEntitiesMarkdown data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesMarkdown|array The current ApiEntitiesMarkdown data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesMarkdown fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesMarkdown fields).
     */
    ...
    /**
     * Create a new ApiEntitiesMarkdown.
     *
     * @param ApiEntitiesMarkdownCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesMarkdownCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesMarkdown|array The created ApiEntitiesMarkdown as an assoc-array at the
