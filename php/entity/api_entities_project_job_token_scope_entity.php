...
class ApiEntitiesProjectJobTokenScopeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_project_job_token_scope";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesProjectJobTokenScopeEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesProjectJobTokenScope|array $args ApiEntitiesProjectJobTokenScope data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesProjectJobTokenScope|array The current ApiEntitiesProjectJobTokenScope data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesProjectJobTokenScope fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesProjectJobTokenScope fields).
     */
    ...
    /**
     * Load a single ApiEntitiesProjectJobTokenScope.
     *
     * @param ApiEntitiesProjectJobTokenScopeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesProjectJobTokenScopeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesProjectJobTokenScope|array The loaded ApiEntitiesProjectJobTokenScope as an assoc-array at the
