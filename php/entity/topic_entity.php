...
class TopicEntity
{
    ...
    /**
     * Remove an Topic matching the given criteria.
     *
     * @param TopicRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; TopicRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Topic|array The removed Topic as an assoc-array at the
