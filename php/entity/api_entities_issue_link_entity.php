...
class ApiEntitiesIssueLinkEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_issue_link";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesIssueLinkEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesIssueLink|array $args ApiEntitiesIssueLink data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesIssueLink|array The current ApiEntitiesIssueLink data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesIssueLink fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesIssueLink fields).
     */
    ...
    /**
     * Load a single ApiEntitiesIssueLink.
     *
     * @param ApiEntitiesIssueLinkLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesIssueLinkLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesIssueLink|array The loaded ApiEntitiesIssueLink as an assoc-array at the
    ...
    /**
     * Create a new ApiEntitiesIssueLink.
     *
     * @param ApiEntitiesIssueLinkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesIssueLinkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesIssueLink|array The created ApiEntitiesIssueLink as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
