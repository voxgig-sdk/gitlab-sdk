...
class ApiEntitiesSnippetEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_snippet";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesSnippetEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesSnippet|array $args ApiEntitiesSnippet data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesSnippet|array The current ApiEntitiesSnippet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesSnippet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesSnippet fields).
     */
    ...
    /**
     * List ApiEntitiesSnippet items matching the given filter.
     *
     * @param ApiEntitiesSnippetListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesSnippet fields) as an assoc-array; ApiEntitiesSnippetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesSnippet[]|array A list of ApiEntitiesSnippet items as assoc-arrays at
