...
// Gitlab SDK ApiEntitiesIssue entity
...
class ApiEntitiesIssueEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesIssueEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesIssue|array $args ApiEntitiesIssue data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesIssue|array The current ApiEntitiesIssue data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesIssue fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesIssue fields).
     */
    ...
    /**
     * Load a single ApiEntitiesIssue.
     *
     * @param ApiEntitiesIssueLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesIssueLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesIssue|array The loaded ApiEntitiesIssue as an assoc-array at the
    ...
    /**
     * List ApiEntitiesIssue items matching the given filter.
     *
     * @param ApiEntitiesIssueListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiEntitiesIssue fields) as an assoc-array; ApiEntitiesIssueListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesIssue[]|array A list of ApiEntitiesIssue items as assoc-arrays at
    ...
    /**
     * Create a new ApiEntitiesIssue.
     *
     * @param ApiEntitiesIssueCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesIssueCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesIssue|array The created ApiEntitiesIssue as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ApiEntitiesIssue.
     *
     * @param ApiEntitiesIssueUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiEntitiesIssueUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesIssue|array The updated ApiEntitiesIssue as an assoc-array at the
     *   SDK boundary; throws GitlabError on failure (item-5 convention).
     */
