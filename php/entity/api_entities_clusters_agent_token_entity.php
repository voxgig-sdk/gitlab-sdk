...
class ApiEntitiesClustersAgentTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_entities_clusters_agent_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiEntitiesClustersAgentTokenEntity($this->_client, $opts);
    }

    /**
     * @param ApiEntitiesClustersAgentToken|array $args ApiEntitiesClustersAgentToken data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiEntitiesClustersAgentToken|array The current ApiEntitiesClustersAgentToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiEntitiesClustersAgentToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiEntitiesClustersAgentToken fields).
     */
    ...
    /**
     * Load a single ApiEntitiesClustersAgentToken.
     *
     * @param ApiEntitiesClustersAgentTokenLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiEntitiesClustersAgentTokenLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiEntitiesClustersAgentToken|array The loaded ApiEntitiesClustersAgentToken as an assoc-array at the
