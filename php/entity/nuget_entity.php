...
class NugetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NugetEntity($this->_client, $opts);
    }

    /**
     * @param Nuget|array $args Nuget data (assoc-array) to store.
     */
    ...
    /**
     * @return Nuget|array The current Nuget data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Nuget fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Nuget fields).
     */
    ...
    /**
     * Update an existing Nuget.
     *
     * @param NugetUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NugetUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Nuget|array The updated Nuget as an assoc-array at the
