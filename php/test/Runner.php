...
class GitlabTestRunner
{
    ...
    {
        $live = self::getenv('GITLAB_TEST_LIVE');
        $override = self::getenv('GITLAB_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GITLAB_TEST_EXPLAIN');
...
class_alias('GitlabTestRunner', 'Runner');
class_alias('GitlabHelpers', 'Helpers');
