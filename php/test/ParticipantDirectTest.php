...
class ParticipantDirectTest extends TestCase
{
    public function test_direct_list_participant(): void
    {
        $setup = participant_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-participant", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
