...
class JobDirectTest extends TestCase
{
    public function test_direct_load_job(): void
    {
        $setup = job_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-job", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
