...
class EeApiEntitiesSshCertificateDirectTest extends TestCase
{
    public function test_direct_list_ee_api_entities_ssh_certificate(): void
    {
        $setup = ee_api_entities_ssh_certificate_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-ee_api_entities_ssh_certificate", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
