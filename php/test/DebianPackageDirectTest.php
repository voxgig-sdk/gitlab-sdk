...
class DebianPackageDirectTest extends TestCase
{
    public function test_direct_load_debian_package(): void
    {
        $setup = debian_package_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-debian_package", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
