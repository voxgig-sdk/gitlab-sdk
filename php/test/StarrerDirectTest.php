...
class StarrerDirectTest extends TestCase
{
    public function test_direct_list_starrer(): void
    {
        $setup = starrer_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-starrer", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
