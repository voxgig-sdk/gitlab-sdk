...
class ProjectDirectTest extends TestCase
{
    public function test_direct_load_project(): void
    {
        $setup = project_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-project", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
