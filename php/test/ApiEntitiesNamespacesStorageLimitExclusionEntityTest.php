...
class ApiEntitiesNamespacesStorageLimitExclusionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        $api_entities_namespaces_storage_limit_exclusion_ref01_data = Helpers::to_map(is_object($api_entities_namespaces_storage_limit_exclusion_ref01_data_result) && method_exists($api_entities_namespaces_storage_limit_exclusion_ref01_data_result, 'data_get') ? $api_entities_namespaces_storage_limit_exclusion_ref01_data_result->data_get() : $api_entities_namespaces_storage_limit_exclusion_ref01_data_result);
        ...
        $api_entities_namespaces_storage_limit_exclusion_ref01_data_dt0_load_result = Helpers::to_map(is_object($api_entities_namespaces_storage_limit_exclusion_ref01_data_dt0_loaded) && method_exists($api_entities_namespaces_storage_limit_exclusion_ref01_data_dt0_loaded, 'data_get') ? $api_entities_namespaces_storage_limit_exclusion_ref01_data_dt0_loaded->data_get() : $api_entities_namespaces_storage_limit_exclusion_ref01_data_dt0_loaded);
