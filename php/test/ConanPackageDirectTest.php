...
class ConanPackageDirectTest extends TestCase
{
    public function test_direct_load_conan_package(): void
    {
        $setup = conan_package_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-conan_package", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
