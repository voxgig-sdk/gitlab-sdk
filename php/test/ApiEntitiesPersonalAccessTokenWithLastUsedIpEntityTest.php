...
class ApiEntitiesPersonalAccessTokenWithLastUsedIpEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->ApiEntitiesPersonalAccessTokenWithLastUsedIp(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->ApiEntitiesPersonalAccessTokenWithLastUsedIp(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        $api_entities_personal_access_token_with_last_used_ip_ref01_data_dt0_load_result = Helpers::to_map(is_object($api_entities_personal_access_token_with_last_used_ip_ref01_data_dt0_loaded) && method_exists($api_entities_personal_access_token_with_last_used_ip_ref01_data_dt0_loaded, 'data_get') ? $api_entities_personal_access_token_with_last_used_ip_ref01_data_dt0_loaded->data_get() : $api_entities_personal_access_token_with_last_used_ip_ref01_data_dt0_loaded);
