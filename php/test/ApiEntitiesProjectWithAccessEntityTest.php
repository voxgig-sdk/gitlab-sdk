...
class ApiEntitiesProjectWithAccessEntityTest extends TestCase
{
    public function test_create_instance(): void
    {
        $testsdk = GitlabSDK::test(null, null);
        $ent = $testsdk->ApiEntitiesProjectWithAccess(null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GITLAB_TEST_API_ENTITIES_PROJECT_WITH_ACCESS_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $api_entities_project_with_access_ref01_data_dt0_loaded = $api_entities_project_with_access_ref01_ent->load($api_entities_project_with_access_ref01_match_dt0, null);
        $api_entities_project_with_access_ref01_data_dt0_load_result = Helpers::to_map(is_object($api_entities_project_with_access_ref01_data_dt0_loaded) && method_exists($api_entities_project_with_access_ref01_data_dt0_loaded, 'data_get') ? $api_entities_project_with_access_ref01_data_dt0_loaded->data_get() : $api_entities_project_with_access_ref01_data_dt0_loaded);
        $this->assertNotNull($api_entities_project_with_access_ref01_data_dt0_load_result);
        $this->assertEquals($api_entities_project_with_access_ref01_data_dt0_load_result["id"], $api_entities_project_with_access_ref01_data["id"]);
...
function api_entities_project_with_access_basic_setup($extra)
{
    ...
    $entity_data_file = __DIR__ . '/../../.sdk/test/entity/api_entities_project_with_access/ApiEntitiesProjectWithAccessTestData.json';
    ...
    $entid_env_raw = getenv("GITLAB_TEST_API_ENTITIES_PROJECT_WITH_ACCESS_ENTID");
