...
class GitlabPagingFeature extends GitlabBaseFeature
{
    ...
    private function _graphql_pre_request(GitlabContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(GitlabContext $ctx): bool
    {
