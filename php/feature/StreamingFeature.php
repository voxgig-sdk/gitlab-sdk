...
class GitlabStreamingFeature extends GitlabBaseFeature
{
    ...
    private function _iterate(GitlabResult $result): \Generator
    {
    ...
    private function _streamable(GitlabContext $ctx): bool
    {
