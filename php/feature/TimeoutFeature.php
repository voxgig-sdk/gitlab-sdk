...
class GitlabTimeoutFeature extends GitlabBaseFeature
{
    ...
    private function _with_timeout(GitlabContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GitlabContext $_ctx, float $ms): void
    {
        $client = $this->client;
