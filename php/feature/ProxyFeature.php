...
class GitlabProxyFeature extends GitlabBaseFeature
{
    ...
    public function init(GitlabContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GitlabContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
