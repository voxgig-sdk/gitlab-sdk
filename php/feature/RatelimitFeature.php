...
class GitlabRatelimitFeature extends GitlabBaseFeature
{
    ...
    private function _acquire(GitlabContext $ctx): void
    {
    ...
    private function _track(GitlabContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
