...
class GitlabCacheFeature extends GitlabBaseFeature
{
    ...
    private function _through(GitlabContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
