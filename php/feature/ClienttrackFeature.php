...
// Gitlab SDK clienttrack feature
...
class GitlabClienttrackFeature extends GitlabBaseFeature
{
    ...
    public function PostConstruct(GitlabContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Gitlab-SDK';
