...
class GitlabFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GitlabSDK/1.0)';
    ...
    public static function call(GitlabContext $ctx, string $fullurl, array $fetchdef): array
    {
