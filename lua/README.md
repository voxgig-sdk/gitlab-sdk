...
```lua
local apientitiesmetricimages, err = client:ApiEntitiesMetricImage():list()
if err then error(err) end
```
...
local result, err = client:ApiEntitiesMetricImage():list()
...
Check `err` first (it is non-`nil` on failure), then use `value`:
    ...
    if err then error(err) end
    -- api_entities_appearance is the loaded record
...
| `updated_at` | `string` |  |
| `url` | `string` |  |
| `user` | `table` | API_Entities_UserBasic model |
| `username` | `string` |  |
| `web_url` | `string` |  |
...
| `can_push` | `boolean` |  |
| `commit` | `table` | API_Entities_Commit model |
...
| `coverage` | `number` |  |
| `created_at` | `string` |  |
| `downstream_pipeline` | `table` | API_Entities_Ci_PipelineBasic model |
...
| `id` | `number` |  |
| `name` | `string` |  |
| `pipeline` | `table` | API_Entities_Ci_PipelineBasic model |
| `project` | `table` |  |
...
| `queued_duration` | `number` | Time spent enqueued |
| `ref` | `string` |  |
| `runner` | `table` | API_Entities_Ci_Runner model |
| `runner_manager` | `table` | API_Entities_Ci_RunnerManager model |
| `size` | `number` |  |
| `stage` | `string` |  |
| `started_at` | `string` |  |
| `status` | `string` |  |
...
| `id` | `number` |  |
| `inputs` | `table` |  |
| `last_pipeline` | `table` | API_Entities_Ci_PipelineBasic model |
| `next_run_at` | `string` |  |
| `owner` | `table` | API_Entities_UserBasic model |
| `ref` | `string` |  |
| `updated_at` | `string` |  |
| `variables` | `table` | API_Entities_Ci_Variable model |
...
| `contacted_at` | `string` |  |
| `created_at` | `string` |  |
| `created_by` | `table` | API_Entities_UserBasic model |
| `description` | `string` |  |
| `groups` | `table` | API_Entities_BasicGroupDetails model |
| `id` | `number` |  |
| `ip_address` | `string` |  |
| `is_shared` | `boolean` |  |
...
| `paused` | `boolean` |  |
| `platform` | `string` |  |
| `projects` | `table` | API_Entities_BasicProjectDetails model |
| `revision` | `string` |  |
| `run_untagged` | `string` |  |
| `runner_type` | `string` |  |
| `status` | `string` |  |
...
```lua
local api_entities_ci_variable, err = client:ApiEntitiesCiVariable():load({ id = "api_entities_ci_variable_id", project_id = "project_id" })
```
...
| `enabled` | `boolean` |  |
| `environment_scope` | `string` |  |
| `group` | `table` | API_Entities_BasicGroupDetails model |
| `id` | `string` |  |
| `managed` | `string` |  |
| `management_project` | `table` |  |
| `name` | `string` |  |
...
| `platform_kubernetes` | `table` |  |
| `platform_type` | `string` |  |
| `project` | `table` | API_Entities_BasicProjectDetails model |
| `provider_gcp` | `table` |  |
| `provider_type` | `string` |  |
| `user` | `table` | API_Entities_UserBasic model |
...
| Field | Type | Description |
| --- | --- | --- |
| `author` | `table` | API_Entities_UserBasic model |
| `avatar_path` | `string` |  |
| `avatar_url` | `string` |  |
| `created_at` | `string` |  |
| `custom_attributes` | `table` |  |
...
| `size` | `number` |  |
| `status` | `string` |  |
| `tags` | `table` | API_Entities_ContainerRegistry_Tag model |
| `tags_count` | `number` |  |
...
| --- | --- | --- |
| `created_at` | `string` |  |
| `deployable` | `table` | API_Entities_Ci_Job model |
| `environment` | `table` | API_Entities_EnvironmentBasic model |
| `id` | `number` |  |
| `iid` | `number` |  |
| `ref` | `string` |  |
| `sha` | `string` |  |
...
| `approvals` | `table` | API_Entities_Deployments_Approval model |
| `created_at` | `string` |  |
| `deployable` | `table` | API_Entities_Ci_Job model |
| `environment` | `table` | API_Entities_EnvironmentBasic model |
| `id` | `number` |  |
...
| `cluster_agent` | `table` | API_Entities_Clusters_Agent model |
| `created_at` | `string` |  |
| `description` | `string` |  |
| `external_url` | `string` |  |
...
| `last_deployment` | `table` | API_Entities_Deployment model |
| `name` | `string` |  |
| `project` | `table` | API_Entities_BasicProjectDetails model |
| `slug` | `string` |  |
| `state` | `string` |  |
...
| `target_title` | `string` |  |
| `target_type` | `string` |  |
| `wiki_page` | `table` | API_Entities_WikiPageBasic model |
...
| Field | Type | Description |
| --- | --- | --- |
| `definition` | `table` | API_Entities_Feature_Definition model |
| `gates` | `table` |  |
| `id` | `string` |  |
| `name` | `string` |  |
| `state` | `string` |  |
...
| `root_storage_statistics` | `table` |  |
| `saml_group_links` | `table` |  |
...
| `project_creation_level` | `string` |  |
| `projects` | `table` | API_Entities_Project model |
| `repository_storage` | `string` |  |
| `request_access_enabled` | `string` |  |
| `require_two_factor_authentication` | `string` |  |
| `root_storage_statistics` | `table` |  |
...
| `share_with_group_lock` | `string` |  |
| `shared_projects` | `table` | API_Entities_Project model |
...
```lua
local api_entities_integration, err = client:ApiEntitiesIntegration():load({ id = "api_entities_integration_id", group_id = "group_id" })
```
...
| Field | Type | Description |
| --- | --- | --- |
| `assignee` | `table` | API_Entities_UserBasic model |
| `assignees` | `table` | API_Entities_UserBasic model |
| `author` | `table` | API_Entities_UserBasic model |
| `blocking_issues_count` | `string` |  |
| `closed_at` | `string` |  |
| `closed_by` | `table` | API_Entities_UserBasic model |
| `confidential` | `boolean` |  |
| `created_at` | `string` |  |
| `description` | `string` |  |
...
| `task_status` | `string` |  |
| `time_stats` | `table` | API_Entities_IssuableTimeStats model |
| `title` | `string` |  |
...
```lua
local api_entities_license, err = client:ApiEntitiesLicense():load({ id = "api_entities_license_id", name = "name", type = "type" })
```
...
```lua
local api_entities_member, err = client:ApiEntitiesMember():load({ id = "api_entities_member_id", group_id = "group_id" })
```
...
| `head_pipeline` | `table` | API_Entities_Ci_Pipeline model |
| `id` | `number` |  |
| `iid` | `number` |  |
| `imported` | `string` |  |
| `imported_from` | `string` |  |
...
| `merge_error` | `string` |  |
| `merge_status` | `string` |  |
| `merge_user` | `table` | API_Entities_UserBasic model |
| `merge_when_pipeline_succeeds` | `string` |  |
| `merged_at` | `string` |  |
| `merged_by` | `table` | API_Entities_UserBasic model |
| `milestone` | `table` |  |
| `pipeline` | `table` | API_Entities_Ci_PipelineBasic model |
| `prepared_at` | `string` |  |
| `project_id` | `number` |  |
...
| `reference` | `string` |  |
| `references` | `table` |  |
| `reviewers` | `table` | API_Entities_UserBasic model |
| `sha` | `string` |  |
...
| `author` | `table` | API_Entities_UserBasic model |
| `blocking_discussions_resolved` | `string` |  |
| `changes` | `table` | API_Entities_Diff model |
| `changes_count` | `string` |  |
| `closed_at` | `string` |  |
| `closed_by` | `table` | API_Entities_UserBasic model |
| `created_at` | `string` |  |
...
| --- | --- | --- |
| `base_commit_sha` | `string` |  |
| `commits` | `table` | API_Entities_Commit model |
| `created_at` | `string` |  |
| `diffs` | `table` | API_Entities_Diff model |
| `head_commit_sha` | `string` |  |
| `id` | `string` |  |
| `merge_request_id` | `string` |  |
| `patch_id_sha` | `string` |  |
...
| `name` | `string` |  |
| `package_type` | `string` |  |
| `pipeline` | `table` | API_Entities_Package_Pipeline model |
| `pipelines` | `table` | API_Entities_Package_Pipeline model |
| `project_id` | `number` |  |
| `project_path` | `string` |  |
| `status` | `string` |  |
| `tags` | `string` |  |
...
| `id` | `number` |  |
| `inherited` | `boolean` |  |
| `merge_access_levels` | `table` |  |
| `name` | `string` |  |
| `push_access_levels` | `table` |  |
| `unprotect_access_levels` | `table` |  |
...
```lua
local api_entities_user_agent_detail, err = client:ApiEntitiesUserAgentDetail():load({ snippet_id = "snippet_id" })
```
...
```lua
local composer_package, err = client:ComposerPackage():load({ group_id = "group_id", sha = "sha" })
```
...
```lua
local conan_package, err = client:ConanPackage():load({ file_id = "file_id", file_name = "file_name", package_channel = "package_channel", package_username = "package_username", package_version = "package_version", recipe_revision = "recipe_revision" })
```
...
```lua
local custom_attribute, err = client:CustomAttribute():load({ id = "custom_attribute_id", group_id = "group_id" })
```
...
```lua
local nuget_package, err = client:NugetPackage():load({ project_id = "project_id" })
```
...
```lua
local pypi_package, err = client:PypiPackage():load({ project_id = "project_id" })
```
...
```lua
local apientitiesmetricimage = client:ApiEntitiesMetricImage()
