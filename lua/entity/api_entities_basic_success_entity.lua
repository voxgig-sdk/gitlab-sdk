-- Gitlab SDK ApiEntitiesBasicSuccess entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesBasicSuccessEntity = {}
ApiEntitiesBasicSuccessEntity.__index = ApiEntitiesBasicSuccessEntity


function ApiEntitiesBasicSuccessEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBasicSuccessEntity)
  self._name = "api_entities_basic_success"
  self._client = client
...
function ApiEntitiesBasicSuccessEntity:get_name()
  return self._name
end


function ApiEntitiesBasicSuccessEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBasicSuccessEntity.new(self._client, opts)
end
...
function ApiEntitiesBasicSuccessEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBasicSuccessEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBasicSuccessEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBasicSuccessEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBasicSuccessEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBasicSuccessEntity:match_get()
...
function ApiEntitiesBasicSuccessEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesBasicSuccessCreateData
---@param ctrl? table
---@return ApiEntitiesBasicSuccess
---@return string? err
function ApiEntitiesBasicSuccessEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesBasicSuccessEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesBasicSuccessEntity
