...
local ApiEntitiesDiffEntity = {}
ApiEntitiesDiffEntity.__index = ApiEntitiesDiffEntity


function ApiEntitiesDiffEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDiffEntity)
  self._name = "api_entities_diff"
  self._client = client
...
function ApiEntitiesDiffEntity:get_name()
  return self._name
end


function ApiEntitiesDiffEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDiffEntity.new(self._client, opts)
end
...
function ApiEntitiesDiffEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDiffEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDiffEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDiffEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDiffEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDiffEntity:match_get()
...
function ApiEntitiesDiffEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesDiffLoadMatch
---@param ctrl? table
---@return ApiEntitiesDiff
---@return string? err
function ApiEntitiesDiffEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesDiffListMatch
---@param ctrl? table
---@return ApiEntitiesDiff[]
---@return string? err
function ApiEntitiesDiffEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiEntitiesDiffEntity:_run_op(ctx, post_done)
  local utility = self._utility
