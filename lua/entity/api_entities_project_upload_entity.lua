-- Gitlab SDK ApiEntitiesProjectUpload entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesProjectUploadEntity = {}
ApiEntitiesProjectUploadEntity.__index = ApiEntitiesProjectUploadEntity


function ApiEntitiesProjectUploadEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectUploadEntity)
  self._name = "api_entities_project_upload"
  self._client = client
...
function ApiEntitiesProjectUploadEntity:get_name()
  return self._name
end


function ApiEntitiesProjectUploadEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectUploadEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectUploadEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectUploadEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectUploadEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectUploadEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectUploadEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectUploadEntity:match_get()
...
function ApiEntitiesProjectUploadEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesProjectUploadCreateData
---@param ctrl? table
---@return ApiEntitiesProjectUpload
---@return string? err
function ApiEntitiesProjectUploadEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesProjectUploadEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectUploadEntity
