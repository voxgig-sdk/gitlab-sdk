-- Gitlab SDK ApiEntitiesAppearance entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesAppearanceEntity = {}
ApiEntitiesAppearanceEntity.__index = ApiEntitiesAppearanceEntity


function ApiEntitiesAppearanceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesAppearanceEntity)
  self._name = "api_entities_appearance"
  self._client = client
...
function ApiEntitiesAppearanceEntity:get_name()
  return self._name
end


function ApiEntitiesAppearanceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesAppearanceEntity.new(self._client, opts)
end
...
function ApiEntitiesAppearanceEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesAppearanceEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesAppearanceEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesAppearanceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesAppearanceEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesAppearanceEntity:match_get()
...
function ApiEntitiesAppearanceEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesAppearanceLoadMatch
---@param ctrl? table
---@return ApiEntitiesAppearance
---@return string? err
function ApiEntitiesAppearanceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesAppearanceUpdateData
---@param ctrl? table
---@return ApiEntitiesAppearance
---@return string? err
function ApiEntitiesAppearanceEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesAppearanceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesAppearanceEntity
