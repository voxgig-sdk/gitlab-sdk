-- Gitlab SDK ApiEntitiesCiRunnerRegistrationDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiRunnerRegistrationDetailEntity = {}
ApiEntitiesCiRunnerRegistrationDetailEntity.__index = ApiEntitiesCiRunnerRegistrationDetailEntity


function ApiEntitiesCiRunnerRegistrationDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiRunnerRegistrationDetailEntity)
  self._name = "api_entities_ci_runner_registration_detail"
  self._client = client
...
function ApiEntitiesCiRunnerRegistrationDetailEntity:get_name()
  return self._name
end


function ApiEntitiesCiRunnerRegistrationDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiRunnerRegistrationDetailEntity.new(self._client, opts)
end
...
function ApiEntitiesCiRunnerRegistrationDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiRunnerRegistrationDetailEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiRunnerRegistrationDetailEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiRunnerRegistrationDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiRunnerRegistrationDetailEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiRunnerRegistrationDetailEntity:match_get()
...
function ApiEntitiesCiRunnerRegistrationDetailEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesCiRunnerRegistrationDetailCreateData
---@param ctrl? table
---@return ApiEntitiesCiRunnerRegistrationDetail
---@return string? err
function ApiEntitiesCiRunnerRegistrationDetailEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesCiRunnerRegistrationDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiRunnerRegistrationDetailEntity
