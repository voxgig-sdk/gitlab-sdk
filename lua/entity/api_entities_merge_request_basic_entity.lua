...
local ApiEntitiesMergeRequestBasicEntity = {}
ApiEntitiesMergeRequestBasicEntity.__index = ApiEntitiesMergeRequestBasicEntity


function ApiEntitiesMergeRequestBasicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMergeRequestBasicEntity)
  self._name = "api_entities_merge_request_basic"
  self._client = client
...
function ApiEntitiesMergeRequestBasicEntity:get_name()
  return self._name
end


function ApiEntitiesMergeRequestBasicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMergeRequestBasicEntity.new(self._client, opts)
end
...
function ApiEntitiesMergeRequestBasicEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMergeRequestBasicEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMergeRequestBasicEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestBasicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMergeRequestBasicEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestBasicEntity:match_get()
...
function ApiEntitiesMergeRequestBasicEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMergeRequestBasicLoadMatch
---@param ctrl? table
---@return ApiEntitiesMergeRequestBasic
---@return string? err
function ApiEntitiesMergeRequestBasicEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesMergeRequestBasicListMatch
---@param ctrl? table
---@return ApiEntitiesMergeRequestBasic[]
---@return string? err
function ApiEntitiesMergeRequestBasicEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiEntitiesMergeRequestBasicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMergeRequestBasicEntity
