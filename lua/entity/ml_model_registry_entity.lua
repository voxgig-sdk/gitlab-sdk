...
local MlModelRegistryEntity = {}
MlModelRegistryEntity.__index = MlModelRegistryEntity


function MlModelRegistryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MlModelRegistryEntity)
  self._name = "ml_model_registry"
  self._client = client
...
function MlModelRegistryEntity:get_name()
  return self._name
end


function MlModelRegistryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MlModelRegistryEntity.new(self._client, opts)
end
...
function MlModelRegistryEntity:mark_deleted()
  self._deleted = true
end


function MlModelRegistryEntity:deleted()
  return true == self._deleted
end


function MlModelRegistryEntity:data_set(args)
  if args ~= nil then
...
function MlModelRegistryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MlModelRegistryEntity:match_set(args)
  if args ~= nil then
...
function MlModelRegistryEntity:match_get()
...
function MlModelRegistryEntity:stream(action, args, callopts)
...
---@param reqmatch MlModelRegistryLoadMatch
---@param ctrl? table
---@return MlModelRegistry
---@return string? err
function MlModelRegistryEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata MlModelRegistryUpdateData
---@param ctrl? table
---@return MlModelRegistry
---@return string? err
function MlModelRegistryEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function MlModelRegistryEntity:_run_op(ctx, post_done)
  local utility = self._utility
