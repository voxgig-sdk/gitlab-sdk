-- Gitlab SDK ApiEntitiesUserWithAdmin entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesUserWithAdminEntity = {}
ApiEntitiesUserWithAdminEntity.__index = ApiEntitiesUserWithAdminEntity


function ApiEntitiesUserWithAdminEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesUserWithAdminEntity)
  self._name = "api_entities_user_with_admin"
  self._client = client
...
function ApiEntitiesUserWithAdminEntity:get_name()
  return self._name
end


function ApiEntitiesUserWithAdminEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesUserWithAdminEntity.new(self._client, opts)
end
...
function ApiEntitiesUserWithAdminEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesUserWithAdminEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesUserWithAdminEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesUserWithAdminEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesUserWithAdminEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesUserWithAdminEntity:match_get()
...
function ApiEntitiesUserWithAdminEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesUserWithAdminListMatch
---@param ctrl? table
---@return ApiEntitiesUserWithAdmin[]
---@return string? err
function ApiEntitiesUserWithAdminEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesUserWithAdminEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesUserWithAdminEntity
