...
local MavenPackageEntity = {}
MavenPackageEntity.__index = MavenPackageEntity


function MavenPackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MavenPackageEntity)
  self._name = "maven_package"
  self._client = client
...
function MavenPackageEntity:get_name()
  return self._name
end


function MavenPackageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MavenPackageEntity.new(self._client, opts)
end
...
function MavenPackageEntity:mark_deleted()
  self._deleted = true
end


function MavenPackageEntity:deleted()
  return true == self._deleted
end


function MavenPackageEntity:data_set(args)
  if args ~= nil then
...
function MavenPackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MavenPackageEntity:match_set(args)
  if args ~= nil then
...
function MavenPackageEntity:match_get()
...
function MavenPackageEntity:stream(action, args, callopts)
...
---@param reqmatch MavenPackageLoadMatch
---@param ctrl? table
---@return MavenPackage
---@return string? err
function MavenPackageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata MavenPackageUpdateData
---@param ctrl? table
---@return MavenPackage
---@return string? err
function MavenPackageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function MavenPackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
