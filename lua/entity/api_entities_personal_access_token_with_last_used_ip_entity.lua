-- Gitlab SDK ApiEntitiesPersonalAccessTokenWithLastUsedIp entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity = {}
ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity.__index = ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity


function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity)
  self._name = "api_entities_personal_access_token_with_last_used_ip"
  self._client = client
...
function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:get_name()
  return self._name
end


function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity.new(self._client, opts)
end
...
function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:match_get()
...
function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPersonalAccessTokenWithLastUsedIpLoadMatch
---@param ctrl? table
---@return ApiEntitiesPersonalAccessTokenWithLastUsedIp
---@return string? err
function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesPersonalAccessTokenWithLastUsedIpListMatch
---@param ctrl? table
---@return ApiEntitiesPersonalAccessTokenWithLastUsedIp[]
---@return string? err
function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPersonalAccessTokenWithLastUsedIpEntity
