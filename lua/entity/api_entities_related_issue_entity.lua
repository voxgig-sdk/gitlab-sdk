-- Gitlab SDK ApiEntitiesRelatedIssue entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesRelatedIssueEntity = {}
ApiEntitiesRelatedIssueEntity.__index = ApiEntitiesRelatedIssueEntity


function ApiEntitiesRelatedIssueEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesRelatedIssueEntity)
  self._name = "api_entities_related_issue"
  self._client = client
...
function ApiEntitiesRelatedIssueEntity:get_name()
  return self._name
end


function ApiEntitiesRelatedIssueEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesRelatedIssueEntity.new(self._client, opts)
end
...
function ApiEntitiesRelatedIssueEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesRelatedIssueEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesRelatedIssueEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesRelatedIssueEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesRelatedIssueEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesRelatedIssueEntity:match_get()
...
function ApiEntitiesRelatedIssueEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesRelatedIssueListMatch
---@param ctrl? table
---@return ApiEntitiesRelatedIssue[]
---@return string? err
function ApiEntitiesRelatedIssueEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesRelatedIssueEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesRelatedIssueEntity
