...
local ApiEntitiesDeployKeysProjectEntity = {}
ApiEntitiesDeployKeysProjectEntity.__index = ApiEntitiesDeployKeysProjectEntity


function ApiEntitiesDeployKeysProjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDeployKeysProjectEntity)
  self._name = "api_entities_deploy_keys_project"
  self._client = client
...
function ApiEntitiesDeployKeysProjectEntity:get_name()
  return self._name
end


function ApiEntitiesDeployKeysProjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDeployKeysProjectEntity.new(self._client, opts)
end
...
function ApiEntitiesDeployKeysProjectEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDeployKeysProjectEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDeployKeysProjectEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDeployKeysProjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDeployKeysProjectEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDeployKeysProjectEntity:match_get()
...
function ApiEntitiesDeployKeysProjectEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesDeployKeysProjectLoadMatch
---@param ctrl? table
---@return ApiEntitiesDeployKeysProject
---@return string? err
function ApiEntitiesDeployKeysProjectEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesDeployKeysProjectListMatch
---@param ctrl? table
---@return ApiEntitiesDeployKeysProject[]
---@return string? err
function ApiEntitiesDeployKeysProjectEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesDeployKeysProjectCreateData
---@param ctrl? table
---@return ApiEntitiesDeployKeysProject
---@return string? err
function ApiEntitiesDeployKeysProjectEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesDeployKeysProjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesDeployKeysProjectEntity
