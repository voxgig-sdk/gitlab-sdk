...
function ApiEntitiesBasicBadgeDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBasicBadgeDetailEntity:deleted()
...
function ApiEntitiesBasicBadgeDetailEntity:stream(action, args, callopts)
