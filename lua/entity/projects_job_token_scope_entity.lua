-- Gitlab SDK ProjectsJobTokenScope entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ProjectsJobTokenScopeEntity = {}
ProjectsJobTokenScopeEntity.__index = ProjectsJobTokenScopeEntity


function ProjectsJobTokenScopeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProjectsJobTokenScopeEntity)
  self._name = "projects_job_token_scope"
  self._client = client
...
function ProjectsJobTokenScopeEntity:get_name()
  return self._name
end


function ProjectsJobTokenScopeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProjectsJobTokenScopeEntity.new(self._client, opts)
end
...
function ProjectsJobTokenScopeEntity:mark_deleted()
  self._deleted = true
end


function ProjectsJobTokenScopeEntity:deleted()
  return true == self._deleted
end


function ProjectsJobTokenScopeEntity:data_set(args)
  if args ~= nil then
...
function ProjectsJobTokenScopeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProjectsJobTokenScopeEntity:match_set(args)
  if args ~= nil then
...
function ProjectsJobTokenScopeEntity:match_get()
...
function ProjectsJobTokenScopeEntity:stream(action, args, callopts)
...
---@param reqdata ProjectsJobTokenScopeUpdateData
---@param ctrl? table
---@return ProjectsJobTokenScope
---@return string? err
function ProjectsJobTokenScopeEntity:update(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch ProjectsJobTokenScopeRemoveMatch
---@param ctrl? table
---@return ProjectsJobTokenScope
---@return string? err
function ProjectsJobTokenScopeEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ProjectsJobTokenScopeEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ProjectsJobTokenScopeEntity
