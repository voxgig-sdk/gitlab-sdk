...
function ApiEntitiesCiPipelineScheduleDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiPipelineScheduleDetailEntity:deleted()
...
function ApiEntitiesCiPipelineScheduleDetailEntity:stream(action, args, callopts)
