-- Gitlab SDK ApiEntitiesIssueLink entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesIssueLinkEntity = {}
ApiEntitiesIssueLinkEntity.__index = ApiEntitiesIssueLinkEntity


function ApiEntitiesIssueLinkEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesIssueLinkEntity)
  self._name = "api_entities_issue_link"
  self._client = client
...
function ApiEntitiesIssueLinkEntity:get_name()
  return self._name
end


function ApiEntitiesIssueLinkEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesIssueLinkEntity.new(self._client, opts)
end
...
function ApiEntitiesIssueLinkEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesIssueLinkEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesIssueLinkEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesIssueLinkEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesIssueLinkEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesIssueLinkEntity:match_get()
...
function ApiEntitiesIssueLinkEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesIssueLinkLoadMatch
---@param ctrl? table
---@return ApiEntitiesIssueLink
---@return string? err
function ApiEntitiesIssueLinkEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesIssueLinkCreateData
---@param ctrl? table
---@return ApiEntitiesIssueLink
---@return string? err
function ApiEntitiesIssueLinkEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesIssueLinkEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesIssueLinkEntity
