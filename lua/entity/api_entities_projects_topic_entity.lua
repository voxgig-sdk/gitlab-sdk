...
local ApiEntitiesProjectsTopicEntity = {}
ApiEntitiesProjectsTopicEntity.__index = ApiEntitiesProjectsTopicEntity


function ApiEntitiesProjectsTopicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectsTopicEntity)
  self._name = "api_entities_projects_topic"
  self._client = client
...
function ApiEntitiesProjectsTopicEntity:get_name()
  return self._name
end


function ApiEntitiesProjectsTopicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectsTopicEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectsTopicEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectsTopicEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectsTopicEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectsTopicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectsTopicEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectsTopicEntity:match_get()
...
function ApiEntitiesProjectsTopicEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectsTopicLoadMatch
---@param ctrl? table
---@return ApiEntitiesProjectsTopic
---@return string? err
function ApiEntitiesProjectsTopicEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesProjectsTopicCreateData
---@param ctrl? table
---@return ApiEntitiesProjectsTopic
---@return string? err
function ApiEntitiesProjectsTopicEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProjectsTopicUpdateData
---@param ctrl? table
---@return ApiEntitiesProjectsTopic
---@return string? err
function ApiEntitiesProjectsTopicEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesProjectsTopicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectsTopicEntity
