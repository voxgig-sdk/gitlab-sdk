...
function EeApiEntitiesSshCertificateEntity:mark_deleted()
  self._deleted = true
end


function EeApiEntitiesSshCertificateEntity:deleted()
...
function EeApiEntitiesSshCertificateEntity:stream(action, args, callopts)
