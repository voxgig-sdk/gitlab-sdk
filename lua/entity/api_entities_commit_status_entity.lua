...
local ApiEntitiesCommitStatusEntity = {}
ApiEntitiesCommitStatusEntity.__index = ApiEntitiesCommitStatusEntity


function ApiEntitiesCommitStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCommitStatusEntity)
  self._name = "api_entities_commit_status"
  self._client = client
...
function ApiEntitiesCommitStatusEntity:get_name()
  return self._name
end


function ApiEntitiesCommitStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCommitStatusEntity.new(self._client, opts)
end
...
function ApiEntitiesCommitStatusEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCommitStatusEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCommitStatusEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCommitStatusEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitStatusEntity:match_get()
...
function ApiEntitiesCommitStatusEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCommitStatusListMatch
---@param ctrl? table
---@return ApiEntitiesCommitStatus[]
---@return string? err
function ApiEntitiesCommitStatusEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesCommitStatusCreateData
---@param ctrl? table
---@return ApiEntitiesCommitStatus
---@return string? err
function ApiEntitiesCommitStatusEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesCommitStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCommitStatusEntity
