-- Gitlab SDK ApiEntitiesErrorTrackingClientKey entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesErrorTrackingClientKeyEntity = {}
ApiEntitiesErrorTrackingClientKeyEntity.__index = ApiEntitiesErrorTrackingClientKeyEntity


function ApiEntitiesErrorTrackingClientKeyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesErrorTrackingClientKeyEntity)
  self._name = "api_entities_error_tracking_client_key"
  self._client = client
...
function ApiEntitiesErrorTrackingClientKeyEntity:get_name()
  return self._name
end


function ApiEntitiesErrorTrackingClientKeyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesErrorTrackingClientKeyEntity.new(self._client, opts)
end
...
function ApiEntitiesErrorTrackingClientKeyEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesErrorTrackingClientKeyEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesErrorTrackingClientKeyEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesErrorTrackingClientKeyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesErrorTrackingClientKeyEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesErrorTrackingClientKeyEntity:match_get()
...
function ApiEntitiesErrorTrackingClientKeyEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesErrorTrackingClientKeyListMatch
---@param ctrl? table
---@return ApiEntitiesErrorTrackingClientKey[]
---@return string? err
function ApiEntitiesErrorTrackingClientKeyEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesErrorTrackingClientKeyCreateData
---@param ctrl? table
---@return ApiEntitiesErrorTrackingClientKey
---@return string? err
function ApiEntitiesErrorTrackingClientKeyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesErrorTrackingClientKeyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesErrorTrackingClientKeyEntity
