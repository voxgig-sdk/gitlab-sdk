...
local ApiEntitiesCommitEntity = {}
ApiEntitiesCommitEntity.__index = ApiEntitiesCommitEntity


function ApiEntitiesCommitEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCommitEntity)
  self._name = "api_entities_commit"
  self._client = client
...
function ApiEntitiesCommitEntity:get_name()
  return self._name
end


function ApiEntitiesCommitEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCommitEntity.new(self._client, opts)
end
...
function ApiEntitiesCommitEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCommitEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCommitEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCommitEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitEntity:match_get()
...
function ApiEntitiesCommitEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCommitListMatch
---@param ctrl? table
---@return ApiEntitiesCommit[]
---@return string? err
function ApiEntitiesCommitEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesCommitCreateData
---@param ctrl? table
---@return ApiEntitiesCommit
---@return string? err
function ApiEntitiesCommitEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesCommitEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCommitEntity
