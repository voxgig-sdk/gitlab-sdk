...
local ApiEntitiesReleasesLinkEntity = {}
ApiEntitiesReleasesLinkEntity.__index = ApiEntitiesReleasesLinkEntity


function ApiEntitiesReleasesLinkEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesReleasesLinkEntity)
  self._name = "api_entities_releases_link"
  self._client = client
...
function ApiEntitiesReleasesLinkEntity:get_name()
  return self._name
end


function ApiEntitiesReleasesLinkEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesReleasesLinkEntity.new(self._client, opts)
end
...
function ApiEntitiesReleasesLinkEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesReleasesLinkEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesReleasesLinkEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesReleasesLinkEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesReleasesLinkEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesReleasesLinkEntity:match_get()
...
function ApiEntitiesReleasesLinkEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesReleasesLinkLoadMatch
---@param ctrl? table
---@return ApiEntitiesReleasesLink
---@return string? err
function ApiEntitiesReleasesLinkEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesReleasesLinkListMatch
---@param ctrl? table
---@return ApiEntitiesReleasesLink[]
---@return string? err
function ApiEntitiesReleasesLinkEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesReleasesLinkCreateData
---@param ctrl? table
---@return ApiEntitiesReleasesLink
---@return string? err
function ApiEntitiesReleasesLinkEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesReleasesLinkUpdateData
---@param ctrl? table
---@return ApiEntitiesReleasesLink
---@return string? err
function ApiEntitiesReleasesLinkEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesReleasesLinkEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesReleasesLinkEntity
