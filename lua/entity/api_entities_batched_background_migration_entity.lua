...
local ApiEntitiesBatchedBackgroundMigrationEntity = {}
ApiEntitiesBatchedBackgroundMigrationEntity.__index = ApiEntitiesBatchedBackgroundMigrationEntity


function ApiEntitiesBatchedBackgroundMigrationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBatchedBackgroundMigrationEntity)
  self._name = "api_entities_batched_background_migration"
  self._client = client
...
function ApiEntitiesBatchedBackgroundMigrationEntity:get_name()
  return self._name
end


function ApiEntitiesBatchedBackgroundMigrationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBatchedBackgroundMigrationEntity.new(self._client, opts)
end
...
function ApiEntitiesBatchedBackgroundMigrationEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBatchedBackgroundMigrationEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBatchedBackgroundMigrationEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBatchedBackgroundMigrationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBatchedBackgroundMigrationEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBatchedBackgroundMigrationEntity:match_get()
...
function ApiEntitiesBatchedBackgroundMigrationEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesBatchedBackgroundMigrationLoadMatch
---@param ctrl? table
---@return ApiEntitiesBatchedBackgroundMigration
---@return string? err
function ApiEntitiesBatchedBackgroundMigrationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesBatchedBackgroundMigrationListMatch
---@param ctrl? table
---@return ApiEntitiesBatchedBackgroundMigration[]
---@return string? err
function ApiEntitiesBatchedBackgroundMigrationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesBatchedBackgroundMigrationUpdateData
---@param ctrl? table
---@return ApiEntitiesBatchedBackgroundMigration
---@return string? err
function ApiEntitiesBatchedBackgroundMigrationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesBatchedBackgroundMigrationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesBatchedBackgroundMigrationEntity
