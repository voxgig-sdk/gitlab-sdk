...
local ApiEntitiesTerraformModuleVersionEntity = {}
ApiEntitiesTerraformModuleVersionEntity.__index = ApiEntitiesTerraformModuleVersionEntity


function ApiEntitiesTerraformModuleVersionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesTerraformModuleVersionEntity)
  self._name = "api_entities_terraform_module_version"
  self._client = client
...
function ApiEntitiesTerraformModuleVersionEntity:get_name()
  return self._name
end


function ApiEntitiesTerraformModuleVersionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesTerraformModuleVersionEntity.new(self._client, opts)
end
...
function ApiEntitiesTerraformModuleVersionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesTerraformModuleVersionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesTerraformModuleVersionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesTerraformModuleVersionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesTerraformModuleVersionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesTerraformModuleVersionEntity:match_get()
...
function ApiEntitiesTerraformModuleVersionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesTerraformModuleVersionLoadMatch
---@param ctrl? table
---@return ApiEntitiesTerraformModuleVersion
---@return string? err
function ApiEntitiesTerraformModuleVersionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesTerraformModuleVersionListMatch
---@param ctrl? table
---@return ApiEntitiesTerraformModuleVersion[]
---@return string? err
function ApiEntitiesTerraformModuleVersionEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiEntitiesTerraformModuleVersionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesTerraformModuleVersionEntity
