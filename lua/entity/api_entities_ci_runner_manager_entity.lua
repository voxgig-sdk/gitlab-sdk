-- Gitlab SDK ApiEntitiesCiRunnerManager entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiRunnerManagerEntity = {}
ApiEntitiesCiRunnerManagerEntity.__index = ApiEntitiesCiRunnerManagerEntity


function ApiEntitiesCiRunnerManagerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiRunnerManagerEntity)
  self._name = "api_entities_ci_runner_manager"
  self._client = client
...
function ApiEntitiesCiRunnerManagerEntity:get_name()
  return self._name
end


function ApiEntitiesCiRunnerManagerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiRunnerManagerEntity.new(self._client, opts)
end
...
function ApiEntitiesCiRunnerManagerEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiRunnerManagerEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiRunnerManagerEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiRunnerManagerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiRunnerManagerEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiRunnerManagerEntity:match_get()
...
function ApiEntitiesCiRunnerManagerEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiRunnerManagerLoadMatch
---@param ctrl? table
---@return ApiEntitiesCiRunnerManager
---@return string? err
function ApiEntitiesCiRunnerManagerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesCiRunnerManagerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiRunnerManagerEntity
