...
local ApiEntitiesFeatureFlagUserListEntity = {}
ApiEntitiesFeatureFlagUserListEntity.__index = ApiEntitiesFeatureFlagUserListEntity


function ApiEntitiesFeatureFlagUserListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesFeatureFlagUserListEntity)
  self._name = "api_entities_feature_flag_user_list"
  self._client = client
...
function ApiEntitiesFeatureFlagUserListEntity:get_name()
  return self._name
end


function ApiEntitiesFeatureFlagUserListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesFeatureFlagUserListEntity.new(self._client, opts)
end
...
function ApiEntitiesFeatureFlagUserListEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesFeatureFlagUserListEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesFeatureFlagUserListEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesFeatureFlagUserListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesFeatureFlagUserListEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesFeatureFlagUserListEntity:match_get()
...
function ApiEntitiesFeatureFlagUserListEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesFeatureFlagUserListLoadMatch
---@param ctrl? table
---@return ApiEntitiesFeatureFlagUserList
---@return string? err
function ApiEntitiesFeatureFlagUserListEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesFeatureFlagUserListListMatch
---@param ctrl? table
---@return ApiEntitiesFeatureFlagUserList[]
---@return string? err
function ApiEntitiesFeatureFlagUserListEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesFeatureFlagUserListCreateData
---@param ctrl? table
---@return ApiEntitiesFeatureFlagUserList
---@return string? err
function ApiEntitiesFeatureFlagUserListEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesFeatureFlagUserListUpdateData
---@param ctrl? table
---@return ApiEntitiesFeatureFlagUserList
---@return string? err
function ApiEntitiesFeatureFlagUserListEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesFeatureFlagUserListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesFeatureFlagUserListEntity
