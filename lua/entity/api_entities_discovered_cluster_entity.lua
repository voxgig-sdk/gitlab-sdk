-- Gitlab SDK ApiEntitiesDiscoveredCluster entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesDiscoveredClusterEntity = {}
ApiEntitiesDiscoveredClusterEntity.__index = ApiEntitiesDiscoveredClusterEntity


function ApiEntitiesDiscoveredClusterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDiscoveredClusterEntity)
  self._name = "api_entities_discovered_cluster"
  self._client = client
...
function ApiEntitiesDiscoveredClusterEntity:get_name()
  return self._name
end


function ApiEntitiesDiscoveredClusterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDiscoveredClusterEntity.new(self._client, opts)
end
...
function ApiEntitiesDiscoveredClusterEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDiscoveredClusterEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDiscoveredClusterEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDiscoveredClusterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDiscoveredClusterEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDiscoveredClusterEntity:match_get()
...
function ApiEntitiesDiscoveredClusterEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesDiscoveredClusterLoadMatch
---@param ctrl? table
---@return ApiEntitiesDiscoveredCluster
---@return string? err
function ApiEntitiesDiscoveredClusterEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesDiscoveredClusterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesDiscoveredClusterEntity
