...
function ApiEntitiesCiLintResultEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiLintResultEntity:deleted()
...
function ApiEntitiesCiLintResultEntity:stream(action, args, callopts)
