-- Gitlab SDK ApiEntitiesBasicProjectDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesBasicProjectDetailEntity = {}
ApiEntitiesBasicProjectDetailEntity.__index = ApiEntitiesBasicProjectDetailEntity


function ApiEntitiesBasicProjectDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBasicProjectDetailEntity)
  self._name = "api_entities_basic_project_detail"
  self._client = client
...
function ApiEntitiesBasicProjectDetailEntity:get_name()
  return self._name
end


function ApiEntitiesBasicProjectDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBasicProjectDetailEntity.new(self._client, opts)
end
...
function ApiEntitiesBasicProjectDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBasicProjectDetailEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBasicProjectDetailEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBasicProjectDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBasicProjectDetailEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBasicProjectDetailEntity:match_get()
...
function ApiEntitiesBasicProjectDetailEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesBasicProjectDetailListMatch
---@param ctrl? table
---@return ApiEntitiesBasicProjectDetail[]
---@return string? err
function ApiEntitiesBasicProjectDetailEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesBasicProjectDetailCreateData
---@param ctrl? table
---@return ApiEntitiesBasicProjectDetail
---@return string? err
function ApiEntitiesBasicProjectDetailEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesBasicProjectDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesBasicProjectDetailEntity
