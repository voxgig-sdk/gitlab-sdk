-- Gitlab SDK ApiEntitiesResourceAccessTokenWithToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesResourceAccessTokenWithTokenEntity = {}
ApiEntitiesResourceAccessTokenWithTokenEntity.__index = ApiEntitiesResourceAccessTokenWithTokenEntity


function ApiEntitiesResourceAccessTokenWithTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesResourceAccessTokenWithTokenEntity)
  self._name = "api_entities_resource_access_token_with_token"
  self._client = client
...
function ApiEntitiesResourceAccessTokenWithTokenEntity:get_name()
  return self._name
end


function ApiEntitiesResourceAccessTokenWithTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesResourceAccessTokenWithTokenEntity.new(self._client, opts)
end
...
function ApiEntitiesResourceAccessTokenWithTokenEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesResourceAccessTokenWithTokenEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesResourceAccessTokenWithTokenEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesResourceAccessTokenWithTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesResourceAccessTokenWithTokenEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesResourceAccessTokenWithTokenEntity:match_get()
...
function ApiEntitiesResourceAccessTokenWithTokenEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesResourceAccessTokenWithTokenCreateData
---@param ctrl? table
---@return ApiEntitiesResourceAccessTokenWithToken
---@return string? err
function ApiEntitiesResourceAccessTokenWithTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesResourceAccessTokenWithTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesResourceAccessTokenWithTokenEntity
