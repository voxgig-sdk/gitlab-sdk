...
function ApiEntitiesCiPipelineBasicEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiPipelineBasicEntity:deleted()
...
function ApiEntitiesCiPipelineBasicEntity:stream(action, args, callopts)
