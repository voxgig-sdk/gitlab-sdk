-- Gitlab SDK ApiEntitiesLicense entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesLicenseEntity = {}
ApiEntitiesLicenseEntity.__index = ApiEntitiesLicenseEntity


function ApiEntitiesLicenseEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesLicenseEntity)
  self._name = "api_entities_license"
  self._client = client
...
function ApiEntitiesLicenseEntity:get_name()
  return self._name
end


function ApiEntitiesLicenseEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesLicenseEntity.new(self._client, opts)
end
...
function ApiEntitiesLicenseEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesLicenseEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesLicenseEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesLicenseEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesLicenseEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesLicenseEntity:match_get()
...
function ApiEntitiesLicenseEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesLicenseListMatch
---@param ctrl? table
---@return ApiEntitiesLicense[]
---@return string? err
function ApiEntitiesLicenseEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesLicenseEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesLicenseEntity
