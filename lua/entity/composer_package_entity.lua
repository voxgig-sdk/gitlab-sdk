-- Gitlab SDK ComposerPackage entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ComposerPackageEntity = {}
ComposerPackageEntity.__index = ComposerPackageEntity


function ComposerPackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ComposerPackageEntity)
  self._name = "composer_package"
  self._client = client
...
function ComposerPackageEntity:get_name()
  return self._name
end


function ComposerPackageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ComposerPackageEntity.new(self._client, opts)
end
...
function ComposerPackageEntity:mark_deleted()
  self._deleted = true
end


function ComposerPackageEntity:deleted()
  return true == self._deleted
end


function ComposerPackageEntity:data_set(args)
  if args ~= nil then
...
function ComposerPackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ComposerPackageEntity:match_set(args)
  if args ~= nil then
...
function ComposerPackageEntity:match_get()
...
function ComposerPackageEntity:stream(action, args, callopts)
...
---@param reqmatch ComposerPackageLoadMatch
---@param ctrl? table
---@return ComposerPackage
---@return string? err
function ComposerPackageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ComposerPackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
