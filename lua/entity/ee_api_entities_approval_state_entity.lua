-- Gitlab SDK EeApiEntitiesApprovalState entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EeApiEntitiesApprovalStateEntity = {}
EeApiEntitiesApprovalStateEntity.__index = EeApiEntitiesApprovalStateEntity


function EeApiEntitiesApprovalStateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EeApiEntitiesApprovalStateEntity)
  self._name = "ee_api_entities_approval_state"
  self._client = client
...
function EeApiEntitiesApprovalStateEntity:get_name()
  return self._name
end


function EeApiEntitiesApprovalStateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EeApiEntitiesApprovalStateEntity.new(self._client, opts)
end
...
function EeApiEntitiesApprovalStateEntity:mark_deleted()
  self._deleted = true
end


function EeApiEntitiesApprovalStateEntity:deleted()
  return true == self._deleted
end


function EeApiEntitiesApprovalStateEntity:data_set(args)
  if args ~= nil then
...
function EeApiEntitiesApprovalStateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EeApiEntitiesApprovalStateEntity:match_set(args)
  if args ~= nil then
...
function EeApiEntitiesApprovalStateEntity:match_get()
...
function EeApiEntitiesApprovalStateEntity:stream(action, args, callopts)
...
---@param reqdata EeApiEntitiesApprovalStateCreateData
---@param ctrl? table
---@return EeApiEntitiesApprovalState
---@return string? err
function EeApiEntitiesApprovalStateEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function EeApiEntitiesApprovalStateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EeApiEntitiesApprovalStateEntity
