...
local ApiEntitiesAccessRequesterEntity = {}
ApiEntitiesAccessRequesterEntity.__index = ApiEntitiesAccessRequesterEntity


function ApiEntitiesAccessRequesterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesAccessRequesterEntity)
  self._name = "api_entities_access_requester"
  self._client = client
...
function ApiEntitiesAccessRequesterEntity:get_name()
  return self._name
end


function ApiEntitiesAccessRequesterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesAccessRequesterEntity.new(self._client, opts)
end
...
function ApiEntitiesAccessRequesterEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesAccessRequesterEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesAccessRequesterEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesAccessRequesterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesAccessRequesterEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesAccessRequesterEntity:match_get()
...
function ApiEntitiesAccessRequesterEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesAccessRequesterListMatch
---@param ctrl? table
---@return ApiEntitiesAccessRequester[]
---@return string? err
function ApiEntitiesAccessRequesterEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesAccessRequesterCreateData
---@param ctrl? table
---@return ApiEntitiesAccessRequester
---@return string? err
function ApiEntitiesAccessRequesterEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesAccessRequesterUpdateData
---@param ctrl? table
---@return ApiEntitiesAccessRequester
---@return string? err
function ApiEntitiesAccessRequesterEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesAccessRequesterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesAccessRequesterEntity
