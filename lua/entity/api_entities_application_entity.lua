-- Gitlab SDK ApiEntitiesApplication entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesApplicationEntity = {}
ApiEntitiesApplicationEntity.__index = ApiEntitiesApplicationEntity


function ApiEntitiesApplicationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesApplicationEntity)
  self._name = "api_entities_application"
  self._client = client
...
function ApiEntitiesApplicationEntity:get_name()
  return self._name
end


function ApiEntitiesApplicationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesApplicationEntity.new(self._client, opts)
end
...
function ApiEntitiesApplicationEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesApplicationEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesApplicationEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesApplicationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesApplicationEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesApplicationEntity:match_get()
...
function ApiEntitiesApplicationEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesApplicationListMatch
---@param ctrl? table
---@return ApiEntitiesApplication[]
---@return string? err
function ApiEntitiesApplicationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesApplicationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesApplicationEntity
