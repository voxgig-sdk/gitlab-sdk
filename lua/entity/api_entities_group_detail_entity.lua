-- Gitlab SDK ApiEntitiesGroupDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesGroupDetailEntity = {}
ApiEntitiesGroupDetailEntity.__index = ApiEntitiesGroupDetailEntity


function ApiEntitiesGroupDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesGroupDetailEntity)
  self._name = "api_entities_group_detail"
  self._client = client
...
function ApiEntitiesGroupDetailEntity:get_name()
  return self._name
end


function ApiEntitiesGroupDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesGroupDetailEntity.new(self._client, opts)
end
...
function ApiEntitiesGroupDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesGroupDetailEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesGroupDetailEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesGroupDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesGroupDetailEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesGroupDetailEntity:match_get()
...
function ApiEntitiesGroupDetailEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesGroupDetailLoadMatch
---@param ctrl? table
---@return ApiEntitiesGroupDetail
---@return string? err
function ApiEntitiesGroupDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesGroupDetailCreateData
---@param ctrl? table
---@return ApiEntitiesGroupDetail
---@return string? err
function ApiEntitiesGroupDetailEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesGroupDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesGroupDetailEntity
