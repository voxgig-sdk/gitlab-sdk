-- Gitlab SDK ApiEntitiesTagSignature entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesTagSignatureEntity = {}
ApiEntitiesTagSignatureEntity.__index = ApiEntitiesTagSignatureEntity


function ApiEntitiesTagSignatureEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesTagSignatureEntity)
  self._name = "api_entities_tag_signature"
  self._client = client
...
function ApiEntitiesTagSignatureEntity:get_name()
  return self._name
end


function ApiEntitiesTagSignatureEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesTagSignatureEntity.new(self._client, opts)
end
...
function ApiEntitiesTagSignatureEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesTagSignatureEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesTagSignatureEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesTagSignatureEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesTagSignatureEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesTagSignatureEntity:match_get()
...
function ApiEntitiesTagSignatureEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesTagSignatureLoadMatch
---@param ctrl? table
---@return ApiEntitiesTagSignature
---@return string? err
function ApiEntitiesTagSignatureEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesTagSignatureEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesTagSignatureEntity
