-- Gitlab SDK ApiEntitiesMergeRequestApproval entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesMergeRequestApprovalEntity = {}
ApiEntitiesMergeRequestApprovalEntity.__index = ApiEntitiesMergeRequestApprovalEntity


function ApiEntitiesMergeRequestApprovalEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMergeRequestApprovalEntity)
  self._name = "api_entities_merge_request_approval"
  self._client = client
...
function ApiEntitiesMergeRequestApprovalEntity:get_name()
  return self._name
end


function ApiEntitiesMergeRequestApprovalEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMergeRequestApprovalEntity.new(self._client, opts)
end
...
function ApiEntitiesMergeRequestApprovalEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMergeRequestApprovalEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMergeRequestApprovalEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestApprovalEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMergeRequestApprovalEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestApprovalEntity:match_get()
...
function ApiEntitiesMergeRequestApprovalEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMergeRequestApprovalLoadMatch
---@param ctrl? table
---@return ApiEntitiesMergeRequestApproval
---@return string? err
function ApiEntitiesMergeRequestApprovalEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesMergeRequestApprovalCreateData
---@param ctrl? table
---@return ApiEntitiesMergeRequestApproval
---@return string? err
function ApiEntitiesMergeRequestApprovalEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesMergeRequestApprovalEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMergeRequestApprovalEntity
