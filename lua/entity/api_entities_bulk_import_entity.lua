...
local ApiEntitiesBulkImportEntity = {}
ApiEntitiesBulkImportEntity.__index = ApiEntitiesBulkImportEntity


function ApiEntitiesBulkImportEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBulkImportEntity)
  self._name = "api_entities_bulk_import"
  self._client = client
...
function ApiEntitiesBulkImportEntity:get_name()
  return self._name
end


function ApiEntitiesBulkImportEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBulkImportEntity.new(self._client, opts)
end
...
function ApiEntitiesBulkImportEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBulkImportEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBulkImportEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBulkImportEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBulkImportEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBulkImportEntity:match_get()
...
function ApiEntitiesBulkImportEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesBulkImportLoadMatch
---@param ctrl? table
---@return ApiEntitiesBulkImport
---@return string? err
function ApiEntitiesBulkImportEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesBulkImportListMatch
---@param ctrl? table
---@return ApiEntitiesBulkImport[]
---@return string? err
function ApiEntitiesBulkImportEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesBulkImportCreateData
---@param ctrl? table
---@return ApiEntitiesBulkImport
---@return string? err
function ApiEntitiesBulkImportEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesBulkImportEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesBulkImportEntity
