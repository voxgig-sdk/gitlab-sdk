-- Gitlab SDK ApiEntitiesMarkdown entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesMarkdownEntity = {}
ApiEntitiesMarkdownEntity.__index = ApiEntitiesMarkdownEntity


function ApiEntitiesMarkdownEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMarkdownEntity)
  self._name = "api_entities_markdown"
  self._client = client
...
function ApiEntitiesMarkdownEntity:get_name()
  return self._name
end


function ApiEntitiesMarkdownEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMarkdownEntity.new(self._client, opts)
end
...
function ApiEntitiesMarkdownEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMarkdownEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMarkdownEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMarkdownEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMarkdownEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMarkdownEntity:match_get()
...
function ApiEntitiesMarkdownEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesMarkdownCreateData
---@param ctrl? table
---@return ApiEntitiesMarkdown
---@return string? err
function ApiEntitiesMarkdownEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesMarkdownEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMarkdownEntity
