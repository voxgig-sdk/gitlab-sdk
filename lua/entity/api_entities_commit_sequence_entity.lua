-- Gitlab SDK ApiEntitiesCommitSequence entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCommitSequenceEntity = {}
ApiEntitiesCommitSequenceEntity.__index = ApiEntitiesCommitSequenceEntity


function ApiEntitiesCommitSequenceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCommitSequenceEntity)
  self._name = "api_entities_commit_sequence"
  self._client = client
...
function ApiEntitiesCommitSequenceEntity:get_name()
  return self._name
end


function ApiEntitiesCommitSequenceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCommitSequenceEntity.new(self._client, opts)
end
...
function ApiEntitiesCommitSequenceEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCommitSequenceEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCommitSequenceEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitSequenceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCommitSequenceEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitSequenceEntity:match_get()
...
function ApiEntitiesCommitSequenceEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCommitSequenceLoadMatch
---@param ctrl? table
---@return ApiEntitiesCommitSequence
---@return string? err
function ApiEntitiesCommitSequenceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesCommitSequenceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCommitSequenceEntity
