...
local ApiEntitiesProjectEntity = {}
ApiEntitiesProjectEntity.__index = ApiEntitiesProjectEntity


function ApiEntitiesProjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectEntity)
  self._name = "api_entities_project"
  self._client = client
...
function ApiEntitiesProjectEntity:get_name()
  return self._name
end


function ApiEntitiesProjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectEntity:match_get()
...
function ApiEntitiesProjectEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectListMatch
---@param ctrl? table
---@return ApiEntitiesProject[]
---@return string? err
function ApiEntitiesProjectEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesProjectCreateData
---@param ctrl? table
---@return ApiEntitiesProject
---@return string? err
function ApiEntitiesProjectEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProjectUpdateData
---@param ctrl? table
---@return ApiEntitiesProject
---@return string? err
function ApiEntitiesProjectEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesProjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectEntity
