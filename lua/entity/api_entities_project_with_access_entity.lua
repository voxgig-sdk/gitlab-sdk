-- Gitlab SDK ApiEntitiesProjectWithAccess entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesProjectWithAccessEntity = {}
ApiEntitiesProjectWithAccessEntity.__index = ApiEntitiesProjectWithAccessEntity


function ApiEntitiesProjectWithAccessEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectWithAccessEntity)
  self._name = "api_entities_project_with_access"
  self._client = client
...
function ApiEntitiesProjectWithAccessEntity:get_name()
  return self._name
end


function ApiEntitiesProjectWithAccessEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectWithAccessEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectWithAccessEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectWithAccessEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectWithAccessEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectWithAccessEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectWithAccessEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectWithAccessEntity:match_get()
...
function ApiEntitiesProjectWithAccessEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectWithAccessLoadMatch
---@param ctrl? table
---@return ApiEntitiesProjectWithAccess
---@return string? err
function ApiEntitiesProjectWithAccessEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesProjectWithAccessCreateData
---@param ctrl? table
---@return ApiEntitiesProjectWithAccess
---@return string? err
function ApiEntitiesProjectWithAccessEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesProjectWithAccessEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectWithAccessEntity
