-- Gitlab SDK ApiEntitiesClustersAgentTokenWithToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesClustersAgentTokenWithTokenEntity = {}
ApiEntitiesClustersAgentTokenWithTokenEntity.__index = ApiEntitiesClustersAgentTokenWithTokenEntity


function ApiEntitiesClustersAgentTokenWithTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesClustersAgentTokenWithTokenEntity)
  self._name = "api_entities_clusters_agent_token_with_token"
  self._client = client
...
function ApiEntitiesClustersAgentTokenWithTokenEntity:get_name()
  return self._name
end


function ApiEntitiesClustersAgentTokenWithTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesClustersAgentTokenWithTokenEntity.new(self._client, opts)
end
...
function ApiEntitiesClustersAgentTokenWithTokenEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesClustersAgentTokenWithTokenEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesClustersAgentTokenWithTokenEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesClustersAgentTokenWithTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesClustersAgentTokenWithTokenEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesClustersAgentTokenWithTokenEntity:match_get()
...
function ApiEntitiesClustersAgentTokenWithTokenEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesClustersAgentTokenWithTokenCreateData
---@param ctrl? table
---@return ApiEntitiesClustersAgentTokenWithToken
---@return string? err
function ApiEntitiesClustersAgentTokenWithTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesClustersAgentTokenWithTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesClustersAgentTokenWithTokenEntity
