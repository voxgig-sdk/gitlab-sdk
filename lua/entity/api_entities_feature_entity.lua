...
local ApiEntitiesFeatureEntity = {}
ApiEntitiesFeatureEntity.__index = ApiEntitiesFeatureEntity


function ApiEntitiesFeatureEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesFeatureEntity)
  self._name = "api_entities_feature"
  self._client = client
...
function ApiEntitiesFeatureEntity:get_name()
  return self._name
end


function ApiEntitiesFeatureEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesFeatureEntity.new(self._client, opts)
end
...
function ApiEntitiesFeatureEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesFeatureEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesFeatureEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesFeatureEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesFeatureEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesFeatureEntity:match_get()
...
function ApiEntitiesFeatureEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesFeatureListMatch
---@param ctrl? table
---@return ApiEntitiesFeature[]
---@return string? err
function ApiEntitiesFeatureEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesFeatureCreateData
---@param ctrl? table
---@return ApiEntitiesFeature
---@return string? err
function ApiEntitiesFeatureEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesFeatureEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesFeatureEntity
