-- Gitlab SDK ApiEntitiesProjectRepositoryStorage entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesProjectRepositoryStorageEntity = {}
ApiEntitiesProjectRepositoryStorageEntity.__index = ApiEntitiesProjectRepositoryStorageEntity


function ApiEntitiesProjectRepositoryStorageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectRepositoryStorageEntity)
  self._name = "api_entities_project_repository_storage"
  self._client = client
...
function ApiEntitiesProjectRepositoryStorageEntity:get_name()
  return self._name
end


function ApiEntitiesProjectRepositoryStorageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectRepositoryStorageEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectRepositoryStorageEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectRepositoryStorageEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectRepositoryStorageEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectRepositoryStorageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectRepositoryStorageEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectRepositoryStorageEntity:match_get()
...
function ApiEntitiesProjectRepositoryStorageEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectRepositoryStorageLoadMatch
---@param ctrl? table
---@return ApiEntitiesProjectRepositoryStorage
---@return string? err
function ApiEntitiesProjectRepositoryStorageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesProjectRepositoryStorageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectRepositoryStorageEntity
