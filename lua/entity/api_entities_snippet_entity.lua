-- Gitlab SDK ApiEntitiesSnippet entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesSnippetEntity = {}
ApiEntitiesSnippetEntity.__index = ApiEntitiesSnippetEntity


function ApiEntitiesSnippetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesSnippetEntity)
  self._name = "api_entities_snippet"
  self._client = client
...
function ApiEntitiesSnippetEntity:get_name()
  return self._name
end


function ApiEntitiesSnippetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesSnippetEntity.new(self._client, opts)
end
...
function ApiEntitiesSnippetEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesSnippetEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesSnippetEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesSnippetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesSnippetEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesSnippetEntity:match_get()
...
function ApiEntitiesSnippetEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesSnippetListMatch
---@param ctrl? table
---@return ApiEntitiesSnippet[]
---@return string? err
function ApiEntitiesSnippetEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesSnippetEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesSnippetEntity
