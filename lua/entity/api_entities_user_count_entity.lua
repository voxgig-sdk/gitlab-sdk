-- Gitlab SDK ApiEntitiesUserCount entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesUserCountEntity = {}
ApiEntitiesUserCountEntity.__index = ApiEntitiesUserCountEntity


function ApiEntitiesUserCountEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesUserCountEntity)
  self._name = "api_entities_user_count"
  self._client = client
...
function ApiEntitiesUserCountEntity:get_name()
  return self._name
end


function ApiEntitiesUserCountEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesUserCountEntity.new(self._client, opts)
end
...
function ApiEntitiesUserCountEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesUserCountEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesUserCountEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesUserCountEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesUserCountEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesUserCountEntity:match_get()
...
function ApiEntitiesUserCountEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesUserCountLoadMatch
---@param ctrl? table
---@return ApiEntitiesUserCount
---@return string? err
function ApiEntitiesUserCountEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesUserCountEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesUserCountEntity
