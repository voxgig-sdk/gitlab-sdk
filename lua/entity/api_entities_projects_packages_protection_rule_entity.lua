...
local ApiEntitiesProjectsPackagesProtectionRuleEntity = {}
ApiEntitiesProjectsPackagesProtectionRuleEntity.__index = ApiEntitiesProjectsPackagesProtectionRuleEntity


function ApiEntitiesProjectsPackagesProtectionRuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectsPackagesProtectionRuleEntity)
  self._name = "api_entities_projects_packages_protection_rule"
  self._client = client
...
function ApiEntitiesProjectsPackagesProtectionRuleEntity:get_name()
  return self._name
end


function ApiEntitiesProjectsPackagesProtectionRuleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectsPackagesProtectionRuleEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectsPackagesProtectionRuleEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectsPackagesProtectionRuleEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectsPackagesProtectionRuleEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectsPackagesProtectionRuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectsPackagesProtectionRuleEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectsPackagesProtectionRuleEntity:match_get()
...
function ApiEntitiesProjectsPackagesProtectionRuleEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectsPackagesProtectionRuleListMatch
---@param ctrl? table
---@return ApiEntitiesProjectsPackagesProtectionRule[]
---@return string? err
function ApiEntitiesProjectsPackagesProtectionRuleEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesProjectsPackagesProtectionRuleCreateData
---@param ctrl? table
---@return ApiEntitiesProjectsPackagesProtectionRule
---@return string? err
function ApiEntitiesProjectsPackagesProtectionRuleEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProjectsPackagesProtectionRuleUpdateData
---@param ctrl? table
---@return ApiEntitiesProjectsPackagesProtectionRule
---@return string? err
function ApiEntitiesProjectsPackagesProtectionRuleEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesProjectsPackagesProtectionRuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectsPackagesProtectionRuleEntity
