-- Gitlab SDK ApiEntitiesBasicRef entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesBasicRefEntity = {}
ApiEntitiesBasicRefEntity.__index = ApiEntitiesBasicRefEntity


function ApiEntitiesBasicRefEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBasicRefEntity)
  self._name = "api_entities_basic_ref"
  self._client = client
...
function ApiEntitiesBasicRefEntity:get_name()
  return self._name
end


function ApiEntitiesBasicRefEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBasicRefEntity.new(self._client, opts)
end
...
function ApiEntitiesBasicRefEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBasicRefEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBasicRefEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBasicRefEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBasicRefEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBasicRefEntity:match_get()
...
function ApiEntitiesBasicRefEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesBasicRefListMatch
---@param ctrl? table
---@return ApiEntitiesBasicRef[]
---@return string? err
function ApiEntitiesBasicRefEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesBasicRefEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesBasicRefEntity
