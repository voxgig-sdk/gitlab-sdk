-- Gitlab SDK ApiEntitiesPersonalAccessTokenWithToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPersonalAccessTokenWithTokenEntity = {}
ApiEntitiesPersonalAccessTokenWithTokenEntity.__index = ApiEntitiesPersonalAccessTokenWithTokenEntity


function ApiEntitiesPersonalAccessTokenWithTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPersonalAccessTokenWithTokenEntity)
  self._name = "api_entities_personal_access_token_with_token"
  self._client = client
...
function ApiEntitiesPersonalAccessTokenWithTokenEntity:get_name()
  return self._name
end


function ApiEntitiesPersonalAccessTokenWithTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPersonalAccessTokenWithTokenEntity.new(self._client, opts)
end
...
function ApiEntitiesPersonalAccessTokenWithTokenEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPersonalAccessTokenWithTokenEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPersonalAccessTokenWithTokenEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPersonalAccessTokenWithTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPersonalAccessTokenWithTokenEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPersonalAccessTokenWithTokenEntity:match_get()
...
function ApiEntitiesPersonalAccessTokenWithTokenEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesPersonalAccessTokenWithTokenCreateData
---@param ctrl? table
---@return ApiEntitiesPersonalAccessTokenWithToken
---@return string? err
function ApiEntitiesPersonalAccessTokenWithTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesPersonalAccessTokenWithTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPersonalAccessTokenWithTokenEntity
