-- Gitlab SDK ApiEntitiesSshKeyWithUser entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesSshKeyWithUserEntity = {}
ApiEntitiesSshKeyWithUserEntity.__index = ApiEntitiesSshKeyWithUserEntity


function ApiEntitiesSshKeyWithUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesSshKeyWithUserEntity)
  self._name = "api_entities_ssh_key_with_user"
  self._client = client
...
function ApiEntitiesSshKeyWithUserEntity:get_name()
  return self._name
end


function ApiEntitiesSshKeyWithUserEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesSshKeyWithUserEntity.new(self._client, opts)
end
...
function ApiEntitiesSshKeyWithUserEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesSshKeyWithUserEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesSshKeyWithUserEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesSshKeyWithUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesSshKeyWithUserEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesSshKeyWithUserEntity:match_get()
...
function ApiEntitiesSshKeyWithUserEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesSshKeyWithUserLoadMatch
---@param ctrl? table
---@return ApiEntitiesSshKeyWithUser
---@return string? err
function ApiEntitiesSshKeyWithUserEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesSshKeyWithUserEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesSshKeyWithUserEntity
