...
local ApiEntitiesProtectedTagEntity = {}
ApiEntitiesProtectedTagEntity.__index = ApiEntitiesProtectedTagEntity


function ApiEntitiesProtectedTagEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProtectedTagEntity)
  self._name = "api_entities_protected_tag"
  self._client = client
...
function ApiEntitiesProtectedTagEntity:get_name()
  return self._name
end


function ApiEntitiesProtectedTagEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProtectedTagEntity.new(self._client, opts)
end
...
function ApiEntitiesProtectedTagEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProtectedTagEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProtectedTagEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProtectedTagEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProtectedTagEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProtectedTagEntity:match_get()
...
function ApiEntitiesProtectedTagEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProtectedTagLoadMatch
---@param ctrl? table
---@return ApiEntitiesProtectedTag
---@return string? err
function ApiEntitiesProtectedTagEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesProtectedTagListMatch
---@param ctrl? table
---@return ApiEntitiesProtectedTag[]
---@return string? err
function ApiEntitiesProtectedTagEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProtectedTagCreateData
---@param ctrl? table
---@return ApiEntitiesProtectedTag
---@return string? err
function ApiEntitiesProtectedTagEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesProtectedTagEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProtectedTagEntity
