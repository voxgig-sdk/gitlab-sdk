-- Gitlab SDK ApiEntitiesUserPublic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesUserPublicEntity = {}
ApiEntitiesUserPublicEntity.__index = ApiEntitiesUserPublicEntity


function ApiEntitiesUserPublicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesUserPublicEntity)
  self._name = "api_entities_user_public"
  self._client = client
...
function ApiEntitiesUserPublicEntity:get_name()
  return self._name
end


function ApiEntitiesUserPublicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesUserPublicEntity.new(self._client, opts)
end
...
function ApiEntitiesUserPublicEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesUserPublicEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesUserPublicEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesUserPublicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesUserPublicEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesUserPublicEntity:match_get()
...
function ApiEntitiesUserPublicEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesUserPublicListMatch
---@param ctrl? table
---@return ApiEntitiesUserPublic[]
---@return string? err
function ApiEntitiesUserPublicEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesUserPublicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesUserPublicEntity
