-- Gitlab SDK ApiEntitiesPackagesConanPackageRevision entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagesConanPackageRevisionEntity = {}
ApiEntitiesPackagesConanPackageRevisionEntity.__index = ApiEntitiesPackagesConanPackageRevisionEntity


function ApiEntitiesPackagesConanPackageRevisionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesConanPackageRevisionEntity)
  self._name = "api_entities_packages_conan_package_revision"
  self._client = client
...
function ApiEntitiesPackagesConanPackageRevisionEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesConanPackageRevisionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesConanPackageRevisionEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesConanPackageRevisionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesConanPackageRevisionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesConanPackageRevisionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanPackageRevisionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesConanPackageRevisionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanPackageRevisionEntity:match_get()
...
function ApiEntitiesPackagesConanPackageRevisionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagesConanPackageRevisionListMatch
---@param ctrl? table
---@return ApiEntitiesPackagesConanPackageRevision[]
---@return string? err
function ApiEntitiesPackagesConanPackageRevisionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagesConanPackageRevisionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesConanPackageRevisionEntity
