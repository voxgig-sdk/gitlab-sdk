-- Gitlab SDK ApiEntitiesPublicGroupDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPublicGroupDetailEntity = {}
ApiEntitiesPublicGroupDetailEntity.__index = ApiEntitiesPublicGroupDetailEntity


function ApiEntitiesPublicGroupDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPublicGroupDetailEntity)
  self._name = "api_entities_public_group_detail"
  self._client = client
...
function ApiEntitiesPublicGroupDetailEntity:get_name()
  return self._name
end


function ApiEntitiesPublicGroupDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPublicGroupDetailEntity.new(self._client, opts)
end
...
function ApiEntitiesPublicGroupDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPublicGroupDetailEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPublicGroupDetailEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPublicGroupDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPublicGroupDetailEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPublicGroupDetailEntity:match_get()
...
function ApiEntitiesPublicGroupDetailEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPublicGroupDetailListMatch
---@param ctrl? table
---@return ApiEntitiesPublicGroupDetail[]
---@return string? err
function ApiEntitiesPublicGroupDetailEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPublicGroupDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPublicGroupDetailEntity
