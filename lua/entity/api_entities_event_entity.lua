...
local ApiEntitiesEventEntity = {}
ApiEntitiesEventEntity.__index = ApiEntitiesEventEntity


function ApiEntitiesEventEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesEventEntity)
  self._name = "api_entities_event"
  self._client = client
...
function ApiEntitiesEventEntity:get_name()
  return self._name
end


function ApiEntitiesEventEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesEventEntity.new(self._client, opts)
end
...
function ApiEntitiesEventEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesEventEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesEventEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesEventEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesEventEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesEventEntity:match_get()
...
function ApiEntitiesEventEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesEventLoadMatch
---@param ctrl? table
---@return ApiEntitiesEvent
---@return string? err
function ApiEntitiesEventEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesEventListMatch
---@param ctrl? table
---@return ApiEntitiesEvent[]
---@return string? err
function ApiEntitiesEventEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiEntitiesEventEntity:_run_op(ctx, post_done)
  local utility = self._utility
