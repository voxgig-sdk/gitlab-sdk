...
local ApiEntitiesClusterProjectEntity = {}
ApiEntitiesClusterProjectEntity.__index = ApiEntitiesClusterProjectEntity


function ApiEntitiesClusterProjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesClusterProjectEntity)
  self._name = "api_entities_cluster_project"
  self._client = client
...
function ApiEntitiesClusterProjectEntity:get_name()
  return self._name
end


function ApiEntitiesClusterProjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesClusterProjectEntity.new(self._client, opts)
end
...
function ApiEntitiesClusterProjectEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesClusterProjectEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesClusterProjectEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesClusterProjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesClusterProjectEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesClusterProjectEntity:match_get()
...
function ApiEntitiesClusterProjectEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesClusterProjectLoadMatch
---@param ctrl? table
---@return ApiEntitiesClusterProject
---@return string? err
function ApiEntitiesClusterProjectEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesClusterProjectCreateData
---@param ctrl? table
---@return ApiEntitiesClusterProject
---@return string? err
function ApiEntitiesClusterProjectEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesClusterProjectUpdateData
---@param ctrl? table
---@return ApiEntitiesClusterProject
---@return string? err
function ApiEntitiesClusterProjectEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesClusterProjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesClusterProjectEntity
