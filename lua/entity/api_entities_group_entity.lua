...
local ApiEntitiesGroupEntity = {}
ApiEntitiesGroupEntity.__index = ApiEntitiesGroupEntity


function ApiEntitiesGroupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesGroupEntity)
  self._name = "api_entities_group"
  self._client = client
...
function ApiEntitiesGroupEntity:get_name()
  return self._name
end


function ApiEntitiesGroupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesGroupEntity.new(self._client, opts)
end
...
function ApiEntitiesGroupEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesGroupEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesGroupEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesGroupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesGroupEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesGroupEntity:match_get()
...
function ApiEntitiesGroupEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesGroupLoadMatch
---@param ctrl? table
---@return ApiEntitiesGroup
---@return string? err
function ApiEntitiesGroupEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesGroupListMatch
---@param ctrl? table
---@return ApiEntitiesGroup[]
---@return string? err
function ApiEntitiesGroupEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesGroupCreateData
---@param ctrl? table
---@return ApiEntitiesGroup
---@return string? err
function ApiEntitiesGroupEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesGroupUpdateData
---@param ctrl? table
---@return ApiEntitiesGroup
---@return string? err
function ApiEntitiesGroupEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesGroupEntity:_run_op(ctx, post_done)
  local utility = self._utility
