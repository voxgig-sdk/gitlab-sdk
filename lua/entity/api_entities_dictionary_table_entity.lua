-- Gitlab SDK ApiEntitiesDictionaryTable entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesDictionaryTableEntity = {}
ApiEntitiesDictionaryTableEntity.__index = ApiEntitiesDictionaryTableEntity


function ApiEntitiesDictionaryTableEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDictionaryTableEntity)
  self._name = "api_entities_dictionary_table"
  self._client = client
...
function ApiEntitiesDictionaryTableEntity:get_name()
  return self._name
end


function ApiEntitiesDictionaryTableEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDictionaryTableEntity.new(self._client, opts)
end
...
function ApiEntitiesDictionaryTableEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDictionaryTableEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDictionaryTableEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDictionaryTableEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDictionaryTableEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDictionaryTableEntity:match_get()
...
function ApiEntitiesDictionaryTableEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesDictionaryTableLoadMatch
---@param ctrl? table
---@return ApiEntitiesDictionaryTable
---@return string? err
function ApiEntitiesDictionaryTableEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesDictionaryTableEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesDictionaryTableEntity
