-- Gitlab SDK ApiEntitiesSuggestion entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesSuggestionEntity = {}
ApiEntitiesSuggestionEntity.__index = ApiEntitiesSuggestionEntity


function ApiEntitiesSuggestionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesSuggestionEntity)
  self._name = "api_entities_suggestion"
  self._client = client
...
function ApiEntitiesSuggestionEntity:get_name()
  return self._name
end


function ApiEntitiesSuggestionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesSuggestionEntity.new(self._client, opts)
end
...
function ApiEntitiesSuggestionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesSuggestionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesSuggestionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesSuggestionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesSuggestionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesSuggestionEntity:match_get()
...
function ApiEntitiesSuggestionEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesSuggestionUpdateData
---@param ctrl? table
---@return ApiEntitiesSuggestion
---@return string? err
function ApiEntitiesSuggestionEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesSuggestionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesSuggestionEntity
