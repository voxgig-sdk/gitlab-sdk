-- Gitlab SDK ApiEntitiesProjectDailyStatistic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesProjectDailyStatisticEntity = {}
ApiEntitiesProjectDailyStatisticEntity.__index = ApiEntitiesProjectDailyStatisticEntity


function ApiEntitiesProjectDailyStatisticEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectDailyStatisticEntity)
  self._name = "api_entities_project_daily_statistic"
  self._client = client
...
function ApiEntitiesProjectDailyStatisticEntity:get_name()
  return self._name
end


function ApiEntitiesProjectDailyStatisticEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectDailyStatisticEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectDailyStatisticEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectDailyStatisticEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectDailyStatisticEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectDailyStatisticEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectDailyStatisticEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectDailyStatisticEntity:match_get()
...
function ApiEntitiesProjectDailyStatisticEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectDailyStatisticLoadMatch
---@param ctrl? table
---@return ApiEntitiesProjectDailyStatistic
---@return string? err
function ApiEntitiesProjectDailyStatisticEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesProjectDailyStatisticEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectDailyStatisticEntity
