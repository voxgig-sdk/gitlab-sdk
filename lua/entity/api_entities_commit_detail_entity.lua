...
local ApiEntitiesCommitDetailEntity = {}
ApiEntitiesCommitDetailEntity.__index = ApiEntitiesCommitDetailEntity


function ApiEntitiesCommitDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCommitDetailEntity)
  self._name = "api_entities_commit_detail"
  self._client = client
...
function ApiEntitiesCommitDetailEntity:get_name()
  return self._name
end


function ApiEntitiesCommitDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCommitDetailEntity.new(self._client, opts)
end
...
function ApiEntitiesCommitDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCommitDetailEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCommitDetailEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCommitDetailEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitDetailEntity:match_get()
...
function ApiEntitiesCommitDetailEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCommitDetailLoadMatch
---@param ctrl? table
---@return ApiEntitiesCommitDetail
---@return string? err
function ApiEntitiesCommitDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesCommitDetailCreateData
---@param ctrl? table
---@return ApiEntitiesCommitDetail
---@return string? err
function ApiEntitiesCommitDetailEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesCommitDetailUpdateData
---@param ctrl? table
---@return ApiEntitiesCommitDetail
---@return string? err
function ApiEntitiesCommitDetailEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesCommitDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCommitDetailEntity
