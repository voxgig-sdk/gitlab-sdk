-- Gitlab SDK ApiEntitiesIntegrationBasic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesIntegrationBasicEntity = {}
ApiEntitiesIntegrationBasicEntity.__index = ApiEntitiesIntegrationBasicEntity


function ApiEntitiesIntegrationBasicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesIntegrationBasicEntity)
  self._name = "api_entities_integration_basic"
  self._client = client
...
function ApiEntitiesIntegrationBasicEntity:get_name()
  return self._name
end


function ApiEntitiesIntegrationBasicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesIntegrationBasicEntity.new(self._client, opts)
end
...
function ApiEntitiesIntegrationBasicEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesIntegrationBasicEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesIntegrationBasicEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesIntegrationBasicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesIntegrationBasicEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesIntegrationBasicEntity:match_get()
...
function ApiEntitiesIntegrationBasicEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesIntegrationBasicListMatch
---@param ctrl? table
---@return ApiEntitiesIntegrationBasic[]
---@return string? err
function ApiEntitiesIntegrationBasicEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesIntegrationBasicUpdateData
---@param ctrl? table
---@return ApiEntitiesIntegrationBasic
---@return string? err
function ApiEntitiesIntegrationBasicEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesIntegrationBasicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesIntegrationBasicEntity
