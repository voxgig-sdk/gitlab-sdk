...
local ApiEntitiesDeploymentExtendedEntity = {}
ApiEntitiesDeploymentExtendedEntity.__index = ApiEntitiesDeploymentExtendedEntity


function ApiEntitiesDeploymentExtendedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDeploymentExtendedEntity)
  self._name = "api_entities_deployment_extended"
  self._client = client
...
function ApiEntitiesDeploymentExtendedEntity:get_name()
  return self._name
end


function ApiEntitiesDeploymentExtendedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDeploymentExtendedEntity.new(self._client, opts)
end
...
function ApiEntitiesDeploymentExtendedEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDeploymentExtendedEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDeploymentExtendedEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDeploymentExtendedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDeploymentExtendedEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDeploymentExtendedEntity:match_get()
...
function ApiEntitiesDeploymentExtendedEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesDeploymentExtendedLoadMatch
---@param ctrl? table
---@return ApiEntitiesDeploymentExtended
---@return string? err
function ApiEntitiesDeploymentExtendedEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesDeploymentExtendedCreateData
---@param ctrl? table
---@return ApiEntitiesDeploymentExtended
---@return string? err
function ApiEntitiesDeploymentExtendedEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesDeploymentExtendedUpdateData
---@param ctrl? table
---@return ApiEntitiesDeploymentExtended
---@return string? err
function ApiEntitiesDeploymentExtendedEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesDeploymentExtendedEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesDeploymentExtendedEntity
