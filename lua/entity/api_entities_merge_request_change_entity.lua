-- Gitlab SDK ApiEntitiesMergeRequestChange entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesMergeRequestChangeEntity = {}
ApiEntitiesMergeRequestChangeEntity.__index = ApiEntitiesMergeRequestChangeEntity


function ApiEntitiesMergeRequestChangeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMergeRequestChangeEntity)
  self._name = "api_entities_merge_request_change"
  self._client = client
...
function ApiEntitiesMergeRequestChangeEntity:get_name()
  return self._name
end


function ApiEntitiesMergeRequestChangeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMergeRequestChangeEntity.new(self._client, opts)
end
...
function ApiEntitiesMergeRequestChangeEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMergeRequestChangeEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMergeRequestChangeEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestChangeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMergeRequestChangeEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestChangeEntity:match_get()
...
function ApiEntitiesMergeRequestChangeEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMergeRequestChangeLoadMatch
---@param ctrl? table
---@return ApiEntitiesMergeRequestChange
---@return string? err
function ApiEntitiesMergeRequestChangeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesMergeRequestChangeEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMergeRequestChangeEntity
