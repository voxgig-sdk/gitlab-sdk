...
local ApiEntitiesSystemBroadcastMessageEntity = {}
ApiEntitiesSystemBroadcastMessageEntity.__index = ApiEntitiesSystemBroadcastMessageEntity


function ApiEntitiesSystemBroadcastMessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesSystemBroadcastMessageEntity)
  self._name = "api_entities_system_broadcast_message"
  self._client = client
...
function ApiEntitiesSystemBroadcastMessageEntity:get_name()
  return self._name
end


function ApiEntitiesSystemBroadcastMessageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesSystemBroadcastMessageEntity.new(self._client, opts)
end
...
function ApiEntitiesSystemBroadcastMessageEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesSystemBroadcastMessageEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesSystemBroadcastMessageEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesSystemBroadcastMessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesSystemBroadcastMessageEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesSystemBroadcastMessageEntity:match_get()
...
function ApiEntitiesSystemBroadcastMessageEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesSystemBroadcastMessageLoadMatch
---@param ctrl? table
---@return ApiEntitiesSystemBroadcastMessage
---@return string? err
function ApiEntitiesSystemBroadcastMessageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesSystemBroadcastMessageCreateData
---@param ctrl? table
---@return ApiEntitiesSystemBroadcastMessage
---@return string? err
function ApiEntitiesSystemBroadcastMessageEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesSystemBroadcastMessageUpdateData
---@param ctrl? table
---@return ApiEntitiesSystemBroadcastMessage
---@return string? err
function ApiEntitiesSystemBroadcastMessageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ApiEntitiesSystemBroadcastMessageRemoveMatch
---@param ctrl? table
---@return ApiEntitiesSystemBroadcastMessage
---@return string? err
function ApiEntitiesSystemBroadcastMessageEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ApiEntitiesSystemBroadcastMessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesSystemBroadcastMessageEntity
