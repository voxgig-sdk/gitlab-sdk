-- Gitlab SDK ApiEntitiesClustersAgentTokenBasic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesClustersAgentTokenBasicEntity = {}
ApiEntitiesClustersAgentTokenBasicEntity.__index = ApiEntitiesClustersAgentTokenBasicEntity


function ApiEntitiesClustersAgentTokenBasicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesClustersAgentTokenBasicEntity)
  self._name = "api_entities_clusters_agent_token_basic"
  self._client = client
...
function ApiEntitiesClustersAgentTokenBasicEntity:get_name()
  return self._name
end


function ApiEntitiesClustersAgentTokenBasicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesClustersAgentTokenBasicEntity.new(self._client, opts)
end
...
function ApiEntitiesClustersAgentTokenBasicEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesClustersAgentTokenBasicEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesClustersAgentTokenBasicEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesClustersAgentTokenBasicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesClustersAgentTokenBasicEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesClustersAgentTokenBasicEntity:match_get()
...
function ApiEntitiesClustersAgentTokenBasicEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesClustersAgentTokenBasicLoadMatch
---@param ctrl? table
---@return ApiEntitiesClustersAgentTokenBasic
---@return string? err
function ApiEntitiesClustersAgentTokenBasicEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesClustersAgentTokenBasicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesClustersAgentTokenBasicEntity
