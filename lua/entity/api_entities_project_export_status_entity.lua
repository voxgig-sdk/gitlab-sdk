-- Gitlab SDK ApiEntitiesProjectExportStatus entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesProjectExportStatusEntity = {}
ApiEntitiesProjectExportStatusEntity.__index = ApiEntitiesProjectExportStatusEntity


function ApiEntitiesProjectExportStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectExportStatusEntity)
  self._name = "api_entities_project_export_status"
  self._client = client
...
function ApiEntitiesProjectExportStatusEntity:get_name()
  return self._name
end


function ApiEntitiesProjectExportStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectExportStatusEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectExportStatusEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectExportStatusEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectExportStatusEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectExportStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectExportStatusEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectExportStatusEntity:match_get()
...
function ApiEntitiesProjectExportStatusEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectExportStatusLoadMatch
---@param ctrl? table
---@return ApiEntitiesProjectExportStatus
---@return string? err
function ApiEntitiesProjectExportStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesProjectExportStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectExportStatusEntity
