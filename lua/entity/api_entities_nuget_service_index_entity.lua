-- Gitlab SDK ApiEntitiesNugetServiceIndex entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesNugetServiceIndexEntity = {}
ApiEntitiesNugetServiceIndexEntity.__index = ApiEntitiesNugetServiceIndexEntity


function ApiEntitiesNugetServiceIndexEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesNugetServiceIndexEntity)
  self._name = "api_entities_nuget_service_index"
  self._client = client
...
function ApiEntitiesNugetServiceIndexEntity:get_name()
  return self._name
end


function ApiEntitiesNugetServiceIndexEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesNugetServiceIndexEntity.new(self._client, opts)
end
...
function ApiEntitiesNugetServiceIndexEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesNugetServiceIndexEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesNugetServiceIndexEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesNugetServiceIndexEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesNugetServiceIndexEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesNugetServiceIndexEntity:match_get()
...
function ApiEntitiesNugetServiceIndexEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesNugetServiceIndexListMatch
---@param ctrl? table
---@return ApiEntitiesNugetServiceIndex[]
---@return string? err
function ApiEntitiesNugetServiceIndexEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesNugetServiceIndexEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesNugetServiceIndexEntity
