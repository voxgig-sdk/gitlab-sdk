-- Gitlab SDK ApiEntitiesPackageFile entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackageFileEntity = {}
ApiEntitiesPackageFileEntity.__index = ApiEntitiesPackageFileEntity


function ApiEntitiesPackageFileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackageFileEntity)
  self._name = "api_entities_package_file"
  self._client = client
...
function ApiEntitiesPackageFileEntity:get_name()
  return self._name
end


function ApiEntitiesPackageFileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackageFileEntity.new(self._client, opts)
end
...
function ApiEntitiesPackageFileEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackageFileEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackageFileEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackageFileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackageFileEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackageFileEntity:match_get()
...
function ApiEntitiesPackageFileEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackageFileListMatch
---@param ctrl? table
---@return ApiEntitiesPackageFile[]
---@return string? err
function ApiEntitiesPackageFileEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackageFileEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackageFileEntity
