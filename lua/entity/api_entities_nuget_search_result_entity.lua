-- Gitlab SDK ApiEntitiesNugetSearchResult entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesNugetSearchResultEntity = {}
ApiEntitiesNugetSearchResultEntity.__index = ApiEntitiesNugetSearchResultEntity


function ApiEntitiesNugetSearchResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesNugetSearchResultEntity)
  self._name = "api_entities_nuget_search_result"
  self._client = client
...
function ApiEntitiesNugetSearchResultEntity:get_name()
  return self._name
end


function ApiEntitiesNugetSearchResultEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesNugetSearchResultEntity.new(self._client, opts)
end
...
function ApiEntitiesNugetSearchResultEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesNugetSearchResultEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesNugetSearchResultEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesNugetSearchResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesNugetSearchResultEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesNugetSearchResultEntity:match_get()
...
function ApiEntitiesNugetSearchResultEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesNugetSearchResultListMatch
---@param ctrl? table
---@return ApiEntitiesNugetSearchResult[]
---@return string? err
function ApiEntitiesNugetSearchResultEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesNugetSearchResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesNugetSearchResultEntity
