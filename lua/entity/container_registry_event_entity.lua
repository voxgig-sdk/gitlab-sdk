-- Gitlab SDK ContainerRegistryEvent entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ContainerRegistryEventEntity = {}
ContainerRegistryEventEntity.__index = ContainerRegistryEventEntity


function ContainerRegistryEventEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContainerRegistryEventEntity)
  self._name = "container_registry_event"
  self._client = client
...
function ContainerRegistryEventEntity:get_name()
  return self._name
end


function ContainerRegistryEventEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContainerRegistryEventEntity.new(self._client, opts)
end
...
function ContainerRegistryEventEntity:mark_deleted()
  self._deleted = true
end


function ContainerRegistryEventEntity:deleted()
  return true == self._deleted
end


function ContainerRegistryEventEntity:data_set(args)
  if args ~= nil then
...
function ContainerRegistryEventEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContainerRegistryEventEntity:match_set(args)
  if args ~= nil then
...
function ContainerRegistryEventEntity:match_get()
...
function ContainerRegistryEventEntity:stream(action, args, callopts)
...
---@param reqdata ContainerRegistryEventCreateData
---@param ctrl? table
---@return ContainerRegistryEvent
---@return string? err
function ContainerRegistryEventEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ContainerRegistryEventEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ContainerRegistryEventEntity
