-- Gitlab SDK ApiEntitiesRepositoryHealth entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesRepositoryHealthEntity = {}
ApiEntitiesRepositoryHealthEntity.__index = ApiEntitiesRepositoryHealthEntity


function ApiEntitiesRepositoryHealthEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesRepositoryHealthEntity)
  self._name = "api_entities_repository_health"
  self._client = client
...
function ApiEntitiesRepositoryHealthEntity:get_name()
  return self._name
end


function ApiEntitiesRepositoryHealthEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesRepositoryHealthEntity.new(self._client, opts)
end
...
function ApiEntitiesRepositoryHealthEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesRepositoryHealthEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesRepositoryHealthEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesRepositoryHealthEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesRepositoryHealthEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesRepositoryHealthEntity:match_get()
...
function ApiEntitiesRepositoryHealthEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesRepositoryHealthLoadMatch
---@param ctrl? table
---@return ApiEntitiesRepositoryHealth
---@return string? err
function ApiEntitiesRepositoryHealthEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesRepositoryHealthEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesRepositoryHealthEntity
