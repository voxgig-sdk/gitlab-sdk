-- Gitlab SDK ApiEntitiesNamespaceExistence entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesNamespaceExistenceEntity = {}
ApiEntitiesNamespaceExistenceEntity.__index = ApiEntitiesNamespaceExistenceEntity


function ApiEntitiesNamespaceExistenceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesNamespaceExistenceEntity)
  self._name = "api_entities_namespace_existence"
  self._client = client
...
function ApiEntitiesNamespaceExistenceEntity:get_name()
  return self._name
end


function ApiEntitiesNamespaceExistenceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesNamespaceExistenceEntity.new(self._client, opts)
end
...
function ApiEntitiesNamespaceExistenceEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesNamespaceExistenceEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesNamespaceExistenceEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesNamespaceExistenceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesNamespaceExistenceEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesNamespaceExistenceEntity:match_get()
...
function ApiEntitiesNamespaceExistenceEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesNamespaceExistenceListMatch
---@param ctrl? table
---@return ApiEntitiesNamespaceExistence[]
---@return string? err
function ApiEntitiesNamespaceExistenceEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesNamespaceExistenceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesNamespaceExistenceEntity
