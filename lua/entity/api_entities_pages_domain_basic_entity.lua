-- Gitlab SDK ApiEntitiesPagesDomainBasic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPagesDomainBasicEntity = {}
ApiEntitiesPagesDomainBasicEntity.__index = ApiEntitiesPagesDomainBasicEntity


function ApiEntitiesPagesDomainBasicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPagesDomainBasicEntity)
  self._name = "api_entities_pages_domain_basic"
  self._client = client
...
function ApiEntitiesPagesDomainBasicEntity:get_name()
  return self._name
end


function ApiEntitiesPagesDomainBasicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPagesDomainBasicEntity.new(self._client, opts)
end
...
function ApiEntitiesPagesDomainBasicEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPagesDomainBasicEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPagesDomainBasicEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPagesDomainBasicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPagesDomainBasicEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPagesDomainBasicEntity:match_get()
...
function ApiEntitiesPagesDomainBasicEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPagesDomainBasicLoadMatch
---@param ctrl? table
---@return ApiEntitiesPagesDomainBasic
---@return string? err
function ApiEntitiesPagesDomainBasicEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPagesDomainBasicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPagesDomainBasicEntity
