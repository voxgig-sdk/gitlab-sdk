...
local ApiEntitiesResourceMilestoneEventEntity = {}
ApiEntitiesResourceMilestoneEventEntity.__index = ApiEntitiesResourceMilestoneEventEntity


function ApiEntitiesResourceMilestoneEventEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesResourceMilestoneEventEntity)
  self._name = "api_entities_resource_milestone_event"
  self._client = client
...
function ApiEntitiesResourceMilestoneEventEntity:get_name()
  return self._name
end


function ApiEntitiesResourceMilestoneEventEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesResourceMilestoneEventEntity.new(self._client, opts)
end
...
function ApiEntitiesResourceMilestoneEventEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesResourceMilestoneEventEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesResourceMilestoneEventEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesResourceMilestoneEventEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesResourceMilestoneEventEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesResourceMilestoneEventEntity:match_get()
...
function ApiEntitiesResourceMilestoneEventEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesResourceMilestoneEventLoadMatch
---@param ctrl? table
---@return ApiEntitiesResourceMilestoneEvent
---@return string? err
function ApiEntitiesResourceMilestoneEventEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesResourceMilestoneEventListMatch
---@param ctrl? table
---@return ApiEntitiesResourceMilestoneEvent[]
---@return string? err
function ApiEntitiesResourceMilestoneEventEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiEntitiesResourceMilestoneEventEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesResourceMilestoneEventEntity
