...
local ApiEntitiesCiJobBasicEntity = {}
ApiEntitiesCiJobBasicEntity.__index = ApiEntitiesCiJobBasicEntity


function ApiEntitiesCiJobBasicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiJobBasicEntity)
  self._name = "api_entities_ci_job_basic"
  self._client = client
...
function ApiEntitiesCiJobBasicEntity:get_name()
  return self._name
end


function ApiEntitiesCiJobBasicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiJobBasicEntity.new(self._client, opts)
end
...
function ApiEntitiesCiJobBasicEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiJobBasicEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiJobBasicEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiJobBasicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiJobBasicEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiJobBasicEntity:match_get()
...
function ApiEntitiesCiJobBasicEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiJobBasicListMatch
---@param ctrl? table
---@return ApiEntitiesCiJobBasic[]
---@return string? err
function ApiEntitiesCiJobBasicEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesCiJobBasicCreateData
---@param ctrl? table
---@return ApiEntitiesCiJobBasic
---@return string? err
function ApiEntitiesCiJobBasicEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesCiJobBasicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiJobBasicEntity
