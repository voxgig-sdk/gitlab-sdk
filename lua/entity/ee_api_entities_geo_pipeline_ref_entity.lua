-- Gitlab SDK EeApiEntitiesGeoPipelineRef entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EeApiEntitiesGeoPipelineRefEntity = {}
EeApiEntitiesGeoPipelineRefEntity.__index = EeApiEntitiesGeoPipelineRefEntity


function EeApiEntitiesGeoPipelineRefEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EeApiEntitiesGeoPipelineRefEntity)
  self._name = "ee_api_entities_geo_pipeline_ref"
  self._client = client
...
function EeApiEntitiesGeoPipelineRefEntity:get_name()
  return self._name
end


function EeApiEntitiesGeoPipelineRefEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EeApiEntitiesGeoPipelineRefEntity.new(self._client, opts)
end
...
function EeApiEntitiesGeoPipelineRefEntity:mark_deleted()
  self._deleted = true
end


function EeApiEntitiesGeoPipelineRefEntity:deleted()
  return true == self._deleted
end


function EeApiEntitiesGeoPipelineRefEntity:data_set(args)
  if args ~= nil then
...
function EeApiEntitiesGeoPipelineRefEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EeApiEntitiesGeoPipelineRefEntity:match_set(args)
  if args ~= nil then
...
function EeApiEntitiesGeoPipelineRefEntity:match_get()
...
function EeApiEntitiesGeoPipelineRefEntity:stream(action, args, callopts)
...
---@param reqmatch EeApiEntitiesGeoPipelineRefListMatch
---@param ctrl? table
---@return EeApiEntitiesGeoPipelineRef[]
---@return string? err
function EeApiEntitiesGeoPipelineRefEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EeApiEntitiesGeoPipelineRefEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EeApiEntitiesGeoPipelineRefEntity
