...
local ApiEntitiesCiJobEntity = {}
ApiEntitiesCiJobEntity.__index = ApiEntitiesCiJobEntity


function ApiEntitiesCiJobEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiJobEntity)
  self._name = "api_entities_ci_job"
  self._client = client
...
function ApiEntitiesCiJobEntity:get_name()
  return self._name
end


function ApiEntitiesCiJobEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiJobEntity.new(self._client, opts)
end
...
function ApiEntitiesCiJobEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiJobEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiJobEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiJobEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiJobEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiJobEntity:match_get()
...
function ApiEntitiesCiJobEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiJobLoadMatch
---@param ctrl? table
---@return ApiEntitiesCiJob
---@return string? err
function ApiEntitiesCiJobEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesCiJobListMatch
---@param ctrl? table
---@return ApiEntitiesCiJob[]
---@return string? err
function ApiEntitiesCiJobEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesCiJobCreateData
---@param ctrl? table
---@return ApiEntitiesCiJob
---@return string? err
function ApiEntitiesCiJobEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesCiJobEntity:_run_op(ctx, post_done)
  local utility = self._utility
