-- Gitlab SDK ApiEntitiesNpmPackage entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesNpmPackageEntity = {}
ApiEntitiesNpmPackageEntity.__index = ApiEntitiesNpmPackageEntity


function ApiEntitiesNpmPackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesNpmPackageEntity)
  self._name = "api_entities_npm_package"
  self._client = client
...
function ApiEntitiesNpmPackageEntity:get_name()
  return self._name
end


function ApiEntitiesNpmPackageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesNpmPackageEntity.new(self._client, opts)
end
...
function ApiEntitiesNpmPackageEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesNpmPackageEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesNpmPackageEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesNpmPackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesNpmPackageEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesNpmPackageEntity:match_get()
...
function ApiEntitiesNpmPackageEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesNpmPackageLoadMatch
---@param ctrl? table
---@return ApiEntitiesNpmPackage
---@return string? err
function ApiEntitiesNpmPackageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesNpmPackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesNpmPackageEntity
