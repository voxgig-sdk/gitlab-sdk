...
local ApiEntitiesProtectedBranchEntity = {}
ApiEntitiesProtectedBranchEntity.__index = ApiEntitiesProtectedBranchEntity


function ApiEntitiesProtectedBranchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProtectedBranchEntity)
  self._name = "api_entities_protected_branch"
  self._client = client
...
function ApiEntitiesProtectedBranchEntity:get_name()
  return self._name
end


function ApiEntitiesProtectedBranchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProtectedBranchEntity.new(self._client, opts)
end
...
function ApiEntitiesProtectedBranchEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProtectedBranchEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProtectedBranchEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProtectedBranchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProtectedBranchEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProtectedBranchEntity:match_get()
...
function ApiEntitiesProtectedBranchEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProtectedBranchLoadMatch
---@param ctrl? table
---@return ApiEntitiesProtectedBranch
---@return string? err
function ApiEntitiesProtectedBranchEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesProtectedBranchListMatch
---@param ctrl? table
---@return ApiEntitiesProtectedBranch[]
---@return string? err
function ApiEntitiesProtectedBranchEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProtectedBranchCreateData
---@param ctrl? table
---@return ApiEntitiesProtectedBranch
---@return string? err
function ApiEntitiesProtectedBranchEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProtectedBranchUpdateData
---@param ctrl? table
---@return ApiEntitiesProtectedBranch
---@return string? err
function ApiEntitiesProtectedBranchEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesProtectedBranchEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProtectedBranchEntity
