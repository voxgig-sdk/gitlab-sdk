-- Gitlab SDK ApiEntitiesPackagesConanRecipeManifest entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagesConanRecipeManifestEntity = {}
ApiEntitiesPackagesConanRecipeManifestEntity.__index = ApiEntitiesPackagesConanRecipeManifestEntity


function ApiEntitiesPackagesConanRecipeManifestEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesConanRecipeManifestEntity)
  self._name = "api_entities_packages_conan_recipe_manifest"
  self._client = client
...
function ApiEntitiesPackagesConanRecipeManifestEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesConanRecipeManifestEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesConanRecipeManifestEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesConanRecipeManifestEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesConanRecipeManifestEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesConanRecipeManifestEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanRecipeManifestEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesConanRecipeManifestEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanRecipeManifestEntity:match_get()
...
function ApiEntitiesPackagesConanRecipeManifestEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagesConanRecipeManifestLoadMatch
---@param ctrl? table
---@return ApiEntitiesPackagesConanRecipeManifest
---@return string? err
function ApiEntitiesPackagesConanRecipeManifestEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagesConanRecipeManifestEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesConanRecipeManifestEntity
