...
function ApiEntitiesCiRunnerDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiRunnerDetailEntity:deleted()
...
function ApiEntitiesCiRunnerDetailEntity:stream(action, args, callopts)
