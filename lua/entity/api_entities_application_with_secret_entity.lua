-- Gitlab SDK ApiEntitiesApplicationWithSecret entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesApplicationWithSecretEntity = {}
ApiEntitiesApplicationWithSecretEntity.__index = ApiEntitiesApplicationWithSecretEntity


function ApiEntitiesApplicationWithSecretEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesApplicationWithSecretEntity)
  self._name = "api_entities_application_with_secret"
  self._client = client
...
function ApiEntitiesApplicationWithSecretEntity:get_name()
  return self._name
end


function ApiEntitiesApplicationWithSecretEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesApplicationWithSecretEntity.new(self._client, opts)
end
...
function ApiEntitiesApplicationWithSecretEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesApplicationWithSecretEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesApplicationWithSecretEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesApplicationWithSecretEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesApplicationWithSecretEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesApplicationWithSecretEntity:match_get()
...
function ApiEntitiesApplicationWithSecretEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesApplicationWithSecretCreateData
---@param ctrl? table
---@return ApiEntitiesApplicationWithSecret
---@return string? err
function ApiEntitiesApplicationWithSecretEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesApplicationWithSecretEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesApplicationWithSecretEntity
