...
local ApiEntitiesReleaseEntity = {}
ApiEntitiesReleaseEntity.__index = ApiEntitiesReleaseEntity


function ApiEntitiesReleaseEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesReleaseEntity)
  self._name = "api_entities_release"
  self._client = client
...
function ApiEntitiesReleaseEntity:get_name()
  return self._name
end


function ApiEntitiesReleaseEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesReleaseEntity.new(self._client, opts)
end
...
function ApiEntitiesReleaseEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesReleaseEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesReleaseEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesReleaseEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesReleaseEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesReleaseEntity:match_get()
...
function ApiEntitiesReleaseEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesReleaseLoadMatch
---@param ctrl? table
---@return ApiEntitiesRelease
---@return string? err
function ApiEntitiesReleaseEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesReleaseListMatch
---@param ctrl? table
---@return ApiEntitiesRelease[]
---@return string? err
function ApiEntitiesReleaseEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesReleaseCreateData
---@param ctrl? table
---@return ApiEntitiesRelease
---@return string? err
function ApiEntitiesReleaseEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesReleaseUpdateData
---@param ctrl? table
---@return ApiEntitiesRelease
---@return string? err
function ApiEntitiesReleaseEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesReleaseEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesReleaseEntity
