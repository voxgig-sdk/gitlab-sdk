-- Gitlab SDK EeApiEntitiesBillableMembership entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EeApiEntitiesBillableMembershipEntity = {}
EeApiEntitiesBillableMembershipEntity.__index = EeApiEntitiesBillableMembershipEntity


function EeApiEntitiesBillableMembershipEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EeApiEntitiesBillableMembershipEntity)
  self._name = "ee_api_entities_billable_membership"
  self._client = client
...
function EeApiEntitiesBillableMembershipEntity:get_name()
  return self._name
end


function EeApiEntitiesBillableMembershipEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EeApiEntitiesBillableMembershipEntity.new(self._client, opts)
end
...
function EeApiEntitiesBillableMembershipEntity:mark_deleted()
  self._deleted = true
end


function EeApiEntitiesBillableMembershipEntity:deleted()
  return true == self._deleted
end


function EeApiEntitiesBillableMembershipEntity:data_set(args)
  if args ~= nil then
...
function EeApiEntitiesBillableMembershipEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EeApiEntitiesBillableMembershipEntity:match_set(args)
  if args ~= nil then
...
function EeApiEntitiesBillableMembershipEntity:match_get()
...
function EeApiEntitiesBillableMembershipEntity:stream(action, args, callopts)
...
---@param reqmatch EeApiEntitiesBillableMembershipLoadMatch
---@param ctrl? table
---@return EeApiEntitiesBillableMembership
---@return string? err
function EeApiEntitiesBillableMembershipEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EeApiEntitiesBillableMembershipEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EeApiEntitiesBillableMembershipEntity
