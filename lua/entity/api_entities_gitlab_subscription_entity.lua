-- Gitlab SDK ApiEntitiesGitlabSubscription entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesGitlabSubscriptionEntity = {}
ApiEntitiesGitlabSubscriptionEntity.__index = ApiEntitiesGitlabSubscriptionEntity


function ApiEntitiesGitlabSubscriptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesGitlabSubscriptionEntity)
  self._name = "api_entities_gitlab_subscription"
  self._client = client
...
function ApiEntitiesGitlabSubscriptionEntity:get_name()
  return self._name
end


function ApiEntitiesGitlabSubscriptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesGitlabSubscriptionEntity.new(self._client, opts)
end
...
function ApiEntitiesGitlabSubscriptionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesGitlabSubscriptionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesGitlabSubscriptionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesGitlabSubscriptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesGitlabSubscriptionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesGitlabSubscriptionEntity:match_get()
...
function ApiEntitiesGitlabSubscriptionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesGitlabSubscriptionLoadMatch
---@param ctrl? table
---@return ApiEntitiesGitlabSubscription
---@return string? err
function ApiEntitiesGitlabSubscriptionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesGitlabSubscriptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesGitlabSubscriptionEntity
