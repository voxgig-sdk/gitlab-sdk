-- Gitlab SDK ApiEntitiesMarkdownUploadAdmin entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesMarkdownUploadAdminEntity = {}
ApiEntitiesMarkdownUploadAdminEntity.__index = ApiEntitiesMarkdownUploadAdminEntity


function ApiEntitiesMarkdownUploadAdminEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMarkdownUploadAdminEntity)
  self._name = "api_entities_markdown_upload_admin"
  self._client = client
...
function ApiEntitiesMarkdownUploadAdminEntity:get_name()
  return self._name
end


function ApiEntitiesMarkdownUploadAdminEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMarkdownUploadAdminEntity.new(self._client, opts)
end
...
function ApiEntitiesMarkdownUploadAdminEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMarkdownUploadAdminEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMarkdownUploadAdminEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMarkdownUploadAdminEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMarkdownUploadAdminEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMarkdownUploadAdminEntity:match_get()
...
function ApiEntitiesMarkdownUploadAdminEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMarkdownUploadAdminListMatch
---@param ctrl? table
---@return ApiEntitiesMarkdownUploadAdmin[]
---@return string? err
function ApiEntitiesMarkdownUploadAdminEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesMarkdownUploadAdminEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMarkdownUploadAdminEntity
