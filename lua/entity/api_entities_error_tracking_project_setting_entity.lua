-- Gitlab SDK ApiEntitiesErrorTrackingProjectSetting entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesErrorTrackingProjectSettingEntity = {}
ApiEntitiesErrorTrackingProjectSettingEntity.__index = ApiEntitiesErrorTrackingProjectSettingEntity


function ApiEntitiesErrorTrackingProjectSettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesErrorTrackingProjectSettingEntity)
  self._name = "api_entities_error_tracking_project_setting"
  self._client = client
...
function ApiEntitiesErrorTrackingProjectSettingEntity:get_name()
  return self._name
end


function ApiEntitiesErrorTrackingProjectSettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesErrorTrackingProjectSettingEntity.new(self._client, opts)
end
...
function ApiEntitiesErrorTrackingProjectSettingEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesErrorTrackingProjectSettingEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesErrorTrackingProjectSettingEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesErrorTrackingProjectSettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesErrorTrackingProjectSettingEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesErrorTrackingProjectSettingEntity:match_get()
...
function ApiEntitiesErrorTrackingProjectSettingEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesErrorTrackingProjectSettingLoadMatch
---@param ctrl? table
---@return ApiEntitiesErrorTrackingProjectSetting
---@return string? err
function ApiEntitiesErrorTrackingProjectSettingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesErrorTrackingProjectSettingUpdateData
---@param ctrl? table
---@return ApiEntitiesErrorTrackingProjectSetting
---@return string? err
function ApiEntitiesErrorTrackingProjectSettingEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesErrorTrackingProjectSettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesErrorTrackingProjectSettingEntity
