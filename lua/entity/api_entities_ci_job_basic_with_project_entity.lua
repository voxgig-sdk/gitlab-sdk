-- Gitlab SDK ApiEntitiesCiJobBasicWithProject entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiJobBasicWithProjectEntity = {}
ApiEntitiesCiJobBasicWithProjectEntity.__index = ApiEntitiesCiJobBasicWithProjectEntity


function ApiEntitiesCiJobBasicWithProjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiJobBasicWithProjectEntity)
  self._name = "api_entities_ci_job_basic_with_project"
  self._client = client
...
function ApiEntitiesCiJobBasicWithProjectEntity:get_name()
  return self._name
end


function ApiEntitiesCiJobBasicWithProjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiJobBasicWithProjectEntity.new(self._client, opts)
end
...
function ApiEntitiesCiJobBasicWithProjectEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiJobBasicWithProjectEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiJobBasicWithProjectEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiJobBasicWithProjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiJobBasicWithProjectEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiJobBasicWithProjectEntity:match_get()
...
function ApiEntitiesCiJobBasicWithProjectEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiJobBasicWithProjectLoadMatch
---@param ctrl? table
---@return ApiEntitiesCiJobBasicWithProject
---@return string? err
function ApiEntitiesCiJobBasicWithProjectEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesCiJobBasicWithProjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiJobBasicWithProjectEntity
