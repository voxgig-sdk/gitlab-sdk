...
local ApiEntitiesInvitationEntity = {}
ApiEntitiesInvitationEntity.__index = ApiEntitiesInvitationEntity


function ApiEntitiesInvitationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesInvitationEntity)
  self._name = "api_entities_invitation"
  self._client = client
...
function ApiEntitiesInvitationEntity:get_name()
  return self._name
end


function ApiEntitiesInvitationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesInvitationEntity.new(self._client, opts)
end
...
function ApiEntitiesInvitationEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesInvitationEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesInvitationEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesInvitationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesInvitationEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesInvitationEntity:match_get()
...
function ApiEntitiesInvitationEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesInvitationListMatch
---@param ctrl? table
---@return ApiEntitiesInvitation[]
---@return string? err
function ApiEntitiesInvitationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesInvitationCreateData
---@param ctrl? table
---@return ApiEntitiesInvitation
---@return string? err
function ApiEntitiesInvitationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesInvitationUpdateData
---@param ctrl? table
---@return ApiEntitiesInvitation
---@return string? err
function ApiEntitiesInvitationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesInvitationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesInvitationEntity
