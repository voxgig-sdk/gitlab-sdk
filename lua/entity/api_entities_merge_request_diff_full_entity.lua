-- Gitlab SDK ApiEntitiesMergeRequestDiffFull entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesMergeRequestDiffFullEntity = {}
ApiEntitiesMergeRequestDiffFullEntity.__index = ApiEntitiesMergeRequestDiffFullEntity


function ApiEntitiesMergeRequestDiffFullEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMergeRequestDiffFullEntity)
  self._name = "api_entities_merge_request_diff_full"
  self._client = client
...
function ApiEntitiesMergeRequestDiffFullEntity:get_name()
  return self._name
end


function ApiEntitiesMergeRequestDiffFullEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMergeRequestDiffFullEntity.new(self._client, opts)
end
...
function ApiEntitiesMergeRequestDiffFullEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMergeRequestDiffFullEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMergeRequestDiffFullEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestDiffFullEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMergeRequestDiffFullEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestDiffFullEntity:match_get()
...
function ApiEntitiesMergeRequestDiffFullEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMergeRequestDiffFullLoadMatch
---@param ctrl? table
---@return ApiEntitiesMergeRequestDiffFull
---@return string? err
function ApiEntitiesMergeRequestDiffFullEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesMergeRequestDiffFullEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMergeRequestDiffFullEntity
