...
local ApiEntitiesIssueEntity = {}
ApiEntitiesIssueEntity.__index = ApiEntitiesIssueEntity


function ApiEntitiesIssueEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesIssueEntity)
  self._name = "api_entities_issue"
  self._client = client
...
function ApiEntitiesIssueEntity:get_name()
  return self._name
end


function ApiEntitiesIssueEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesIssueEntity.new(self._client, opts)
end
...
function ApiEntitiesIssueEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesIssueEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesIssueEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesIssueEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesIssueEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesIssueEntity:match_get()
...
function ApiEntitiesIssueEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesIssueLoadMatch
---@param ctrl? table
---@return ApiEntitiesIssue
---@return string? err
function ApiEntitiesIssueEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesIssueListMatch
---@param ctrl? table
---@return ApiEntitiesIssue[]
---@return string? err
function ApiEntitiesIssueEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesIssueCreateData
---@param ctrl? table
---@return ApiEntitiesIssue
---@return string? err
function ApiEntitiesIssueEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesIssueUpdateData
---@param ctrl? table
---@return ApiEntitiesIssue
---@return string? err
function ApiEntitiesIssueEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesIssueEntity:_run_op(ctx, post_done)
  local utility = self._utility
