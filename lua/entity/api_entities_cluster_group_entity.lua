...
local ApiEntitiesClusterGroupEntity = {}
ApiEntitiesClusterGroupEntity.__index = ApiEntitiesClusterGroupEntity


function ApiEntitiesClusterGroupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesClusterGroupEntity)
  self._name = "api_entities_cluster_group"
  self._client = client
...
function ApiEntitiesClusterGroupEntity:get_name()
  return self._name
end


function ApiEntitiesClusterGroupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesClusterGroupEntity.new(self._client, opts)
end
...
function ApiEntitiesClusterGroupEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesClusterGroupEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesClusterGroupEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesClusterGroupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesClusterGroupEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesClusterGroupEntity:match_get()
...
function ApiEntitiesClusterGroupEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesClusterGroupLoadMatch
---@param ctrl? table
---@return ApiEntitiesClusterGroup
---@return string? err
function ApiEntitiesClusterGroupEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesClusterGroupCreateData
---@param ctrl? table
---@return ApiEntitiesClusterGroup
---@return string? err
function ApiEntitiesClusterGroupEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesClusterGroupUpdateData
---@param ctrl? table
---@return ApiEntitiesClusterGroup
---@return string? err
function ApiEntitiesClusterGroupEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesClusterGroupEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesClusterGroupEntity
