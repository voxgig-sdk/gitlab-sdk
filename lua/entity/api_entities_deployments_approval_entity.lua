-- Gitlab SDK ApiEntitiesDeploymentsApproval entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesDeploymentsApprovalEntity = {}
ApiEntitiesDeploymentsApprovalEntity.__index = ApiEntitiesDeploymentsApprovalEntity


function ApiEntitiesDeploymentsApprovalEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDeploymentsApprovalEntity)
  self._name = "api_entities_deployments_approval"
  self._client = client
...
function ApiEntitiesDeploymentsApprovalEntity:get_name()
  return self._name
end


function ApiEntitiesDeploymentsApprovalEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDeploymentsApprovalEntity.new(self._client, opts)
end
...
function ApiEntitiesDeploymentsApprovalEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDeploymentsApprovalEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDeploymentsApprovalEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDeploymentsApprovalEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDeploymentsApprovalEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDeploymentsApprovalEntity:match_get()
...
function ApiEntitiesDeploymentsApprovalEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesDeploymentsApprovalCreateData
---@param ctrl? table
---@return ApiEntitiesDeploymentsApproval
---@return string? err
function ApiEntitiesDeploymentsApprovalEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesDeploymentsApprovalEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesDeploymentsApprovalEntity
