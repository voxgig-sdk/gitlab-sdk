-- Gitlab SDK ApiEntitiesOrganizationsOrganization entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesOrganizationsOrganizationEntity = {}
ApiEntitiesOrganizationsOrganizationEntity.__index = ApiEntitiesOrganizationsOrganizationEntity


function ApiEntitiesOrganizationsOrganizationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesOrganizationsOrganizationEntity)
  self._name = "api_entities_organizations_organization"
  self._client = client
...
function ApiEntitiesOrganizationsOrganizationEntity:get_name()
  return self._name
end


function ApiEntitiesOrganizationsOrganizationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesOrganizationsOrganizationEntity.new(self._client, opts)
end
...
function ApiEntitiesOrganizationsOrganizationEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesOrganizationsOrganizationEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesOrganizationsOrganizationEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesOrganizationsOrganizationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesOrganizationsOrganizationEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesOrganizationsOrganizationEntity:match_get()
...
function ApiEntitiesOrganizationsOrganizationEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesOrganizationsOrganizationCreateData
---@param ctrl? table
---@return ApiEntitiesOrganizationsOrganization
---@return string? err
function ApiEntitiesOrganizationsOrganizationEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesOrganizationsOrganizationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesOrganizationsOrganizationEntity
