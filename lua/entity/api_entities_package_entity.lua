...
local ApiEntitiesPackageEntity = {}
ApiEntitiesPackageEntity.__index = ApiEntitiesPackageEntity


function ApiEntitiesPackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackageEntity)
  self._name = "api_entities_package"
  self._client = client
...
function ApiEntitiesPackageEntity:get_name()
  return self._name
end


function ApiEntitiesPackageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackageEntity.new(self._client, opts)
end
...
function ApiEntitiesPackageEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackageEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackageEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackageEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackageEntity:match_get()
...
function ApiEntitiesPackageEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackageLoadMatch
---@param ctrl? table
---@return ApiEntitiesPackage
---@return string? err
function ApiEntitiesPackageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesPackageListMatch
---@param ctrl? table
---@return ApiEntitiesPackage[]
---@return string? err
function ApiEntitiesPackageEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiEntitiesPackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackageEntity
