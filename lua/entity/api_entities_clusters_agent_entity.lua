-- Gitlab SDK ApiEntitiesClustersAgent entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesClustersAgentEntity = {}
ApiEntitiesClustersAgentEntity.__index = ApiEntitiesClustersAgentEntity


function ApiEntitiesClustersAgentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesClustersAgentEntity)
  self._name = "api_entities_clusters_agent"
  self._client = client
...
function ApiEntitiesClustersAgentEntity:get_name()
  return self._name
end


function ApiEntitiesClustersAgentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesClustersAgentEntity.new(self._client, opts)
end
...
function ApiEntitiesClustersAgentEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesClustersAgentEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesClustersAgentEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesClustersAgentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesClustersAgentEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesClustersAgentEntity:match_get()
...
function ApiEntitiesClustersAgentEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesClustersAgentLoadMatch
---@param ctrl? table
---@return ApiEntitiesClustersAgent
---@return string? err
function ApiEntitiesClustersAgentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesClustersAgentCreateData
---@param ctrl? table
---@return ApiEntitiesClustersAgent
---@return string? err
function ApiEntitiesClustersAgentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesClustersAgentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesClustersAgentEntity
