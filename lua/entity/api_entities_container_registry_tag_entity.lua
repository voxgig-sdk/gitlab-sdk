-- Gitlab SDK ApiEntitiesContainerRegistryTag entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesContainerRegistryTagEntity = {}
ApiEntitiesContainerRegistryTagEntity.__index = ApiEntitiesContainerRegistryTagEntity


function ApiEntitiesContainerRegistryTagEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesContainerRegistryTagEntity)
  self._name = "api_entities_container_registry_tag"
  self._client = client
...
function ApiEntitiesContainerRegistryTagEntity:get_name()
  return self._name
end


function ApiEntitiesContainerRegistryTagEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesContainerRegistryTagEntity.new(self._client, opts)
end
...
function ApiEntitiesContainerRegistryTagEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesContainerRegistryTagEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesContainerRegistryTagEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesContainerRegistryTagEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesContainerRegistryTagEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesContainerRegistryTagEntity:match_get()
...
function ApiEntitiesContainerRegistryTagEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesContainerRegistryTagListMatch
---@param ctrl? table
---@return ApiEntitiesContainerRegistryTag[]
---@return string? err
function ApiEntitiesContainerRegistryTagEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesContainerRegistryTagEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesContainerRegistryTagEntity
