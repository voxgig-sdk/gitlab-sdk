-- Gitlab SDK ApiEntitiesCompare entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCompareEntity = {}
ApiEntitiesCompareEntity.__index = ApiEntitiesCompareEntity


function ApiEntitiesCompareEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCompareEntity)
  self._name = "api_entities_compare"
  self._client = client
...
function ApiEntitiesCompareEntity:get_name()
  return self._name
end


function ApiEntitiesCompareEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCompareEntity.new(self._client, opts)
end
...
function ApiEntitiesCompareEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCompareEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCompareEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCompareEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCompareEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCompareEntity:match_get()
...
function ApiEntitiesCompareEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCompareListMatch
---@param ctrl? table
---@return ApiEntitiesCompare[]
---@return string? err
function ApiEntitiesCompareEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesCompareEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCompareEntity
