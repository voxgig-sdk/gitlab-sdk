-- Gitlab SDK ApiEntitiesCommitSignature entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCommitSignatureEntity = {}
ApiEntitiesCommitSignatureEntity.__index = ApiEntitiesCommitSignatureEntity


function ApiEntitiesCommitSignatureEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCommitSignatureEntity)
  self._name = "api_entities_commit_signature"
  self._client = client
...
function ApiEntitiesCommitSignatureEntity:get_name()
  return self._name
end


function ApiEntitiesCommitSignatureEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCommitSignatureEntity.new(self._client, opts)
end
...
function ApiEntitiesCommitSignatureEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCommitSignatureEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCommitSignatureEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitSignatureEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCommitSignatureEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCommitSignatureEntity:match_get()
...
function ApiEntitiesCommitSignatureEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCommitSignatureLoadMatch
---@param ctrl? table
---@return ApiEntitiesCommitSignature
---@return string? err
function ApiEntitiesCommitSignatureEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesCommitSignatureEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCommitSignatureEntity
