-- Gitlab SDK ApiEntitiesMrNote entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesMrNoteEntity = {}
ApiEntitiesMrNoteEntity.__index = ApiEntitiesMrNoteEntity


function ApiEntitiesMrNoteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMrNoteEntity)
  self._name = "api_entities_mr_note"
  self._client = client
...
function ApiEntitiesMrNoteEntity:get_name()
  return self._name
end


function ApiEntitiesMrNoteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMrNoteEntity.new(self._client, opts)
end
...
function ApiEntitiesMrNoteEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMrNoteEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMrNoteEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMrNoteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMrNoteEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMrNoteEntity:match_get()
...
function ApiEntitiesMrNoteEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMrNoteLoadMatch
---@param ctrl? table
---@return ApiEntitiesMrNote
---@return string? err
function ApiEntitiesMrNoteEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesMrNoteEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMrNoteEntity
