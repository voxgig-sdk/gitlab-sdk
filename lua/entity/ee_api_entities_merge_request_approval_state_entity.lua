-- Gitlab SDK EeApiEntitiesMergeRequestApprovalState entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EeApiEntitiesMergeRequestApprovalStateEntity = {}
EeApiEntitiesMergeRequestApprovalStateEntity.__index = EeApiEntitiesMergeRequestApprovalStateEntity


function EeApiEntitiesMergeRequestApprovalStateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EeApiEntitiesMergeRequestApprovalStateEntity)
  self._name = "ee_api_entities_merge_request_approval_state"
  self._client = client
...
function EeApiEntitiesMergeRequestApprovalStateEntity:get_name()
  return self._name
end


function EeApiEntitiesMergeRequestApprovalStateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EeApiEntitiesMergeRequestApprovalStateEntity.new(self._client, opts)
end
...
function EeApiEntitiesMergeRequestApprovalStateEntity:mark_deleted()
  self._deleted = true
end


function EeApiEntitiesMergeRequestApprovalStateEntity:deleted()
  return true == self._deleted
end


function EeApiEntitiesMergeRequestApprovalStateEntity:data_set(args)
  if args ~= nil then
...
function EeApiEntitiesMergeRequestApprovalStateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EeApiEntitiesMergeRequestApprovalStateEntity:match_set(args)
  if args ~= nil then
...
function EeApiEntitiesMergeRequestApprovalStateEntity:match_get()
...
function EeApiEntitiesMergeRequestApprovalStateEntity:stream(action, args, callopts)
...
---@param reqmatch EeApiEntitiesMergeRequestApprovalStateListMatch
---@param ctrl? table
---@return EeApiEntitiesMergeRequestApprovalState[]
---@return string? err
function EeApiEntitiesMergeRequestApprovalStateEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EeApiEntitiesMergeRequestApprovalStateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EeApiEntitiesMergeRequestApprovalStateEntity
