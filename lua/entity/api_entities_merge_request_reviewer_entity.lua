-- Gitlab SDK ApiEntitiesMergeRequestReviewer entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesMergeRequestReviewerEntity = {}
ApiEntitiesMergeRequestReviewerEntity.__index = ApiEntitiesMergeRequestReviewerEntity


function ApiEntitiesMergeRequestReviewerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMergeRequestReviewerEntity)
  self._name = "api_entities_merge_request_reviewer"
  self._client = client
...
function ApiEntitiesMergeRequestReviewerEntity:get_name()
  return self._name
end


function ApiEntitiesMergeRequestReviewerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMergeRequestReviewerEntity.new(self._client, opts)
end
...
function ApiEntitiesMergeRequestReviewerEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMergeRequestReviewerEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMergeRequestReviewerEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestReviewerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMergeRequestReviewerEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestReviewerEntity:match_get()
...
function ApiEntitiesMergeRequestReviewerEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMergeRequestReviewerLoadMatch
---@param ctrl? table
---@return ApiEntitiesMergeRequestReviewer
---@return string? err
function ApiEntitiesMergeRequestReviewerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesMergeRequestReviewerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMergeRequestReviewerEntity
