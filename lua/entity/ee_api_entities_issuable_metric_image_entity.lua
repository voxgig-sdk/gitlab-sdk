...
local EeApiEntitiesIssuableMetricImageEntity = {}
EeApiEntitiesIssuableMetricImageEntity.__index = EeApiEntitiesIssuableMetricImageEntity


function EeApiEntitiesIssuableMetricImageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EeApiEntitiesIssuableMetricImageEntity)
  self._name = "ee_api_entities_issuable_metric_image"
  self._client = client
...
function EeApiEntitiesIssuableMetricImageEntity:get_name()
  return self._name
end


function EeApiEntitiesIssuableMetricImageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EeApiEntitiesIssuableMetricImageEntity.new(self._client, opts)
end
...
function EeApiEntitiesIssuableMetricImageEntity:mark_deleted()
  self._deleted = true
end


function EeApiEntitiesIssuableMetricImageEntity:deleted()
  return true == self._deleted
end


function EeApiEntitiesIssuableMetricImageEntity:data_set(args)
  if args ~= nil then
...
function EeApiEntitiesIssuableMetricImageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EeApiEntitiesIssuableMetricImageEntity:match_set(args)
  if args ~= nil then
...
function EeApiEntitiesIssuableMetricImageEntity:match_get()
...
function EeApiEntitiesIssuableMetricImageEntity:stream(action, args, callopts)
...
---@param reqdata EeApiEntitiesIssuableMetricImageCreateData
---@param ctrl? table
---@return EeApiEntitiesIssuableMetricImage
---@return string? err
function EeApiEntitiesIssuableMetricImageEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqdata EeApiEntitiesIssuableMetricImageUpdateData
---@param ctrl? table
---@return EeApiEntitiesIssuableMetricImage
---@return string? err
function EeApiEntitiesIssuableMetricImageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch EeApiEntitiesIssuableMetricImageRemoveMatch
---@param ctrl? table
---@return EeApiEntitiesIssuableMetricImage
---@return string? err
function EeApiEntitiesIssuableMetricImageEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function EeApiEntitiesIssuableMetricImageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EeApiEntitiesIssuableMetricImageEntity
