-- Gitlab SDK ApiEntitiesPackagesConanUploadUrl entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagesConanUploadUrlEntity = {}
ApiEntitiesPackagesConanUploadUrlEntity.__index = ApiEntitiesPackagesConanUploadUrlEntity


function ApiEntitiesPackagesConanUploadUrlEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesConanUploadUrlEntity)
  self._name = "api_entities_packages_conan_upload_url"
  self._client = client
...
function ApiEntitiesPackagesConanUploadUrlEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesConanUploadUrlEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesConanUploadUrlEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesConanUploadUrlEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesConanUploadUrlEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesConanUploadUrlEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanUploadUrlEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesConanUploadUrlEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanUploadUrlEntity:match_get()
...
function ApiEntitiesPackagesConanUploadUrlEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesPackagesConanUploadUrlCreateData
---@param ctrl? table
---@return ApiEntitiesPackagesConanUploadUrl
---@return string? err
function ApiEntitiesPackagesConanUploadUrlEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagesConanUploadUrlEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesConanUploadUrlEntity
