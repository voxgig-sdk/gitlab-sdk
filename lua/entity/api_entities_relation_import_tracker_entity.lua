-- Gitlab SDK ApiEntitiesRelationImportTracker entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesRelationImportTrackerEntity = {}
ApiEntitiesRelationImportTrackerEntity.__index = ApiEntitiesRelationImportTrackerEntity


function ApiEntitiesRelationImportTrackerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesRelationImportTrackerEntity)
  self._name = "api_entities_relation_import_tracker"
  self._client = client
...
function ApiEntitiesRelationImportTrackerEntity:get_name()
  return self._name
end


function ApiEntitiesRelationImportTrackerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesRelationImportTrackerEntity.new(self._client, opts)
end
...
function ApiEntitiesRelationImportTrackerEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesRelationImportTrackerEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesRelationImportTrackerEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesRelationImportTrackerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesRelationImportTrackerEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesRelationImportTrackerEntity:match_get()
...
function ApiEntitiesRelationImportTrackerEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesRelationImportTrackerCreateData
---@param ctrl? table
---@return ApiEntitiesRelationImportTracker
---@return string? err
function ApiEntitiesRelationImportTrackerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesRelationImportTrackerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesRelationImportTrackerEntity
