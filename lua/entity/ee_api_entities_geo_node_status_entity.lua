-- Gitlab SDK EeApiEntitiesGeoNodeStatus entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EeApiEntitiesGeoNodeStatusEntity = {}
EeApiEntitiesGeoNodeStatusEntity.__index = EeApiEntitiesGeoNodeStatusEntity


function EeApiEntitiesGeoNodeStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EeApiEntitiesGeoNodeStatusEntity)
  self._name = "ee_api_entities_geo_node_status"
  self._client = client
...
function EeApiEntitiesGeoNodeStatusEntity:get_name()
  return self._name
end


function EeApiEntitiesGeoNodeStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EeApiEntitiesGeoNodeStatusEntity.new(self._client, opts)
end
...
function EeApiEntitiesGeoNodeStatusEntity:mark_deleted()
  self._deleted = true
end


function EeApiEntitiesGeoNodeStatusEntity:deleted()
  return true == self._deleted
end


function EeApiEntitiesGeoNodeStatusEntity:data_set(args)
  if args ~= nil then
...
function EeApiEntitiesGeoNodeStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EeApiEntitiesGeoNodeStatusEntity:match_set(args)
  if args ~= nil then
...
function EeApiEntitiesGeoNodeStatusEntity:match_get()
...
function EeApiEntitiesGeoNodeStatusEntity:stream(action, args, callopts)
...
---@param reqdata EeApiEntitiesGeoNodeStatusCreateData
---@param ctrl? table
---@return EeApiEntitiesGeoNodeStatus
---@return string? err
function EeApiEntitiesGeoNodeStatusEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function EeApiEntitiesGeoNodeStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EeApiEntitiesGeoNodeStatusEntity
