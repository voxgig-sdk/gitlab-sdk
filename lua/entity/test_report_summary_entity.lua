-- Gitlab SDK TestReportSummary entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local TestReportSummaryEntity = {}
TestReportSummaryEntity.__index = TestReportSummaryEntity


function TestReportSummaryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TestReportSummaryEntity)
  self._name = "test_report_summary"
  self._client = client
...
function TestReportSummaryEntity:get_name()
  return self._name
end


function TestReportSummaryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TestReportSummaryEntity.new(self._client, opts)
end
...
function TestReportSummaryEntity:mark_deleted()
  self._deleted = true
end


function TestReportSummaryEntity:deleted()
  return true == self._deleted
end


function TestReportSummaryEntity:data_set(args)
  if args ~= nil then
...
function TestReportSummaryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TestReportSummaryEntity:match_set(args)
  if args ~= nil then
...
function TestReportSummaryEntity:match_get()
...
function TestReportSummaryEntity:stream(action, args, callopts)
...
---@param reqmatch TestReportSummaryLoadMatch
---@param ctrl? table
---@return TestReportSummary
---@return string? err
function TestReportSummaryEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function TestReportSummaryEntity:_run_op(ctx, post_done)
  local utility = self._utility
