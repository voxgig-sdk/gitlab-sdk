...
local ApiEntitiesProjectImportStatusEntity = {}
ApiEntitiesProjectImportStatusEntity.__index = ApiEntitiesProjectImportStatusEntity


function ApiEntitiesProjectImportStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectImportStatusEntity)
  self._name = "api_entities_project_import_status"
  self._client = client
...
function ApiEntitiesProjectImportStatusEntity:get_name()
  return self._name
end


function ApiEntitiesProjectImportStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectImportStatusEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectImportStatusEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectImportStatusEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectImportStatusEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectImportStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectImportStatusEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectImportStatusEntity:match_get()
...
function ApiEntitiesProjectImportStatusEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectImportStatusListMatch
---@param ctrl? table
---@return ApiEntitiesProjectImportStatus[]
---@return string? err
function ApiEntitiesProjectImportStatusEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesProjectImportStatusCreateData
---@param ctrl? table
---@return ApiEntitiesProjectImportStatus
---@return string? err
function ApiEntitiesProjectImportStatusEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesProjectImportStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectImportStatusEntity
