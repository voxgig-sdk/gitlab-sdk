-- Gitlab SDK ApiEntitiesCiRunner entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiRunnerEntity = {}
ApiEntitiesCiRunnerEntity.__index = ApiEntitiesCiRunnerEntity


function ApiEntitiesCiRunnerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiRunnerEntity)
  self._name = "api_entities_ci_runner"
  self._client = client
...
function ApiEntitiesCiRunnerEntity:get_name()
  return self._name
end


function ApiEntitiesCiRunnerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiRunnerEntity.new(self._client, opts)
end
...
function ApiEntitiesCiRunnerEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiRunnerEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiRunnerEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiRunnerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiRunnerEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiRunnerEntity:match_get()
...
function ApiEntitiesCiRunnerEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiRunnerLoadMatch
---@param ctrl? table
---@return ApiEntitiesCiRunner
---@return string? err
function ApiEntitiesCiRunnerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesCiRunnerCreateData
---@param ctrl? table
---@return ApiEntitiesCiRunner
---@return string? err
function ApiEntitiesCiRunnerEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesCiRunnerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiRunnerEntity
