-- Gitlab SDK ApiEntitiesClustersAgentToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesClustersAgentTokenEntity = {}
ApiEntitiesClustersAgentTokenEntity.__index = ApiEntitiesClustersAgentTokenEntity


function ApiEntitiesClustersAgentTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesClustersAgentTokenEntity)
  self._name = "api_entities_clusters_agent_token"
  self._client = client
...
function ApiEntitiesClustersAgentTokenEntity:get_name()
  return self._name
end


function ApiEntitiesClustersAgentTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesClustersAgentTokenEntity.new(self._client, opts)
end
...
function ApiEntitiesClustersAgentTokenEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesClustersAgentTokenEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesClustersAgentTokenEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesClustersAgentTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesClustersAgentTokenEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesClustersAgentTokenEntity:match_get()
...
function ApiEntitiesClustersAgentTokenEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesClustersAgentTokenLoadMatch
---@param ctrl? table
---@return ApiEntitiesClustersAgentToken
---@return string? err
function ApiEntitiesClustersAgentTokenEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesClustersAgentTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesClustersAgentTokenEntity
