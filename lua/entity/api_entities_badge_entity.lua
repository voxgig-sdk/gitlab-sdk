...
local ApiEntitiesBadgeEntity = {}
ApiEntitiesBadgeEntity.__index = ApiEntitiesBadgeEntity


function ApiEntitiesBadgeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBadgeEntity)
  self._name = "api_entities_badge"
  self._client = client
...
function ApiEntitiesBadgeEntity:get_name()
  return self._name
end


function ApiEntitiesBadgeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBadgeEntity.new(self._client, opts)
end
...
function ApiEntitiesBadgeEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBadgeEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBadgeEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBadgeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBadgeEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBadgeEntity:match_get()
...
function ApiEntitiesBadgeEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesBadgeLoadMatch
---@param ctrl? table
---@return ApiEntitiesBadge
---@return string? err
function ApiEntitiesBadgeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesBadgeListMatch
---@param ctrl? table
---@return ApiEntitiesBadge[]
---@return string? err
function ApiEntitiesBadgeEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesBadgeCreateData
---@param ctrl? table
---@return ApiEntitiesBadge
---@return string? err
function ApiEntitiesBadgeEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesBadgeUpdateData
---@param ctrl? table
---@return ApiEntitiesBadge
---@return string? err
function ApiEntitiesBadgeEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesBadgeEntity:_run_op(ctx, post_done)
  local utility = self._utility
