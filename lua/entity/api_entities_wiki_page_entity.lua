...
local ApiEntitiesWikiPageEntity = {}
ApiEntitiesWikiPageEntity.__index = ApiEntitiesWikiPageEntity


function ApiEntitiesWikiPageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesWikiPageEntity)
  self._name = "api_entities_wiki_page"
  self._client = client
...
function ApiEntitiesWikiPageEntity:get_name()
  return self._name
end


function ApiEntitiesWikiPageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesWikiPageEntity.new(self._client, opts)
end
...
function ApiEntitiesWikiPageEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesWikiPageEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesWikiPageEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesWikiPageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesWikiPageEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesWikiPageEntity:match_get()
...
function ApiEntitiesWikiPageEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesWikiPageLoadMatch
---@param ctrl? table
---@return ApiEntitiesWikiPage
---@return string? err
function ApiEntitiesWikiPageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesWikiPageCreateData
---@param ctrl? table
---@return ApiEntitiesWikiPage
---@return string? err
function ApiEntitiesWikiPageEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesWikiPageUpdateData
---@param ctrl? table
---@return ApiEntitiesWikiPage
---@return string? err
function ApiEntitiesWikiPageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesWikiPageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesWikiPageEntity
