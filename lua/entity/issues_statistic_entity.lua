-- Gitlab SDK IssuesStatistic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local IssuesStatisticEntity = {}
IssuesStatisticEntity.__index = IssuesStatisticEntity


function IssuesStatisticEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IssuesStatisticEntity)
  self._name = "issues_statistic"
  self._client = client
...
function IssuesStatisticEntity:get_name()
  return self._name
end


function IssuesStatisticEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IssuesStatisticEntity.new(self._client, opts)
end
...
function IssuesStatisticEntity:mark_deleted()
  self._deleted = true
end


function IssuesStatisticEntity:deleted()
  return true == self._deleted
end


function IssuesStatisticEntity:data_set(args)
  if args ~= nil then
...
function IssuesStatisticEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IssuesStatisticEntity:match_set(args)
  if args ~= nil then
...
function IssuesStatisticEntity:match_get()
...
function IssuesStatisticEntity:stream(action, args, callopts)
...
---@param reqmatch IssuesStatisticLoadMatch
---@param ctrl? table
---@return IssuesStatistic
---@return string? err
function IssuesStatisticEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function IssuesStatisticEntity:_run_op(ctx, post_done)
  local utility = self._utility
