-- Gitlab SDK ApiEntitiesWikiPageBasic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesWikiPageBasicEntity = {}
ApiEntitiesWikiPageBasicEntity.__index = ApiEntitiesWikiPageBasicEntity


function ApiEntitiesWikiPageBasicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesWikiPageBasicEntity)
  self._name = "api_entities_wiki_page_basic"
  self._client = client
...
function ApiEntitiesWikiPageBasicEntity:get_name()
  return self._name
end


function ApiEntitiesWikiPageBasicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesWikiPageBasicEntity.new(self._client, opts)
end
...
function ApiEntitiesWikiPageBasicEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesWikiPageBasicEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesWikiPageBasicEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesWikiPageBasicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesWikiPageBasicEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesWikiPageBasicEntity:match_get()
...
function ApiEntitiesWikiPageBasicEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesWikiPageBasicListMatch
---@param ctrl? table
---@return ApiEntitiesWikiPageBasic[]
---@return string? err
function ApiEntitiesWikiPageBasicEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesWikiPageBasicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesWikiPageBasicEntity
