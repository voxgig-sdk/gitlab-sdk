...
local AlertManagementEntity = {}
AlertManagementEntity.__index = AlertManagementEntity


function AlertManagementEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AlertManagementEntity)
  self._name = "alert_management"
  self._client = client
...
function AlertManagementEntity:get_name()
  return self._name
end


function AlertManagementEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AlertManagementEntity.new(self._client, opts)
end
...
function AlertManagementEntity:mark_deleted()
  self._deleted = true
end


function AlertManagementEntity:deleted()
  return true == self._deleted
end


function AlertManagementEntity:data_set(args)
  if args ~= nil then
...
function AlertManagementEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AlertManagementEntity:match_set(args)
  if args ~= nil then
...
function AlertManagementEntity:match_get()
...
function AlertManagementEntity:stream(action, args, callopts)
...
---@param reqdata AlertManagementCreateData
---@param ctrl? table
---@return AlertManagement
---@return string? err
function AlertManagementEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch AlertManagementRemoveMatch
---@param ctrl? table
---@return AlertManagement
---@return string? err
function AlertManagementEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function AlertManagementEntity:_run_op(ctx, post_done)
  local utility = self._utility
