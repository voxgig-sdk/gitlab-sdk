...
local ApiEntitiesFeatureFlagEntity = {}
ApiEntitiesFeatureFlagEntity.__index = ApiEntitiesFeatureFlagEntity


function ApiEntitiesFeatureFlagEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesFeatureFlagEntity)
  self._name = "api_entities_feature_flag"
  self._client = client
...
function ApiEntitiesFeatureFlagEntity:get_name()
  return self._name
end


function ApiEntitiesFeatureFlagEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesFeatureFlagEntity.new(self._client, opts)
end
...
function ApiEntitiesFeatureFlagEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesFeatureFlagEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesFeatureFlagEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesFeatureFlagEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesFeatureFlagEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesFeatureFlagEntity:match_get()
...
function ApiEntitiesFeatureFlagEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesFeatureFlagLoadMatch
---@param ctrl? table
---@return ApiEntitiesFeatureFlag
---@return string? err
function ApiEntitiesFeatureFlagEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesFeatureFlagListMatch
---@param ctrl? table
---@return ApiEntitiesFeatureFlag[]
---@return string? err
function ApiEntitiesFeatureFlagEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesFeatureFlagCreateData
---@param ctrl? table
---@return ApiEntitiesFeatureFlag
---@return string? err
function ApiEntitiesFeatureFlagEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesFeatureFlagUpdateData
---@param ctrl? table
---@return ApiEntitiesFeatureFlag
---@return string? err
function ApiEntitiesFeatureFlagEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesFeatureFlagEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesFeatureFlagEntity
