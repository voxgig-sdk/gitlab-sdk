...
local ApiEntitiesMetricImageEntity = {}
ApiEntitiesMetricImageEntity.__index = ApiEntitiesMetricImageEntity


function ApiEntitiesMetricImageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMetricImageEntity)
  self._name = "api_entities_metric_image"
  self._client = client
...
function ApiEntitiesMetricImageEntity:get_name()
  return self._name
end


function ApiEntitiesMetricImageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMetricImageEntity.new(self._client, opts)
end
...
function ApiEntitiesMetricImageEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMetricImageEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMetricImageEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMetricImageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMetricImageEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMetricImageEntity:match_get()
...
function ApiEntitiesMetricImageEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMetricImageListMatch
---@param ctrl? table
---@return ApiEntitiesMetricImage[]
---@return string? err
function ApiEntitiesMetricImageEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesMetricImageCreateData
---@param ctrl? table
---@return ApiEntitiesMetricImage
---@return string? err
function ApiEntitiesMetricImageEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesMetricImageUpdateData
---@param ctrl? table
---@return ApiEntitiesMetricImage
---@return string? err
function ApiEntitiesMetricImageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesMetricImageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMetricImageEntity
