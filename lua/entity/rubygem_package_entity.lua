...
local RubygemPackageEntity = {}
RubygemPackageEntity.__index = RubygemPackageEntity


function RubygemPackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RubygemPackageEntity)
  self._name = "rubygem_package"
  self._client = client
...
function RubygemPackageEntity:get_name()
  return self._name
end


function RubygemPackageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RubygemPackageEntity.new(self._client, opts)
end
...
function RubygemPackageEntity:mark_deleted()
  self._deleted = true
end


function RubygemPackageEntity:deleted()
  return true == self._deleted
end


function RubygemPackageEntity:data_set(args)
  if args ~= nil then
...
function RubygemPackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RubygemPackageEntity:match_set(args)
  if args ~= nil then
...
function RubygemPackageEntity:match_get()
...
function RubygemPackageEntity:stream(action, args, callopts)
...
---@param reqmatch RubygemPackageLoadMatch
---@param ctrl? table
---@return RubygemPackage
---@return string? err
function RubygemPackageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata RubygemPackageCreateData
---@param ctrl? table
---@return RubygemPackage
---@return string? err
function RubygemPackageEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function RubygemPackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
