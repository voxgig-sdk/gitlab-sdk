...
local ApiEntitiesCiResourceGroupEntity = {}
ApiEntitiesCiResourceGroupEntity.__index = ApiEntitiesCiResourceGroupEntity


function ApiEntitiesCiResourceGroupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiResourceGroupEntity)
  self._name = "api_entities_ci_resource_group"
  self._client = client
...
function ApiEntitiesCiResourceGroupEntity:get_name()
  return self._name
end


function ApiEntitiesCiResourceGroupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiResourceGroupEntity.new(self._client, opts)
end
...
function ApiEntitiesCiResourceGroupEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiResourceGroupEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiResourceGroupEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiResourceGroupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiResourceGroupEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiResourceGroupEntity:match_get()
...
function ApiEntitiesCiResourceGroupEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiResourceGroupLoadMatch
---@param ctrl? table
---@return ApiEntitiesCiResourceGroup
---@return string? err
function ApiEntitiesCiResourceGroupEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesCiResourceGroupListMatch
---@param ctrl? table
---@return ApiEntitiesCiResourceGroup[]
---@return string? err
function ApiEntitiesCiResourceGroupEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesCiResourceGroupUpdateData
---@param ctrl? table
---@return ApiEntitiesCiResourceGroup
---@return string? err
function ApiEntitiesCiResourceGroupEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesCiResourceGroupEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiResourceGroupEntity
