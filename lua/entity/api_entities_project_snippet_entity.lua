...
local ApiEntitiesProjectSnippetEntity = {}
ApiEntitiesProjectSnippetEntity.__index = ApiEntitiesProjectSnippetEntity


function ApiEntitiesProjectSnippetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectSnippetEntity)
  self._name = "api_entities_project_snippet"
  self._client = client
...
function ApiEntitiesProjectSnippetEntity:get_name()
  return self._name
end


function ApiEntitiesProjectSnippetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectSnippetEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectSnippetEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectSnippetEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectSnippetEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectSnippetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectSnippetEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectSnippetEntity:match_get()
...
function ApiEntitiesProjectSnippetEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectSnippetLoadMatch
---@param ctrl? table
---@return ApiEntitiesProjectSnippet
---@return string? err
function ApiEntitiesProjectSnippetEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesProjectSnippetListMatch
---@param ctrl? table
---@return ApiEntitiesProjectSnippet[]
---@return string? err
function ApiEntitiesProjectSnippetEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProjectSnippetCreateData
---@param ctrl? table
---@return ApiEntitiesProjectSnippet
---@return string? err
function ApiEntitiesProjectSnippetEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProjectSnippetUpdateData
---@param ctrl? table
---@return ApiEntitiesProjectSnippet
---@return string? err
function ApiEntitiesProjectSnippetEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesProjectSnippetEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectSnippetEntity
