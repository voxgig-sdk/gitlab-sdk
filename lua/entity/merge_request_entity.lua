...
local MergeRequestEntity = {}
MergeRequestEntity.__index = MergeRequestEntity


function MergeRequestEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MergeRequestEntity)
  self._name = "merge_request"
  self._client = client
...
function MergeRequestEntity:get_name()
  return self._name
end


function MergeRequestEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MergeRequestEntity.new(self._client, opts)
end
...
function MergeRequestEntity:mark_deleted()
  self._deleted = true
end


function MergeRequestEntity:deleted()
  return true == self._deleted
end


function MergeRequestEntity:data_set(args)
  if args ~= nil then
...
function MergeRequestEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MergeRequestEntity:match_set(args)
  if args ~= nil then
...
function MergeRequestEntity:match_get()
...
function MergeRequestEntity:stream(action, args, callopts)
...
---@param reqmatch MergeRequestLoadMatch
---@param ctrl? table
---@return MergeRequest
---@return string? err
function MergeRequestEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata MergeRequestUpdateData
---@param ctrl? table
---@return MergeRequest
---@return string? err
function MergeRequestEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch MergeRequestRemoveMatch
---@param ctrl? table
---@return MergeRequest
---@return string? err
function MergeRequestEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function MergeRequestEntity:_run_op(ctx, post_done)
  local utility = self._utility
