-- Gitlab SDK ApiEntitiesCiSecureFile entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiSecureFileEntity = {}
ApiEntitiesCiSecureFileEntity.__index = ApiEntitiesCiSecureFileEntity


function ApiEntitiesCiSecureFileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiSecureFileEntity)
  self._name = "api_entities_ci_secure_file"
  self._client = client
...
function ApiEntitiesCiSecureFileEntity:get_name()
  return self._name
end


function ApiEntitiesCiSecureFileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiSecureFileEntity.new(self._client, opts)
end
...
function ApiEntitiesCiSecureFileEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiSecureFileEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiSecureFileEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiSecureFileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiSecureFileEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiSecureFileEntity:match_get()
...
function ApiEntitiesCiSecureFileEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiSecureFileLoadMatch
---@param ctrl? table
---@return ApiEntitiesCiSecureFile
---@return string? err
function ApiEntitiesCiSecureFileEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesCiSecureFileCreateData
---@param ctrl? table
---@return ApiEntitiesCiSecureFile
---@return string? err
function ApiEntitiesCiSecureFileEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesCiSecureFileEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiSecureFileEntity
