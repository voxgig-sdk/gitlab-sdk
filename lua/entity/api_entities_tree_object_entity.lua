-- Gitlab SDK ApiEntitiesTreeObject entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesTreeObjectEntity = {}
ApiEntitiesTreeObjectEntity.__index = ApiEntitiesTreeObjectEntity


function ApiEntitiesTreeObjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesTreeObjectEntity)
  self._name = "api_entities_tree_object"
  self._client = client
...
function ApiEntitiesTreeObjectEntity:get_name()
  return self._name
end


function ApiEntitiesTreeObjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesTreeObjectEntity.new(self._client, opts)
end
...
function ApiEntitiesTreeObjectEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesTreeObjectEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesTreeObjectEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesTreeObjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesTreeObjectEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesTreeObjectEntity:match_get()
...
function ApiEntitiesTreeObjectEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesTreeObjectLoadMatch
---@param ctrl? table
---@return ApiEntitiesTreeObject
---@return string? err
function ApiEntitiesTreeObjectEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesTreeObjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesTreeObjectEntity
