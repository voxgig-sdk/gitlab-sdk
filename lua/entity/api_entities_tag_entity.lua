...
local ApiEntitiesTagEntity = {}
ApiEntitiesTagEntity.__index = ApiEntitiesTagEntity


function ApiEntitiesTagEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesTagEntity)
  self._name = "api_entities_tag"
  self._client = client
...
function ApiEntitiesTagEntity:get_name()
  return self._name
end


function ApiEntitiesTagEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesTagEntity.new(self._client, opts)
end
...
function ApiEntitiesTagEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesTagEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesTagEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesTagEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesTagEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesTagEntity:match_get()
...
function ApiEntitiesTagEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesTagLoadMatch
---@param ctrl? table
---@return ApiEntitiesTag
---@return string? err
function ApiEntitiesTagEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesTagListMatch
---@param ctrl? table
---@return ApiEntitiesTag[]
---@return string? err
function ApiEntitiesTagEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesTagCreateData
---@param ctrl? table
---@return ApiEntitiesTag
---@return string? err
function ApiEntitiesTagEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesTagEntity:_run_op(ctx, post_done)
  local utility = self._utility
