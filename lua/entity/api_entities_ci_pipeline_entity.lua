-- Gitlab SDK ApiEntitiesCiPipeline entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiPipelineEntity = {}
ApiEntitiesCiPipelineEntity.__index = ApiEntitiesCiPipelineEntity


function ApiEntitiesCiPipelineEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiPipelineEntity)
  self._name = "api_entities_ci_pipeline"
  self._client = client
...
function ApiEntitiesCiPipelineEntity:get_name()
  return self._name
end


function ApiEntitiesCiPipelineEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiPipelineEntity.new(self._client, opts)
end
...
function ApiEntitiesCiPipelineEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiPipelineEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiPipelineEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiPipelineEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiPipelineEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiPipelineEntity:match_get()
...
function ApiEntitiesCiPipelineEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesCiPipelineCreateData
---@param ctrl? table
---@return ApiEntitiesCiPipeline
---@return string? err
function ApiEntitiesCiPipelineEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesCiPipelineEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiPipelineEntity
