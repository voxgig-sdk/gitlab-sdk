-- Gitlab SDK ApiEntitiesDeployTokenWithToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesDeployTokenWithTokenEntity = {}
ApiEntitiesDeployTokenWithTokenEntity.__index = ApiEntitiesDeployTokenWithTokenEntity


function ApiEntitiesDeployTokenWithTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDeployTokenWithTokenEntity)
  self._name = "api_entities_deploy_token_with_token"
  self._client = client
...
function ApiEntitiesDeployTokenWithTokenEntity:get_name()
  return self._name
end


function ApiEntitiesDeployTokenWithTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDeployTokenWithTokenEntity.new(self._client, opts)
end
...
function ApiEntitiesDeployTokenWithTokenEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDeployTokenWithTokenEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDeployTokenWithTokenEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDeployTokenWithTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDeployTokenWithTokenEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDeployTokenWithTokenEntity:match_get()
...
function ApiEntitiesDeployTokenWithTokenEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesDeployTokenWithTokenCreateData
---@param ctrl? table
---@return ApiEntitiesDeployTokenWithToken
---@return string? err
function ApiEntitiesDeployTokenWithTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesDeployTokenWithTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesDeployTokenWithTokenEntity
