...
local UsageDataEntity = {}
UsageDataEntity.__index = UsageDataEntity


function UsageDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UsageDataEntity)
  self._name = "usage_data"
  self._client = client
...
function UsageDataEntity:get_name()
  return self._name
end


function UsageDataEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UsageDataEntity.new(self._client, opts)
end
...
function UsageDataEntity:mark_deleted()
  self._deleted = true
end


function UsageDataEntity:deleted()
  return true == self._deleted
end


function UsageDataEntity:data_set(args)
  if args ~= nil then
...
function UsageDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UsageDataEntity:match_set(args)
  if args ~= nil then
...
function UsageDataEntity:match_get()
...
function UsageDataEntity:stream(action, args, callopts)
...
---@param reqmatch UsageDataLoadMatch
---@param ctrl? table
---@return UsageData
---@return string? err
function UsageDataEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata UsageDataCreateData
---@param ctrl? table
---@return UsageData
---@return string? err
function UsageDataEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function UsageDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
