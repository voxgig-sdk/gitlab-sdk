-- Gitlab SDK ApiEntitiesDeployment entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesDeploymentEntity = {}
ApiEntitiesDeploymentEntity.__index = ApiEntitiesDeploymentEntity


function ApiEntitiesDeploymentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDeploymentEntity)
  self._name = "api_entities_deployment"
  self._client = client
...
function ApiEntitiesDeploymentEntity:get_name()
  return self._name
end


function ApiEntitiesDeploymentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDeploymentEntity.new(self._client, opts)
end
...
function ApiEntitiesDeploymentEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDeploymentEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDeploymentEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDeploymentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDeploymentEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDeploymentEntity:match_get()
...
function ApiEntitiesDeploymentEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesDeploymentListMatch
---@param ctrl? table
---@return ApiEntitiesDeployment[]
---@return string? err
function ApiEntitiesDeploymentEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesDeploymentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesDeploymentEntity
