-- Gitlab SDK ApiEntitiesNugetPackagesVersion entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesNugetPackagesVersionEntity = {}
ApiEntitiesNugetPackagesVersionEntity.__index = ApiEntitiesNugetPackagesVersionEntity


function ApiEntitiesNugetPackagesVersionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesNugetPackagesVersionEntity)
  self._name = "api_entities_nuget_packages_version"
  self._client = client
...
function ApiEntitiesNugetPackagesVersionEntity:get_name()
  return self._name
end


function ApiEntitiesNugetPackagesVersionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesNugetPackagesVersionEntity.new(self._client, opts)
end
...
function ApiEntitiesNugetPackagesVersionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesNugetPackagesVersionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesNugetPackagesVersionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesNugetPackagesVersionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesNugetPackagesVersionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesNugetPackagesVersionEntity:match_get()
...
function ApiEntitiesNugetPackagesVersionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesNugetPackagesVersionListMatch
---@param ctrl? table
---@return ApiEntitiesNugetPackagesVersion[]
---@return string? err
function ApiEntitiesNugetPackagesVersionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesNugetPackagesVersionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesNugetPackagesVersionEntity
