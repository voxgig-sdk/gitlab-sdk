-- Gitlab SDK ApiEntitiesPersonalAccessToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPersonalAccessTokenEntity = {}
ApiEntitiesPersonalAccessTokenEntity.__index = ApiEntitiesPersonalAccessTokenEntity


function ApiEntitiesPersonalAccessTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPersonalAccessTokenEntity)
  self._name = "api_entities_personal_access_token"
  self._client = client
...
function ApiEntitiesPersonalAccessTokenEntity:get_name()
  return self._name
end


function ApiEntitiesPersonalAccessTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPersonalAccessTokenEntity.new(self._client, opts)
end
...
function ApiEntitiesPersonalAccessTokenEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPersonalAccessTokenEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPersonalAccessTokenEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPersonalAccessTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPersonalAccessTokenEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPersonalAccessTokenEntity:match_get()
...
function ApiEntitiesPersonalAccessTokenEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPersonalAccessTokenListMatch
---@param ctrl? table
---@return ApiEntitiesPersonalAccessToken[]
---@return string? err
function ApiEntitiesPersonalAccessTokenEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPersonalAccessTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPersonalAccessTokenEntity
