...
local EeApiEntitiesAuditEventEntity = {}
EeApiEntitiesAuditEventEntity.__index = EeApiEntitiesAuditEventEntity


function EeApiEntitiesAuditEventEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EeApiEntitiesAuditEventEntity)
  self._name = "ee_api_entities_audit_event"
  self._client = client
...
function EeApiEntitiesAuditEventEntity:get_name()
  return self._name
end


function EeApiEntitiesAuditEventEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EeApiEntitiesAuditEventEntity.new(self._client, opts)
end
...
function EeApiEntitiesAuditEventEntity:mark_deleted()
  self._deleted = true
end


function EeApiEntitiesAuditEventEntity:deleted()
  return true == self._deleted
end


function EeApiEntitiesAuditEventEntity:data_set(args)
  if args ~= nil then
...
function EeApiEntitiesAuditEventEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EeApiEntitiesAuditEventEntity:match_set(args)
  if args ~= nil then
...
function EeApiEntitiesAuditEventEntity:match_get()
...
function EeApiEntitiesAuditEventEntity:stream(action, args, callopts)
...
---@param reqmatch EeApiEntitiesAuditEventLoadMatch
---@param ctrl? table
---@return EeApiEntitiesAuditEvent
---@return string? err
function EeApiEntitiesAuditEventEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch EeApiEntitiesAuditEventListMatch
---@param ctrl? table
---@return EeApiEntitiesAuditEvent[]
---@return string? err
function EeApiEntitiesAuditEventEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function EeApiEntitiesAuditEventEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EeApiEntitiesAuditEventEntity
