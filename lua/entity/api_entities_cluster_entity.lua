...
local ApiEntitiesClusterEntity = {}
ApiEntitiesClusterEntity.__index = ApiEntitiesClusterEntity


function ApiEntitiesClusterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesClusterEntity)
  self._name = "api_entities_cluster"
  self._client = client
...
function ApiEntitiesClusterEntity:get_name()
  return self._name
end


function ApiEntitiesClusterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesClusterEntity.new(self._client, opts)
end
...
function ApiEntitiesClusterEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesClusterEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesClusterEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesClusterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesClusterEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesClusterEntity:match_get()
...
function ApiEntitiesClusterEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesClusterLoadMatch
---@param ctrl? table
---@return ApiEntitiesCluster
---@return string? err
function ApiEntitiesClusterEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesClusterListMatch
---@param ctrl? table
---@return ApiEntitiesCluster[]
---@return string? err
function ApiEntitiesClusterEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesClusterCreateData
---@param ctrl? table
---@return ApiEntitiesCluster
---@return string? err
function ApiEntitiesClusterEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesClusterUpdateData
---@param ctrl? table
---@return ApiEntitiesCluster
---@return string? err
function ApiEntitiesClusterEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesClusterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesClusterEntity
