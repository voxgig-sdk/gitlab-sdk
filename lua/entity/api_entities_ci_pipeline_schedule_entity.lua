-- Gitlab SDK ApiEntitiesCiPipelineSchedule entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiPipelineScheduleEntity = {}
ApiEntitiesCiPipelineScheduleEntity.__index = ApiEntitiesCiPipelineScheduleEntity


function ApiEntitiesCiPipelineScheduleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiPipelineScheduleEntity)
  self._name = "api_entities_ci_pipeline_schedule"
  self._client = client
...
function ApiEntitiesCiPipelineScheduleEntity:get_name()
  return self._name
end


function ApiEntitiesCiPipelineScheduleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiPipelineScheduleEntity.new(self._client, opts)
end
...
function ApiEntitiesCiPipelineScheduleEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiPipelineScheduleEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiPipelineScheduleEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiPipelineScheduleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiPipelineScheduleEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiPipelineScheduleEntity:match_get()
...
function ApiEntitiesCiPipelineScheduleEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiPipelineScheduleListMatch
---@param ctrl? table
---@return ApiEntitiesCiPipelineSchedule[]
---@return string? err
function ApiEntitiesCiPipelineScheduleEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesCiPipelineScheduleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiPipelineScheduleEntity
