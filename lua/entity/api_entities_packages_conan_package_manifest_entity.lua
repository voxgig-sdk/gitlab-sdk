-- Gitlab SDK ApiEntitiesPackagesConanPackageManifest entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagesConanPackageManifestEntity = {}
ApiEntitiesPackagesConanPackageManifestEntity.__index = ApiEntitiesPackagesConanPackageManifestEntity


function ApiEntitiesPackagesConanPackageManifestEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesConanPackageManifestEntity)
  self._name = "api_entities_packages_conan_package_manifest"
  self._client = client
...
function ApiEntitiesPackagesConanPackageManifestEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesConanPackageManifestEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesConanPackageManifestEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesConanPackageManifestEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesConanPackageManifestEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesConanPackageManifestEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanPackageManifestEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesConanPackageManifestEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanPackageManifestEntity:match_get()
...
function ApiEntitiesPackagesConanPackageManifestEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagesConanPackageManifestLoadMatch
---@param ctrl? table
---@return ApiEntitiesPackagesConanPackageManifest
---@return string? err
function ApiEntitiesPackagesConanPackageManifestEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagesConanPackageManifestEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesConanPackageManifestEntity
