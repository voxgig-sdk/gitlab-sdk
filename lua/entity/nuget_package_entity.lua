...
local NugetPackageEntity = {}
NugetPackageEntity.__index = NugetPackageEntity


function NugetPackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NugetPackageEntity)
  self._name = "nuget_package"
  self._client = client
...
function NugetPackageEntity:get_name()
  return self._name
end


function NugetPackageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NugetPackageEntity.new(self._client, opts)
end
...
function NugetPackageEntity:mark_deleted()
  self._deleted = true
end


function NugetPackageEntity:deleted()
  return true == self._deleted
end


function NugetPackageEntity:data_set(args)
  if args ~= nil then
...
function NugetPackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NugetPackageEntity:match_set(args)
  if args ~= nil then
...
function NugetPackageEntity:match_get()
...
function NugetPackageEntity:stream(action, args, callopts)
...
---@param reqmatch NugetPackageLoadMatch
---@param ctrl? table
---@return NugetPackage
---@return string? err
function NugetPackageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch NugetPackageListMatch
---@param ctrl? table
---@return NugetPackage[]
---@return string? err
function NugetPackageEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata NugetPackageUpdateData
---@param ctrl? table
---@return NugetPackage
---@return string? err
function NugetPackageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch NugetPackageRemoveMatch
---@param ctrl? table
---@return NugetPackage
---@return string? err
function NugetPackageEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function NugetPackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
