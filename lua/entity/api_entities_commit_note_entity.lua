...
function ApiEntitiesCommitNoteEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCommitNoteEntity:deleted()
...
function ApiEntitiesCommitNoteEntity:stream(action, args, callopts)
