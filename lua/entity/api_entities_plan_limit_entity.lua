-- Gitlab SDK ApiEntitiesPlanLimit entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPlanLimitEntity = {}
ApiEntitiesPlanLimitEntity.__index = ApiEntitiesPlanLimitEntity


function ApiEntitiesPlanLimitEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPlanLimitEntity)
  self._name = "api_entities_plan_limit"
  self._client = client
...
function ApiEntitiesPlanLimitEntity:get_name()
  return self._name
end


function ApiEntitiesPlanLimitEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPlanLimitEntity.new(self._client, opts)
end
...
function ApiEntitiesPlanLimitEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPlanLimitEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPlanLimitEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPlanLimitEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPlanLimitEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPlanLimitEntity:match_get()
...
function ApiEntitiesPlanLimitEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPlanLimitLoadMatch
---@param ctrl? table
---@return ApiEntitiesPlanLimit
---@return string? err
function ApiEntitiesPlanLimitEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesPlanLimitUpdateData
---@param ctrl? table
---@return ApiEntitiesPlanLimit
---@return string? err
function ApiEntitiesPlanLimitEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesPlanLimitEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPlanLimitEntity
