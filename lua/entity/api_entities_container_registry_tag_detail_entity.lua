-- Gitlab SDK ApiEntitiesContainerRegistryTagDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesContainerRegistryTagDetailEntity = {}
ApiEntitiesContainerRegistryTagDetailEntity.__index = ApiEntitiesContainerRegistryTagDetailEntity


function ApiEntitiesContainerRegistryTagDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesContainerRegistryTagDetailEntity)
  self._name = "api_entities_container_registry_tag_detail"
  self._client = client
...
function ApiEntitiesContainerRegistryTagDetailEntity:get_name()
  return self._name
end


function ApiEntitiesContainerRegistryTagDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesContainerRegistryTagDetailEntity.new(self._client, opts)
end
...
function ApiEntitiesContainerRegistryTagDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesContainerRegistryTagDetailEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesContainerRegistryTagDetailEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesContainerRegistryTagDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesContainerRegistryTagDetailEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesContainerRegistryTagDetailEntity:match_get()
...
function ApiEntitiesContainerRegistryTagDetailEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesContainerRegistryTagDetailLoadMatch
---@param ctrl? table
---@return ApiEntitiesContainerRegistryTagDetail
---@return string? err
function ApiEntitiesContainerRegistryTagDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesContainerRegistryTagDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesContainerRegistryTagDetailEntity
