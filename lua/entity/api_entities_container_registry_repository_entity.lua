...
local ApiEntitiesContainerRegistryRepositoryEntity = {}
ApiEntitiesContainerRegistryRepositoryEntity.__index = ApiEntitiesContainerRegistryRepositoryEntity


function ApiEntitiesContainerRegistryRepositoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesContainerRegistryRepositoryEntity)
  self._name = "api_entities_container_registry_repository"
  self._client = client
...
function ApiEntitiesContainerRegistryRepositoryEntity:get_name()
  return self._name
end


function ApiEntitiesContainerRegistryRepositoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesContainerRegistryRepositoryEntity.new(self._client, opts)
end
...
function ApiEntitiesContainerRegistryRepositoryEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesContainerRegistryRepositoryEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesContainerRegistryRepositoryEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesContainerRegistryRepositoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesContainerRegistryRepositoryEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesContainerRegistryRepositoryEntity:match_get()
...
function ApiEntitiesContainerRegistryRepositoryEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesContainerRegistryRepositoryLoadMatch
---@param ctrl? table
---@return ApiEntitiesContainerRegistryRepository
---@return string? err
function ApiEntitiesContainerRegistryRepositoryEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesContainerRegistryRepositoryListMatch
---@param ctrl? table
---@return ApiEntitiesContainerRegistryRepository[]
---@return string? err
function ApiEntitiesContainerRegistryRepositoryEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiEntitiesContainerRegistryRepositoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesContainerRegistryRepositoryEntity
