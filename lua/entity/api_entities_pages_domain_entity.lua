...
local ApiEntitiesPagesDomainEntity = {}
ApiEntitiesPagesDomainEntity.__index = ApiEntitiesPagesDomainEntity


function ApiEntitiesPagesDomainEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPagesDomainEntity)
  self._name = "api_entities_pages_domain"
  self._client = client
...
function ApiEntitiesPagesDomainEntity:get_name()
  return self._name
end


function ApiEntitiesPagesDomainEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPagesDomainEntity.new(self._client, opts)
end
...
function ApiEntitiesPagesDomainEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPagesDomainEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPagesDomainEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPagesDomainEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPagesDomainEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPagesDomainEntity:match_get()
...
function ApiEntitiesPagesDomainEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPagesDomainLoadMatch
---@param ctrl? table
---@return ApiEntitiesPagesDomain
---@return string? err
function ApiEntitiesPagesDomainEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesPagesDomainListMatch
---@param ctrl? table
---@return ApiEntitiesPagesDomain[]
---@return string? err
function ApiEntitiesPagesDomainEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesPagesDomainCreateData
---@param ctrl? table
---@return ApiEntitiesPagesDomain
---@return string? err
function ApiEntitiesPagesDomainEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesPagesDomainUpdateData
---@param ctrl? table
---@return ApiEntitiesPagesDomain
---@return string? err
function ApiEntitiesPagesDomainEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesPagesDomainEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPagesDomainEntity
