...
local ApiEntitiesProjectHookEntity = {}
ApiEntitiesProjectHookEntity.__index = ApiEntitiesProjectHookEntity


function ApiEntitiesProjectHookEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectHookEntity)
  self._name = "api_entities_project_hook"
  self._client = client
...
function ApiEntitiesProjectHookEntity:get_name()
  return self._name
end


function ApiEntitiesProjectHookEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectHookEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectHookEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectHookEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectHookEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectHookEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectHookEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectHookEntity:match_get()
...
function ApiEntitiesProjectHookEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectHookLoadMatch
---@param ctrl? table
---@return ApiEntitiesProjectHook
---@return string? err
function ApiEntitiesProjectHookEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesProjectHookListMatch
---@param ctrl? table
---@return ApiEntitiesProjectHook[]
---@return string? err
function ApiEntitiesProjectHookEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProjectHookCreateData
---@param ctrl? table
---@return ApiEntitiesProjectHook
---@return string? err
function ApiEntitiesProjectHookEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProjectHookUpdateData
---@param ctrl? table
---@return ApiEntitiesProjectHook
---@return string? err
function ApiEntitiesProjectHookEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesProjectHookEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectHookEntity
