...
local ApiEntitiesPackagesDebianDistributionEntity = {}
ApiEntitiesPackagesDebianDistributionEntity.__index = ApiEntitiesPackagesDebianDistributionEntity


function ApiEntitiesPackagesDebianDistributionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesDebianDistributionEntity)
  self._name = "api_entities_packages_debian_distribution"
  self._client = client
...
function ApiEntitiesPackagesDebianDistributionEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesDebianDistributionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesDebianDistributionEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesDebianDistributionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesDebianDistributionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesDebianDistributionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesDebianDistributionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesDebianDistributionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesDebianDistributionEntity:match_get()
...
function ApiEntitiesPackagesDebianDistributionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagesDebianDistributionLoadMatch
---@param ctrl? table
---@return ApiEntitiesPackagesDebianDistribution
---@return string? err
function ApiEntitiesPackagesDebianDistributionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesPackagesDebianDistributionListMatch
---@param ctrl? table
---@return ApiEntitiesPackagesDebianDistribution[]
---@return string? err
function ApiEntitiesPackagesDebianDistributionEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesPackagesDebianDistributionCreateData
---@param ctrl? table
---@return ApiEntitiesPackagesDebianDistribution
---@return string? err
function ApiEntitiesPackagesDebianDistributionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesPackagesDebianDistributionUpdateData
---@param ctrl? table
---@return ApiEntitiesPackagesDebianDistribution
---@return string? err
function ApiEntitiesPackagesDebianDistributionEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesPackagesDebianDistributionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesDebianDistributionEntity
