-- Gitlab SDK ApiEntitiesPackagesConanFilesList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagesConanFilesListEntity = {}
ApiEntitiesPackagesConanFilesListEntity.__index = ApiEntitiesPackagesConanFilesListEntity


function ApiEntitiesPackagesConanFilesListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesConanFilesListEntity)
  self._name = "api_entities_packages_conan_files_list"
  self._client = client
...
function ApiEntitiesPackagesConanFilesListEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesConanFilesListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesConanFilesListEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesConanFilesListEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesConanFilesListEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesConanFilesListEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanFilesListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesConanFilesListEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanFilesListEntity:match_get()
...
function ApiEntitiesPackagesConanFilesListEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagesConanFilesListLoadMatch
---@param ctrl? table
---@return ApiEntitiesPackagesConanFilesList
---@return string? err
function ApiEntitiesPackagesConanFilesListEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagesConanFilesListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesConanFilesListEntity
