-- Gitlab SDK ApiEntitiesChangelog entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesChangelogEntity = {}
ApiEntitiesChangelogEntity.__index = ApiEntitiesChangelogEntity


function ApiEntitiesChangelogEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesChangelogEntity)
  self._name = "api_entities_changelog"
  self._client = client
...
function ApiEntitiesChangelogEntity:get_name()
  return self._name
end


function ApiEntitiesChangelogEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesChangelogEntity.new(self._client, opts)
end
...
function ApiEntitiesChangelogEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesChangelogEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesChangelogEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesChangelogEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesChangelogEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesChangelogEntity:match_get()
...
function ApiEntitiesChangelogEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesChangelogLoadMatch
---@param ctrl? table
---@return ApiEntitiesChangelog
---@return string? err
function ApiEntitiesChangelogEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesChangelogEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesChangelogEntity
