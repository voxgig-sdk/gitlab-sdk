...
local ApiEntitiesCiVariableEntity = {}
ApiEntitiesCiVariableEntity.__index = ApiEntitiesCiVariableEntity


function ApiEntitiesCiVariableEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiVariableEntity)
  self._name = "api_entities_ci_variable"
  self._client = client
...
function ApiEntitiesCiVariableEntity:get_name()
  return self._name
end


function ApiEntitiesCiVariableEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiVariableEntity.new(self._client, opts)
end
...
function ApiEntitiesCiVariableEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiVariableEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiVariableEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiVariableEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiVariableEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiVariableEntity:match_get()
...
function ApiEntitiesCiVariableEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiVariableLoadMatch
---@param ctrl? table
---@return ApiEntitiesCiVariable
---@return string? err
function ApiEntitiesCiVariableEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesCiVariableListMatch
---@param ctrl? table
---@return ApiEntitiesCiVariable[]
---@return string? err
function ApiEntitiesCiVariableEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesCiVariableCreateData
---@param ctrl? table
---@return ApiEntitiesCiVariable
---@return string? err
function ApiEntitiesCiVariableEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesCiVariableUpdateData
---@param ctrl? table
---@return ApiEntitiesCiVariable
---@return string? err
function ApiEntitiesCiVariableEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesCiVariableEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiVariableEntity
