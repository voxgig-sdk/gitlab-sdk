...
function ApiEntitiesDraftNoteEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDraftNoteEntity:deleted()
...
function ApiEntitiesDraftNoteEntity:stream(action, args, callopts)
