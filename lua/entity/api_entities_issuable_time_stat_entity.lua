-- Gitlab SDK ApiEntitiesIssuableTimeStat entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesIssuableTimeStatEntity = {}
ApiEntitiesIssuableTimeStatEntity.__index = ApiEntitiesIssuableTimeStatEntity


function ApiEntitiesIssuableTimeStatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesIssuableTimeStatEntity)
  self._name = "api_entities_issuable_time_stat"
  self._client = client
...
function ApiEntitiesIssuableTimeStatEntity:get_name()
  return self._name
end


function ApiEntitiesIssuableTimeStatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesIssuableTimeStatEntity.new(self._client, opts)
end
...
function ApiEntitiesIssuableTimeStatEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesIssuableTimeStatEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesIssuableTimeStatEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesIssuableTimeStatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesIssuableTimeStatEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesIssuableTimeStatEntity:match_get()
...
function ApiEntitiesIssuableTimeStatEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesIssuableTimeStatLoadMatch
---@param ctrl? table
---@return ApiEntitiesIssuableTimeStat
---@return string? err
function ApiEntitiesIssuableTimeStatEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesIssuableTimeStatCreateData
---@param ctrl? table
---@return ApiEntitiesIssuableTimeStat
---@return string? err
function ApiEntitiesIssuableTimeStatEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesIssuableTimeStatEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesIssuableTimeStatEntity
