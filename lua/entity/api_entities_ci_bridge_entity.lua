-- Gitlab SDK ApiEntitiesCiBridge entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiBridgeEntity = {}
ApiEntitiesCiBridgeEntity.__index = ApiEntitiesCiBridgeEntity


function ApiEntitiesCiBridgeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiBridgeEntity)
  self._name = "api_entities_ci_bridge"
  self._client = client
...
function ApiEntitiesCiBridgeEntity:get_name()
  return self._name
end


function ApiEntitiesCiBridgeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiBridgeEntity.new(self._client, opts)
end
...
function ApiEntitiesCiBridgeEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiBridgeEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiBridgeEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiBridgeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiBridgeEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiBridgeEntity:match_get()
...
function ApiEntitiesCiBridgeEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesCiBridgeListMatch
---@param ctrl? table
---@return ApiEntitiesCiBridge[]
---@return string? err
function ApiEntitiesCiBridgeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesCiBridgeEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiBridgeEntity
