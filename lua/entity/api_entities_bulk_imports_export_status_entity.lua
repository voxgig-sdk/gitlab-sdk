-- Gitlab SDK ApiEntitiesBulkImportsExportStatus entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesBulkImportsExportStatusEntity = {}
ApiEntitiesBulkImportsExportStatusEntity.__index = ApiEntitiesBulkImportsExportStatusEntity


function ApiEntitiesBulkImportsExportStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBulkImportsExportStatusEntity)
  self._name = "api_entities_bulk_imports_export_status"
  self._client = client
...
function ApiEntitiesBulkImportsExportStatusEntity:get_name()
  return self._name
end


function ApiEntitiesBulkImportsExportStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBulkImportsExportStatusEntity.new(self._client, opts)
end
...
function ApiEntitiesBulkImportsExportStatusEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBulkImportsExportStatusEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBulkImportsExportStatusEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBulkImportsExportStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBulkImportsExportStatusEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBulkImportsExportStatusEntity:match_get()
...
function ApiEntitiesBulkImportsExportStatusEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesBulkImportsExportStatusListMatch
---@param ctrl? table
---@return ApiEntitiesBulkImportsExportStatus[]
---@return string? err
function ApiEntitiesBulkImportsExportStatusEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesBulkImportsExportStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesBulkImportsExportStatusEntity
