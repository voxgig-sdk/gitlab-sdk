-- Gitlab SDK ApiEntitiesUserAgentDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesUserAgentDetailEntity = {}
ApiEntitiesUserAgentDetailEntity.__index = ApiEntitiesUserAgentDetailEntity


function ApiEntitiesUserAgentDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesUserAgentDetailEntity)
  self._name = "api_entities_user_agent_detail"
  self._client = client
...
function ApiEntitiesUserAgentDetailEntity:get_name()
  return self._name
end


function ApiEntitiesUserAgentDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesUserAgentDetailEntity.new(self._client, opts)
end
...
function ApiEntitiesUserAgentDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesUserAgentDetailEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesUserAgentDetailEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesUserAgentDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesUserAgentDetailEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesUserAgentDetailEntity:match_get()
...
function ApiEntitiesUserAgentDetailEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesUserAgentDetailLoadMatch
---@param ctrl? table
---@return ApiEntitiesUserAgentDetail
---@return string? err
function ApiEntitiesUserAgentDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesUserAgentDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesUserAgentDetailEntity
