-- Gitlab SDK ApiEntitiesFeatureDefinition entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesFeatureDefinitionEntity = {}
ApiEntitiesFeatureDefinitionEntity.__index = ApiEntitiesFeatureDefinitionEntity


function ApiEntitiesFeatureDefinitionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesFeatureDefinitionEntity)
  self._name = "api_entities_feature_definition"
  self._client = client
...
function ApiEntitiesFeatureDefinitionEntity:get_name()
  return self._name
end


function ApiEntitiesFeatureDefinitionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesFeatureDefinitionEntity.new(self._client, opts)
end
...
function ApiEntitiesFeatureDefinitionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesFeatureDefinitionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesFeatureDefinitionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesFeatureDefinitionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesFeatureDefinitionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesFeatureDefinitionEntity:match_get()
...
function ApiEntitiesFeatureDefinitionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesFeatureDefinitionListMatch
---@param ctrl? table
---@return ApiEntitiesFeatureDefinition[]
---@return string? err
function ApiEntitiesFeatureDefinitionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesFeatureDefinitionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesFeatureDefinitionEntity
