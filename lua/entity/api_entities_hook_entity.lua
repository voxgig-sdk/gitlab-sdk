...
local ApiEntitiesHookEntity = {}
ApiEntitiesHookEntity.__index = ApiEntitiesHookEntity


function ApiEntitiesHookEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesHookEntity)
  self._name = "api_entities_hook"
  self._client = client
...
function ApiEntitiesHookEntity:get_name()
  return self._name
end


function ApiEntitiesHookEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesHookEntity.new(self._client, opts)
end
...
function ApiEntitiesHookEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesHookEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesHookEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesHookEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesHookEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesHookEntity:match_get()
...
function ApiEntitiesHookEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesHookLoadMatch
---@param ctrl? table
---@return ApiEntitiesHook
---@return string? err
function ApiEntitiesHookEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesHookListMatch
---@param ctrl? table
---@return ApiEntitiesHook[]
---@return string? err
function ApiEntitiesHookEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesHookCreateData
---@param ctrl? table
---@return ApiEntitiesHook
---@return string? err
function ApiEntitiesHookEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesHookUpdateData
---@param ctrl? table
---@return ApiEntitiesHook
---@return string? err
function ApiEntitiesHookEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesHookEntity:_run_op(ctx, post_done)
  local utility = self._utility
