-- Gitlab SDK ApiEntitiesGoModuleVersion entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesGoModuleVersionEntity = {}
ApiEntitiesGoModuleVersionEntity.__index = ApiEntitiesGoModuleVersionEntity


function ApiEntitiesGoModuleVersionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesGoModuleVersionEntity)
  self._name = "api_entities_go_module_version"
  self._client = client
...
function ApiEntitiesGoModuleVersionEntity:get_name()
  return self._name
end


function ApiEntitiesGoModuleVersionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesGoModuleVersionEntity.new(self._client, opts)
end
...
function ApiEntitiesGoModuleVersionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesGoModuleVersionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesGoModuleVersionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesGoModuleVersionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesGoModuleVersionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesGoModuleVersionEntity:match_get()
...
function ApiEntitiesGoModuleVersionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesGoModuleVersionLoadMatch
---@param ctrl? table
---@return ApiEntitiesGoModuleVersion
---@return string? err
function ApiEntitiesGoModuleVersionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesGoModuleVersionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesGoModuleVersionEntity
