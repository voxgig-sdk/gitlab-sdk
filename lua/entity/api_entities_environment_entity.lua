...
local ApiEntitiesEnvironmentEntity = {}
ApiEntitiesEnvironmentEntity.__index = ApiEntitiesEnvironmentEntity


function ApiEntitiesEnvironmentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesEnvironmentEntity)
  self._name = "api_entities_environment"
  self._client = client
...
function ApiEntitiesEnvironmentEntity:get_name()
  return self._name
end


function ApiEntitiesEnvironmentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesEnvironmentEntity.new(self._client, opts)
end
...
function ApiEntitiesEnvironmentEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesEnvironmentEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesEnvironmentEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesEnvironmentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesEnvironmentEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesEnvironmentEntity:match_get()
...
function ApiEntitiesEnvironmentEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesEnvironmentLoadMatch
---@param ctrl? table
---@return ApiEntitiesEnvironment
---@return string? err
function ApiEntitiesEnvironmentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesEnvironmentListMatch
---@param ctrl? table
---@return ApiEntitiesEnvironment[]
---@return string? err
function ApiEntitiesEnvironmentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesEnvironmentCreateData
---@param ctrl? table
---@return ApiEntitiesEnvironment
---@return string? err
function ApiEntitiesEnvironmentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesEnvironmentUpdateData
---@param ctrl? table
---@return ApiEntitiesEnvironment
---@return string? err
function ApiEntitiesEnvironmentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesEnvironmentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesEnvironmentEntity
