...
local ApiEntitiesProjectsContainerRegistryProtectionRuleEntity = {}
ApiEntitiesProjectsContainerRegistryProtectionRuleEntity.__index = ApiEntitiesProjectsContainerRegistryProtectionRuleEntity


function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectsContainerRegistryProtectionRuleEntity)
  self._name = "api_entities_projects_container_registry_protection_rule"
  self._client = client
...
function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:get_name()
  return self._name
end


function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectsContainerRegistryProtectionRuleEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:match_get()
...
function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectsContainerRegistryProtectionRuleListMatch
---@param ctrl? table
---@return ApiEntitiesProjectsContainerRegistryProtectionRule[]
---@return string? err
function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesProjectsContainerRegistryProtectionRuleCreateData
---@param ctrl? table
---@return ApiEntitiesProjectsContainerRegistryProtectionRule
---@return string? err
function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesProjectsContainerRegistryProtectionRuleUpdateData
---@param ctrl? table
---@return ApiEntitiesProjectsContainerRegistryProtectionRule
---@return string? err
function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectsContainerRegistryProtectionRuleEntity
