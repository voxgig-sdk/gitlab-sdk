...
local ApiEntitiesTriggerEntity = {}
ApiEntitiesTriggerEntity.__index = ApiEntitiesTriggerEntity


function ApiEntitiesTriggerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesTriggerEntity)
  self._name = "api_entities_trigger"
  self._client = client
...
function ApiEntitiesTriggerEntity:get_name()
  return self._name
end


function ApiEntitiesTriggerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesTriggerEntity.new(self._client, opts)
end
...
function ApiEntitiesTriggerEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesTriggerEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesTriggerEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesTriggerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesTriggerEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesTriggerEntity:match_get()
...
function ApiEntitiesTriggerEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesTriggerLoadMatch
---@param ctrl? table
---@return ApiEntitiesTrigger
---@return string? err
function ApiEntitiesTriggerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesTriggerListMatch
---@param ctrl? table
---@return ApiEntitiesTrigger[]
---@return string? err
function ApiEntitiesTriggerEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesTriggerCreateData
---@param ctrl? table
---@return ApiEntitiesTrigger
---@return string? err
function ApiEntitiesTriggerEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesTriggerUpdateData
---@param ctrl? table
---@return ApiEntitiesTrigger
---@return string? err
function ApiEntitiesTriggerEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesTriggerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesTriggerEntity
