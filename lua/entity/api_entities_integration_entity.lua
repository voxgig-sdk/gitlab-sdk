-- Gitlab SDK ApiEntitiesIntegration entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesIntegrationEntity = {}
ApiEntitiesIntegrationEntity.__index = ApiEntitiesIntegrationEntity


function ApiEntitiesIntegrationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesIntegrationEntity)
  self._name = "api_entities_integration"
  self._client = client
...
function ApiEntitiesIntegrationEntity:get_name()
  return self._name
end


function ApiEntitiesIntegrationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesIntegrationEntity.new(self._client, opts)
end
...
function ApiEntitiesIntegrationEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesIntegrationEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesIntegrationEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesIntegrationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesIntegrationEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesIntegrationEntity:match_get()
...
function ApiEntitiesIntegrationEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesIntegrationLoadMatch
---@param ctrl? table
---@return ApiEntitiesIntegration
---@return string? err
function ApiEntitiesIntegrationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesIntegrationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesIntegrationEntity
