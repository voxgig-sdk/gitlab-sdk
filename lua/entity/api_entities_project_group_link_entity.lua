-- Gitlab SDK ApiEntitiesProjectGroupLink entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesProjectGroupLinkEntity = {}
ApiEntitiesProjectGroupLinkEntity.__index = ApiEntitiesProjectGroupLinkEntity


function ApiEntitiesProjectGroupLinkEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectGroupLinkEntity)
  self._name = "api_entities_project_group_link"
  self._client = client
...
function ApiEntitiesProjectGroupLinkEntity:get_name()
  return self._name
end


function ApiEntitiesProjectGroupLinkEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectGroupLinkEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectGroupLinkEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectGroupLinkEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectGroupLinkEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectGroupLinkEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectGroupLinkEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectGroupLinkEntity:match_get()
...
function ApiEntitiesProjectGroupLinkEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesProjectGroupLinkCreateData
---@param ctrl? table
---@return ApiEntitiesProjectGroupLink
---@return string? err
function ApiEntitiesProjectGroupLinkEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesProjectGroupLinkEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectGroupLinkEntity
