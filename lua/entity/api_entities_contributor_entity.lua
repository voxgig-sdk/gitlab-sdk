-- Gitlab SDK ApiEntitiesContributor entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesContributorEntity = {}
ApiEntitiesContributorEntity.__index = ApiEntitiesContributorEntity


function ApiEntitiesContributorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesContributorEntity)
  self._name = "api_entities_contributor"
  self._client = client
...
function ApiEntitiesContributorEntity:get_name()
  return self._name
end


function ApiEntitiesContributorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesContributorEntity.new(self._client, opts)
end
...
function ApiEntitiesContributorEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesContributorEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesContributorEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesContributorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesContributorEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesContributorEntity:match_get()
...
function ApiEntitiesContributorEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesContributorLoadMatch
---@param ctrl? table
---@return ApiEntitiesContributor
---@return string? err
function ApiEntitiesContributorEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesContributorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesContributorEntity
