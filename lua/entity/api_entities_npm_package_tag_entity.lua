-- Gitlab SDK ApiEntitiesNpmPackageTag entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesNpmPackageTagEntity = {}
ApiEntitiesNpmPackageTagEntity.__index = ApiEntitiesNpmPackageTagEntity


function ApiEntitiesNpmPackageTagEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesNpmPackageTagEntity)
  self._name = "api_entities_npm_package_tag"
  self._client = client
...
function ApiEntitiesNpmPackageTagEntity:get_name()
  return self._name
end


function ApiEntitiesNpmPackageTagEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesNpmPackageTagEntity.new(self._client, opts)
end
...
function ApiEntitiesNpmPackageTagEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesNpmPackageTagEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesNpmPackageTagEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesNpmPackageTagEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesNpmPackageTagEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesNpmPackageTagEntity:match_get()
...
function ApiEntitiesNpmPackageTagEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesNpmPackageTagLoadMatch
---@param ctrl? table
---@return ApiEntitiesNpmPackageTag
---@return string? err
function ApiEntitiesNpmPackageTagEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesNpmPackageTagEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesNpmPackageTagEntity
