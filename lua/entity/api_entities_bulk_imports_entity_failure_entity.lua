-- Gitlab SDK ApiEntitiesBulkImportsEntityFailure entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesBulkImportsEntityFailureEntity = {}
ApiEntitiesBulkImportsEntityFailureEntity.__index = ApiEntitiesBulkImportsEntityFailureEntity


function ApiEntitiesBulkImportsEntityFailureEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBulkImportsEntityFailureEntity)
  self._name = "api_entities_bulk_imports_entity_failure"
  self._client = client
...
function ApiEntitiesBulkImportsEntityFailureEntity:get_name()
  return self._name
end


function ApiEntitiesBulkImportsEntityFailureEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBulkImportsEntityFailureEntity.new(self._client, opts)
end
...
function ApiEntitiesBulkImportsEntityFailureEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBulkImportsEntityFailureEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBulkImportsEntityFailureEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBulkImportsEntityFailureEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBulkImportsEntityFailureEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBulkImportsEntityFailureEntity:match_get()
...
function ApiEntitiesBulkImportsEntityFailureEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesBulkImportsEntityFailureLoadMatch
---@param ctrl? table
---@return ApiEntitiesBulkImportsEntityFailure
---@return string? err
function ApiEntitiesBulkImportsEntityFailureEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesBulkImportsEntityFailureEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesBulkImportsEntityFailureEntity
