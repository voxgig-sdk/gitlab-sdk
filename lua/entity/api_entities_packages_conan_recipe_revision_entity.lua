-- Gitlab SDK ApiEntitiesPackagesConanRecipeRevision entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagesConanRecipeRevisionEntity = {}
ApiEntitiesPackagesConanRecipeRevisionEntity.__index = ApiEntitiesPackagesConanRecipeRevisionEntity


function ApiEntitiesPackagesConanRecipeRevisionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesConanRecipeRevisionEntity)
  self._name = "api_entities_packages_conan_recipe_revision"
  self._client = client
...
function ApiEntitiesPackagesConanRecipeRevisionEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesConanRecipeRevisionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesConanRecipeRevisionEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesConanRecipeRevisionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesConanRecipeRevisionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesConanRecipeRevisionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanRecipeRevisionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesConanRecipeRevisionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanRecipeRevisionEntity:match_get()
...
function ApiEntitiesPackagesConanRecipeRevisionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagesConanRecipeRevisionListMatch
---@param ctrl? table
---@return ApiEntitiesPackagesConanRecipeRevision[]
---@return string? err
function ApiEntitiesPackagesConanRecipeRevisionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagesConanRecipeRevisionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesConanRecipeRevisionEntity
