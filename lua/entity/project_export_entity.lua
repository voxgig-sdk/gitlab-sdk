...
local ProjectExportEntity = {}
ProjectExportEntity.__index = ProjectExportEntity


function ProjectExportEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProjectExportEntity)
  self._name = "project_export"
  self._client = client
...
function ProjectExportEntity:get_name()
  return self._name
end


function ProjectExportEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProjectExportEntity.new(self._client, opts)
end
...
function ProjectExportEntity:mark_deleted()
  self._deleted = true
end


function ProjectExportEntity:deleted()
  return true == self._deleted
end


function ProjectExportEntity:data_set(args)
  if args ~= nil then
...
function ProjectExportEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProjectExportEntity:match_set(args)
  if args ~= nil then
...
function ProjectExportEntity:match_get()
...
function ProjectExportEntity:stream(action, args, callopts)
...
---@param reqmatch ProjectExportLoadMatch
---@param ctrl? table
---@return ProjectExport
---@return string? err
function ProjectExportEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ProjectExportCreateData
---@param ctrl? table
---@return ProjectExport
---@return string? err
function ProjectExportEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ProjectExportEntity:_run_op(ctx, post_done)
  local utility = self._utility
