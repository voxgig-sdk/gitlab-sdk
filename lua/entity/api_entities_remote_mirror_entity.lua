...
local ApiEntitiesRemoteMirrorEntity = {}
ApiEntitiesRemoteMirrorEntity.__index = ApiEntitiesRemoteMirrorEntity


function ApiEntitiesRemoteMirrorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesRemoteMirrorEntity)
  self._name = "api_entities_remote_mirror"
  self._client = client
...
function ApiEntitiesRemoteMirrorEntity:get_name()
  return self._name
end


function ApiEntitiesRemoteMirrorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesRemoteMirrorEntity.new(self._client, opts)
end
...
function ApiEntitiesRemoteMirrorEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesRemoteMirrorEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesRemoteMirrorEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesRemoteMirrorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesRemoteMirrorEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesRemoteMirrorEntity:match_get()
...
function ApiEntitiesRemoteMirrorEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesRemoteMirrorLoadMatch
---@param ctrl? table
---@return ApiEntitiesRemoteMirror
---@return string? err
function ApiEntitiesRemoteMirrorEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesRemoteMirrorListMatch
---@param ctrl? table
---@return ApiEntitiesRemoteMirror[]
---@return string? err
function ApiEntitiesRemoteMirrorEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesRemoteMirrorCreateData
---@param ctrl? table
---@return ApiEntitiesRemoteMirror
---@return string? err
function ApiEntitiesRemoteMirrorEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesRemoteMirrorUpdateData
---@param ctrl? table
---@return ApiEntitiesRemoteMirror
---@return string? err
function ApiEntitiesRemoteMirrorEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesRemoteMirrorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesRemoteMirrorEntity
