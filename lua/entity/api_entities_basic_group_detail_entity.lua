-- Gitlab SDK ApiEntitiesBasicGroupDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesBasicGroupDetailEntity = {}
ApiEntitiesBasicGroupDetailEntity.__index = ApiEntitiesBasicGroupDetailEntity


function ApiEntitiesBasicGroupDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBasicGroupDetailEntity)
  self._name = "api_entities_basic_group_detail"
  self._client = client
...
function ApiEntitiesBasicGroupDetailEntity:get_name()
  return self._name
end


function ApiEntitiesBasicGroupDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBasicGroupDetailEntity.new(self._client, opts)
end
...
function ApiEntitiesBasicGroupDetailEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBasicGroupDetailEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBasicGroupDetailEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBasicGroupDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBasicGroupDetailEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBasicGroupDetailEntity:match_get()
...
function ApiEntitiesBasicGroupDetailEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesBasicGroupDetailCreateData
---@param ctrl? table
---@return ApiEntitiesBasicGroupDetail
---@return string? err
function ApiEntitiesBasicGroupDetailEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesBasicGroupDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesBasicGroupDetailEntity
