-- Gitlab SDK ApiEntitiesPackagePipeline entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagePipelineEntity = {}
ApiEntitiesPackagePipelineEntity.__index = ApiEntitiesPackagePipelineEntity


function ApiEntitiesPackagePipelineEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagePipelineEntity)
  self._name = "api_entities_package_pipeline"
  self._client = client
...
function ApiEntitiesPackagePipelineEntity:get_name()
  return self._name
end


function ApiEntitiesPackagePipelineEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagePipelineEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagePipelineEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagePipelineEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagePipelineEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagePipelineEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagePipelineEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagePipelineEntity:match_get()
...
function ApiEntitiesPackagePipelineEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagePipelineLoadMatch
---@param ctrl? table
---@return ApiEntitiesPackagePipeline
---@return string? err
function ApiEntitiesPackagePipelineEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagePipelineEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagePipelineEntity
