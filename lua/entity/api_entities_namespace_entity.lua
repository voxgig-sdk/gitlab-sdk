...
local ApiEntitiesNamespaceEntity = {}
ApiEntitiesNamespaceEntity.__index = ApiEntitiesNamespaceEntity


function ApiEntitiesNamespaceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesNamespaceEntity)
  self._name = "api_entities_namespace"
  self._client = client
...
function ApiEntitiesNamespaceEntity:get_name()
  return self._name
end


function ApiEntitiesNamespaceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesNamespaceEntity.new(self._client, opts)
end
...
function ApiEntitiesNamespaceEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesNamespaceEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesNamespaceEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesNamespaceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesNamespaceEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesNamespaceEntity:match_get()
...
function ApiEntitiesNamespaceEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesNamespaceLoadMatch
---@param ctrl? table
---@return ApiEntitiesNamespace
---@return string? err
function ApiEntitiesNamespaceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesNamespaceListMatch
---@param ctrl? table
---@return ApiEntitiesNamespace[]
---@return string? err
function ApiEntitiesNamespaceEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesNamespaceUpdateData
---@param ctrl? table
---@return ApiEntitiesNamespace
---@return string? err
function ApiEntitiesNamespaceEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesNamespaceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesNamespaceEntity
