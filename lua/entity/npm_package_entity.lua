...
local NpmPackageEntity = {}
NpmPackageEntity.__index = NpmPackageEntity


function NpmPackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NpmPackageEntity)
  self._name = "npm_package"
  self._client = client
...
function NpmPackageEntity:get_name()
  return self._name
end


function NpmPackageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NpmPackageEntity.new(self._client, opts)
end
...
function NpmPackageEntity:mark_deleted()
  self._deleted = true
end


function NpmPackageEntity:deleted()
  return true == self._deleted
end


function NpmPackageEntity:data_set(args)
  if args ~= nil then
...
function NpmPackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NpmPackageEntity:match_set(args)
  if args ~= nil then
...
function NpmPackageEntity:match_get()
...
function NpmPackageEntity:stream(action, args, callopts)
...
---@param reqmatch NpmPackageLoadMatch
---@param ctrl? table
---@return NpmPackage
---@return string? err
function NpmPackageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata NpmPackageCreateData
---@param ctrl? table
---@return NpmPackage
---@return string? err
function NpmPackageEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata NpmPackageUpdateData
---@param ctrl? table
---@return NpmPackage
---@return string? err
function NpmPackageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch NpmPackageRemoveMatch
---@param ctrl? table
---@return NpmPackage
---@return string? err
function NpmPackageEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function NpmPackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
