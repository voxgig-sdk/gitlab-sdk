-- Gitlab SDK ApiEntitiesApplicationStatistic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesApplicationStatisticEntity = {}
ApiEntitiesApplicationStatisticEntity.__index = ApiEntitiesApplicationStatisticEntity


function ApiEntitiesApplicationStatisticEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesApplicationStatisticEntity)
  self._name = "api_entities_application_statistic"
  self._client = client
...
function ApiEntitiesApplicationStatisticEntity:get_name()
  return self._name
end


function ApiEntitiesApplicationStatisticEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesApplicationStatisticEntity.new(self._client, opts)
end
...
function ApiEntitiesApplicationStatisticEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesApplicationStatisticEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesApplicationStatisticEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesApplicationStatisticEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesApplicationStatisticEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesApplicationStatisticEntity:match_get()
...
function ApiEntitiesApplicationStatisticEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesApplicationStatisticLoadMatch
---@param ctrl? table
---@return ApiEntitiesApplicationStatistic
---@return string? err
function ApiEntitiesApplicationStatisticEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesApplicationStatisticEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesApplicationStatisticEntity
