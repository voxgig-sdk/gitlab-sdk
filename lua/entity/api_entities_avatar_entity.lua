-- Gitlab SDK ApiEntitiesAvatar entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesAvatarEntity = {}
ApiEntitiesAvatarEntity.__index = ApiEntitiesAvatarEntity


function ApiEntitiesAvatarEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesAvatarEntity)
  self._name = "api_entities_avatar"
  self._client = client
...
function ApiEntitiesAvatarEntity:get_name()
  return self._name
end


function ApiEntitiesAvatarEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesAvatarEntity.new(self._client, opts)
end
...
function ApiEntitiesAvatarEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesAvatarEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesAvatarEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesAvatarEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesAvatarEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesAvatarEntity:match_get()
...
function ApiEntitiesAvatarEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesAvatarLoadMatch
---@param ctrl? table
---@return ApiEntitiesAvatar
---@return string? err
function ApiEntitiesAvatarEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesAvatarEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesAvatarEntity
