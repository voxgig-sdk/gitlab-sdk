...
local ApiEntitiesBranchEntity = {}
ApiEntitiesBranchEntity.__index = ApiEntitiesBranchEntity


function ApiEntitiesBranchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesBranchEntity)
  self._name = "api_entities_branch"
  self._client = client
...
function ApiEntitiesBranchEntity:get_name()
  return self._name
end


function ApiEntitiesBranchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesBranchEntity.new(self._client, opts)
end
...
function ApiEntitiesBranchEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesBranchEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesBranchEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesBranchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesBranchEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesBranchEntity:match_get()
...
function ApiEntitiesBranchEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesBranchLoadMatch
---@param ctrl? table
---@return ApiEntitiesBranch
---@return string? err
function ApiEntitiesBranchEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesBranchListMatch
---@param ctrl? table
---@return ApiEntitiesBranch[]
---@return string? err
function ApiEntitiesBranchEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesBranchCreateData
---@param ctrl? table
---@return ApiEntitiesBranch
---@return string? err
function ApiEntitiesBranchEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesBranchUpdateData
---@param ctrl? table
---@return ApiEntitiesBranch
---@return string? err
function ApiEntitiesBranchEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesBranchEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesBranchEntity
