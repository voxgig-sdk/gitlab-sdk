-- Gitlab SDK ApiEntitiesPackagesConanRevision entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagesConanRevisionEntity = {}
ApiEntitiesPackagesConanRevisionEntity.__index = ApiEntitiesPackagesConanRevisionEntity


function ApiEntitiesPackagesConanRevisionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesConanRevisionEntity)
  self._name = "api_entities_packages_conan_revision"
  self._client = client
...
function ApiEntitiesPackagesConanRevisionEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesConanRevisionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesConanRevisionEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesConanRevisionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesConanRevisionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesConanRevisionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanRevisionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesConanRevisionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanRevisionEntity:match_get()
...
function ApiEntitiesPackagesConanRevisionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagesConanRevisionLoadMatch
---@param ctrl? table
---@return ApiEntitiesPackagesConanRevision
---@return string? err
function ApiEntitiesPackagesConanRevisionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagesConanRevisionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesConanRevisionEntity
