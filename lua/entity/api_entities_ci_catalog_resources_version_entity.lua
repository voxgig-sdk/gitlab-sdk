-- Gitlab SDK ApiEntitiesCiCatalogResourcesVersion entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiCatalogResourcesVersionEntity = {}
ApiEntitiesCiCatalogResourcesVersionEntity.__index = ApiEntitiesCiCatalogResourcesVersionEntity


function ApiEntitiesCiCatalogResourcesVersionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiCatalogResourcesVersionEntity)
  self._name = "api_entities_ci_catalog_resources_version"
  self._client = client
...
function ApiEntitiesCiCatalogResourcesVersionEntity:get_name()
  return self._name
end


function ApiEntitiesCiCatalogResourcesVersionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiCatalogResourcesVersionEntity.new(self._client, opts)
end
...
function ApiEntitiesCiCatalogResourcesVersionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiCatalogResourcesVersionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiCatalogResourcesVersionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiCatalogResourcesVersionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiCatalogResourcesVersionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiCatalogResourcesVersionEntity:match_get()
...
function ApiEntitiesCiCatalogResourcesVersionEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesCiCatalogResourcesVersionCreateData
---@param ctrl? table
---@return ApiEntitiesCiCatalogResourcesVersion
---@return string? err
function ApiEntitiesCiCatalogResourcesVersionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesCiCatalogResourcesVersionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiCatalogResourcesVersionEntity
