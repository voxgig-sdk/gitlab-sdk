-- Gitlab SDK ApiEntitiesPackagesConanRecipeSnapshot entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagesConanRecipeSnapshotEntity = {}
ApiEntitiesPackagesConanRecipeSnapshotEntity.__index = ApiEntitiesPackagesConanRecipeSnapshotEntity


function ApiEntitiesPackagesConanRecipeSnapshotEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesConanRecipeSnapshotEntity)
  self._name = "api_entities_packages_conan_recipe_snapshot"
  self._client = client
...
function ApiEntitiesPackagesConanRecipeSnapshotEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesConanRecipeSnapshotEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesConanRecipeSnapshotEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesConanRecipeSnapshotEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesConanRecipeSnapshotEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesConanRecipeSnapshotEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanRecipeSnapshotEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesConanRecipeSnapshotEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanRecipeSnapshotEntity:match_get()
...
function ApiEntitiesPackagesConanRecipeSnapshotEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagesConanRecipeSnapshotLoadMatch
---@param ctrl? table
---@return ApiEntitiesPackagesConanRecipeSnapshot
---@return string? err
function ApiEntitiesPackagesConanRecipeSnapshotEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagesConanRecipeSnapshotEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesConanRecipeSnapshotEntity
