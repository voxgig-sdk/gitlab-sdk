-- Gitlab SDK ApiEntitiesWikiAttachment entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesWikiAttachmentEntity = {}
ApiEntitiesWikiAttachmentEntity.__index = ApiEntitiesWikiAttachmentEntity


function ApiEntitiesWikiAttachmentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesWikiAttachmentEntity)
  self._name = "api_entities_wiki_attachment"
  self._client = client
...
function ApiEntitiesWikiAttachmentEntity:get_name()
  return self._name
end


function ApiEntitiesWikiAttachmentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesWikiAttachmentEntity.new(self._client, opts)
end
...
function ApiEntitiesWikiAttachmentEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesWikiAttachmentEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesWikiAttachmentEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesWikiAttachmentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesWikiAttachmentEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesWikiAttachmentEntity:match_get()
...
function ApiEntitiesWikiAttachmentEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesWikiAttachmentCreateData
---@param ctrl? table
---@return ApiEntitiesWikiAttachment
---@return string? err
function ApiEntitiesWikiAttachmentEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesWikiAttachmentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesWikiAttachmentEntity
