...
local ApiEntitiesMemberEntity = {}
ApiEntitiesMemberEntity.__index = ApiEntitiesMemberEntity


function ApiEntitiesMemberEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMemberEntity)
  self._name = "api_entities_member"
  self._client = client
...
function ApiEntitiesMemberEntity:get_name()
  return self._name
end


function ApiEntitiesMemberEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMemberEntity.new(self._client, opts)
end
...
function ApiEntitiesMemberEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMemberEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMemberEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMemberEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMemberEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMemberEntity:match_get()
...
function ApiEntitiesMemberEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMemberLoadMatch
---@param ctrl? table
---@return ApiEntitiesMember
---@return string? err
function ApiEntitiesMemberEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesMemberListMatch
---@param ctrl? table
---@return ApiEntitiesMember[]
---@return string? err
function ApiEntitiesMemberEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesMemberCreateData
---@param ctrl? table
---@return ApiEntitiesMember
---@return string? err
function ApiEntitiesMemberEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesMemberUpdateData
---@param ctrl? table
---@return ApiEntitiesMember
---@return string? err
function ApiEntitiesMemberEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ApiEntitiesMemberRemoveMatch
---@param ctrl? table
---@return ApiEntitiesMember
---@return string? err
function ApiEntitiesMemberEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ApiEntitiesMemberEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMemberEntity
