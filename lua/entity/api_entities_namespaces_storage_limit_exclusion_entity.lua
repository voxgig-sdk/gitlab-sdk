-- Gitlab SDK ApiEntitiesNamespacesStorageLimitExclusion entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesNamespacesStorageLimitExclusionEntity = {}
ApiEntitiesNamespacesStorageLimitExclusionEntity.__index = ApiEntitiesNamespacesStorageLimitExclusionEntity


function ApiEntitiesNamespacesStorageLimitExclusionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesNamespacesStorageLimitExclusionEntity)
  self._name = "api_entities_namespaces_storage_limit_exclusion"
  self._client = client
...
function ApiEntitiesNamespacesStorageLimitExclusionEntity:get_name()
  return self._name
end


function ApiEntitiesNamespacesStorageLimitExclusionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesNamespacesStorageLimitExclusionEntity.new(self._client, opts)
end
...
function ApiEntitiesNamespacesStorageLimitExclusionEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesNamespacesStorageLimitExclusionEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesNamespacesStorageLimitExclusionEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesNamespacesStorageLimitExclusionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesNamespacesStorageLimitExclusionEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesNamespacesStorageLimitExclusionEntity:match_get()
...
function ApiEntitiesNamespacesStorageLimitExclusionEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesNamespacesStorageLimitExclusionLoadMatch
---@param ctrl? table
---@return ApiEntitiesNamespacesStorageLimitExclusion
---@return string? err
function ApiEntitiesNamespacesStorageLimitExclusionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesNamespacesStorageLimitExclusionCreateData
---@param ctrl? table
---@return ApiEntitiesNamespacesStorageLimitExclusion
---@return string? err
function ApiEntitiesNamespacesStorageLimitExclusionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesNamespacesStorageLimitExclusionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesNamespacesStorageLimitExclusionEntity
