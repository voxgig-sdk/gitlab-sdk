-- Gitlab SDK ApiEntitiesProjectJobTokenScope entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesProjectJobTokenScopeEntity = {}
ApiEntitiesProjectJobTokenScopeEntity.__index = ApiEntitiesProjectJobTokenScopeEntity


function ApiEntitiesProjectJobTokenScopeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesProjectJobTokenScopeEntity)
  self._name = "api_entities_project_job_token_scope"
  self._client = client
...
function ApiEntitiesProjectJobTokenScopeEntity:get_name()
  return self._name
end


function ApiEntitiesProjectJobTokenScopeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesProjectJobTokenScopeEntity.new(self._client, opts)
end
...
function ApiEntitiesProjectJobTokenScopeEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesProjectJobTokenScopeEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesProjectJobTokenScopeEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectJobTokenScopeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesProjectJobTokenScopeEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesProjectJobTokenScopeEntity:match_get()
...
function ApiEntitiesProjectJobTokenScopeEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesProjectJobTokenScopeLoadMatch
---@param ctrl? table
---@return ApiEntitiesProjectJobTokenScope
---@return string? err
function ApiEntitiesProjectJobTokenScopeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesProjectJobTokenScopeEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesProjectJobTokenScopeEntity
