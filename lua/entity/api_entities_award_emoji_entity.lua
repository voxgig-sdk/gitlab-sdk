...
local ApiEntitiesAwardEmojiEntity = {}
ApiEntitiesAwardEmojiEntity.__index = ApiEntitiesAwardEmojiEntity


function ApiEntitiesAwardEmojiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesAwardEmojiEntity)
  self._name = "api_entities_award_emoji"
  self._client = client
...
function ApiEntitiesAwardEmojiEntity:get_name()
  return self._name
end


function ApiEntitiesAwardEmojiEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesAwardEmojiEntity.new(self._client, opts)
end
...
function ApiEntitiesAwardEmojiEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesAwardEmojiEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesAwardEmojiEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesAwardEmojiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesAwardEmojiEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesAwardEmojiEntity:match_get()
...
function ApiEntitiesAwardEmojiEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesAwardEmojiLoadMatch
---@param ctrl? table
---@return ApiEntitiesAwardEmoji
---@return string? err
function ApiEntitiesAwardEmojiEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesAwardEmojiListMatch
---@param ctrl? table
---@return ApiEntitiesAwardEmoji[]
---@return string? err
function ApiEntitiesAwardEmojiEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesAwardEmojiCreateData
---@param ctrl? table
---@return ApiEntitiesAwardEmoji
---@return string? err
function ApiEntitiesAwardEmojiEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApiEntitiesAwardEmojiEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesAwardEmojiEntity
