-- Gitlab SDK ApiEntitiesPackagesConanPackageSnapshot entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesPackagesConanPackageSnapshotEntity = {}
ApiEntitiesPackagesConanPackageSnapshotEntity.__index = ApiEntitiesPackagesConanPackageSnapshotEntity


function ApiEntitiesPackagesConanPackageSnapshotEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPackagesConanPackageSnapshotEntity)
  self._name = "api_entities_packages_conan_package_snapshot"
  self._client = client
...
function ApiEntitiesPackagesConanPackageSnapshotEntity:get_name()
  return self._name
end


function ApiEntitiesPackagesConanPackageSnapshotEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPackagesConanPackageSnapshotEntity.new(self._client, opts)
end
...
function ApiEntitiesPackagesConanPackageSnapshotEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPackagesConanPackageSnapshotEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPackagesConanPackageSnapshotEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanPackageSnapshotEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPackagesConanPackageSnapshotEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPackagesConanPackageSnapshotEntity:match_get()
...
function ApiEntitiesPackagesConanPackageSnapshotEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPackagesConanPackageSnapshotLoadMatch
---@param ctrl? table
---@return ApiEntitiesPackagesConanPackageSnapshot
---@return string? err
function ApiEntitiesPackagesConanPackageSnapshotEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesPackagesConanPackageSnapshotEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPackagesConanPackageSnapshotEntity
