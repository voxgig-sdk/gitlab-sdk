...
local GenericPackageEntity = {}
GenericPackageEntity.__index = GenericPackageEntity


function GenericPackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GenericPackageEntity)
  self._name = "generic_package"
  self._client = client
...
function GenericPackageEntity:get_name()
  return self._name
end


function GenericPackageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GenericPackageEntity.new(self._client, opts)
end
...
function GenericPackageEntity:mark_deleted()
  self._deleted = true
end


function GenericPackageEntity:deleted()
  return true == self._deleted
end


function GenericPackageEntity:data_set(args)
  if args ~= nil then
...
function GenericPackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GenericPackageEntity:match_set(args)
  if args ~= nil then
...
function GenericPackageEntity:match_get()
...
function GenericPackageEntity:stream(action, args, callopts)
...
---@param reqmatch GenericPackageLoadMatch
---@param ctrl? table
---@return GenericPackage
---@return string? err
function GenericPackageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata GenericPackageUpdateData
---@param ctrl? table
---@return GenericPackage
---@return string? err
function GenericPackageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function GenericPackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
