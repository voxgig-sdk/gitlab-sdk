...
local ApiEntitiesDeployKeyEntity = {}
ApiEntitiesDeployKeyEntity.__index = ApiEntitiesDeployKeyEntity


function ApiEntitiesDeployKeyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDeployKeyEntity)
  self._name = "api_entities_deploy_key"
  self._client = client
...
function ApiEntitiesDeployKeyEntity:get_name()
  return self._name
end


function ApiEntitiesDeployKeyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDeployKeyEntity.new(self._client, opts)
end
...
function ApiEntitiesDeployKeyEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDeployKeyEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDeployKeyEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDeployKeyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDeployKeyEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDeployKeyEntity:match_get()
...
function ApiEntitiesDeployKeyEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesDeployKeyListMatch
---@param ctrl? table
---@return ApiEntitiesDeployKey[]
---@return string? err
function ApiEntitiesDeployKeyEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApiEntitiesDeployKeyCreateData
---@param ctrl? table
---@return ApiEntitiesDeployKey
---@return string? err
function ApiEntitiesDeployKeyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesDeployKeyUpdateData
---@param ctrl? table
---@return ApiEntitiesDeployKey
---@return string? err
function ApiEntitiesDeployKeyEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesDeployKeyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesDeployKeyEntity
