...
local ApiEntitiesDeployTokenEntity = {}
ApiEntitiesDeployTokenEntity.__index = ApiEntitiesDeployTokenEntity


function ApiEntitiesDeployTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesDeployTokenEntity)
  self._name = "api_entities_deploy_token"
  self._client = client
...
function ApiEntitiesDeployTokenEntity:get_name()
  return self._name
end


function ApiEntitiesDeployTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesDeployTokenEntity.new(self._client, opts)
end
...
function ApiEntitiesDeployTokenEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesDeployTokenEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesDeployTokenEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesDeployTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesDeployTokenEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesDeployTokenEntity:match_get()
...
function ApiEntitiesDeployTokenEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesDeployTokenLoadMatch
---@param ctrl? table
---@return ApiEntitiesDeployToken
---@return string? err
function ApiEntitiesDeployTokenEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesDeployTokenListMatch
---@param ctrl? table
---@return ApiEntitiesDeployToken[]
---@return string? err
function ApiEntitiesDeployTokenEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiEntitiesDeployTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesDeployTokenEntity
