-- Gitlab SDK ApiEntitiesMergeRequestDiff entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesMergeRequestDiffEntity = {}
ApiEntitiesMergeRequestDiffEntity.__index = ApiEntitiesMergeRequestDiffEntity


function ApiEntitiesMergeRequestDiffEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesMergeRequestDiffEntity)
  self._name = "api_entities_merge_request_diff"
  self._client = client
...
function ApiEntitiesMergeRequestDiffEntity:get_name()
  return self._name
end


function ApiEntitiesMergeRequestDiffEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesMergeRequestDiffEntity.new(self._client, opts)
end
...
function ApiEntitiesMergeRequestDiffEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesMergeRequestDiffEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesMergeRequestDiffEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestDiffEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesMergeRequestDiffEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesMergeRequestDiffEntity:match_get()
...
function ApiEntitiesMergeRequestDiffEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesMergeRequestDiffListMatch
---@param ctrl? table
---@return ApiEntitiesMergeRequestDiff[]
---@return string? err
function ApiEntitiesMergeRequestDiffEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesMergeRequestDiffEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesMergeRequestDiffEntity
