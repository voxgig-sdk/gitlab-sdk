-- Gitlab SDK ApiEntitiesCiResetTokenResult entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesCiResetTokenResultEntity = {}
ApiEntitiesCiResetTokenResultEntity.__index = ApiEntitiesCiResetTokenResultEntity


function ApiEntitiesCiResetTokenResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesCiResetTokenResultEntity)
  self._name = "api_entities_ci_reset_token_result"
  self._client = client
...
function ApiEntitiesCiResetTokenResultEntity:get_name()
  return self._name
end


function ApiEntitiesCiResetTokenResultEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesCiResetTokenResultEntity.new(self._client, opts)
end
...
function ApiEntitiesCiResetTokenResultEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesCiResetTokenResultEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesCiResetTokenResultEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesCiResetTokenResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesCiResetTokenResultEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesCiResetTokenResultEntity:match_get()
...
function ApiEntitiesCiResetTokenResultEntity:stream(action, args, callopts)
...
---@param reqdata ApiEntitiesCiResetTokenResultCreateData
---@param ctrl? table
---@return ApiEntitiesCiResetTokenResult
---@return string? err
function ApiEntitiesCiResetTokenResultEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApiEntitiesCiResetTokenResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesCiResetTokenResultEntity
