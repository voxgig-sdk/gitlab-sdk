-- Gitlab SDK ApiEntitiesTemplatesList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiEntitiesTemplatesListEntity = {}
ApiEntitiesTemplatesListEntity.__index = ApiEntitiesTemplatesListEntity


function ApiEntitiesTemplatesListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesTemplatesListEntity)
  self._name = "api_entities_templates_list"
  self._client = client
...
function ApiEntitiesTemplatesListEntity:get_name()
  return self._name
end


function ApiEntitiesTemplatesListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesTemplatesListEntity.new(self._client, opts)
end
...
function ApiEntitiesTemplatesListEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesTemplatesListEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesTemplatesListEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesTemplatesListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesTemplatesListEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesTemplatesListEntity:match_get()
...
function ApiEntitiesTemplatesListEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesTemplatesListLoadMatch
---@param ctrl? table
---@return ApiEntitiesTemplatesList
---@return string? err
function ApiEntitiesTemplatesListEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiEntitiesTemplatesListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesTemplatesListEntity
