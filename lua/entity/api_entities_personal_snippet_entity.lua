...
local ApiEntitiesPersonalSnippetEntity = {}
ApiEntitiesPersonalSnippetEntity.__index = ApiEntitiesPersonalSnippetEntity


function ApiEntitiesPersonalSnippetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiEntitiesPersonalSnippetEntity)
  self._name = "api_entities_personal_snippet"
  self._client = client
...
function ApiEntitiesPersonalSnippetEntity:get_name()
  return self._name
end


function ApiEntitiesPersonalSnippetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiEntitiesPersonalSnippetEntity.new(self._client, opts)
end
...
function ApiEntitiesPersonalSnippetEntity:mark_deleted()
  self._deleted = true
end


function ApiEntitiesPersonalSnippetEntity:deleted()
  return true == self._deleted
end


function ApiEntitiesPersonalSnippetEntity:data_set(args)
  if args ~= nil then
...
function ApiEntitiesPersonalSnippetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiEntitiesPersonalSnippetEntity:match_set(args)
  if args ~= nil then
...
function ApiEntitiesPersonalSnippetEntity:match_get()
...
function ApiEntitiesPersonalSnippetEntity:stream(action, args, callopts)
...
---@param reqmatch ApiEntitiesPersonalSnippetLoadMatch
---@param ctrl? table
---@return ApiEntitiesPersonalSnippet
---@return string? err
function ApiEntitiesPersonalSnippetEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiEntitiesPersonalSnippetListMatch
---@param ctrl? table
---@return ApiEntitiesPersonalSnippet[]
---@return string? err
function ApiEntitiesPersonalSnippetEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesPersonalSnippetCreateData
---@param ctrl? table
---@return ApiEntitiesPersonalSnippet
---@return string? err
function ApiEntitiesPersonalSnippetEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApiEntitiesPersonalSnippetUpdateData
---@param ctrl? table
---@return ApiEntitiesPersonalSnippet
---@return string? err
function ApiEntitiesPersonalSnippetEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApiEntitiesPersonalSnippetEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiEntitiesPersonalSnippetEntity
