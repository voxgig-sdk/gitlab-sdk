...
describe("ProjectDirect", function()
  it("should direct-list-project", function()
    local setup = project_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-project", setup.live and "live" or "unit")
