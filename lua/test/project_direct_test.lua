...
describe("ProjectDirect", function()
  it("should direct-load-project", function()
    local setup = project_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-project", setup.live and "live" or "unit")
...
function project_direct_setup(mockres)
