-- ApiEntitiesGitlabSubscription direct test
...
describe("ApiEntitiesGitlabSubscriptionDirect", function()
  it("should direct-load-api_entities_gitlab_subscription", function()
    local setup = api_entities_gitlab_subscription_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_gitlab_subscription", setup.live and "live" or "unit")
...
function api_entities_gitlab_subscription_direct_setup(mockres)
