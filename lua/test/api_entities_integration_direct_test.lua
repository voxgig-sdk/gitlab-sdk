-- ApiEntitiesIntegration direct test
...
describe("ApiEntitiesIntegrationDirect", function()
  it("should direct-load-api_entities_integration", function()
    local setup = api_entities_integration_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_integration", setup.live and "live" or "unit")
...
function api_entities_integration_direct_setup(mockres)
