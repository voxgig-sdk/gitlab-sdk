...
describe("ApiEntitiesProtectedBranchEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:ApiEntitiesProtectedBranch(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:ApiEntitiesProtectedBranch(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    assert.is_nil(err)
    api_entities_protected_branch_ref01_data = helpers.to_map(type(api_entities_protected_branch_ref01_data_result) == 'table' and api_entities_protected_branch_ref01_data_result.data_get and api_entities_protected_branch_ref01_data_result:data_get() or api_entities_protected_branch_ref01_data_result)
    ...
    assert.is_nil(err)
    local api_entities_protected_branch_ref01_resdata_up0 = helpers.to_map(type(api_entities_protected_branch_ref01_resdata_up0_result) == 'table' and api_entities_protected_branch_ref01_resdata_up0_result.data_get and api_entities_protected_branch_ref01_resdata_up0_result:data_get() or api_entities_protected_branch_ref01_resdata_up0_result)
    ...
    assert.is_nil(err)
    local api_entities_protected_branch_ref01_data_dt0_load_result = helpers.to_map(type(api_entities_protected_branch_ref01_data_dt0_loaded) == 'table' and api_entities_protected_branch_ref01_data_dt0_loaded.data_get and api_entities_protected_branch_ref01_data_dt0_loaded:data_get() or api_entities_protected_branch_ref01_data_dt0_loaded)
