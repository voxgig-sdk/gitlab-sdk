-- ApiEntitiesPackagesConanRecipeManifest direct test
...
describe("ApiEntitiesPackagesConanRecipeManifestDirect", function()
  it("should direct-load-api_entities_packages_conan_recipe_manifest", function()
    local setup = api_entities_packages_conan_recipe_manifest_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_packages_conan_recipe_manifest", setup.live and "live" or "unit")
...
function api_entities_packages_conan_recipe_manifest_direct_setup(mockres)
