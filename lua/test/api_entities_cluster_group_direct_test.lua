-- ApiEntitiesClusterGroup direct test
...
describe("ApiEntitiesClusterGroupDirect", function()
  it("should direct-load-api_entities_cluster_group", function()
    local setup = api_entities_cluster_group_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_cluster_group", setup.live and "live" or "unit")
...
function api_entities_cluster_group_direct_setup(mockres)
