-- ApiEntitiesPackagesConanRevision direct test
...
describe("ApiEntitiesPackagesConanRevisionDirect", function()
  it("should direct-load-api_entities_packages_conan_revision", function()
    local setup = api_entities_packages_conan_revision_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_packages_conan_revision", setup.live and "live" or "unit")
...
function api_entities_packages_conan_revision_direct_setup(mockres)
