...
describe("MavenPackageDirect", function()
  it("should direct-load-maven_package", function()
    local setup = maven_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-maven_package", setup.live and "live" or "unit")
...
function maven_package_direct_setup(mockres)
