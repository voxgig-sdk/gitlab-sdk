...
describe("ConanPackageDirect", function()
  it("should direct-load-conan_package", function()
    local setup = conan_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-conan_package", setup.live and "live" or "unit")
...
function conan_package_direct_setup(mockres)
