...
describe("WebCommitDirect", function()
  it("should direct-load-web_commit", function()
    local setup = web_commit_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-web_commit", setup.live and "live" or "unit")
...
function web_commit_direct_setup(mockres)
