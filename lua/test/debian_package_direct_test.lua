...
describe("DebianPackageDirect", function()
  it("should direct-load-debian_package", function()
    local setup = debian_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-debian_package", setup.live and "live" or "unit")
...
function debian_package_direct_setup(mockres)
