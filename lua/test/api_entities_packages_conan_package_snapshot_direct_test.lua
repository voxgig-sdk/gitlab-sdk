-- ApiEntitiesPackagesConanPackageSnapshot direct test
...
describe("ApiEntitiesPackagesConanPackageSnapshotDirect", function()
  it("should direct-load-api_entities_packages_conan_package_snapshot", function()
    local setup = api_entities_packages_conan_package_snapshot_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_packages_conan_package_snapshot", setup.live and "live" or "unit")
...
function api_entities_packages_conan_package_snapshot_direct_setup(mockres)
