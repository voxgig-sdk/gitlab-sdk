-- ApiEntitiesPlanLimit direct test
...
describe("ApiEntitiesPlanLimitDirect", function()
  it("should direct-load-api_entities_plan_limit", function()
    local setup = api_entities_plan_limit_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_plan_limit", setup.live and "live" or "unit")
...
function api_entities_plan_limit_direct_setup(mockres)
