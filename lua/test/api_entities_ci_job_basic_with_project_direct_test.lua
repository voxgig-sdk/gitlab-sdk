-- ApiEntitiesCiJobBasicWithProject direct test
...
describe("ApiEntitiesCiJobBasicWithProjectDirect", function()
  it("should direct-load-api_entities_ci_job_basic_with_project", function()
    local setup = api_entities_ci_job_basic_with_project_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_ci_job_basic_with_project", setup.live and "live" or "unit")
...
function api_entities_ci_job_basic_with_project_direct_setup(mockres)
