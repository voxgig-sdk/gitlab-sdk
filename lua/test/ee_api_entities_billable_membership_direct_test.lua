-- EeApiEntitiesBillableMembership direct test
...
describe("EeApiEntitiesBillableMembershipDirect", function()
  it("should direct-load-ee_api_entities_billable_membership", function()
    local setup = ee_api_entities_billable_membership_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ee_api_entities_billable_membership", setup.live and "live" or "unit")
...
function ee_api_entities_billable_membership_direct_setup(mockres)
