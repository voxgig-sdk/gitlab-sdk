...
describe("GoProxyDirect", function()
  it("should direct-load-go_proxy", function()
    local setup = go_proxy_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-go_proxy", setup.live and "live" or "unit")
...
function go_proxy_direct_setup(mockres)
