-- ApiEntitiesContributor direct test
...
describe("ApiEntitiesContributorDirect", function()
  it("should direct-load-api_entities_contributor", function()
    local setup = api_entities_contributor_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_contributor", setup.live and "live" or "unit")
...
function api_entities_contributor_direct_setup(mockres)
