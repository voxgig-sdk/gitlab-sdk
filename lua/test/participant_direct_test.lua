...
describe("ParticipantDirect", function()
  it("should direct-list-participant", function()
    local setup = participant_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-participant", setup.live and "live" or "unit")
...
function participant_direct_setup(mockres)
