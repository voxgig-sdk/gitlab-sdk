-- ApiEntitiesMergeRequestReviewer direct test
...
describe("ApiEntitiesMergeRequestReviewerDirect", function()
  it("should direct-load-api_entities_merge_request_reviewer", function()
    local setup = api_entities_merge_request_reviewer_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_merge_request_reviewer", setup.live and "live" or "unit")
...
function api_entities_merge_request_reviewer_direct_setup(mockres)
