...
describe("CargoPackageDirect", function()
  it("should direct-load-cargo_package", function()
    local setup = cargo_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cargo_package", setup.live and "live" or "unit")
...
function cargo_package_direct_setup(mockres)
