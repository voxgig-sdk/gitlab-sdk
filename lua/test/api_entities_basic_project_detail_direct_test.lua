-- ApiEntitiesBasicProjectDetail direct test
...
describe("ApiEntitiesBasicProjectDetailDirect", function()
  it("should direct-list-api_entities_basic_project_detail", function()
    local setup = api_entities_basic_project_detail_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_entities_basic_project_detail", setup.live and "live" or "unit")
...
function api_entities_basic_project_detail_direct_setup(mockres)
