...
describe("IssuesStatisticDirect", function()
  it("should direct-load-issues_statistic", function()
    local setup = issues_statistic_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-issues_statistic", setup.live and "live" or "unit")
...
function issues_statistic_direct_setup(mockres)
