...
describe("RubygemDirect", function()
  it("should direct-load-rubygem", function()
    local setup = rubygem_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rubygem", setup.live and "live" or "unit")
...
function rubygem_direct_setup(mockres)
