...
describe("ApiEntitiesNugetServiceIndexDirect", function()
  it("should direct-list-api_entities_nuget_service_index", function()
    local setup = api_entities_nuget_service_index_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_entities_nuget_service_index", setup.live and "live" or "unit")
