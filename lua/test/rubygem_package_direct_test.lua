...
describe("RubygemPackageDirect", function()
  it("should direct-load-rubygem_package", function()
    local setup = rubygem_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rubygem_package", setup.live and "live" or "unit")
...
function rubygem_package_direct_setup(mockres)
