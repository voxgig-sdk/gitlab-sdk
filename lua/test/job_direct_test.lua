...
describe("JobDirect", function()
  it("should direct-load-job", function()
    local setup = job_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-job", setup.live and "live" or "unit")
...
function job_direct_setup(mockres)
