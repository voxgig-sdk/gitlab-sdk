...
describe("MlModelRegistryDirect", function()
  it("should direct-load-ml_model_registry", function()
    local setup = ml_model_registry_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ml_model_registry", setup.live and "live" or "unit")
...
function ml_model_registry_direct_setup(mockres)
