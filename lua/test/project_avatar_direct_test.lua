...
describe("ProjectAvatarDirect", function()
  it("should direct-load-project_avatar", function()
    local setup = project_avatar_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-project_avatar", setup.live and "live" or "unit")
...
function project_avatar_direct_setup(mockres)
