...
describe("GroupExportDirect", function()
  it("should direct-load-group_export", function()
    local setup = group_export_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-group_export", setup.live and "live" or "unit")
...
function group_export_direct_setup(mockres)
