...
describe("UnleashApiDirect", function()
  it("should direct-load-unleash_api", function()
    local setup = unleash_api_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-unleash_api", setup.live and "live" or "unit")
...
function unleash_api_direct_setup(mockres)
