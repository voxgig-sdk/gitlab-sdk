...
describe("ComposerPackageDirect", function()
  it("should direct-load-composer_package", function()
    local setup = composer_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-composer_package", setup.live and "live" or "unit")
...
function composer_package_direct_setup(mockres)
