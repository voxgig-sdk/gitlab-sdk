-- ApiEntitiesTreeObject direct test
...
describe("ApiEntitiesTreeObjectDirect", function()
  it("should direct-load-api_entities_tree_object", function()
    local setup = api_entities_tree_object_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_tree_object", setup.live and "live" or "unit")
...
function api_entities_tree_object_direct_setup(mockres)
