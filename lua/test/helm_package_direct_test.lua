...
describe("HelmPackageDirect", function()
  it("should direct-load-helm_package", function()
    local setup = helm_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-helm_package", setup.live and "live" or "unit")
...
function helm_package_direct_setup(mockres)
