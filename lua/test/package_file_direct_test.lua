...
describe("PackageFileDirect", function()
  it("should direct-load-package_file", function()
    local setup = package_file_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-package_file", setup.live and "live" or "unit")
...
function package_file_direct_setup(mockres)
