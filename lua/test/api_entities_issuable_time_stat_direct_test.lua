-- ApiEntitiesIssuableTimeStat direct test
...
describe("ApiEntitiesIssuableTimeStatDirect", function()
  it("should direct-load-api_entities_issuable_time_stat", function()
    local setup = api_entities_issuable_time_stat_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_issuable_time_stat", setup.live and "live" or "unit")
...
function api_entities_issuable_time_stat_direct_setup(mockres)
