...
describe("TestReportSummaryDirect", function()
  it("should direct-load-test_report_summary", function()
    local setup = test_report_summary_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-test_report_summary", setup.live and "live" or "unit")
...
function test_report_summary_direct_setup(mockres)
