-- ApiEntitiesDictionaryTable direct test
...
describe("ApiEntitiesDictionaryTableDirect", function()
  it("should direct-load-api_entities_dictionary_table", function()
    local setup = api_entities_dictionary_table_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_dictionary_table", setup.live and "live" or "unit")
...
function api_entities_dictionary_table_direct_setup(mockres)
