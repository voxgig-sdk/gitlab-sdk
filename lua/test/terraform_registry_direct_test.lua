...
describe("TerraformRegistryDirect", function()
  it("should direct-load-terraform_registry", function()
    local setup = terraform_registry_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-terraform_registry", setup.live and "live" or "unit")
...
function terraform_registry_direct_setup(mockres)
