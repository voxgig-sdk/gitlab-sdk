-- ApiEntitiesBulkImportsExportStatus direct test
...
describe("ApiEntitiesBulkImportsExportStatusDirect", function()
  it("should direct-list-api_entities_bulk_imports_export_status", function()
    local setup = api_entities_bulk_imports_export_status_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_entities_bulk_imports_export_status", setup.live and "live" or "unit")
...
function api_entities_bulk_imports_export_status_direct_setup(mockres)
