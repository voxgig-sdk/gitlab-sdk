...
describe("NpmPackageDirect", function()
  it("should direct-load-npm_package", function()
    local setup = npm_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-npm_package", setup.live and "live" or "unit")
...
function npm_package_direct_setup(mockres)
