-- ApiEntitiesAppearance direct test
...
describe("ApiEntitiesAppearanceDirect", function()
  it("should direct-load-api_entities_appearance", function()
    local setup = api_entities_appearance_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_appearance", setup.live and "live" or "unit")
...
function api_entities_appearance_direct_setup(mockres)
