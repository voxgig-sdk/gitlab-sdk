-- ApiEntitiesNpmPackageTag direct test
...
describe("ApiEntitiesNpmPackageTagDirect", function()
  it("should direct-load-api_entities_npm_package_tag", function()
    local setup = api_entities_npm_package_tag_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_npm_package_tag", setup.live and "live" or "unit")
...
function api_entities_npm_package_tag_direct_setup(mockres)
