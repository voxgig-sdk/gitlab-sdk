-- ApiEntitiesIssueLink direct test
...
describe("ApiEntitiesIssueLinkDirect", function()
  it("should direct-load-api_entities_issue_link", function()
    local setup = api_entities_issue_link_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_issue_link", setup.live and "live" or "unit")
...
function api_entities_issue_link_direct_setup(mockres)
