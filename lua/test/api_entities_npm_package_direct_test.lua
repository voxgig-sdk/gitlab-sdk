-- ApiEntitiesNpmPackage direct test
...
describe("ApiEntitiesNpmPackageDirect", function()
  it("should direct-load-api_entities_npm_package", function()
    local setup = api_entities_npm_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_npm_package", setup.live and "live" or "unit")
...
function api_entities_npm_package_direct_setup(mockres)
