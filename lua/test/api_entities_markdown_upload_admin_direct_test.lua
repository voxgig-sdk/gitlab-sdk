-- ApiEntitiesMarkdownUploadAdmin direct test
...
describe("ApiEntitiesMarkdownUploadAdminDirect", function()
  it("should direct-list-api_entities_markdown_upload_admin", function()
    local setup = api_entities_markdown_upload_admin_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_entities_markdown_upload_admin", setup.live and "live" or "unit")
...
function api_entities_markdown_upload_admin_direct_setup(mockres)
