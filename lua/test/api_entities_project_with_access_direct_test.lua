-- ApiEntitiesProjectWithAccess direct test
...
describe("ApiEntitiesProjectWithAccessDirect", function()
  it("should direct-load-api_entities_project_with_access", function()
    local setup = api_entities_project_with_access_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_project_with_access", setup.live and "live" or "unit")
...
function api_entities_project_with_access_direct_setup(mockres)
