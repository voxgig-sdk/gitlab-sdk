...
describe("SecureFileDirect", function()
  it("should direct-load-secure_file", function()
    local setup = secure_file_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-secure_file", setup.live and "live" or "unit")
...
function secure_file_direct_setup(mockres)
