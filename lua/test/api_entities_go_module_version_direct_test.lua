-- ApiEntitiesGoModuleVersion direct test
...
describe("ApiEntitiesGoModuleVersionDirect", function()
  it("should direct-load-api_entities_go_module_version", function()
    local setup = api_entities_go_module_version_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_go_module_version", setup.live and "live" or "unit")
...
function api_entities_go_module_version_direct_setup(mockres)
