...
describe("PageEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GITLAB_TEST_PAGE_ENTID JSON to run live")
      return
    end
...
function page_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GITLAB_TEST_PAGE_ENTID")
