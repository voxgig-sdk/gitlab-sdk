-- ApiEntitiesSshKeyWithUser direct test
...
describe("ApiEntitiesSshKeyWithUserDirect", function()
  it("should direct-load-api_entities_ssh_key_with_user", function()
    local setup = api_entities_ssh_key_with_user_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_ssh_key_with_user", setup.live and "live" or "unit")
...
function api_entities_ssh_key_with_user_direct_setup(mockres)
