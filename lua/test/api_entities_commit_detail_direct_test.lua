-- ApiEntitiesCommitDetail direct test
...
describe("ApiEntitiesCommitDetailDirect", function()
  it("should direct-load-api_entities_commit_detail", function()
    local setup = api_entities_commit_detail_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_commit_detail", setup.live and "live" or "unit")
...
function api_entities_commit_detail_direct_setup(mockres)
