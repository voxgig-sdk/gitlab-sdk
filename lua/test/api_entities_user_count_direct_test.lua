-- ApiEntitiesUserCount direct test
...
describe("ApiEntitiesUserCountDirect", function()
  it("should direct-load-api_entities_user_count", function()
    local setup = api_entities_user_count_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_user_count", setup.live and "live" or "unit")
...
function api_entities_user_count_direct_setup(mockres)
