...
describe("ProjectExportDirect", function()
  it("should direct-load-project_export", function()
    local setup = project_export_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-project_export", setup.live and "live" or "unit")
...
function project_export_direct_setup(mockres)
