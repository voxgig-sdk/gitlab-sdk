-- ApiEntitiesTagSignature direct test
...
describe("ApiEntitiesTagSignatureDirect", function()
  it("should direct-load-api_entities_tag_signature", function()
    local setup = api_entities_tag_signature_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_tag_signature", setup.live and "live" or "unit")
...
function api_entities_tag_signature_direct_setup(mockres)
