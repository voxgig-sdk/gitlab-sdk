...
describe("EeApiEntitiesMergeRequestApprovalStateDirect", function()
  it("should direct-list-ee_api_entities_merge_request_approval_state", function()
    local setup = ee_api_entities_merge_request_approval_state_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ee_api_entities_merge_request_approval_state", setup.live and "live" or "unit")
