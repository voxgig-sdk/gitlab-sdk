-- ApiEntitiesProjectsTopic direct test
...
describe("ApiEntitiesProjectsTopicDirect", function()
  it("should direct-load-api_entities_projects_topic", function()
    local setup = api_entities_projects_topic_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_projects_topic", setup.live and "live" or "unit")
...
function api_entities_projects_topic_direct_setup(mockres)
