-- ApiEntitiesWikiPage direct test
...
describe("ApiEntitiesWikiPageDirect", function()
  it("should direct-load-api_entities_wiki_page", function()
    local setup = api_entities_wiki_page_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_wiki_page", setup.live and "live" or "unit")
...
function api_entities_wiki_page_direct_setup(mockres)
