...
describe("TerraformStateDirect", function()
  it("should direct-load-terraform_state", function()
    local setup = terraform_state_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-terraform_state", setup.live and "live" or "unit")
...
function terraform_state_direct_setup(mockres)
