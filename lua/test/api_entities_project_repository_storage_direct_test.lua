-- ApiEntitiesProjectRepositoryStorage direct test
...
describe("ApiEntitiesProjectRepositoryStorageDirect", function()
  it("should direct-load-api_entities_project_repository_storage", function()
    local setup = api_entities_project_repository_storage_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_project_repository_storage", setup.live and "live" or "unit")
...
function api_entities_project_repository_storage_direct_setup(mockres)
