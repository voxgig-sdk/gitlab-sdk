...
describe("UsageDataDirect", function()
  it("should direct-load-usage_data", function()
    local setup = usage_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-usage_data", setup.live and "live" or "unit")
...
function usage_data_direct_setup(mockres)
