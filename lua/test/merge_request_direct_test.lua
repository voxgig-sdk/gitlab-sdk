...
describe("MergeRequestDirect", function()
  it("should direct-load-merge_request", function()
    local setup = merge_request_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-merge_request", setup.live and "live" or "unit")
...
function merge_request_direct_setup(mockres)
