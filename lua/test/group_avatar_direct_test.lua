...
describe("GroupAvatarDirect", function()
  it("should direct-load-group_avatar", function()
    local setup = group_avatar_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-group_avatar", setup.live and "live" or "unit")
...
function group_avatar_direct_setup(mockres)
