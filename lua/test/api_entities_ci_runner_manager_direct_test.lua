-- ApiEntitiesCiRunnerManager direct test
...
describe("ApiEntitiesCiRunnerManagerDirect", function()
  it("should direct-load-api_entities_ci_runner_manager", function()
    local setup = api_entities_ci_runner_manager_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_ci_runner_manager", setup.live and "live" or "unit")
...
function api_entities_ci_runner_manager_direct_setup(mockres)
