-- ApiEntitiesCiSecureFile direct test
...
describe("ApiEntitiesCiSecureFileDirect", function()
  it("should direct-load-api_entities_ci_secure_file", function()
    local setup = api_entities_ci_secure_file_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_ci_secure_file", setup.live and "live" or "unit")
...
function api_entities_ci_secure_file_direct_setup(mockres)
