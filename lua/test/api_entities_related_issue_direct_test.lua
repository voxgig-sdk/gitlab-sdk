-- ApiEntitiesRelatedIssue direct test
...
describe("ApiEntitiesRelatedIssueDirect", function()
  it("should direct-list-api_entities_related_issue", function()
    local setup = api_entities_related_issue_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_entities_related_issue", setup.live and "live" or "unit")
...
function api_entities_related_issue_direct_setup(mockres)
