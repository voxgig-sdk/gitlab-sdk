-- ApiEntitiesErrorTrackingProjectSetting direct test
...
describe("ApiEntitiesErrorTrackingProjectSettingDirect", function()
  it("should direct-load-api_entities_error_tracking_project_setting", function()
    local setup = api_entities_error_tracking_project_setting_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_error_tracking_project_setting", setup.live and "live" or "unit")
...
function api_entities_error_tracking_project_setting_direct_setup(mockres)
