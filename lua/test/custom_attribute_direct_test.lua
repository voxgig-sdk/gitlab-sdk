...
describe("CustomAttributeDirect", function()
  it("should direct-load-custom_attribute", function()
    local setup = custom_attribute_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-custom_attribute", setup.live and "live" or "unit")
...
function custom_attribute_direct_setup(mockres)
