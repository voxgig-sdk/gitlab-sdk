...
describe("TestReportDirect", function()
  it("should direct-list-test_report", function()
    local setup = test_report_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-test_report", setup.live and "live" or "unit")
...
function test_report_direct_setup(mockres)
