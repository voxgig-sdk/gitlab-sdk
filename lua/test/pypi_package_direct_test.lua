...
describe("PypiPackageDirect", function()
  it("should direct-load-pypi_package", function()
    local setup = pypi_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-pypi_package", setup.live and "live" or "unit")
...
function pypi_package_direct_setup(mockres)
