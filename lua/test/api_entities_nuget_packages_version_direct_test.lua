-- ApiEntitiesNugetPackagesVersion direct test
...
describe("ApiEntitiesNugetPackagesVersionDirect", function()
  it("should direct-list-api_entities_nuget_packages_version", function()
    local setup = api_entities_nuget_packages_version_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_entities_nuget_packages_version", setup.live and "live" or "unit")
...
function api_entities_nuget_packages_version_direct_setup(mockres)
