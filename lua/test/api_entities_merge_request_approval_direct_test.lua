-- ApiEntitiesMergeRequestApproval direct test
...
describe("ApiEntitiesMergeRequestApprovalDirect", function()
  it("should direct-load-api_entities_merge_request_approval", function()
    local setup = api_entities_merge_request_approval_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_merge_request_approval", setup.live and "live" or "unit")
...
function api_entities_merge_request_approval_direct_setup(mockres)
