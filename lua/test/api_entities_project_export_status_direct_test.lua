-- ApiEntitiesProjectExportStatus direct test
...
describe("ApiEntitiesProjectExportStatusDirect", function()
  it("should direct-load-api_entities_project_export_status", function()
    local setup = api_entities_project_export_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_project_export_status", setup.live and "live" or "unit")
...
function api_entities_project_export_status_direct_setup(mockres)
