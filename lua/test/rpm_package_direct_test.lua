...
describe("RpmPackageDirect", function()
  it("should direct-load-rpm_package", function()
    local setup = rpm_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rpm_package", setup.live and "live" or "unit")
...
function rpm_package_direct_setup(mockres)
