-- ApiEntitiesProjectJobTokenScope direct test
...
describe("ApiEntitiesProjectJobTokenScopeDirect", function()
  it("should direct-load-api_entities_project_job_token_scope", function()
    local setup = api_entities_project_job_token_scope_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_project_job_token_scope", setup.live and "live" or "unit")
...
function api_entities_project_job_token_scope_direct_setup(mockres)
