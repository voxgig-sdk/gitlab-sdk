...
describe("GeoEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GITLAB_TEST_GEO_ENTID JSON to run live")
      return
    end
    ...
    local geo_ref01_data = helpers.to_map(vs.getprop(
...
function geo_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GITLAB_TEST_GEO_ENTID")
