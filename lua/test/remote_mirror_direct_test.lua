...
describe("RemoteMirrorDirect", function()
  it("should direct-load-remote_mirror", function()
    local setup = remote_mirror_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-remote_mirror", setup.live and "live" or "unit")
...
function remote_mirror_direct_setup(mockres)
