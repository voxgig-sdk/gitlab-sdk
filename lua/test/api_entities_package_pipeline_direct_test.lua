-- ApiEntitiesPackagePipeline direct test
...
describe("ApiEntitiesPackagePipelineDirect", function()
  it("should direct-load-api_entities_package_pipeline", function()
    local setup = api_entities_package_pipeline_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_package_pipeline", setup.live and "live" or "unit")
...
function api_entities_package_pipeline_direct_setup(mockres)
