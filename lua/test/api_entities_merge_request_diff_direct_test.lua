-- ApiEntitiesMergeRequestDiff direct test
...
describe("ApiEntitiesMergeRequestDiffDirect", function()
  it("should direct-list-api_entities_merge_request_diff", function()
    local setup = api_entities_merge_request_diff_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_entities_merge_request_diff", setup.live and "live" or "unit")
...
function api_entities_merge_request_diff_direct_setup(mockres)
