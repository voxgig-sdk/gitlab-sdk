-- ApiEntitiesPagesDomainBasic direct test
...
describe("ApiEntitiesPagesDomainBasicDirect", function()
  it("should direct-load-api_entities_pages_domain_basic", function()
    local setup = api_entities_pages_domain_basic_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_pages_domain_basic", setup.live and "live" or "unit")
...
function api_entities_pages_domain_basic_direct_setup(mockres)
