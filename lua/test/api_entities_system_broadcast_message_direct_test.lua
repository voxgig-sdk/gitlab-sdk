-- ApiEntitiesSystemBroadcastMessage direct test
...
describe("ApiEntitiesSystemBroadcastMessageDirect", function()
  it("should direct-load-api_entities_system_broadcast_message", function()
    local setup = api_entities_system_broadcast_message_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_system_broadcast_message", setup.live and "live" or "unit")
...
function api_entities_system_broadcast_message_direct_setup(mockres)
