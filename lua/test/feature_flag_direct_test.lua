...
describe("FeatureFlagDirect", function()
  it("should direct-load-feature_flag", function()
    local setup = feature_flag_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-feature_flag", setup.live and "live" or "unit")
...
function feature_flag_direct_setup(mockres)
