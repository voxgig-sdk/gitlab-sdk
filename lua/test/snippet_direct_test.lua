...
describe("SnippetDirect", function()
  it("should direct-load-snippet", function()
    local setup = snippet_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-snippet", setup.live and "live" or "unit")
