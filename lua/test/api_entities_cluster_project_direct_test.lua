-- ApiEntitiesClusterProject direct test
...
describe("ApiEntitiesClusterProjectDirect", function()
  it("should direct-load-api_entities_cluster_project", function()
    local setup = api_entities_cluster_project_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_cluster_project", setup.live and "live" or "unit")
...
function api_entities_cluster_project_direct_setup(mockres)
