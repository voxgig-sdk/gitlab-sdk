...
describe("GenericPackageDirect", function()
  it("should direct-load-generic_package", function()
    local setup = generic_package_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-generic_package", setup.live and "live" or "unit")
...
function generic_package_direct_setup(mockres)
