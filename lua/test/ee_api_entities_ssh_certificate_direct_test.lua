-- EeApiEntitiesSshCertificate direct test
...
describe("EeApiEntitiesSshCertificateDirect", function()
  it("should direct-list-ee_api_entities_ssh_certificate", function()
    local setup = ee_api_entities_ssh_certificate_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ee_api_entities_ssh_certificate", setup.live and "live" or "unit")
...
function ee_api_entities_ssh_certificate_direct_setup(mockres)
