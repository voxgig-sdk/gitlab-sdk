-- ApiEntitiesDiscoveredCluster direct test
...
describe("ApiEntitiesDiscoveredClusterDirect", function()
  it("should direct-load-api_entities_discovered_cluster", function()
    local setup = api_entities_discovered_cluster_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_discovered_cluster", setup.live and "live" or "unit")
...
function api_entities_discovered_cluster_direct_setup(mockres)
