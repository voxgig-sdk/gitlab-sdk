-- ApiEntitiesApplicationStatistic direct test
...
describe("ApiEntitiesApplicationStatisticDirect", function()
  it("should direct-load-api_entities_application_statistic", function()
    local setup = api_entities_application_statistic_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_application_statistic", setup.live and "live" or "unit")
...
function api_entities_application_statistic_direct_setup(mockres)
