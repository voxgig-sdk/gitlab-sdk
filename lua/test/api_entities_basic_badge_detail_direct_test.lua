-- ApiEntitiesBasicBadgeDetail direct test
...
describe("ApiEntitiesBasicBadgeDetailDirect", function()
  it("should direct-load-api_entities_basic_badge_detail", function()
    local setup = api_entities_basic_badge_detail_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_basic_badge_detail", setup.live and "live" or "unit")
...
function api_entities_basic_badge_detail_direct_setup(mockres)
