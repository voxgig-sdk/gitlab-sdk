-- ApiEntitiesTemplatesList direct test
...
describe("ApiEntitiesTemplatesListDirect", function()
  it("should direct-load-api_entities_templates_list", function()
    local setup = api_entities_templates_list_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_entities_templates_list", setup.live and "live" or "unit")
...
function api_entities_templates_list_direct_setup(mockres)
