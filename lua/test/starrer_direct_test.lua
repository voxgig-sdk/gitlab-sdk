...
describe("StarrerDirect", function()
  it("should direct-list-starrer", function()
    local setup = starrer_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-starrer", setup.live and "live" or "unit")
...
function starrer_direct_setup(mockres)
