-- ApiEntitiesPersonalAccessToken direct test
...
describe("ApiEntitiesPersonalAccessTokenDirect", function()
  it("should direct-list-api_entities_personal_access_token", function()
    local setup = api_entities_personal_access_token_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_entities_personal_access_token", setup.live and "live" or "unit")
...
function api_entities_personal_access_token_direct_setup(mockres)
