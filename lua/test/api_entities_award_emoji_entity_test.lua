...
describe("ApiEntitiesAwardEmojiEntity", function()
  ...
  it("should run basic flow", function()
    ...
    assert.is_nil(err)
    api_entities_award_emoji_ref01_data = helpers.to_map(type(api_entities_award_emoji_ref01_data_result) == 'table' and api_entities_award_emoji_ref01_data_result.data_get and api_entities_award_emoji_ref01_data_result:data_get() or api_entities_award_emoji_ref01_data_result)
    ...
    assert.is_nil(err)
    local api_entities_award_emoji_ref01_data_dt0_load_result = helpers.to_map(type(api_entities_award_emoji_ref01_data_dt0_loaded) == 'table' and api_entities_award_emoji_ref01_data_dt0_loaded.data_get and api_entities_award_emoji_ref01_data_dt0_loaded:data_get() or api_entities_award_emoji_ref01_data_dt0_loaded)
