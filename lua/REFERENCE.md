...
| `root_storage_statistics` | `table` | No |  |
...
| `ci_id_token_sub_claim_components` | `table` | No |  |
...
| `id` | `number` | No |  |
| `inherited` | `boolean` | No |  |
| `merge_access_levels` | `table` | No |  |
| `name` | `string` | No |  |
| `push_access_levels` | `table` | No |  |
| `unprotect_access_levels` | `table` | No |  |
