...
Full documentation for this SDK: [https://voxgig-sdk.github.io/gitlab-sdk/](https://voxgig-sdk.github.io/gitlab-sdk/)
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/gitlab` | publish pending — [install from git tag](https://github.com/voxgig-sdk/gitlab-sdk/tags) |
| Python | `voxgig-sdk-gitlab` | publish pending — [install from git tag](https://github.com/voxgig-sdk/gitlab-sdk/tags) |
| PHP | `voxgig-sdk/gitlab` | publish pending — [install from git tag](https://github.com/voxgig-sdk/gitlab-sdk/tags) |
| Golang | `github.com/voxgig-sdk/gitlab-sdk/go` | `go get github.com/voxgig-sdk/gitlab-sdk/go@latest` |
| Ruby | `voxgig-sdk-gitlab` | publish pending — [install from git tag](https://github.com/voxgig-sdk/gitlab-sdk/tags) |
| Lua | `voxgig-sdk-gitlab` | publish pending — [install from git tag](https://github.com/voxgig-sdk/gitlab-sdk/tags) |
...
| **ApiEntitiesLicense** | The ApiEntitiesLicense entity (load). | `/api/v4/projects/{id}/templates/{type}/{name}` |
...
fmt.Println(apiEntitiesBasicBadgeDetail)
```
