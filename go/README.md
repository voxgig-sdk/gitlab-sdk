...
```go
apiEntitiesAvatar, err := client.ApiEntitiesAvatar(nil).Load(map[string]any{"email": "email"}, nil)
if err != nil {
    panic(err)
}
...
| `updated_at` | `string` |  |
| `url` | `string` |  |
| `user` | `map[string]any` | API_Entities_UserBasic model |
| `username` | `string` |  |
| `web_url` | `string` |  |
...
```go
apiEntitiesBasicBadgeDetail, err := client.ApiEntitiesBasicBadgeDetail(nil).Load(map[string]any{"image_url": "image_url", "link_url": "link_url"}, nil)
if err != nil {
    panic(err)
}
...
| `can_push` | `bool` |  |
| `commit` | `map[string]any` | API_Entities_Commit model |
...
```go
apiEntitiesChangelog, err := client.ApiEntitiesChangelog(nil).Load(map[string]any{"project_id": "project_id", "version": "version"}, nil)
if err != nil {
    panic(err)
}
...
| `coverage` | `float64` |  |
| `created_at` | `string` |  |
| `downstream_pipeline` | `map[string]any` | API_Entities_Ci_PipelineBasic model |
| `duration` | `float64` | Time spent running |
| `erased_at` | `string` |  |
| `failure_reason` | `string` |  |
| `finished_at` | `string` |  |
| `id` | `int` |  |
| `name` | `string` |  |
| `pipeline` | `map[string]any` | API_Entities_Ci_PipelineBasic model |
| `project` | `map[string]any` |  |
| `queued_duration` | `float64` | Time spent enqueued |
| `ref` | `string` |  |
| `stage` | `string` |  |
| `started_at` | `string` |  |
| `status` | `string` |  |
...
| `queued_duration` | `float64` | Time spent enqueued |
| `ref` | `string` |  |
| `runner` | `map[string]any` | API_Entities_Ci_Runner model |
| `runner_manager` | `map[string]any` | API_Entities_Ci_RunnerManager model |
| `size` | `int` |  |
| `stage` | `string` |  |
| `started_at` | `string` |  |
| `status` | `string` |  |
...
| `id` | `int` |  |
| `inputs` | `map[string]any` |  |
| `last_pipeline` | `map[string]any` | API_Entities_Ci_PipelineBasic model |
| `next_run_at` | `string` |  |
| `owner` | `map[string]any` | API_Entities_UserBasic model |
| `ref` | `string` |  |
| `updated_at` | `string` |  |
| `variables` | `map[string]any` | API_Entities_Ci_Variable model |
...
| `contacted_at` | `string` |  |
| `created_at` | `string` |  |
| `created_by` | `map[string]any` | API_Entities_UserBasic model |
| `description` | `string` |  |
| `groups` | `map[string]any` | API_Entities_BasicGroupDetails model |
| `id` | `int` |  |
| `ip_address` | `string` |  |
| `is_shared` | `bool` |  |
...
| `paused` | `bool` |  |
| `platform` | `string` |  |
| `projects` | `map[string]any` | API_Entities_BasicProjectDetails model |
| `revision` | `string` |  |
| `run_untagged` | `string` |  |
| `runner_type` | `string` |  |
| `status` | `string` |  |
...
```go
apiEntitiesCiVariable, err := client.ApiEntitiesCiVariable(nil).Load(map[string]any{"id": "api_entities_ci_variable_id", "project_id": "project_id"}, nil)
if err != nil {
    panic(err)
}
...
| `enabled` | `bool` |  |
| `environment_scope` | `string` |  |
| `group` | `map[string]any` | API_Entities_BasicGroupDetails model |
| `id` | `string` |  |
| `managed` | `string` |  |
| `management_project` | `map[string]any` |  |
| `name` | `string` |  |
...
| `platform_kubernetes` | `map[string]any` |  |
| `platform_type` | `string` |  |
| `project` | `map[string]any` | API_Entities_BasicProjectDetails model |
| `provider_gcp` | `map[string]any` |  |
| `provider_type` | `string` |  |
| `user` | `map[string]any` | API_Entities_UserBasic model |
...
| Field | Type | Description |
| --- | --- | --- |
| `author` | `map[string]any` | API_Entities_UserBasic model |
| `avatar_path` | `string` |  |
| `avatar_url` | `string` |  |
| `created_at` | `string` |  |
| `custom_attributes` | `[]any` |  |
...
| `size` | `int` |  |
| `status` | `string` |  |
| `tags` | `map[string]any` | API_Entities_ContainerRegistry_Tag model |
| `tags_count` | `int` |  |
...
| --- | --- | --- |
| `created_at` | `string` |  |
| `deployable` | `map[string]any` | API_Entities_Ci_Job model |
| `environment` | `map[string]any` | API_Entities_EnvironmentBasic model |
| `id` | `int` |  |
| `iid` | `int` |  |
| `ref` | `string` |  |
| `sha` | `string` |  |
...
| `approvals` | `map[string]any` | API_Entities_Deployments_Approval model |
| `created_at` | `string` |  |
| `deployable` | `map[string]any` | API_Entities_Ci_Job model |
| `environment` | `map[string]any` | API_Entities_EnvironmentBasic model |
| `id` | `int` |  |
...
```go
apiEntitiesDiscoveredCluster, err := client.ApiEntitiesDiscoveredCluster(nil).Load(map[string]any{"group_id": "group_id"}, nil)
if err != nil {
    panic(err)
}
...
| `cluster_agent` | `map[string]any` | API_Entities_Clusters_Agent model |
| `created_at` | `string` |  |
| `description` | `string` |  |
| `external_url` | `string` |  |
...
| `last_deployment` | `map[string]any` | API_Entities_Deployment model |
| `name` | `string` |  |
| `project` | `map[string]any` | API_Entities_BasicProjectDetails model |
| `slug` | `string` |  |
| `state` | `string` |  |
...
| `target_title` | `string` |  |
| `target_type` | `string` |  |
| `wiki_page` | `map[string]any` | API_Entities_WikiPageBasic model |
...
| Field | Type | Description |
| --- | --- | --- |
| `definition` | `map[string]any` | API_Entities_Feature_Definition model |
...
```go
apiEntitiesGoModuleVersion, err := client.ApiEntitiesGoModuleVersion(nil).Load(map[string]any{"module_version": "module_version", "project_id": "project_id", "module_name": "module_name"}, nil)
if err != nil {
    panic(err)
}
...
| `project_creation_level` | `string` |  |
| `projects` | `map[string]any` | API_Entities_Project model |
| `repository_storage` | `string` |  |
| `request_access_enabled` | `string` |  |
| `require_two_factor_authentication` | `string` |  |
| `root_storage_statistics` | `map[string]any` |  |
...
| `share_with_group_lock` | `string` |  |
| `shared_projects` | `map[string]any` | API_Entities_Project model |
...
```go
apiEntitiesIntegration, err := client.ApiEntitiesIntegration(nil).Load(map[string]any{"id": "api_entities_integration_id", "group_id": "group_id"}, nil)
if err != nil {
    panic(err)
}
...
| Field | Type | Description |
| --- | --- | --- |
| `assignee` | `map[string]any` | API_Entities_UserBasic model |
| `assignees` | `map[string]any` | API_Entities_UserBasic model |
| `author` | `map[string]any` | API_Entities_UserBasic model |
| `blocking_issues_count` | `string` |  |
| `closed_at` | `string` |  |
| `closed_by` | `map[string]any` | API_Entities_UserBasic model |
| `confidential` | `bool` |  |
| `created_at` | `string` |  |
| `description` | `string` |  |
...
| `task_status` | `string` |  |
| `time_stats` | `map[string]any` | API_Entities_IssuableTimeStats model |
| `title` | `string` |  |
...
```go
apiEntitiesLicense, err := client.ApiEntitiesLicense(nil).Load(map[string]any{"id": "api_entities_license_id", "name": "name", "type": "type"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(apiEntitiesLicense) // the loaded record
```
...
```go
apiEntitiesMember, err := client.ApiEntitiesMember(nil).Load(map[string]any{"id": "api_entities_member_id", "group_id": "group_id"}, nil)
if err != nil {
    panic(err)
}
...
| `has_conflicts` | `bool` |  |
| `head_pipeline` | `map[string]any` | API_Entities_Ci_Pipeline model |
| `id` | `int` |  |
| `iid` | `int` |  |
| `imported` | `string` |  |
| `imported_from` | `string` |  |
...
| `merge_error` | `string` |  |
| `merge_status` | `string` |  |
| `merge_user` | `map[string]any` | API_Entities_UserBasic model |
| `merge_when_pipeline_succeeds` | `string` |  |
| `merged_at` | `string` |  |
| `merged_by` | `map[string]any` | API_Entities_UserBasic model |
| `milestone` | `map[string]any` |  |
| `pipeline` | `map[string]any` | API_Entities_Ci_PipelineBasic model |
| `prepared_at` | `string` |  |
| `project_id` | `int` |  |
...
| `reference` | `string` |  |
| `references` | `map[string]any` |  |
| `reviewers` | `map[string]any` | API_Entities_UserBasic model |
| `sha` | `string` |  |
...
| `author` | `map[string]any` | API_Entities_UserBasic model |
| `blocking_discussions_resolved` | `string` |  |
| `changes` | `map[string]any` | API_Entities_Diff model |
| `changes_count` | `string` |  |
| `closed_at` | `string` |  |
| `closed_by` | `map[string]any` | API_Entities_UserBasic model |
| `created_at` | `string` |  |
...
| --- | --- | --- |
| `base_commit_sha` | `string` |  |
| `commits` | `map[string]any` | API_Entities_Commit model |
| `created_at` | `string` |  |
| `diffs` | `map[string]any` | API_Entities_Diff model |
| `head_commit_sha` | `string` |  |
| `id` | `string` |  |
| `merge_request_id` | `string` |  |
| `patch_id_sha` | `string` |  |
...
```go
apiEntitiesNamespacesStorageLimitExclusion, err := client.ApiEntitiesNamespacesStorageLimitExclusion(nil).Load(nil, nil)
if err != nil {
    panic(err)
}
...
```go
apiEntitiesNpmPackage, err := client.ApiEntitiesNpmPackage(nil).Load(map[string]any{"package_name": "package_name"}, nil)
if err != nil {
    panic(err)
}
...
```go
apiEntitiesNpmPackageTag, err := client.ApiEntitiesNpmPackageTag(nil).Load(map[string]any{"package_name": "package_name"}, nil)
if err != nil {
    panic(err)
}
...
| `name` | `string` |  |
| `package_type` | `string` |  |
| `pipeline` | `map[string]any` | API_Entities_Package_Pipeline model |
| `pipelines` | `map[string]any` | API_Entities_Package_Pipeline model |
| `project_id` | `int` |  |
| `project_path` | `string` |  |
| `status` | `string` |  |
| `tags` | `string` |  |
...
```go
apiEntitiesUserAgentDetail, err := client.ApiEntitiesUserAgentDetail(nil).Load(map[string]any{"snippet_id": "snippet_id"}, nil)
if err != nil {
    panic(err)
}
...
```go
composerPackage, err := client.ComposerPackage(nil).Load(map[string]any{"group_id": "group_id", "sha": "sha"}, nil)
if err != nil {
    panic(err)
}
...
```go
conanPackage, err := client.ConanPackage(nil).Load(map[string]any{"file_id": "file_id", "file_name": "file_name", "package_channel": "package_channel", "package_username": "package_username", "package_version": "package_version", "recipe_revision": "recipe_revision"}, nil)
if err != nil {
    panic(err)
}
...
```go
customAttribute, err := client.CustomAttribute(nil).Load(map[string]any{"id": "custom_attribute_id", "group_id": "group_id"}, nil)
if err != nil {
    panic(err)
}
...
```go
debianPackage, err := client.DebianPackage(nil).Load(map[string]any{"id": "debian_package_id", "distribution": "distribution"}, nil)
if err != nil {
    panic(err)
}
...
```go
genericPackage, err := client.GenericPackage(nil).Load(map[string]any{"file_name": "file_name", "generic_id": "generic_id", "project_id": "project_id", "package_version": "package_version"}, nil)
if err != nil {
    panic(err)
}
...
```go
goProxy, err := client.GoProxy(nil).Load(map[string]any{"project_id": "project_id", "module_name": "module_name"}, nil)
if err != nil {
    panic(err)
}
...
```go
mavenPackage, err := client.MavenPackage(nil).Load(map[string]any{"file_name": "file_name", "path": "path"}, nil)
if err != nil {
    panic(err)
}
...
```go
npmPackage, err := client.NpmPackage(nil).Load(map[string]any{"project_id": "project_id", "file_name": "file_name", "package_name": "package_name"}, nil)
if err != nil {
    panic(err)
}
...
```go
nugetPackage, err := client.NugetPackage(nil).Load(map[string]any{"project_id": "project_id"}, nil)
if err != nil {
    panic(err)
}
...
```go
pypiPackage, err := client.PypiPackage(nil).Load(map[string]any{"project_id": "project_id"}, nil)
if err != nil {
    panic(err)
}
...
```go
release, err := client.Release(nil).Load(map[string]any{"project_id": "project_id", "suffix_path": "suffix_path"}, nil)
if err != nil {
    panic(err)
}
...
```go
rpmPackage, err := client.RpmPackage(nil).Load(map[string]any{"project_id": "project_id", "file_name": "file_name"}, nil)
if err != nil {
    panic(err)
}
...
```go
search, err := client.Search(nil).Load(map[string]any{"scope": "scope", "search": "search"}, nil)
if err != nil {
    panic(err)
}
