...
func TestApiEntitiesProjectImportStatusEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesProjectImportStatusRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "api_entities_project_import_status"}), "api_entities_project_import_status_ref01"))
		...
		apiEntitiesProjectImportStatusRef01Data = core.ToMapAny(entityData(apiEntitiesProjectImportStatusRef01DataResult))
