...
func TestApiEntitiesPersonalSnippetEntity(t *testing.T) {
	...
	t.Run("stream", func(t *testing.T) {
		seed := map[string]any{
			"entity": map[string]any{
				"api_entities_personal_snippet": map[string]any{
		...
		var seen []any
		for item := range base.ApiEntitiesPersonalSnippet(nil).Stream("list", nil, nil) {
		...
		if hasStreaming {
			...
			var got []any
			for item := range streamSdk.ApiEntitiesPersonalSnippet(nil).Stream("list", nil, nil) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesPersonalSnippetRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "api_entities_personal_snippet"}), "api_entities_personal_snippet_ref01"))
		...
		apiEntitiesPersonalSnippetRef01Data = core.ToMapAny(entityData(apiEntitiesPersonalSnippetRef01DataResult))
		...
		apiEntitiesPersonalSnippetRef01ResdataUp0 := core.ToMapAny(entityData(apiEntitiesPersonalSnippetRef01ResdataUp0Result))
		...
		apiEntitiesPersonalSnippetRef01DataDt0LoadResult := core.ToMapAny(entityData(apiEntitiesPersonalSnippetRef01DataDt0Loaded))
