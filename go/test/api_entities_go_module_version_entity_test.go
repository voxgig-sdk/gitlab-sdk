...
func TestApiEntitiesGoModuleVersionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesGoModuleVersionRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.api_entities_go_module_version")))
...
func api_entities_go_module_versionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap, _ := vs.Transform(
		[]any{"api_entities_go_module_version01", "api_entities_go_module_version02", "api_entities_go_module_version03", "project01", "project02", "project03", "module_version01"},
		map[string]any{
