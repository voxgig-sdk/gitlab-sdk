...
func TestApiEntitiesPackagePipelineEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesPackagePipelineRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.api_entities_package_pipeline")))
		...
		apiEntitiesPackagePipelineRef01DataDt0LoadResult := core.ToMapAny(entityData(apiEntitiesPackagePipelineRef01DataDt0Loaded))
