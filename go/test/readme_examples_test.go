...
const testSeed = `map[string]any{"entity": map[string]any{"api_entities_project_with_access": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
