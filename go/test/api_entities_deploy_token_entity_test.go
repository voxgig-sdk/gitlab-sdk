...
func TestApiEntitiesDeployTokenEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesDeployTokenRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.api_entities_deploy_token")))
		...
		apiEntitiesDeployTokenRef01DataDt0LoadResult := core.ToMapAny(entityData(apiEntitiesDeployTokenRef01DataDt0Loaded))
