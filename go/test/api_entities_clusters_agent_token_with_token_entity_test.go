...
func TestApiEntitiesClustersAgentTokenWithTokenEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesClustersAgentTokenWithTokenRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "api_entities_clusters_agent_token_with_token"}), "api_entities_clusters_agent_token_with_token_ref01"))
		...
		apiEntitiesClustersAgentTokenWithTokenRef01Data = core.ToMapAny(entityData(apiEntitiesClustersAgentTokenWithTokenRef01DataResult))
