...
func TestApplicationEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set GITLAB_TEST_APPLICATION_ENTID JSON to run live")
			return
		}
...
func applicationBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GITLAB_TEST_APPLICATION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GITLAB_TEST_APPLICATION_ENTID"])
