...
func TestApiEntitiesCiVariableEntity(t *testing.T) {
	...
	t.Run("stream", func(t *testing.T) {
		seed := map[string]any{
			"entity": map[string]any{
				"api_entities_ci_variable": map[string]any{
		...
		var seen []any
		for item := range base.ApiEntitiesCiVariable(nil).Stream("list", nil, nil) {
		...
		if hasStreaming {
			...
			var got []any
			for item := range streamSdk.ApiEntitiesCiVariable(nil).Stream("list", nil, nil) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesCiVariableRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "api_entities_ci_variable"}), "api_entities_ci_variable_ref01"))
		...
		apiEntitiesCiVariableRef01Data = core.ToMapAny(entityData(apiEntitiesCiVariableRef01DataResult))
		if apiEntitiesCiVariableRef01Data == nil {
			t.Fatal("expected create result to be a map")
		}
		if apiEntitiesCiVariableRef01Data["id"] == nil {
		...
		apiEntitiesCiVariableRef01DataUp0Up := map[string]any{
			"id": apiEntitiesCiVariableRef01Data["id"],
		}
		...
		apiEntitiesCiVariableRef01ResdataUp0 := core.ToMapAny(entityData(apiEntitiesCiVariableRef01ResdataUp0Result))
		if apiEntitiesCiVariableRef01ResdataUp0 == nil {
			t.Fatal("expected update result to be a map")
		}
		if apiEntitiesCiVariableRef01ResdataUp0["id"] != apiEntitiesCiVariableRef01DataUp0Up["id"] {
		...
		apiEntitiesCiVariableRef01DataDt0LoadResult := core.ToMapAny(entityData(apiEntitiesCiVariableRef01DataDt0Loaded))
		if apiEntitiesCiVariableRef01DataDt0LoadResult == nil {
			t.Fatal("expected load result to be a map")
		}
		if apiEntitiesCiVariableRef01DataDt0LoadResult["id"] != apiEntitiesCiVariableRef01Data["id"] {
