...
func TestFeatureEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		featureRef01MatchRm0 := map[string]any{
			"id": featureRef01Data["id"],
		}
		_, err := featureRef01Ent.Remove(featureRef01MatchRm0, nil)
		if err != nil {
...
func featureBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GITLAB_TEST_FEATURE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GITLAB_TEST_FEATURE_ENTID"])
