...
func TestApiEntitiesReleasesLinkEntity(t *testing.T) {
	...
	t.Run("stream", func(t *testing.T) {
		seed := map[string]any{
			"entity": map[string]any{
				"api_entities_releases_link": map[string]any{
		...
		var seen []any
		for item := range base.ApiEntitiesReleasesLink(nil).Stream("list", nil, nil) {
		...
		if hasStreaming {
			...
			var got []any
			for item := range streamSdk.ApiEntitiesReleasesLink(nil).Stream("list", nil, nil) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesReleasesLinkRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "api_entities_releases_link"}), "api_entities_releases_link_ref01"))
		...
		apiEntitiesReleasesLinkRef01Data = core.ToMapAny(entityData(apiEntitiesReleasesLinkRef01DataResult))
		...
		apiEntitiesReleasesLinkRef01ResdataUp0 := core.ToMapAny(entityData(apiEntitiesReleasesLinkRef01ResdataUp0Result))
		...
		apiEntitiesReleasesLinkRef01DataDt0LoadResult := core.ToMapAny(entityData(apiEntitiesReleasesLinkRef01DataDt0Loaded))
