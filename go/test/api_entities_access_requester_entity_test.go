...
func TestApiEntitiesAccessRequesterEntity(t *testing.T) {
	...
	t.Run("stream", func(t *testing.T) {
		seed := map[string]any{
			"entity": map[string]any{
				"api_entities_access_requester": map[string]any{
		...
		var seen []any
		for item := range base.ApiEntitiesAccessRequester(nil).Stream("list", nil, nil) {
		...
		if hasStreaming {
			...
			var got []any
			for item := range streamSdk.ApiEntitiesAccessRequester(nil).Stream("list", nil, nil) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesAccessRequesterRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "api_entities_access_requester"}), "api_entities_access_requester_ref01"))
		...
		apiEntitiesAccessRequesterRef01Data = core.ToMapAny(entityData(apiEntitiesAccessRequesterRef01DataResult))
		...
		apiEntitiesAccessRequesterRef01ResdataUp0 := core.ToMapAny(entityData(apiEntitiesAccessRequesterRef01ResdataUp0Result))
