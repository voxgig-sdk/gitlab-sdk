...
func TestApiEntitiesProjectEntity(t *testing.T) {
	...
	t.Run("stream", func(t *testing.T) {
		seed := map[string]any{
			"entity": map[string]any{
				"api_entities_project": map[string]any{
		...
		var seen []any
		for item := range base.ApiEntitiesProject(nil).Stream("list", nil, nil) {
		...
		if hasStreaming {
			...
			var got []any
			for item := range streamSdk.ApiEntitiesProject(nil).Stream("list", nil, nil) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesProjectRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "api_entities_project"}), "api_entities_project_ref01"))
		...
		apiEntitiesProjectRef01Data = core.ToMapAny(entityData(apiEntitiesProjectRef01DataResult))
		...
		apiEntitiesProjectRef01ResdataUp0 := core.ToMapAny(entityData(apiEntitiesProjectRef01ResdataUp0Result))
