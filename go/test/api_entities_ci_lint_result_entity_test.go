...
func TestApiEntitiesCiLintResultEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesCiLintResultRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "api_entities_ci_lint_result"}), "api_entities_ci_lint_result_ref01"))
		...
		apiEntitiesCiLintResultRef01Data = core.ToMapAny(entityData(apiEntitiesCiLintResultRef01DataResult))
		...
		_, apiEntitiesCiLintResultRef01ListOk := apiEntitiesCiLintResultRef01ListResult.([]any)
