...
func TestApiEntitiesPackagesConanPackageRevisionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apiEntitiesPackagesConanPackageRevisionRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.api_entities_packages_conan_package_revision")))
