...
type DependencyProxyEntity struct {
	name    string
...
func NewDependencyProxyEntity(client *core.GitlabSDK, entopts map[string]any) *DependencyProxyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DependencyProxyEntity) GetName() string { return e.name }
...
func (e *DependencyProxyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DependencyProxyEntity) Deleted() bool {
	return e.deleted
}


func (e *DependencyProxyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDependencyProxyEntity(e.client, opts)
}

func (e *DependencyProxyEntity) Data(args ...any) any {
...
func (e *DependencyProxyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DependencyProxy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DependencyProxyEntity) DataTyped(data ...DependencyProxy) DependencyProxy {
	if len(data) > 0 {
		return typedFrom[DependencyProxy](e.Data(asMap(data[0])))
	}
	return typedFrom[DependencyProxy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DependencyProxy (all fields
// optional at the wire level).
func (e *DependencyProxyEntity) MatchTyped(match ...DependencyProxy) DependencyProxy {
	if len(match) > 0 {
		return typedFrom[DependencyProxy](e.Match(asMap(match[0])))
	}
	return typedFrom[DependencyProxy](e.Match())
}
...
func (e *DependencyProxyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DependencyProxyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DependencyProxyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DependencyProxyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DependencyProxyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DependencyProxyEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DependencyProxyRemoveMatch and returns an DependencyProxy. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DependencyProxyEntity) RemoveTyped(reqmatch DependencyProxyRemoveMatch, ctrl map[string]any) (DependencyProxy, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return DependencyProxy{}, err
	}
	return typedFrom[DependencyProxy](res), nil
}



func (e *DependencyProxyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
