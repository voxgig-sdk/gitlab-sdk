...
func NewStarrerEntity(client *core.GitlabSDK, entopts map[string]any) *StarrerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StarrerEntity) GetName() string { return e.name }
...
func (e *StarrerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StarrerEntity) Deleted() bool {
	return e.deleted
}


func (e *StarrerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStarrerEntity(e.client, opts)
}

func (e *StarrerEntity) Data(args ...any) any {
...
func (e *StarrerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Starrer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StarrerEntity) DataTyped(data ...Starrer) Starrer {
	if len(data) > 0 {
		return typedFrom[Starrer](e.Data(asMap(data[0])))
	}
	return typedFrom[Starrer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Starrer (all fields
// optional at the wire level).
func (e *StarrerEntity) MatchTyped(match ...Starrer) Starrer {
	if len(match) > 0 {
		return typedFrom[Starrer](e.Match(asMap(match[0])))
	}
	return typedFrom[Starrer](e.Match())
}
...
func (e *StarrerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StarrerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *StarrerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StarrerListMatch and returns []Starrer. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StarrerEntity) ListTyped(reqmatch StarrerListMatch, ctrl map[string]any) ([]Starrer, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Starrer](res), nil
}



func (e *StarrerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StarrerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StarrerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StarrerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
