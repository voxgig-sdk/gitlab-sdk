...
func NewTestReportEntity(client *core.GitlabSDK, entopts map[string]any) *TestReportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TestReportEntity) GetName() string { return e.name }
...
func (e *TestReportEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TestReportEntity) Deleted() bool {
	return e.deleted
}


func (e *TestReportEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTestReportEntity(e.client, opts)
}

func (e *TestReportEntity) Data(args ...any) any {
...
func (e *TestReportEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TestReport; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TestReportEntity) DataTyped(data ...TestReport) TestReport {
	if len(data) > 0 {
		return typedFrom[TestReport](e.Data(asMap(data[0])))
	}
	return typedFrom[TestReport](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TestReport (all fields
// optional at the wire level).
func (e *TestReportEntity) MatchTyped(match ...TestReport) TestReport {
	if len(match) > 0 {
		return typedFrom[TestReport](e.Match(asMap(match[0])))
	}
	return typedFrom[TestReport](e.Match())
}
...
func (e *TestReportEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TestReportEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TestReportEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TestReportListMatch and returns []TestReport. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TestReportEntity) ListTyped(reqmatch TestReportListMatch, ctrl map[string]any) ([]TestReport, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TestReport](res), nil
}



func (e *TestReportEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TestReportEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TestReportEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TestReportEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
