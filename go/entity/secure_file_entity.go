...
func NewSecureFileEntity(client *core.GitlabSDK, entopts map[string]any) *SecureFileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SecureFileEntity) GetName() string { return e.name }
...
func (e *SecureFileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SecureFileEntity) Deleted() bool {
	return e.deleted
}


func (e *SecureFileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSecureFileEntity(e.client, opts)
}

func (e *SecureFileEntity) Data(args ...any) any {
...
func (e *SecureFileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SecureFile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SecureFileEntity) DataTyped(data ...SecureFile) SecureFile {
	if len(data) > 0 {
		return typedFrom[SecureFile](e.Data(asMap(data[0])))
	}
	return typedFrom[SecureFile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SecureFile (all fields
// optional at the wire level).
func (e *SecureFileEntity) MatchTyped(match ...SecureFile) SecureFile {
	if len(match) > 0 {
		return typedFrom[SecureFile](e.Match(asMap(match[0])))
	}
	return typedFrom[SecureFile](e.Match())
}
...
func (e *SecureFileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SecureFileEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SecureFileLoadMatch and returns an SecureFile. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SecureFileEntity) LoadTyped(reqmatch SecureFileLoadMatch, ctrl map[string]any) (SecureFile, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return SecureFile{}, err
	}
	return typedFrom[SecureFile](res), nil
}



func (e *SecureFileEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SecureFileEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SecureFileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *SecureFileEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// SecureFileRemoveMatch and returns an SecureFile. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *SecureFileEntity) RemoveTyped(reqmatch SecureFileRemoveMatch, ctrl map[string]any) (SecureFile, error) {
...
func (e *SecureFileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
