...
type CustomAttributeEntity struct {
	name    string
...
func NewCustomAttributeEntity(client *core.GitlabSDK, entopts map[string]any) *CustomAttributeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CustomAttributeEntity) GetName() string { return e.name }
...
func (e *CustomAttributeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CustomAttributeEntity) Deleted() bool {
	return e.deleted
}


func (e *CustomAttributeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCustomAttributeEntity(e.client, opts)
}

func (e *CustomAttributeEntity) Data(args ...any) any {
...
func (e *CustomAttributeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CustomAttribute; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CustomAttributeEntity) DataTyped(data ...CustomAttribute) CustomAttribute {
	if len(data) > 0 {
		return typedFrom[CustomAttribute](e.Data(asMap(data[0])))
	}
	return typedFrom[CustomAttribute](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CustomAttribute (all fields
// optional at the wire level).
func (e *CustomAttributeEntity) MatchTyped(match ...CustomAttribute) CustomAttribute {
	if len(match) > 0 {
		return typedFrom[CustomAttribute](e.Match(asMap(match[0])))
	}
	return typedFrom[CustomAttribute](e.Match())
}
...
func (e *CustomAttributeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CustomAttributeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CustomAttributeLoadMatch and returns an CustomAttribute. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CustomAttributeEntity) LoadTyped(reqmatch CustomAttributeLoadMatch, ctrl map[string]any) (CustomAttribute, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CustomAttribute{}, err
	}
	return typedFrom[CustomAttribute](res), nil
}



func (e *CustomAttributeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CustomAttributeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CustomAttributeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CustomAttributeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CustomAttributeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
