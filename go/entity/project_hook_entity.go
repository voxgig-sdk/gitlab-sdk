...
func NewProjectHookEntity(client *core.GitlabSDK, entopts map[string]any) *ProjectHookEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProjectHookEntity) GetName() string { return e.name }
...
func (e *ProjectHookEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProjectHookEntity) Deleted() bool {
	return e.deleted
}


func (e *ProjectHookEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProjectHookEntity(e.client, opts)
}

func (e *ProjectHookEntity) Data(args ...any) any {
...
func (e *ProjectHookEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProjectHook; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProjectHookEntity) DataTyped(data ...ProjectHook) ProjectHook {
	if len(data) > 0 {
		return typedFrom[ProjectHook](e.Data(asMap(data[0])))
	}
	return typedFrom[ProjectHook](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProjectHook (all fields
// optional at the wire level).
func (e *ProjectHookEntity) MatchTyped(match ...ProjectHook) ProjectHook {
	if len(match) > 0 {
		return typedFrom[ProjectHook](e.Match(asMap(match[0])))
	}
	return typedFrom[ProjectHook](e.Match())
}
...
func (e *ProjectHookEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProjectHookEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ProjectHookEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ProjectHookEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProjectHookEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ProjectHookEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProjectHookRemoveMatch and returns an ProjectHook. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ProjectHookEntity) RemoveTyped(reqmatch ProjectHookRemoveMatch, ctrl map[string]any) (ProjectHook, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return ProjectHook{}, err
	}
	return typedFrom[ProjectHook](res), nil
}



func (e *ProjectHookEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
