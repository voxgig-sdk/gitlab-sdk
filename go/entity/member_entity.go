...
func NewMemberEntity(client *core.GitlabSDK, entopts map[string]any) *MemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MemberEntity) List(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *MemberEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MemberUpdateData and returns an Member. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *MemberEntity) UpdateTyped(reqdata MemberUpdateData, ctrl map[string]any) (Member, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return Member{}, err
	}
	return typedFrom[Member](res), nil
}




func (e *MemberEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// MemberRemoveMatch and returns an Member. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *MemberEntity) RemoveTyped(reqmatch MemberRemoveMatch, ctrl map[string]any) (Member, error) {
