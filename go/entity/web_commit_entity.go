...
func NewWebCommitEntity(client *core.GitlabSDK, entopts map[string]any) *WebCommitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WebCommitEntity) GetName() string { return e.name }
...
func (e *WebCommitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WebCommitEntity) Deleted() bool {
	return e.deleted
}


func (e *WebCommitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWebCommitEntity(e.client, opts)
}

func (e *WebCommitEntity) Data(args ...any) any {
...
func (e *WebCommitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WebCommit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WebCommitEntity) DataTyped(data ...WebCommit) WebCommit {
	if len(data) > 0 {
		return typedFrom[WebCommit](e.Data(asMap(data[0])))
	}
	return typedFrom[WebCommit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WebCommit (all fields
// optional at the wire level).
func (e *WebCommitEntity) MatchTyped(match ...WebCommit) WebCommit {
	if len(match) > 0 {
		return typedFrom[WebCommit](e.Match(asMap(match[0])))
	}
	return typedFrom[WebCommit](e.Match())
}
...
func (e *WebCommitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WebCommitEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WebCommitLoadMatch and returns an WebCommit. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WebCommitEntity) LoadTyped(reqmatch WebCommitLoadMatch, ctrl map[string]any) (WebCommit, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WebCommit{}, err
	}
	return typedFrom[WebCommit](res), nil
}



func (e *WebCommitEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WebCommitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WebCommitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WebCommitEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WebCommitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
