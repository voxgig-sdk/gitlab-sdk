...
func NewBadgeEntity(client *core.GitlabSDK, entopts map[string]any) *BadgeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BadgeEntity) GetName() string { return e.name }
...
func (e *BadgeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BadgeEntity) Deleted() bool {
	return e.deleted
}


func (e *BadgeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBadgeEntity(e.client, opts)
}

func (e *BadgeEntity) Data(args ...any) any {
...
func (e *BadgeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Badge; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BadgeEntity) DataTyped(data ...Badge) Badge {
	if len(data) > 0 {
		return typedFrom[Badge](e.Data(asMap(data[0])))
	}
	return typedFrom[Badge](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Badge (all fields
// optional at the wire level).
func (e *BadgeEntity) MatchTyped(match ...Badge) Badge {
	if len(match) > 0 {
		return typedFrom[Badge](e.Match(asMap(match[0])))
	}
	return typedFrom[Badge](e.Match())
}
...
func (e *BadgeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BadgeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BadgeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BadgeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BadgeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *BadgeEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BadgeRemoveMatch and returns an Badge. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *BadgeEntity) RemoveTyped(reqmatch BadgeRemoveMatch, ctrl map[string]any) (Badge, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Badge{}, err
	}
	return typedFrom[Badge](res), nil
}



func (e *BadgeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
