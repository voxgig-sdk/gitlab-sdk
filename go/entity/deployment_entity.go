...
func NewDeploymentEntity(client *core.GitlabSDK, entopts map[string]any) *DeploymentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeploymentEntity) GetName() string { return e.name }
...
func (e *DeploymentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeploymentEntity) Deleted() bool {
	return e.deleted
}


func (e *DeploymentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeploymentEntity(e.client, opts)
}

func (e *DeploymentEntity) Data(args ...any) any {
...
func (e *DeploymentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Deployment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeploymentEntity) DataTyped(data ...Deployment) Deployment {
	if len(data) > 0 {
		return typedFrom[Deployment](e.Data(asMap(data[0])))
	}
	return typedFrom[Deployment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Deployment (all fields
// optional at the wire level).
func (e *DeploymentEntity) MatchTyped(match ...Deployment) Deployment {
	if len(match) > 0 {
		return typedFrom[Deployment](e.Match(asMap(match[0])))
	}
	return typedFrom[Deployment](e.Match())
}
...
func (e *DeploymentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeploymentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeploymentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeploymentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeploymentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DeploymentEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeploymentRemoveMatch and returns an Deployment. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DeploymentEntity) RemoveTyped(reqmatch DeploymentRemoveMatch, ctrl map[string]any) (Deployment, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Deployment{}, err
	}
	return typedFrom[Deployment](res), nil
}



func (e *DeploymentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
