...
func NewWikiEntity(client *core.GitlabSDK, entopts map[string]any) *WikiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WikiEntity) GetName() string { return e.name }
...
func (e *WikiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WikiEntity) Deleted() bool {
	return e.deleted
}


func (e *WikiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWikiEntity(e.client, opts)
}

func (e *WikiEntity) Data(args ...any) any {
...
func (e *WikiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Wiki; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WikiEntity) DataTyped(data ...Wiki) Wiki {
	if len(data) > 0 {
		return typedFrom[Wiki](e.Data(asMap(data[0])))
	}
	return typedFrom[Wiki](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Wiki (all fields
// optional at the wire level).
func (e *WikiEntity) MatchTyped(match ...Wiki) Wiki {
	if len(match) > 0 {
		return typedFrom[Wiki](e.Match(asMap(match[0])))
	}
	return typedFrom[Wiki](e.Match())
}
...
func (e *WikiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WikiEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *WikiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WikiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WikiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *WikiEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WikiRemoveMatch and returns an Wiki. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *WikiEntity) RemoveTyped(reqmatch WikiRemoveMatch, ctrl map[string]any) (Wiki, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Wiki{}, err
	}
	return typedFrom[Wiki](res), nil
}



func (e *WikiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
