...
func NewGeoEntity(client *core.GitlabSDK, entopts map[string]any) *GeoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GeoEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GeoCreateData and returns an Geo. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GeoEntity) CreateTyped(reqdata GeoCreateData, ctrl map[string]any) (Geo, error) {
