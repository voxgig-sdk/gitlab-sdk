...
type ProjectAvatarEntity struct {
	name    string
...
func NewProjectAvatarEntity(client *core.GitlabSDK, entopts map[string]any) *ProjectAvatarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProjectAvatarEntity) GetName() string { return e.name }
...
func (e *ProjectAvatarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProjectAvatarEntity) Deleted() bool {
	return e.deleted
}


func (e *ProjectAvatarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProjectAvatarEntity(e.client, opts)
}

func (e *ProjectAvatarEntity) Data(args ...any) any {
...
func (e *ProjectAvatarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProjectAvatar; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProjectAvatarEntity) DataTyped(data ...ProjectAvatar) ProjectAvatar {
	if len(data) > 0 {
		return typedFrom[ProjectAvatar](e.Data(asMap(data[0])))
	}
	return typedFrom[ProjectAvatar](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProjectAvatar (all fields
// optional at the wire level).
func (e *ProjectAvatarEntity) MatchTyped(match ...ProjectAvatar) ProjectAvatar {
	if len(match) > 0 {
		return typedFrom[ProjectAvatar](e.Match(asMap(match[0])))
	}
	return typedFrom[ProjectAvatar](e.Match())
}
...
func (e *ProjectAvatarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProjectAvatarEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProjectAvatarLoadMatch and returns an ProjectAvatar. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ProjectAvatarEntity) LoadTyped(reqmatch ProjectAvatarLoadMatch, ctrl map[string]any) (ProjectAvatar, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ProjectAvatar{}, err
	}
	return typedFrom[ProjectAvatar](res), nil
}



func (e *ProjectAvatarEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ProjectAvatarEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProjectAvatarEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProjectAvatarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProjectAvatarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
