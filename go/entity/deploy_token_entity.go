...
func NewDeployTokenEntity(client *core.GitlabSDK, entopts map[string]any) *DeployTokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeployTokenEntity) GetName() string { return e.name }
...
func (e *DeployTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeployTokenEntity) Deleted() bool {
	return e.deleted
}


func (e *DeployTokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeployTokenEntity(e.client, opts)
}

func (e *DeployTokenEntity) Data(args ...any) any {
...
func (e *DeployTokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeployToken; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeployTokenEntity) DataTyped(data ...DeployToken) DeployToken {
	if len(data) > 0 {
		return typedFrom[DeployToken](e.Data(asMap(data[0])))
	}
	return typedFrom[DeployToken](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeployToken (all fields
// optional at the wire level).
func (e *DeployTokenEntity) MatchTyped(match ...DeployToken) DeployToken {
	if len(match) > 0 {
		return typedFrom[DeployToken](e.Match(asMap(match[0])))
	}
	return typedFrom[DeployToken](e.Match())
}
...
func (e *DeployTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeployTokenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeployTokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeployTokenEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeployTokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DeployTokenEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeployTokenRemoveMatch and returns an DeployToken. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DeployTokenEntity) RemoveTyped(reqmatch DeployTokenRemoveMatch, ctrl map[string]any) (DeployToken, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return DeployToken{}, err
	}
	return typedFrom[DeployToken](res), nil
}



func (e *DeployTokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
