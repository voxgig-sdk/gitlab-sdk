...
func NewEnvironmentEntity(client *core.GitlabSDK, entopts map[string]any) *EnvironmentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnvironmentEntity) GetName() string { return e.name }
...
func (e *EnvironmentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnvironmentEntity) Deleted() bool {
	return e.deleted
}


func (e *EnvironmentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnvironmentEntity(e.client, opts)
}

func (e *EnvironmentEntity) Data(args ...any) any {
...
func (e *EnvironmentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Environment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnvironmentEntity) DataTyped(data ...Environment) Environment {
	if len(data) > 0 {
		return typedFrom[Environment](e.Data(asMap(data[0])))
	}
	return typedFrom[Environment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Environment (all fields
// optional at the wire level).
func (e *EnvironmentEntity) MatchTyped(match ...Environment) Environment {
	if len(match) > 0 {
		return typedFrom[Environment](e.Match(asMap(match[0])))
	}
	return typedFrom[Environment](e.Match())
}
...
func (e *EnvironmentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnvironmentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EnvironmentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EnvironmentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnvironmentCreateData and returns an Environment. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EnvironmentEntity) CreateTyped(reqdata EnvironmentCreateData, ctrl map[string]any) (Environment, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Environment{}, err
	}
	return typedFrom[Environment](res), nil
}



func (e *EnvironmentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *EnvironmentEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// EnvironmentRemoveMatch and returns an Environment. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *EnvironmentEntity) RemoveTyped(reqmatch EnvironmentRemoveMatch, ctrl map[string]any) (Environment, error) {
...
func (e *EnvironmentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
