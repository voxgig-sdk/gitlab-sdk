...
func NewRpmEntity(client *core.GitlabSDK, entopts map[string]any) *RpmEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RpmEntity) GetName() string { return e.name }
...
func (e *RpmEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RpmEntity) Deleted() bool {
	return e.deleted
}


func (e *RpmEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRpmEntity(e.client, opts)
}

func (e *RpmEntity) Data(args ...any) any {
...
func (e *RpmEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rpm; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RpmEntity) DataTyped(data ...Rpm) Rpm {
	if len(data) > 0 {
		return typedFrom[Rpm](e.Data(asMap(data[0])))
	}
	return typedFrom[Rpm](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rpm (all fields
// optional at the wire level).
func (e *RpmEntity) MatchTyped(match ...Rpm) Rpm {
	if len(match) > 0 {
		return typedFrom[Rpm](e.Match(asMap(match[0])))
	}
	return typedFrom[Rpm](e.Match())
}
...
func (e *RpmEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RpmEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RpmEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RpmEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RpmCreateData and returns an Rpm. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RpmEntity) CreateTyped(reqdata RpmCreateData, ctrl map[string]any) (Rpm, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Rpm{}, err
	}
	return typedFrom[Rpm](res), nil
}



func (e *RpmEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RpmEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RpmEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
