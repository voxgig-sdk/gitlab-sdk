...
type ComposerPackageEntity struct {
	name    string
...
func NewComposerPackageEntity(client *core.GitlabSDK, entopts map[string]any) *ComposerPackageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ComposerPackageEntity) GetName() string { return e.name }
...
func (e *ComposerPackageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ComposerPackageEntity) Deleted() bool {
	return e.deleted
}


func (e *ComposerPackageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewComposerPackageEntity(e.client, opts)
}

func (e *ComposerPackageEntity) Data(args ...any) any {
...
func (e *ComposerPackageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ComposerPackage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ComposerPackageEntity) DataTyped(data ...ComposerPackage) ComposerPackage {
	if len(data) > 0 {
		return typedFrom[ComposerPackage](e.Data(asMap(data[0])))
	}
	return typedFrom[ComposerPackage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ComposerPackage (all fields
// optional at the wire level).
func (e *ComposerPackageEntity) MatchTyped(match ...ComposerPackage) ComposerPackage {
	if len(match) > 0 {
		return typedFrom[ComposerPackage](e.Match(asMap(match[0])))
	}
	return typedFrom[ComposerPackage](e.Match())
}
...
func (e *ComposerPackageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ComposerPackageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ComposerPackageLoadMatch and returns an ComposerPackage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ComposerPackageEntity) LoadTyped(reqmatch ComposerPackageLoadMatch, ctrl map[string]any) (ComposerPackage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ComposerPackage{}, err
	}
	return typedFrom[ComposerPackage](res), nil
}



func (e *ComposerPackageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ComposerPackageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ComposerPackageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ComposerPackageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ComposerPackageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
