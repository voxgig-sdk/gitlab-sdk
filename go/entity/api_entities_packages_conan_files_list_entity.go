...
func (e *ApiEntitiesPackagesConanFilesListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiEntitiesPackagesConanFilesListEntity) Deleted() bool {
	return e.deleted
}
...
func (e *ApiEntitiesPackagesConanFilesListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
