...
func NewIssueLinkEntity(client *core.GitlabSDK, entopts map[string]any) *IssueLinkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IssueLinkEntity) GetName() string { return e.name }
...
func (e *IssueLinkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IssueLinkEntity) Deleted() bool {
	return e.deleted
}


func (e *IssueLinkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIssueLinkEntity(e.client, opts)
}

func (e *IssueLinkEntity) Data(args ...any) any {
...
func (e *IssueLinkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IssueLink; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IssueLinkEntity) DataTyped(data ...IssueLink) IssueLink {
	if len(data) > 0 {
		return typedFrom[IssueLink](e.Data(asMap(data[0])))
	}
	return typedFrom[IssueLink](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IssueLink (all fields
// optional at the wire level).
func (e *IssueLinkEntity) MatchTyped(match ...IssueLink) IssueLink {
	if len(match) > 0 {
		return typedFrom[IssueLink](e.Match(asMap(match[0])))
	}
	return typedFrom[IssueLink](e.Match())
}
...
func (e *IssueLinkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IssueLinkEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IssueLinkEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IssueLinkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IssueLinkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *IssueLinkEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IssueLinkRemoveMatch and returns an IssueLink. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *IssueLinkEntity) RemoveTyped(reqmatch IssueLinkRemoveMatch, ctrl map[string]any) (IssueLink, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return IssueLink{}, err
	}
	return typedFrom[IssueLink](res), nil
}



func (e *IssueLinkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
