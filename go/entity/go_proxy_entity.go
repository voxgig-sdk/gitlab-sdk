...
func NewGoProxyEntity(client *core.GitlabSDK, entopts map[string]any) *GoProxyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GoProxyEntity) GetName() string { return e.name }
...
func (e *GoProxyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GoProxyEntity) Deleted() bool {
	return e.deleted
}


func (e *GoProxyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGoProxyEntity(e.client, opts)
}

func (e *GoProxyEntity) Data(args ...any) any {
...
func (e *GoProxyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GoProxy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GoProxyEntity) DataTyped(data ...GoProxy) GoProxy {
	if len(data) > 0 {
		return typedFrom[GoProxy](e.Data(asMap(data[0])))
	}
	return typedFrom[GoProxy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GoProxy (all fields
// optional at the wire level).
func (e *GoProxyEntity) MatchTyped(match ...GoProxy) GoProxy {
	if len(match) > 0 {
		return typedFrom[GoProxy](e.Match(asMap(match[0])))
	}
	return typedFrom[GoProxy](e.Match())
}
...
func (e *GoProxyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GoProxyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GoProxyLoadMatch and returns an GoProxy. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GoProxyEntity) LoadTyped(reqmatch GoProxyLoadMatch, ctrl map[string]any) (GoProxy, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GoProxy{}, err
	}
	return typedFrom[GoProxy](res), nil
}



func (e *GoProxyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GoProxyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GoProxyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GoProxyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GoProxyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
