...
func NewUnleashApiEntity(client *core.GitlabSDK, entopts map[string]any) *UnleashApiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UnleashApiEntity) GetName() string { return e.name }
...
func (e *UnleashApiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UnleashApiEntity) Deleted() bool {
	return e.deleted
}


func (e *UnleashApiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUnleashApiEntity(e.client, opts)
}

func (e *UnleashApiEntity) Data(args ...any) any {
...
func (e *UnleashApiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UnleashApi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UnleashApiEntity) DataTyped(data ...UnleashApi) UnleashApi {
	if len(data) > 0 {
		return typedFrom[UnleashApi](e.Data(asMap(data[0])))
	}
	return typedFrom[UnleashApi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UnleashApi (all fields
// optional at the wire level).
func (e *UnleashApiEntity) MatchTyped(match ...UnleashApi) UnleashApi {
	if len(match) > 0 {
		return typedFrom[UnleashApi](e.Match(asMap(match[0])))
	}
	return typedFrom[UnleashApi](e.Match())
}
...
func (e *UnleashApiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UnleashApiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UnleashApiLoadMatch and returns an UnleashApi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UnleashApiEntity) LoadTyped(reqmatch UnleashApiLoadMatch, ctrl map[string]any) (UnleashApi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UnleashApi{}, err
	}
	return typedFrom[UnleashApi](res), nil
}



func (e *UnleashApiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UnleashApiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UnleashApiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UnleashApiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UnleashApiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
