...
func NewGroupAvatarEntity(client *core.GitlabSDK, entopts map[string]any) *GroupAvatarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GroupAvatarEntity) GetName() string { return e.name }
...
func (e *GroupAvatarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GroupAvatarEntity) Deleted() bool {
	return e.deleted
}


func (e *GroupAvatarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGroupAvatarEntity(e.client, opts)
}

func (e *GroupAvatarEntity) Data(args ...any) any {
...
func (e *GroupAvatarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GroupAvatar; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GroupAvatarEntity) DataTyped(data ...GroupAvatar) GroupAvatar {
	if len(data) > 0 {
		return typedFrom[GroupAvatar](e.Data(asMap(data[0])))
	}
	return typedFrom[GroupAvatar](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GroupAvatar (all fields
// optional at the wire level).
func (e *GroupAvatarEntity) MatchTyped(match ...GroupAvatar) GroupAvatar {
	if len(match) > 0 {
		return typedFrom[GroupAvatar](e.Match(asMap(match[0])))
	}
	return typedFrom[GroupAvatar](e.Match())
}
...
func (e *GroupAvatarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GroupAvatarEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GroupAvatarLoadMatch and returns an GroupAvatar. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GroupAvatarEntity) LoadTyped(reqmatch GroupAvatarLoadMatch, ctrl map[string]any) (GroupAvatar, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GroupAvatar{}, err
	}
	return typedFrom[GroupAvatar](res), nil
}



func (e *GroupAvatarEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GroupAvatarEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GroupAvatarEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GroupAvatarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GroupAvatarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
