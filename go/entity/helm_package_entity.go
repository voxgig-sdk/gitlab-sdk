...
func NewHelmPackageEntity(client *core.GitlabSDK, entopts map[string]any) *HelmPackageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HelmPackageEntity) GetName() string { return e.name }
...
func (e *HelmPackageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HelmPackageEntity) Deleted() bool {
	return e.deleted
}


func (e *HelmPackageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHelmPackageEntity(e.client, opts)
}

func (e *HelmPackageEntity) Data(args ...any) any {
...
func (e *HelmPackageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an HelmPackage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HelmPackageEntity) DataTyped(data ...HelmPackage) HelmPackage {
	if len(data) > 0 {
		return typedFrom[HelmPackage](e.Data(asMap(data[0])))
	}
	return typedFrom[HelmPackage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through HelmPackage (all fields
// optional at the wire level).
func (e *HelmPackageEntity) MatchTyped(match ...HelmPackage) HelmPackage {
	if len(match) > 0 {
		return typedFrom[HelmPackage](e.Match(asMap(match[0])))
	}
	return typedFrom[HelmPackage](e.Match())
}
...
func (e *HelmPackageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HelmPackageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HelmPackageLoadMatch and returns an HelmPackage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HelmPackageEntity) LoadTyped(reqmatch HelmPackageLoadMatch, ctrl map[string]any) (HelmPackage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return HelmPackage{}, err
	}
	return typedFrom[HelmPackage](res), nil
}



func (e *HelmPackageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *HelmPackageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// HelmPackageCreateData and returns an HelmPackage. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *HelmPackageEntity) CreateTyped(reqdata HelmPackageCreateData, ctrl map[string]any) (HelmPackage, error) {
...
func (e *HelmPackageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HelmPackageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HelmPackageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
