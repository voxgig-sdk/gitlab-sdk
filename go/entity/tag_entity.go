...
func NewTagEntity(client *core.GitlabSDK, entopts map[string]any) *TagEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TagEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *TagEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *TagEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TagRemoveMatch and returns an Tag. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *TagEntity) RemoveTyped(reqmatch TagRemoveMatch, ctrl map[string]any) (Tag, error) {
