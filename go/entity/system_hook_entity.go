...
func NewSystemHookEntity(client *core.GitlabSDK, entopts map[string]any) *SystemHookEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SystemHookEntity) GetName() string { return e.name }
...
func (e *SystemHookEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SystemHookEntity) Deleted() bool {
	return e.deleted
}


func (e *SystemHookEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSystemHookEntity(e.client, opts)
}

func (e *SystemHookEntity) Data(args ...any) any {
...
func (e *SystemHookEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SystemHook; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SystemHookEntity) DataTyped(data ...SystemHook) SystemHook {
	if len(data) > 0 {
		return typedFrom[SystemHook](e.Data(asMap(data[0])))
	}
	return typedFrom[SystemHook](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SystemHook (all fields
// optional at the wire level).
func (e *SystemHookEntity) MatchTyped(match ...SystemHook) SystemHook {
	if len(match) > 0 {
		return typedFrom[SystemHook](e.Match(asMap(match[0])))
	}
	return typedFrom[SystemHook](e.Match())
}
...
func (e *SystemHookEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SystemHookEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SystemHookEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SystemHookEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SystemHookEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *SystemHookEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SystemHookRemoveMatch and returns an SystemHook. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *SystemHookEntity) RemoveTyped(reqmatch SystemHookRemoveMatch, ctrl map[string]any) (SystemHook, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return SystemHook{}, err
	}
	return typedFrom[SystemHook](res), nil
}



func (e *SystemHookEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
