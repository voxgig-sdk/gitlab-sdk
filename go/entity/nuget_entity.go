...
func NewNugetEntity(client *core.GitlabSDK, entopts map[string]any) *NugetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NugetEntity) GetName() string { return e.name }
...
func (e *NugetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NugetEntity) Deleted() bool {
	return e.deleted
}


func (e *NugetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNugetEntity(e.client, opts)
}

func (e *NugetEntity) Data(args ...any) any {
...
func (e *NugetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Nuget; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NugetEntity) DataTyped(data ...Nuget) Nuget {
	if len(data) > 0 {
		return typedFrom[Nuget](e.Data(asMap(data[0])))
	}
	return typedFrom[Nuget](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Nuget (all fields
// optional at the wire level).
func (e *NugetEntity) MatchTyped(match ...Nuget) Nuget {
	if len(match) > 0 {
		return typedFrom[Nuget](e.Match(asMap(match[0])))
	}
	return typedFrom[Nuget](e.Match())
}
...
func (e *NugetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NugetEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *NugetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NugetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *NugetEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NugetUpdateData and returns an Nuget. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *NugetEntity) UpdateTyped(reqdata NugetUpdateData, ctrl map[string]any) (Nuget, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return Nuget{}, err
	}
	return typedFrom[Nuget](res), nil
}



func (e *NugetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NugetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
