...
func NewConanEntity(client *core.GitlabSDK, entopts map[string]any) *ConanEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConanEntity) GetName() string { return e.name }
...
func (e *ConanEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConanEntity) Deleted() bool {
	return e.deleted
}


func (e *ConanEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConanEntity(e.client, opts)
}

func (e *ConanEntity) Data(args ...any) any {
...
func (e *ConanEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Conan; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConanEntity) DataTyped(data ...Conan) Conan {
	if len(data) > 0 {
		return typedFrom[Conan](e.Data(asMap(data[0])))
	}
	return typedFrom[Conan](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Conan (all fields
// optional at the wire level).
func (e *ConanEntity) MatchTyped(match ...Conan) Conan {
	if len(match) > 0 {
		return typedFrom[Conan](e.Match(asMap(match[0])))
	}
	return typedFrom[Conan](e.Match())
}
...
func (e *ConanEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConanEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ConanEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ConanEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ConanEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ConanEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConanRemoveMatch and returns an Conan. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ConanEntity) RemoveTyped(reqmatch ConanRemoveMatch, ctrl map[string]any) (Conan, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Conan{}, err
	}
	return typedFrom[Conan](res), nil
}



func (e *ConanEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
