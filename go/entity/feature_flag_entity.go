...
func NewFeatureFlagEntity(client *core.GitlabSDK, entopts map[string]any) *FeatureFlagEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FeatureFlagEntity) GetName() string { return e.name }
...
func (e *FeatureFlagEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FeatureFlagEntity) Deleted() bool {
	return e.deleted
}


func (e *FeatureFlagEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFeatureFlagEntity(e.client, opts)
}

func (e *FeatureFlagEntity) Data(args ...any) any {
...
func (e *FeatureFlagEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FeatureFlag; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FeatureFlagEntity) DataTyped(data ...FeatureFlag) FeatureFlag {
	if len(data) > 0 {
		return typedFrom[FeatureFlag](e.Data(asMap(data[0])))
	}
	return typedFrom[FeatureFlag](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FeatureFlag (all fields
// optional at the wire level).
func (e *FeatureFlagEntity) MatchTyped(match ...FeatureFlag) FeatureFlag {
	if len(match) > 0 {
		return typedFrom[FeatureFlag](e.Match(asMap(match[0])))
	}
	return typedFrom[FeatureFlag](e.Match())
}
...
func (e *FeatureFlagEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FeatureFlagEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FeatureFlagLoadMatch and returns an FeatureFlag. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FeatureFlagEntity) LoadTyped(reqmatch FeatureFlagLoadMatch, ctrl map[string]any) (FeatureFlag, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return FeatureFlag{}, err
	}
	return typedFrom[FeatureFlag](res), nil
}



func (e *FeatureFlagEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *FeatureFlagEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// FeatureFlagCreateData and returns an FeatureFlag. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FeatureFlagEntity) CreateTyped(reqdata FeatureFlagCreateData, ctrl map[string]any) (FeatureFlag, error) {
...
func (e *FeatureFlagEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *FeatureFlagEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// FeatureFlagRemoveMatch and returns an FeatureFlag. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *FeatureFlagEntity) RemoveTyped(reqmatch FeatureFlagRemoveMatch, ctrl map[string]any) (FeatureFlag, error) {
...
func (e *FeatureFlagEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
