...
func NewPypiPackageEntity(client *core.GitlabSDK, entopts map[string]any) *PypiPackageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PypiPackageEntity) GetName() string { return e.name }
...
func (e *PypiPackageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PypiPackageEntity) Deleted() bool {
	return e.deleted
}


func (e *PypiPackageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPypiPackageEntity(e.client, opts)
}

func (e *PypiPackageEntity) Data(args ...any) any {
...
func (e *PypiPackageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PypiPackage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PypiPackageEntity) DataTyped(data ...PypiPackage) PypiPackage {
	if len(data) > 0 {
		return typedFrom[PypiPackage](e.Data(asMap(data[0])))
	}
	return typedFrom[PypiPackage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PypiPackage (all fields
// optional at the wire level).
func (e *PypiPackageEntity) MatchTyped(match ...PypiPackage) PypiPackage {
	if len(match) > 0 {
		return typedFrom[PypiPackage](e.Match(asMap(match[0])))
	}
	return typedFrom[PypiPackage](e.Match())
}
...
func (e *PypiPackageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PypiPackageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PypiPackageLoadMatch and returns an PypiPackage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PypiPackageEntity) LoadTyped(reqmatch PypiPackageLoadMatch, ctrl map[string]any) (PypiPackage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PypiPackage{}, err
	}
	return typedFrom[PypiPackage](res), nil
}



func (e *PypiPackageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PypiPackageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PypiPackageCreateData and returns an PypiPackage. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PypiPackageEntity) CreateTyped(reqdata PypiPackageCreateData, ctrl map[string]any) (PypiPackage, error) {
...
func (e *PypiPackageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PypiPackageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PypiPackageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
