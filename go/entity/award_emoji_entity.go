...
func NewAwardEmojiEntity(client *core.GitlabSDK, entopts map[string]any) *AwardEmojiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AwardEmojiEntity) GetName() string { return e.name }
...
func (e *AwardEmojiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AwardEmojiEntity) Deleted() bool {
	return e.deleted
}


func (e *AwardEmojiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAwardEmojiEntity(e.client, opts)
}

func (e *AwardEmojiEntity) Data(args ...any) any {
...
func (e *AwardEmojiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AwardEmoji; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AwardEmojiEntity) DataTyped(data ...AwardEmoji) AwardEmoji {
	if len(data) > 0 {
		return typedFrom[AwardEmoji](e.Data(asMap(data[0])))
	}
	return typedFrom[AwardEmoji](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AwardEmoji (all fields
// optional at the wire level).
func (e *AwardEmojiEntity) MatchTyped(match ...AwardEmoji) AwardEmoji {
	if len(match) > 0 {
		return typedFrom[AwardEmoji](e.Match(asMap(match[0])))
	}
	return typedFrom[AwardEmoji](e.Match())
}
...
func (e *AwardEmojiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AwardEmojiEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AwardEmojiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AwardEmojiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AwardEmojiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *AwardEmojiEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AwardEmojiRemoveMatch and returns an AwardEmoji. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AwardEmojiEntity) RemoveTyped(reqmatch AwardEmojiRemoveMatch, ctrl map[string]any) (AwardEmoji, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return AwardEmoji{}, err
	}
	return typedFrom[AwardEmoji](res), nil
}



func (e *AwardEmojiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
