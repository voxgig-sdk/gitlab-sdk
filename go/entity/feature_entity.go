...
func NewFeatureEntity(client *core.GitlabSDK, entopts map[string]any) *FeatureEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FeatureEntity) GetName() string { return e.name }
...
func (e *FeatureEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FeatureEntity) Deleted() bool {
	return e.deleted
}


func (e *FeatureEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFeatureEntity(e.client, opts)
}

func (e *FeatureEntity) Data(args ...any) any {
...
func (e *FeatureEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Feature; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FeatureEntity) DataTyped(data ...Feature) Feature {
	if len(data) > 0 {
		return typedFrom[Feature](e.Data(asMap(data[0])))
	}
	return typedFrom[Feature](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Feature (all fields
// optional at the wire level).
func (e *FeatureEntity) MatchTyped(match ...Feature) Feature {
	if len(match) > 0 {
		return typedFrom[Feature](e.Match(asMap(match[0])))
	}
	return typedFrom[Feature](e.Match())
}
...
func (e *FeatureEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FeatureEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *FeatureEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FeatureEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FeatureEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *FeatureEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FeatureRemoveMatch and returns an Feature. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *FeatureEntity) RemoveTyped(reqmatch FeatureRemoveMatch, ctrl map[string]any) (Feature, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Feature{}, err
	}
	return typedFrom[Feature](res), nil
}



func (e *FeatureEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
