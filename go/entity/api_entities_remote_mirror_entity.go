...
func (e *ApiEntitiesRemoteMirrorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiEntitiesRemoteMirrorEntity) Deleted() bool {
	return e.deleted
}
...
func (e *ApiEntitiesRemoteMirrorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
