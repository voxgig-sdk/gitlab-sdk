...
func NewDebianEntity(client *core.GitlabSDK, entopts map[string]any) *DebianEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DebianEntity) GetName() string { return e.name }
...
func (e *DebianEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DebianEntity) Deleted() bool {
	return e.deleted
}


func (e *DebianEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDebianEntity(e.client, opts)
}

func (e *DebianEntity) Data(args ...any) any {
...
func (e *DebianEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Debian; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DebianEntity) DataTyped(data ...Debian) Debian {
	if len(data) > 0 {
		return typedFrom[Debian](e.Data(asMap(data[0])))
	}
	return typedFrom[Debian](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Debian (all fields
// optional at the wire level).
func (e *DebianEntity) MatchTyped(match ...Debian) Debian {
	if len(match) > 0 {
		return typedFrom[Debian](e.Match(asMap(match[0])))
	}
	return typedFrom[Debian](e.Match())
}
...
func (e *DebianEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DebianEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DebianEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DebianEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *DebianEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DebianUpdateData and returns an Debian. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *DebianEntity) UpdateTyped(reqdata DebianUpdateData, ctrl map[string]any) (Debian, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return Debian{}, err
	}
	return typedFrom[Debian](res), nil
}



func (e *DebianEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DebianEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
