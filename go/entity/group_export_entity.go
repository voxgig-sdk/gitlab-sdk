...
func NewGroupExportEntity(client *core.GitlabSDK, entopts map[string]any) *GroupExportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GroupExportEntity) GetName() string { return e.name }
...
func (e *GroupExportEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GroupExportEntity) Deleted() bool {
	return e.deleted
}


func (e *GroupExportEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGroupExportEntity(e.client, opts)
}

func (e *GroupExportEntity) Data(args ...any) any {
...
func (e *GroupExportEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GroupExport; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GroupExportEntity) DataTyped(data ...GroupExport) GroupExport {
	if len(data) > 0 {
		return typedFrom[GroupExport](e.Data(asMap(data[0])))
	}
	return typedFrom[GroupExport](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GroupExport (all fields
// optional at the wire level).
func (e *GroupExportEntity) MatchTyped(match ...GroupExport) GroupExport {
	if len(match) > 0 {
		return typedFrom[GroupExport](e.Match(asMap(match[0])))
	}
	return typedFrom[GroupExport](e.Match())
}
...
func (e *GroupExportEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GroupExportEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GroupExportLoadMatch and returns an GroupExport. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GroupExportEntity) LoadTyped(reqmatch GroupExportLoadMatch, ctrl map[string]any) (GroupExport, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GroupExport{}, err
	}
	return typedFrom[GroupExport](res), nil
}



func (e *GroupExportEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GroupExportEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GroupExportCreateData and returns an GroupExport. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GroupExportEntity) CreateTyped(reqdata GroupExportCreateData, ctrl map[string]any) (GroupExport, error) {
...
func (e *GroupExportEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GroupExportEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GroupExportEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
