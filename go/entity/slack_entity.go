...
func NewSlackEntity(client *core.GitlabSDK, entopts map[string]any) *SlackEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SlackEntity) GetName() string { return e.name }
...
func (e *SlackEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SlackEntity) Deleted() bool {
	return e.deleted
}


func (e *SlackEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSlackEntity(e.client, opts)
}

func (e *SlackEntity) Data(args ...any) any {
...
func (e *SlackEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Slack; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SlackEntity) DataTyped(data ...Slack) Slack {
	if len(data) > 0 {
		return typedFrom[Slack](e.Data(asMap(data[0])))
	}
	return typedFrom[Slack](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Slack (all fields
// optional at the wire level).
func (e *SlackEntity) MatchTyped(match ...Slack) Slack {
	if len(match) > 0 {
		return typedFrom[Slack](e.Match(asMap(match[0])))
	}
	return typedFrom[Slack](e.Match())
}
...
func (e *SlackEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SlackEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SlackEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *SlackEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SlackCreateData and returns an Slack. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SlackEntity) CreateTyped(reqdata SlackCreateData, ctrl map[string]any) (Slack, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Slack{}, err
	}
	return typedFrom[Slack](res), nil
}



func (e *SlackEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SlackEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SlackEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
