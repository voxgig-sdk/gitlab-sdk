...
type ProjectSnippetEntity struct {
	name    string
...
func NewProjectSnippetEntity(client *core.GitlabSDK, entopts map[string]any) *ProjectSnippetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProjectSnippetEntity) GetName() string { return e.name }
...
func (e *ProjectSnippetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProjectSnippetEntity) Deleted() bool {
	return e.deleted
}


func (e *ProjectSnippetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProjectSnippetEntity(e.client, opts)
}

func (e *ProjectSnippetEntity) Data(args ...any) any {
...
func (e *ProjectSnippetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProjectSnippet; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProjectSnippetEntity) DataTyped(data ...ProjectSnippet) ProjectSnippet {
	if len(data) > 0 {
		return typedFrom[ProjectSnippet](e.Data(asMap(data[0])))
	}
	return typedFrom[ProjectSnippet](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProjectSnippet (all fields
// optional at the wire level).
func (e *ProjectSnippetEntity) MatchTyped(match ...ProjectSnippet) ProjectSnippet {
	if len(match) > 0 {
		return typedFrom[ProjectSnippet](e.Match(asMap(match[0])))
	}
	return typedFrom[ProjectSnippet](e.Match())
}
...
func (e *ProjectSnippetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProjectSnippetEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ProjectSnippetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ProjectSnippetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProjectSnippetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ProjectSnippetEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProjectSnippetRemoveMatch and returns an ProjectSnippet. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ProjectSnippetEntity) RemoveTyped(reqmatch ProjectSnippetRemoveMatch, ctrl map[string]any) (ProjectSnippet, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return ProjectSnippet{}, err
	}
	return typedFrom[ProjectSnippet](res), nil
}



func (e *ProjectSnippetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
