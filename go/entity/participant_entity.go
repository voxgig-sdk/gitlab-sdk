...
func NewParticipantEntity(client *core.GitlabSDK, entopts map[string]any) *ParticipantEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ParticipantEntity) GetName() string { return e.name }
...
func (e *ParticipantEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ParticipantEntity) Deleted() bool {
	return e.deleted
}


func (e *ParticipantEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewParticipantEntity(e.client, opts)
}

func (e *ParticipantEntity) Data(args ...any) any {
...
func (e *ParticipantEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Participant; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ParticipantEntity) DataTyped(data ...Participant) Participant {
	if len(data) > 0 {
		return typedFrom[Participant](e.Data(asMap(data[0])))
	}
	return typedFrom[Participant](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Participant (all fields
// optional at the wire level).
func (e *ParticipantEntity) MatchTyped(match ...Participant) Participant {
	if len(match) > 0 {
		return typedFrom[Participant](e.Match(asMap(match[0])))
	}
	return typedFrom[Participant](e.Match())
}
...
func (e *ParticipantEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ParticipantEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ParticipantEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ParticipantListMatch and returns []Participant. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ParticipantEntity) ListTyped(reqmatch ParticipantListMatch, ctrl map[string]any) ([]Participant, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Participant](res), nil
}



func (e *ParticipantEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ParticipantEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ParticipantEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ParticipantEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
