...
func (e *FeatureFlagsUserListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FeatureFlagsUserListEntity) Deleted() bool {
	return e.deleted
}
...
func (e *FeatureFlagsUserListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
