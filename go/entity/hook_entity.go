...
func NewHookEntity(client *core.GitlabSDK, entopts map[string]any) *HookEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HookEntity) GetName() string { return e.name }
...
func (e *HookEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HookEntity) Deleted() bool {
	return e.deleted
}


func (e *HookEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHookEntity(e.client, opts)
}

func (e *HookEntity) Data(args ...any) any {
...
func (e *HookEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Hook; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HookEntity) DataTyped(data ...Hook) Hook {
	if len(data) > 0 {
		return typedFrom[Hook](e.Data(asMap(data[0])))
	}
	return typedFrom[Hook](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Hook (all fields
// optional at the wire level).
func (e *HookEntity) MatchTyped(match ...Hook) Hook {
	if len(match) > 0 {
		return typedFrom[Hook](e.Match(asMap(match[0])))
	}
	return typedFrom[Hook](e.Match())
}
...
func (e *HookEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HookEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *HookEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *HookEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HookCreateData and returns an Hook. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *HookEntity) CreateTyped(reqdata HookCreateData, ctrl map[string]any) (Hook, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Hook{}, err
	}
	return typedFrom[Hook](res), nil
}




func (e *HookEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// HookUpdateData and returns an Hook. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *HookEntity) UpdateTyped(reqdata HookUpdateData, ctrl map[string]any) (Hook, error) {
...
func (e *HookEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// HookRemoveMatch and returns an Hook. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *HookEntity) RemoveTyped(reqmatch HookRemoveMatch, ctrl map[string]any) (Hook, error) {
...
func (e *HookEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
