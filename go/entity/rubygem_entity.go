...
func NewRubygemEntity(client *core.GitlabSDK, entopts map[string]any) *RubygemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RubygemEntity) GetName() string { return e.name }
...
func (e *RubygemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RubygemEntity) Deleted() bool {
	return e.deleted
}


func (e *RubygemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRubygemEntity(e.client, opts)
}

func (e *RubygemEntity) Data(args ...any) any {
...
func (e *RubygemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rubygem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RubygemEntity) DataTyped(data ...Rubygem) Rubygem {
	if len(data) > 0 {
		return typedFrom[Rubygem](e.Data(asMap(data[0])))
	}
	return typedFrom[Rubygem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rubygem (all fields
// optional at the wire level).
func (e *RubygemEntity) MatchTyped(match ...Rubygem) Rubygem {
	if len(match) > 0 {
		return typedFrom[Rubygem](e.Match(asMap(match[0])))
	}
	return typedFrom[Rubygem](e.Match())
}
...
func (e *RubygemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RubygemEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RubygemLoadMatch and returns an Rubygem. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RubygemEntity) LoadTyped(reqmatch RubygemLoadMatch, ctrl map[string]any) (Rubygem, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Rubygem{}, err
	}
	return typedFrom[Rubygem](res), nil
}



func (e *RubygemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RubygemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RubygemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RubygemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RubygemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
