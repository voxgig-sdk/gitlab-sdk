...
func NewJobEntity(client *core.GitlabSDK, entopts map[string]any) *JobEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *JobEntity) GetName() string { return e.name }
...
func (e *JobEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *JobEntity) Deleted() bool {
	return e.deleted
}


func (e *JobEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewJobEntity(e.client, opts)
}

func (e *JobEntity) Data(args ...any) any {
...
func (e *JobEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Job; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *JobEntity) DataTyped(data ...Job) Job {
	if len(data) > 0 {
		return typedFrom[Job](e.Data(asMap(data[0])))
	}
	return typedFrom[Job](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Job (all fields
// optional at the wire level).
func (e *JobEntity) MatchTyped(match ...Job) Job {
	if len(match) > 0 {
		return typedFrom[Job](e.Match(asMap(match[0])))
	}
	return typedFrom[Job](e.Match())
}
...
func (e *JobEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *JobEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// JobLoadMatch and returns an Job. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *JobEntity) LoadTyped(reqmatch JobLoadMatch, ctrl map[string]any) (Job, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Job{}, err
	}
	return typedFrom[Job](res), nil
}



func (e *JobEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *JobEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// JobCreateData and returns an Job. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *JobEntity) CreateTyped(reqdata JobCreateData, ctrl map[string]any) (Job, error) {
...
func (e *JobEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// JobUpdateData and returns an Job. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *JobEntity) UpdateTyped(reqdata JobUpdateData, ctrl map[string]any) (Job, error) {
...
func (e *JobEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *JobEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
