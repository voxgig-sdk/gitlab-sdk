...
func NewCiVariableEntity(client *core.GitlabSDK, entopts map[string]any) *CiVariableEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CiVariableEntity) GetName() string { return e.name }
...
func (e *CiVariableEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CiVariableEntity) Deleted() bool {
	return e.deleted
}


func (e *CiVariableEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCiVariableEntity(e.client, opts)
}

func (e *CiVariableEntity) Data(args ...any) any {
...
func (e *CiVariableEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CiVariable; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CiVariableEntity) DataTyped(data ...CiVariable) CiVariable {
	if len(data) > 0 {
		return typedFrom[CiVariable](e.Data(asMap(data[0])))
	}
	return typedFrom[CiVariable](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CiVariable (all fields
// optional at the wire level).
func (e *CiVariableEntity) MatchTyped(match ...CiVariable) CiVariable {
	if len(match) > 0 {
		return typedFrom[CiVariable](e.Match(asMap(match[0])))
	}
	return typedFrom[CiVariable](e.Match())
}
...
func (e *CiVariableEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CiVariableEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CiVariableEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CiVariableEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CiVariableEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *CiVariableEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CiVariableRemoveMatch and returns an CiVariable. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CiVariableEntity) RemoveTyped(reqmatch CiVariableRemoveMatch, ctrl map[string]any) (CiVariable, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return CiVariable{}, err
	}
	return typedFrom[CiVariable](res), nil
}



func (e *CiVariableEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
