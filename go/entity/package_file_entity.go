...
func NewPackageFileEntity(client *core.GitlabSDK, entopts map[string]any) *PackageFileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PackageFileEntity) GetName() string { return e.name }
...
func (e *PackageFileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PackageFileEntity) Deleted() bool {
	return e.deleted
}


func (e *PackageFileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPackageFileEntity(e.client, opts)
}

func (e *PackageFileEntity) Data(args ...any) any {
...
func (e *PackageFileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PackageFile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PackageFileEntity) DataTyped(data ...PackageFile) PackageFile {
	if len(data) > 0 {
		return typedFrom[PackageFile](e.Data(asMap(data[0])))
	}
	return typedFrom[PackageFile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PackageFile (all fields
// optional at the wire level).
func (e *PackageFileEntity) MatchTyped(match ...PackageFile) PackageFile {
	if len(match) > 0 {
		return typedFrom[PackageFile](e.Match(asMap(match[0])))
	}
	return typedFrom[PackageFile](e.Match())
}
...
func (e *PackageFileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PackageFileEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PackageFileLoadMatch and returns an PackageFile. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PackageFileEntity) LoadTyped(reqmatch PackageFileLoadMatch, ctrl map[string]any) (PackageFile, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PackageFile{}, err
	}
	return typedFrom[PackageFile](res), nil
}



func (e *PackageFileEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PackageFileEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PackageFileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *PackageFileEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PackageFileRemoveMatch and returns an PackageFile. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PackageFileEntity) RemoveTyped(reqmatch PackageFileRemoveMatch, ctrl map[string]any) (PackageFile, error) {
...
func (e *PackageFileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
