...
func NewComposerEntity(client *core.GitlabSDK, entopts map[string]any) *ComposerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ComposerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ComposerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ComposerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *ComposerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
