...
func (e *ApiEntitiesCiResetTokenResultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiEntitiesCiResetTokenResultEntity) Deleted() bool {
	return e.deleted
}
...
func (e *ApiEntitiesCiResetTokenResultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
