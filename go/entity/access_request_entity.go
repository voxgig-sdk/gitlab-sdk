...
type AccessRequestEntity struct {
	name    string
...
func NewAccessRequestEntity(client *core.GitlabSDK, entopts map[string]any) *AccessRequestEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AccessRequestEntity) GetName() string { return e.name }
...
func (e *AccessRequestEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AccessRequestEntity) Deleted() bool {
	return e.deleted
}


func (e *AccessRequestEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAccessRequestEntity(e.client, opts)
}

func (e *AccessRequestEntity) Data(args ...any) any {
...
func (e *AccessRequestEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AccessRequest; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AccessRequestEntity) DataTyped(data ...AccessRequest) AccessRequest {
	if len(data) > 0 {
		return typedFrom[AccessRequest](e.Data(asMap(data[0])))
	}
	return typedFrom[AccessRequest](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AccessRequest (all fields
// optional at the wire level).
func (e *AccessRequestEntity) MatchTyped(match ...AccessRequest) AccessRequest {
	if len(match) > 0 {
		return typedFrom[AccessRequest](e.Match(asMap(match[0])))
	}
	return typedFrom[AccessRequest](e.Match())
}
...
func (e *AccessRequestEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AccessRequestEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AccessRequestEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AccessRequestEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AccessRequestEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *AccessRequestEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AccessRequestRemoveMatch and returns an AccessRequest. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AccessRequestEntity) RemoveTyped(reqmatch AccessRequestRemoveMatch, ctrl map[string]any) (AccessRequest, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return AccessRequest{}, err
	}
	return typedFrom[AccessRequest](res), nil
}



func (e *AccessRequestEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
