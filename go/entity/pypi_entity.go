...
func NewPypiEntity(client *core.GitlabSDK, entopts map[string]any) *PypiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PypiEntity) GetName() string { return e.name }
...
func (e *PypiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PypiEntity) Deleted() bool {
	return e.deleted
}


func (e *PypiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPypiEntity(e.client, opts)
}

func (e *PypiEntity) Data(args ...any) any {
...
func (e *PypiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pypi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PypiEntity) DataTyped(data ...Pypi) Pypi {
	if len(data) > 0 {
		return typedFrom[Pypi](e.Data(asMap(data[0])))
	}
	return typedFrom[Pypi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pypi (all fields
// optional at the wire level).
func (e *PypiEntity) MatchTyped(match ...Pypi) Pypi {
	if len(match) > 0 {
		return typedFrom[Pypi](e.Match(asMap(match[0])))
	}
	return typedFrom[Pypi](e.Match())
}
...
func (e *PypiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PypiEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PypiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PypiEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PypiCreateData and returns an Pypi. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PypiEntity) CreateTyped(reqdata PypiCreateData, ctrl map[string]any) (Pypi, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Pypi{}, err
	}
	return typedFrom[Pypi](res), nil
}



func (e *PypiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PypiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PypiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
