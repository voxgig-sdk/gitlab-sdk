...
func NewClusterAgentEntity(client *core.GitlabSDK, entopts map[string]any) *ClusterAgentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClusterAgentEntity) GetName() string { return e.name }
...
func (e *ClusterAgentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClusterAgentEntity) Deleted() bool {
	return e.deleted
}


func (e *ClusterAgentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClusterAgentEntity(e.client, opts)
}

func (e *ClusterAgentEntity) Data(args ...any) any {
...
func (e *ClusterAgentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ClusterAgent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClusterAgentEntity) DataTyped(data ...ClusterAgent) ClusterAgent {
	if len(data) > 0 {
		return typedFrom[ClusterAgent](e.Data(asMap(data[0])))
	}
	return typedFrom[ClusterAgent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ClusterAgent (all fields
// optional at the wire level).
func (e *ClusterAgentEntity) MatchTyped(match ...ClusterAgent) ClusterAgent {
	if len(match) > 0 {
		return typedFrom[ClusterAgent](e.Match(asMap(match[0])))
	}
	return typedFrom[ClusterAgent](e.Match())
}
...
func (e *ClusterAgentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClusterAgentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ClusterAgentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ClusterAgentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ClusterAgentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ClusterAgentEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClusterAgentRemoveMatch and returns an ClusterAgent. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ClusterAgentEntity) RemoveTyped(reqmatch ClusterAgentRemoveMatch, ctrl map[string]any) (ClusterAgent, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return ClusterAgent{}, err
	}
	return typedFrom[ClusterAgent](res), nil
}



func (e *ClusterAgentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
