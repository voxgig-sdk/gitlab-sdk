...
type PersonalAccessTokenEntity struct {
	name    string
...
func NewPersonalAccessTokenEntity(client *core.GitlabSDK, entopts map[string]any) *PersonalAccessTokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PersonalAccessTokenEntity) GetName() string { return e.name }
...
func (e *PersonalAccessTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PersonalAccessTokenEntity) Deleted() bool {
	return e.deleted
}


func (e *PersonalAccessTokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPersonalAccessTokenEntity(e.client, opts)
}

func (e *PersonalAccessTokenEntity) Data(args ...any) any {
...
func (e *PersonalAccessTokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PersonalAccessToken; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PersonalAccessTokenEntity) DataTyped(data ...PersonalAccessToken) PersonalAccessToken {
	if len(data) > 0 {
		return typedFrom[PersonalAccessToken](e.Data(asMap(data[0])))
	}
	return typedFrom[PersonalAccessToken](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PersonalAccessToken (all fields
// optional at the wire level).
func (e *PersonalAccessTokenEntity) MatchTyped(match ...PersonalAccessToken) PersonalAccessToken {
	if len(match) > 0 {
		return typedFrom[PersonalAccessToken](e.Match(asMap(match[0])))
	}
	return typedFrom[PersonalAccessToken](e.Match())
}
...
func (e *PersonalAccessTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PersonalAccessTokenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PersonalAccessTokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PersonalAccessTokenEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PersonalAccessTokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *PersonalAccessTokenEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PersonalAccessTokenRemoveMatch and returns an PersonalAccessToken. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PersonalAccessTokenEntity) RemoveTyped(reqmatch PersonalAccessTokenRemoveMatch, ctrl map[string]any) (PersonalAccessToken, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return PersonalAccessToken{}, err
	}
	return typedFrom[PersonalAccessToken](res), nil
}



func (e *PersonalAccessTokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
