...
func NewGroupImportEntity(client *core.GitlabSDK, entopts map[string]any) *GroupImportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GroupImportEntity) GetName() string { return e.name }
...
func (e *GroupImportEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GroupImportEntity) Deleted() bool {
	return e.deleted
}


func (e *GroupImportEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGroupImportEntity(e.client, opts)
}

func (e *GroupImportEntity) Data(args ...any) any {
...
func (e *GroupImportEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GroupImport; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GroupImportEntity) DataTyped(data ...GroupImport) GroupImport {
	if len(data) > 0 {
		return typedFrom[GroupImport](e.Data(asMap(data[0])))
	}
	return typedFrom[GroupImport](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GroupImport (all fields
// optional at the wire level).
func (e *GroupImportEntity) MatchTyped(match ...GroupImport) GroupImport {
	if len(match) > 0 {
		return typedFrom[GroupImport](e.Match(asMap(match[0])))
	}
	return typedFrom[GroupImport](e.Match())
}
...
func (e *GroupImportEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GroupImportEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GroupImportEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GroupImportEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GroupImportCreateData and returns an GroupImport. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GroupImportEntity) CreateTyped(reqdata GroupImportCreateData, ctrl map[string]any) (GroupImport, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return GroupImport{}, err
	}
	return typedFrom[GroupImport](res), nil
}



func (e *GroupImportEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GroupImportEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GroupImportEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
