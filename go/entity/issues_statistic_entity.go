...
type IssuesStatisticEntity struct {
	name    string
...
func NewIssuesStatisticEntity(client *core.GitlabSDK, entopts map[string]any) *IssuesStatisticEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IssuesStatisticEntity) GetName() string { return e.name }
...
func (e *IssuesStatisticEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IssuesStatisticEntity) Deleted() bool {
	return e.deleted
}


func (e *IssuesStatisticEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIssuesStatisticEntity(e.client, opts)
}

func (e *IssuesStatisticEntity) Data(args ...any) any {
...
func (e *IssuesStatisticEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IssuesStatistic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IssuesStatisticEntity) DataTyped(data ...IssuesStatistic) IssuesStatistic {
	if len(data) > 0 {
		return typedFrom[IssuesStatistic](e.Data(asMap(data[0])))
	}
	return typedFrom[IssuesStatistic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IssuesStatistic (all fields
// optional at the wire level).
func (e *IssuesStatisticEntity) MatchTyped(match ...IssuesStatistic) IssuesStatistic {
	if len(match) > 0 {
		return typedFrom[IssuesStatistic](e.Match(asMap(match[0])))
	}
	return typedFrom[IssuesStatistic](e.Match())
}
...
func (e *IssuesStatisticEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IssuesStatisticEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IssuesStatisticLoadMatch and returns an IssuesStatistic. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IssuesStatisticEntity) LoadTyped(reqmatch IssuesStatisticLoadMatch, ctrl map[string]any) (IssuesStatistic, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IssuesStatistic{}, err
	}
	return typedFrom[IssuesStatistic](res), nil
}



func (e *IssuesStatisticEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IssuesStatisticEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IssuesStatisticEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IssuesStatisticEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IssuesStatisticEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
