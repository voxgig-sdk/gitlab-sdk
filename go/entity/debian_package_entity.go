...
type DebianPackageEntity struct {
	name    string
...
func NewDebianPackageEntity(client *core.GitlabSDK, entopts map[string]any) *DebianPackageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DebianPackageEntity) GetName() string { return e.name }
...
func (e *DebianPackageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DebianPackageEntity) Deleted() bool {
	return e.deleted
}


func (e *DebianPackageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDebianPackageEntity(e.client, opts)
}

func (e *DebianPackageEntity) Data(args ...any) any {
...
func (e *DebianPackageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DebianPackage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DebianPackageEntity) DataTyped(data ...DebianPackage) DebianPackage {
	if len(data) > 0 {
		return typedFrom[DebianPackage](e.Data(asMap(data[0])))
	}
	return typedFrom[DebianPackage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DebianPackage (all fields
// optional at the wire level).
func (e *DebianPackageEntity) MatchTyped(match ...DebianPackage) DebianPackage {
	if len(match) > 0 {
		return typedFrom[DebianPackage](e.Match(asMap(match[0])))
	}
	return typedFrom[DebianPackage](e.Match())
}
...
func (e *DebianPackageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DebianPackageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DebianPackageLoadMatch and returns an DebianPackage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DebianPackageEntity) LoadTyped(reqmatch DebianPackageLoadMatch, ctrl map[string]any) (DebianPackage, error) {
...
func (e *DebianPackageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DebianPackageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *DebianPackageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
