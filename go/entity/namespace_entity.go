...
func NewNamespaceEntity(client *core.GitlabSDK, entopts map[string]any) *NamespaceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NamespaceEntity) GetName() string { return e.name }
...
func (e *NamespaceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NamespaceEntity) Deleted() bool {
	return e.deleted
}


func (e *NamespaceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNamespaceEntity(e.client, opts)
}

func (e *NamespaceEntity) Data(args ...any) any {
...
func (e *NamespaceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Namespace; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NamespaceEntity) DataTyped(data ...Namespace) Namespace {
	if len(data) > 0 {
		return typedFrom[Namespace](e.Data(asMap(data[0])))
	}
	return typedFrom[Namespace](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Namespace (all fields
// optional at the wire level).
func (e *NamespaceEntity) MatchTyped(match ...Namespace) Namespace {
	if len(match) > 0 {
		return typedFrom[Namespace](e.Match(asMap(match[0])))
	}
	return typedFrom[Namespace](e.Match())
}
...
func (e *NamespaceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NamespaceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *NamespaceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NamespaceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NamespaceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *NamespaceEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NamespaceRemoveMatch and returns an Namespace. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *NamespaceEntity) RemoveTyped(reqmatch NamespaceRemoveMatch, ctrl map[string]any) (Namespace, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Namespace{}, err
	}
	return typedFrom[Namespace](res), nil
}



func (e *NamespaceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
