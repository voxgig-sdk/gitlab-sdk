...
func NewBranchEntity(client *core.GitlabSDK, entopts map[string]any) *BranchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BranchEntity) GetName() string { return e.name }
...
func (e *BranchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BranchEntity) Deleted() bool {
	return e.deleted
}


func (e *BranchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBranchEntity(e.client, opts)
}

func (e *BranchEntity) Data(args ...any) any {
...
func (e *BranchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Branch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BranchEntity) DataTyped(data ...Branch) Branch {
	if len(data) > 0 {
		return typedFrom[Branch](e.Data(asMap(data[0])))
	}
	return typedFrom[Branch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Branch (all fields
// optional at the wire level).
func (e *BranchEntity) MatchTyped(match ...Branch) Branch {
	if len(match) > 0 {
		return typedFrom[Branch](e.Match(asMap(match[0])))
	}
	return typedFrom[Branch](e.Match())
}
...
func (e *BranchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BranchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BranchEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BranchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BranchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *BranchEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BranchRemoveMatch and returns an Branch. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *BranchEntity) RemoveTyped(reqmatch BranchRemoveMatch, ctrl map[string]any) (Branch, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Branch{}, err
	}
	return typedFrom[Branch](res), nil
}



func (e *BranchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
