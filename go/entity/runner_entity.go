...
func NewRunnerEntity(client *core.GitlabSDK, entopts map[string]any) *RunnerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RunnerEntity) GetName() string { return e.name }
...
func (e *RunnerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RunnerEntity) Deleted() bool {
	return e.deleted
}


func (e *RunnerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRunnerEntity(e.client, opts)
}

func (e *RunnerEntity) Data(args ...any) any {
...
func (e *RunnerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Runner; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RunnerEntity) DataTyped(data ...Runner) Runner {
	if len(data) > 0 {
		return typedFrom[Runner](e.Data(asMap(data[0])))
	}
	return typedFrom[Runner](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Runner (all fields
// optional at the wire level).
func (e *RunnerEntity) MatchTyped(match ...Runner) Runner {
	if len(match) > 0 {
		return typedFrom[Runner](e.Match(asMap(match[0])))
	}
	return typedFrom[Runner](e.Match())
}
...
func (e *RunnerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RunnerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RunnerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RunnerEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RunnerCreateData and returns an Runner. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RunnerEntity) CreateTyped(reqdata RunnerCreateData, ctrl map[string]any) (Runner, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Runner{}, err
	}
	return typedFrom[Runner](res), nil
}



func (e *RunnerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *RunnerEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// RunnerRemoveMatch and returns an Runner. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *RunnerEntity) RemoveTyped(reqmatch RunnerRemoveMatch, ctrl map[string]any) (Runner, error) {
...
func (e *RunnerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
