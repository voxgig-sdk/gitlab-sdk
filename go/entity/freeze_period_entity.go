...
type FreezePeriodEntity struct {
	name    string
...
func NewFreezePeriodEntity(client *core.GitlabSDK, entopts map[string]any) *FreezePeriodEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FreezePeriodEntity) GetName() string { return e.name }
...
func (e *FreezePeriodEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FreezePeriodEntity) Deleted() bool {
	return e.deleted
}


func (e *FreezePeriodEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFreezePeriodEntity(e.client, opts)
}

func (e *FreezePeriodEntity) Data(args ...any) any {
...
func (e *FreezePeriodEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FreezePeriod; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FreezePeriodEntity) DataTyped(data ...FreezePeriod) FreezePeriod {
	if len(data) > 0 {
		return typedFrom[FreezePeriod](e.Data(asMap(data[0])))
	}
	return typedFrom[FreezePeriod](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FreezePeriod (all fields
// optional at the wire level).
func (e *FreezePeriodEntity) MatchTyped(match ...FreezePeriod) FreezePeriod {
	if len(match) > 0 {
		return typedFrom[FreezePeriod](e.Match(asMap(match[0])))
	}
	return typedFrom[FreezePeriod](e.Match())
}
...
func (e *FreezePeriodEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FreezePeriodEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *FreezePeriodEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FreezePeriodEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FreezePeriodEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *FreezePeriodEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FreezePeriodRemoveMatch and returns an FreezePeriod. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *FreezePeriodEntity) RemoveTyped(reqmatch FreezePeriodRemoveMatch, ctrl map[string]any) (FreezePeriod, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return FreezePeriod{}, err
	}
	return typedFrom[FreezePeriod](res), nil
}



func (e *FreezePeriodEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
