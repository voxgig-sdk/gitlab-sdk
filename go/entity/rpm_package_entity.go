...
func NewRpmPackageEntity(client *core.GitlabSDK, entopts map[string]any) *RpmPackageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RpmPackageEntity) GetName() string { return e.name }
...
func (e *RpmPackageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RpmPackageEntity) Deleted() bool {
	return e.deleted
}


func (e *RpmPackageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRpmPackageEntity(e.client, opts)
}

func (e *RpmPackageEntity) Data(args ...any) any {
...
func (e *RpmPackageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RpmPackage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RpmPackageEntity) DataTyped(data ...RpmPackage) RpmPackage {
	if len(data) > 0 {
		return typedFrom[RpmPackage](e.Data(asMap(data[0])))
	}
	return typedFrom[RpmPackage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RpmPackage (all fields
// optional at the wire level).
func (e *RpmPackageEntity) MatchTyped(match ...RpmPackage) RpmPackage {
	if len(match) > 0 {
		return typedFrom[RpmPackage](e.Match(asMap(match[0])))
	}
	return typedFrom[RpmPackage](e.Match())
}
...
func (e *RpmPackageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RpmPackageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RpmPackageLoadMatch and returns an RpmPackage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RpmPackageEntity) LoadTyped(reqmatch RpmPackageLoadMatch, ctrl map[string]any) (RpmPackage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RpmPackage{}, err
	}
	return typedFrom[RpmPackage](res), nil
}



func (e *RpmPackageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RpmPackageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// RpmPackageCreateData and returns an RpmPackage. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RpmPackageEntity) CreateTyped(reqdata RpmPackageCreateData, ctrl map[string]any) (RpmPackage, error) {
...
func (e *RpmPackageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RpmPackageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RpmPackageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
