...
func NewNpmEntity(client *core.GitlabSDK, entopts map[string]any) *NpmEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NpmEntity) GetName() string { return e.name }
...
func (e *NpmEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NpmEntity) Deleted() bool {
	return e.deleted
}


func (e *NpmEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNpmEntity(e.client, opts)
}

func (e *NpmEntity) Data(args ...any) any {
...
func (e *NpmEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Npm; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NpmEntity) DataTyped(data ...Npm) Npm {
	if len(data) > 0 {
		return typedFrom[Npm](e.Data(asMap(data[0])))
	}
	return typedFrom[Npm](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Npm (all fields
// optional at the wire level).
func (e *NpmEntity) MatchTyped(match ...Npm) Npm {
	if len(match) > 0 {
		return typedFrom[Npm](e.Match(asMap(match[0])))
	}
	return typedFrom[Npm](e.Match())
}
...
func (e *NpmEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NpmEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *NpmEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NpmEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *NpmEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NpmUpdateData and returns an Npm. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *NpmEntity) UpdateTyped(reqdata NpmUpdateData, ctrl map[string]any) (Npm, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return Npm{}, err
	}
	return typedFrom[Npm](res), nil
}



func (e *NpmEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NpmEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
