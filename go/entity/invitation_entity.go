...
func NewInvitationEntity(client *core.GitlabSDK, entopts map[string]any) *InvitationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InvitationEntity) GetName() string { return e.name }
...
func (e *InvitationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InvitationEntity) Deleted() bool {
	return e.deleted
}


func (e *InvitationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInvitationEntity(e.client, opts)
}

func (e *InvitationEntity) Data(args ...any) any {
...
func (e *InvitationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Invitation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InvitationEntity) DataTyped(data ...Invitation) Invitation {
	if len(data) > 0 {
		return typedFrom[Invitation](e.Data(asMap(data[0])))
	}
	return typedFrom[Invitation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Invitation (all fields
// optional at the wire level).
func (e *InvitationEntity) MatchTyped(match ...Invitation) Invitation {
	if len(match) > 0 {
		return typedFrom[Invitation](e.Match(asMap(match[0])))
	}
	return typedFrom[Invitation](e.Match())
}
...
func (e *InvitationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InvitationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *InvitationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InvitationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InvitationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *InvitationEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InvitationRemoveMatch and returns an Invitation. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *InvitationEntity) RemoveTyped(reqmatch InvitationRemoveMatch, ctrl map[string]any) (Invitation, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Invitation{}, err
	}
	return typedFrom[Invitation](res), nil
}



func (e *InvitationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
