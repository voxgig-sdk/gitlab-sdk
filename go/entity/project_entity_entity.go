...
type ProjectEntityEntity struct {
	name    string
...
func NewProjectEntityEntity(client *core.GitlabSDK, entopts map[string]any) *ProjectEntityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProjectEntityEntity) GetName() string { return e.name }
...
func (e *ProjectEntityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProjectEntityEntity) Deleted() bool {
	return e.deleted
}


func (e *ProjectEntityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProjectEntityEntity(e.client, opts)
}

func (e *ProjectEntityEntity) Data(args ...any) any {
...
func (e *ProjectEntityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProjectEntity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProjectEntityEntity) DataTyped(data ...ProjectEntity) ProjectEntity {
	if len(data) > 0 {
		return typedFrom[ProjectEntity](e.Data(asMap(data[0])))
	}
	return typedFrom[ProjectEntity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProjectEntity (all fields
// optional at the wire level).
func (e *ProjectEntityEntity) MatchTyped(match ...ProjectEntity) ProjectEntity {
	if len(match) > 0 {
		return typedFrom[ProjectEntity](e.Match(asMap(match[0])))
	}
	return typedFrom[ProjectEntity](e.Match())
}
...
func (e *ProjectEntityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProjectEntityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ProjectEntityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ProjectEntityEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProjectEntityCreateData and returns an ProjectEntity. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ProjectEntityEntity) CreateTyped(reqdata ProjectEntityCreateData, ctrl map[string]any) (ProjectEntity, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ProjectEntity{}, err
	}
	return typedFrom[ProjectEntity](res), nil
}



func (e *ProjectEntityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProjectEntityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProjectEntityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
