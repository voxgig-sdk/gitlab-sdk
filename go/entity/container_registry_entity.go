...
func NewContainerRegistryEntity(client *core.GitlabSDK, entopts map[string]any) *ContainerRegistryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContainerRegistryEntity) GetName() string { return e.name }
...
func (e *ContainerRegistryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContainerRegistryEntity) Deleted() bool {
	return e.deleted
}


func (e *ContainerRegistryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContainerRegistryEntity(e.client, opts)
}

func (e *ContainerRegistryEntity) Data(args ...any) any {
...
func (e *ContainerRegistryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ContainerRegistry; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContainerRegistryEntity) DataTyped(data ...ContainerRegistry) ContainerRegistry {
	if len(data) > 0 {
		return typedFrom[ContainerRegistry](e.Data(asMap(data[0])))
	}
	return typedFrom[ContainerRegistry](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ContainerRegistry (all fields
// optional at the wire level).
func (e *ContainerRegistryEntity) MatchTyped(match ...ContainerRegistry) ContainerRegistry {
	if len(match) > 0 {
		return typedFrom[ContainerRegistry](e.Match(asMap(match[0])))
	}
	return typedFrom[ContainerRegistry](e.Match())
}
...
func (e *ContainerRegistryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContainerRegistryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ContainerRegistryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ContainerRegistryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContainerRegistryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ContainerRegistryEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContainerRegistryRemoveMatch and returns an ContainerRegistry. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ContainerRegistryEntity) RemoveTyped(reqmatch ContainerRegistryRemoveMatch, ctrl map[string]any) (ContainerRegistry, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return ContainerRegistry{}, err
	}
	return typedFrom[ContainerRegistry](res), nil
}



func (e *ContainerRegistryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
