...
func NewClusterEntity(client *core.GitlabSDK, entopts map[string]any) *ClusterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClusterEntity) GetName() string { return e.name }
...
func (e *ClusterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClusterEntity) Deleted() bool {
	return e.deleted
}


func (e *ClusterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClusterEntity(e.client, opts)
}

func (e *ClusterEntity) Data(args ...any) any {
...
func (e *ClusterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cluster; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClusterEntity) DataTyped(data ...Cluster) Cluster {
	if len(data) > 0 {
		return typedFrom[Cluster](e.Data(asMap(data[0])))
	}
	return typedFrom[Cluster](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cluster (all fields
// optional at the wire level).
func (e *ClusterEntity) MatchTyped(match ...Cluster) Cluster {
	if len(match) > 0 {
		return typedFrom[Cluster](e.Match(asMap(match[0])))
	}
	return typedFrom[Cluster](e.Match())
}
...
func (e *ClusterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClusterEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ClusterEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ClusterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ClusterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ClusterEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClusterRemoveMatch and returns an Cluster. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ClusterEntity) RemoveTyped(reqmatch ClusterRemoveMatch, ctrl map[string]any) (Cluster, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Cluster{}, err
	}
	return typedFrom[Cluster](res), nil
}



func (e *ClusterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
