...
func NewUsageDataEntity(client *core.GitlabSDK, entopts map[string]any) *UsageDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UsageDataEntity) GetName() string { return e.name }
...
func (e *UsageDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UsageDataEntity) Deleted() bool {
	return e.deleted
}


func (e *UsageDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUsageDataEntity(e.client, opts)
}

func (e *UsageDataEntity) Data(args ...any) any {
...
func (e *UsageDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UsageData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UsageDataEntity) DataTyped(data ...UsageData) UsageData {
	if len(data) > 0 {
		return typedFrom[UsageData](e.Data(asMap(data[0])))
	}
	return typedFrom[UsageData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UsageData (all fields
// optional at the wire level).
func (e *UsageDataEntity) MatchTyped(match ...UsageData) UsageData {
	if len(match) > 0 {
		return typedFrom[UsageData](e.Match(asMap(match[0])))
	}
	return typedFrom[UsageData](e.Match())
}
...
func (e *UsageDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UsageDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UsageDataLoadMatch and returns an UsageData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UsageDataEntity) LoadTyped(reqmatch UsageDataLoadMatch, ctrl map[string]any) (UsageData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UsageData{}, err
	}
	return typedFrom[UsageData](res), nil
}



func (e *UsageDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UsageDataEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// UsageDataCreateData and returns an UsageData. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UsageDataEntity) CreateTyped(reqdata UsageDataCreateData, ctrl map[string]any) (UsageData, error) {
...
func (e *UsageDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UsageDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UsageDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
