...
type CargoPackageEntity struct {
	name    string
...
func NewCargoPackageEntity(client *core.GitlabSDK, entopts map[string]any) *CargoPackageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CargoPackageEntity) GetName() string { return e.name }
...
func (e *CargoPackageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CargoPackageEntity) Deleted() bool {
	return e.deleted
}


func (e *CargoPackageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCargoPackageEntity(e.client, opts)
}

func (e *CargoPackageEntity) Data(args ...any) any {
...
func (e *CargoPackageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CargoPackage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CargoPackageEntity) DataTyped(data ...CargoPackage) CargoPackage {
	if len(data) > 0 {
		return typedFrom[CargoPackage](e.Data(asMap(data[0])))
	}
	return typedFrom[CargoPackage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CargoPackage (all fields
// optional at the wire level).
func (e *CargoPackageEntity) MatchTyped(match ...CargoPackage) CargoPackage {
	if len(match) > 0 {
		return typedFrom[CargoPackage](e.Match(asMap(match[0])))
	}
	return typedFrom[CargoPackage](e.Match())
}
...
func (e *CargoPackageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CargoPackageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CargoPackageLoadMatch and returns an CargoPackage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CargoPackageEntity) LoadTyped(reqmatch CargoPackageLoadMatch, ctrl map[string]any) (CargoPackage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CargoPackage{}, err
	}
	return typedFrom[CargoPackage](res), nil
}



func (e *CargoPackageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CargoPackageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CargoPackageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CargoPackageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CargoPackageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
