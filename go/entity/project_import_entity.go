...
func (e *ProjectImportEntityClient) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProjectImportEntityClient) Deleted() bool {
	return e.deleted
}
...
func (e *ProjectImportEntityClient) DataTyped(data ...ProjectImport) ProjectImport {
	...
	return typedFrom[ProjectImport](e.Data())
}
...
func (e *ProjectImportEntityClient) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProjectImportEntityClient) CreateTyped(reqdata ProjectImportCreateData, ctrl map[string]any) (ProjectImport, error) {
	...
	return typedFrom[ProjectImport](res), nil
}
