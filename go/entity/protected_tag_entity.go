...
type ProtectedTagEntity struct {
	name    string
...
func NewProtectedTagEntity(client *core.GitlabSDK, entopts map[string]any) *ProtectedTagEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProtectedTagEntity) GetName() string { return e.name }
...
func (e *ProtectedTagEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProtectedTagEntity) Deleted() bool {
	return e.deleted
}


func (e *ProtectedTagEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProtectedTagEntity(e.client, opts)
}

func (e *ProtectedTagEntity) Data(args ...any) any {
...
func (e *ProtectedTagEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProtectedTag; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProtectedTagEntity) DataTyped(data ...ProtectedTag) ProtectedTag {
	if len(data) > 0 {
		return typedFrom[ProtectedTag](e.Data(asMap(data[0])))
	}
	return typedFrom[ProtectedTag](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProtectedTag (all fields
// optional at the wire level).
func (e *ProtectedTagEntity) MatchTyped(match ...ProtectedTag) ProtectedTag {
	if len(match) > 0 {
		return typedFrom[ProtectedTag](e.Match(asMap(match[0])))
	}
	return typedFrom[ProtectedTag](e.Match())
}
...
func (e *ProtectedTagEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProtectedTagEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ProtectedTagEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ProtectedTagEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProtectedTagEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ProtectedTagEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProtectedTagRemoveMatch and returns an ProtectedTag. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ProtectedTagEntity) RemoveTyped(reqmatch ProtectedTagRemoveMatch, ctrl map[string]any) (ProtectedTag, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return ProtectedTag{}, err
	}
	return typedFrom[ProtectedTag](res), nil
}



func (e *ProtectedTagEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
