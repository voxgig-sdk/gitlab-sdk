...
func NewTestReportSummaryEntity(client *core.GitlabSDK, entopts map[string]any) *TestReportSummaryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TestReportSummaryEntity) GetName() string { return e.name }
...
func (e *TestReportSummaryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TestReportSummaryEntity) Deleted() bool {
	return e.deleted
}


func (e *TestReportSummaryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTestReportSummaryEntity(e.client, opts)
}

func (e *TestReportSummaryEntity) Data(args ...any) any {
...
func (e *TestReportSummaryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TestReportSummary; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TestReportSummaryEntity) DataTyped(data ...TestReportSummary) TestReportSummary {
	if len(data) > 0 {
		return typedFrom[TestReportSummary](e.Data(asMap(data[0])))
	}
	return typedFrom[TestReportSummary](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TestReportSummary (all fields
// optional at the wire level).
func (e *TestReportSummaryEntity) MatchTyped(match ...TestReportSummary) TestReportSummary {
	if len(match) > 0 {
		return typedFrom[TestReportSummary](e.Match(asMap(match[0])))
	}
	return typedFrom[TestReportSummary](e.Match())
}
...
func (e *TestReportSummaryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TestReportSummaryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TestReportSummaryLoadMatch and returns an TestReportSummary. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TestReportSummaryEntity) LoadTyped(reqmatch TestReportSummaryLoadMatch, ctrl map[string]any) (TestReportSummary, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return TestReportSummary{}, err
	}
	return typedFrom[TestReportSummary](res), nil
}



func (e *TestReportSummaryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TestReportSummaryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TestReportSummaryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TestReportSummaryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TestReportSummaryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
