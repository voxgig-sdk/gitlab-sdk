...
class ApiEntitiesPackagePipelineEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    api_entities_package_pipeline_ref01_data_dt0_load_result = Helpers.to_map(api_entities_package_pipeline_ref01_data_dt0_loaded.respond_to?(:data_get) ? api_entities_package_pipeline_ref01_data_dt0_loaded.data_get : api_entities_package_pipeline_ref01_data_dt0_loaded)
