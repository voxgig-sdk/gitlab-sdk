...
class ApiEntitiesProjectHookEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    api_entities_project_hook_ref01_data = Helpers.to_map(api_entities_project_hook_ref01_data_result.respond_to?(:data_get) ? api_entities_project_hook_ref01_data_result.data_get : api_entities_project_hook_ref01_data_result)
    ...
    api_entities_project_hook_ref01_resdata_up0 = Helpers.to_map(api_entities_project_hook_ref01_resdata_up0_result.respond_to?(:data_get) ? api_entities_project_hook_ref01_resdata_up0_result.data_get : api_entities_project_hook_ref01_resdata_up0_result)
    ...
    api_entities_project_hook_ref01_data_dt0_load_result = Helpers.to_map(api_entities_project_hook_ref01_data_dt0_loaded.respond_to?(:data_get) ? api_entities_project_hook_ref01_data_dt0_loaded.data_get : api_entities_project_hook_ref01_data_dt0_loaded)
