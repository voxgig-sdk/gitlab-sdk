...
module GitlabTestRunner
  ...
  def self.env_override(m)
    live = getenv("GITLAB_TEST_LIVE")
    override = getenv("GITLAB_TEST_OVERRIDE")
    ...
    explain = getenv("GITLAB_TEST_EXPLAIN")
    m["GITLAB_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = GitlabTestRunner
Helpers = GitlabHelpers
Vs = VoxgigStruct
