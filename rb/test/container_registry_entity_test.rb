...
class ContainerRegistryEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GITLAB_TEST_CONTAINER_REGISTRY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
    ...
    container_registry_ref01_data = nil
...
def container_registry_basic_setup(extra)
  Runner.load_env_local

  entity_data_file = File.join(__dir__, "..", "..", ".sdk", "test", "entity", "container_registry", "ContainerRegistryTestData.json")
  ...
  entid_env_raw = ENV["GITLAB_TEST_CONTAINER_REGISTRY_ENTID"]
