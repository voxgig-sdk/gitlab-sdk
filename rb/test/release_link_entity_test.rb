...
class ReleaseLinkEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GITLAB_TEST_RELEASE_LINK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def release_link_basic_setup(extra)
  Runner.load_env_local

  entity_data_file = File.join(__dir__, "..", "..", ".sdk", "test", "entity", "release_link", "ReleaseLinkTestData.json")
  ...
  entid_env_raw = ENV["GITLAB_TEST_RELEASE_LINK_ENTID"]
