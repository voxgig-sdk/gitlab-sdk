...
class ApiEntitiesProjectGroupLinkEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    api_entities_project_group_link_ref01_data = Helpers.to_map(api_entities_project_group_link_ref01_data_result.respond_to?(:data_get) ? api_entities_project_group_link_ref01_data_result.data_get : api_entities_project_group_link_ref01_data_result)
