...
class ApiEntitiesBadgeEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBadgeEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBadge, Hash] the current ApiEntitiesBadge data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBadge fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesBadgeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesBadge.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBadge, Hash] the loaded ApiEntitiesBadge; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesBadgeListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesBadge fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesBadge>, Array] the matching ApiEntitiesBadge items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesBadgeCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBadge, Hash] the created ApiEntitiesBadge; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesBadgeUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBadge, Hash] the updated ApiEntitiesBadge; raises GitlabError on failure
