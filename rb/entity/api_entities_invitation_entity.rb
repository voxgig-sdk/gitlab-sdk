...
class ApiEntitiesInvitationEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesInvitationEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesInvitation, Hash] the current ApiEntitiesInvitation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesInvitation fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesInvitationListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesInvitation fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesInvitation>, Array] the matching ApiEntitiesInvitation items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesInvitationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesInvitation, Hash] the created ApiEntitiesInvitation; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesInvitationUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesInvitation, Hash] the updated ApiEntitiesInvitation; raises GitlabError on failure
