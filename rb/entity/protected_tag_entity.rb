...
class ProtectedTagEntity
  ...
  def make
    opts = @_entopts.dup
    ProtectedTagEntity.new(@_client, opts)
  end
  ...
  # @return [ProtectedTag, Hash] the current ProtectedTag data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProtectedTag fields)
  def match_get
  ...
  #
  # @param reqmatch [ProtectedTagRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProtectedTag, Hash] the removed ProtectedTag; raises GitlabError on failure
