...
class ApiEntitiesProjectWithAccessEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_project_with_access"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectWithAccessEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectWithAccess, Hash] the current ApiEntitiesProjectWithAccess data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectWithAccess fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProjectWithAccessLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesProjectWithAccess.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectWithAccess, Hash] the loaded ApiEntitiesProjectWithAccess; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProjectWithAccessCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectWithAccess, Hash] the created ApiEntitiesProjectWithAccess; raises GitlabError on failure
