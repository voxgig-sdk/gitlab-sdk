...
class ApiEntitiesBasicRefEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBasicRefEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBasicRef, Hash] the current ApiEntitiesBasicRef data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBasicRef fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesBasicRefListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesBasicRef fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesBasicRef>, Array] the matching ApiEntitiesBasicRef items; raises GitlabError on failure
