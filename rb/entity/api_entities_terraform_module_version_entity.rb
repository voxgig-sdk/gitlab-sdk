...
class ApiEntitiesTerraformModuleVersionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_terraform_module_version"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesTerraformModuleVersionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesTerraformModuleVersion, Hash] the current ApiEntitiesTerraformModuleVersion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesTerraformModuleVersion fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesTerraformModuleVersionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesTerraformModuleVersion.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesTerraformModuleVersion, Hash] the loaded ApiEntitiesTerraformModuleVersion; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesTerraformModuleVersionListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesTerraformModuleVersion fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesTerraformModuleVersion>, Array] the matching ApiEntitiesTerraformModuleVersion items; raises GitlabError on failure
