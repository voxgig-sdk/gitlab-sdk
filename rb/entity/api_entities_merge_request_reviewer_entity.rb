...
class ApiEntitiesMergeRequestReviewerEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_merge_request_reviewer"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMergeRequestReviewerEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMergeRequestReviewer, Hash] the current ApiEntitiesMergeRequestReviewer data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMergeRequestReviewer fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesMergeRequestReviewerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesMergeRequestReviewer.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMergeRequestReviewer, Hash] the loaded ApiEntitiesMergeRequestReviewer; raises GitlabError on failure
