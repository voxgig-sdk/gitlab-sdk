...
class GroupImportEntity
  ...
  def make
    opts = @_entopts.dup
    GroupImportEntity.new(@_client, opts)
  end
  ...
  # @return [GroupImport, Hash] the current GroupImport data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GroupImport fields)
  def match_get
  ...
  #
  # @param reqdata [GroupImportCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [GroupImport, Hash] the created GroupImport; raises GitlabError on failure
