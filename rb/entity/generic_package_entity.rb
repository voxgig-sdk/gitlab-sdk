...
class GenericPackageEntity
  ...
  def make
    opts = @_entopts.dup
    GenericPackageEntity.new(@_client, opts)
  end
  ...
  # @return [GenericPackage, Hash] the current GenericPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GenericPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [GenericPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GenericPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GenericPackage, Hash] the loaded GenericPackage; raises GitlabError on failure
  ...
  #
  # @param reqdata [GenericPackageUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [GenericPackage, Hash] the updated GenericPackage; raises GitlabError on failure
