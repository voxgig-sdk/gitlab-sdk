...
class ApiEntitiesMarkdownUploadAdminEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_markdown_upload_admin"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMarkdownUploadAdminEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMarkdownUploadAdmin, Hash] the current ApiEntitiesMarkdownUploadAdmin data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMarkdownUploadAdmin fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesMarkdownUploadAdminListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesMarkdownUploadAdmin fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesMarkdownUploadAdmin>, Array] the matching ApiEntitiesMarkdownUploadAdmin items; raises GitlabError on failure
