...
class ApiEntitiesDeployTokenEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_deploy_token"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDeployTokenEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDeployToken, Hash] the current ApiEntitiesDeployToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDeployToken fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesDeployTokenLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesDeployToken.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDeployToken, Hash] the loaded ApiEntitiesDeployToken; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesDeployTokenListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesDeployToken fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesDeployToken>, Array] the matching ApiEntitiesDeployToken items; raises GitlabError on failure
