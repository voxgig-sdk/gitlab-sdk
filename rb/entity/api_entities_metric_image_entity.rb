...
class ApiEntitiesMetricImageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_metric_image"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMetricImageEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMetricImage, Hash] the current ApiEntitiesMetricImage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMetricImage fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesMetricImageListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesMetricImage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesMetricImage>, Array] the matching ApiEntitiesMetricImage items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesMetricImageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMetricImage, Hash] the created ApiEntitiesMetricImage; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesMetricImageUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMetricImage, Hash] the updated ApiEntitiesMetricImage; raises GitlabError on failure
