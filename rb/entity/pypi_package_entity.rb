...
class PypiPackageEntity
  ...
  def make
    opts = @_entopts.dup
    PypiPackageEntity.new(@_client, opts)
  end
  ...
  # @return [PypiPackage, Hash] the current PypiPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PypiPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [PypiPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PypiPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PypiPackage, Hash] the loaded PypiPackage; raises GitlabError on failure
  ...
  #
  # @param reqdata [PypiPackageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PypiPackage, Hash] the created PypiPackage; raises GitlabError on failure
