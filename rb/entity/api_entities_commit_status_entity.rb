...
class ApiEntitiesCommitStatusEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_commit_status"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCommitStatusEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCommitStatus, Hash] the current ApiEntitiesCommitStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCommitStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCommitStatusListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCommitStatus fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCommitStatus>, Array] the matching ApiEntitiesCommitStatus items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCommitStatusCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCommitStatus, Hash] the created ApiEntitiesCommitStatus; raises GitlabError on failure
