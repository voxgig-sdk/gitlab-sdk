...
class ApiEntitiesProtectedTagEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_protected_tag"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProtectedTagEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProtectedTag, Hash] the current ApiEntitiesProtectedTag data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProtectedTag fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProtectedTagLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesProtectedTag.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProtectedTag, Hash] the loaded ApiEntitiesProtectedTag; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesProtectedTagListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesProtectedTag fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesProtectedTag>, Array] the matching ApiEntitiesProtectedTag items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProtectedTagCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProtectedTag, Hash] the created ApiEntitiesProtectedTag; raises GitlabError on failure
