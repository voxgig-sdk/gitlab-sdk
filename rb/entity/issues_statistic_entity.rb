...
class IssuesStatisticEntity
  ...
  def make
    opts = @_entopts.dup
    IssuesStatisticEntity.new(@_client, opts)
  end
  ...
  # @return [IssuesStatistic, Hash] the current IssuesStatistic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IssuesStatistic fields)
  def match_get
  ...
  #
  # @param reqmatch [IssuesStatisticLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.IssuesStatistic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [IssuesStatistic, Hash] the loaded IssuesStatistic; raises GitlabError on failure
