...
class ApiEntitiesProjectExportStatusEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_project_export_status"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectExportStatusEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectExportStatus, Hash] the current ApiEntitiesProjectExportStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectExportStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProjectExportStatusLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesProjectExportStatus.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectExportStatus, Hash] the loaded ApiEntitiesProjectExportStatus; raises GitlabError on failure
