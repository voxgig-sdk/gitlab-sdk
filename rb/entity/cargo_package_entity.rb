...
class CargoPackageEntity
  ...
  def make
    opts = @_entopts.dup
    CargoPackageEntity.new(@_client, opts)
  end
  ...
  # @return [CargoPackage, Hash] the current CargoPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CargoPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [CargoPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CargoPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CargoPackage, Hash] the loaded CargoPackage; raises GitlabError on failure
