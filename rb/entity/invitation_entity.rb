...
class InvitationEntity
  ...
  def make
    opts = @_entopts.dup
    InvitationEntity.new(@_client, opts)
  end
  ...
  # @return [Invitation, Hash] the current Invitation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Invitation fields)
  def match_get
  ...
  #
  # @param reqmatch [InvitationRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Invitation, Hash] the removed Invitation; raises GitlabError on failure
