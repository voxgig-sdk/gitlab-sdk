...
class TerraformRegistryEntity
  ...
  def make
    opts = @_entopts.dup
    TerraformRegistryEntity.new(@_client, opts)
  end
  ...
  # @return [TerraformRegistry, Hash] the current TerraformRegistry data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TerraformRegistry fields)
  def match_get
  ...
  #
  # @param reqmatch [TerraformRegistryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.TerraformRegistry.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [TerraformRegistry, Hash] the loaded TerraformRegistry; raises GitlabError on failure
  ...
  #
  # @param reqdata [TerraformRegistryUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TerraformRegistry, Hash] the updated TerraformRegistry; raises GitlabError on failure
