...
class ApiEntitiesClusterGroupEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_cluster_group"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesClusterGroupEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesClusterGroup, Hash] the current ApiEntitiesClusterGroup data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesClusterGroup fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesClusterGroupLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesClusterGroup.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesClusterGroup, Hash] the loaded ApiEntitiesClusterGroup; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesClusterGroupCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesClusterGroup, Hash] the created ApiEntitiesClusterGroup; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesClusterGroupUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesClusterGroup, Hash] the updated ApiEntitiesClusterGroup; raises GitlabError on failure
