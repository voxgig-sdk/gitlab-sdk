...
class ApiEntitiesResourceMilestoneEventEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_resource_milestone_event"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesResourceMilestoneEventEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesResourceMilestoneEvent, Hash] the current ApiEntitiesResourceMilestoneEvent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesResourceMilestoneEvent fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesResourceMilestoneEventLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesResourceMilestoneEvent.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesResourceMilestoneEvent, Hash] the loaded ApiEntitiesResourceMilestoneEvent; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesResourceMilestoneEventListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesResourceMilestoneEvent fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesResourceMilestoneEvent>, Array] the matching ApiEntitiesResourceMilestoneEvent items; raises GitlabError on failure
