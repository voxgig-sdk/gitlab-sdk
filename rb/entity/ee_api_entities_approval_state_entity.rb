...
class EeApiEntitiesApprovalStateEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "ee_api_entities_approval_state"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    EeApiEntitiesApprovalStateEntity.new(@_client, opts)
  end
  ...
  # @return [EeApiEntitiesApprovalState, Hash] the current EeApiEntitiesApprovalState data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EeApiEntitiesApprovalState fields)
  def match_get
  ...
  #
  # @param reqdata [EeApiEntitiesApprovalStateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EeApiEntitiesApprovalState, Hash] the created EeApiEntitiesApprovalState; raises GitlabError on failure
