...
class ApiEntitiesProjectsTopicEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_projects_topic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectsTopicEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectsTopic, Hash] the current ApiEntitiesProjectsTopic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectsTopic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProjectsTopicLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesProjectsTopic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectsTopic, Hash] the loaded ApiEntitiesProjectsTopic; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProjectsTopicCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectsTopic, Hash] the created ApiEntitiesProjectsTopic; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProjectsTopicUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectsTopic, Hash] the updated ApiEntitiesProjectsTopic; raises GitlabError on failure
