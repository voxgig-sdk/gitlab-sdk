...
class ApiEntitiesSshKeyWithUserEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ssh_key_with_user"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesSshKeyWithUserEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesSshKeyWithUser, Hash] the current ApiEntitiesSshKeyWithUser data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesSshKeyWithUser fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesSshKeyWithUserLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesSshKeyWithUser.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesSshKeyWithUser, Hash] the loaded ApiEntitiesSshKeyWithUser; raises GitlabError on failure
