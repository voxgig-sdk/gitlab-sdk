...
class GeoEntity
  ...
  # @return [Geo, Hash] the loaded Geo; raises GitlabError on failure
  ...
  # Create a new Geo.
  #
  # @param reqdata [GeoCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Geo, Hash] the created Geo; raises GitlabError on failure
