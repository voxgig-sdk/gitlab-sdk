...
class ClusterEntity
  ...
  def make
    opts = @_entopts.dup
    ClusterEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ClusterRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cluster, Hash] the removed Cluster; raises GitlabError on failure
