...
class ApiEntitiesProjectRepositoryStorageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_project_repository_storage"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectRepositoryStorageEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectRepositoryStorage, Hash] the current ApiEntitiesProjectRepositoryStorage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectRepositoryStorage fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProjectRepositoryStorageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesProjectRepositoryStorage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectRepositoryStorage, Hash] the loaded ApiEntitiesProjectRepositoryStorage; raises GitlabError on failure
