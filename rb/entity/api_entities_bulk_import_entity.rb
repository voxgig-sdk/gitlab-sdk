...
class ApiEntitiesBulkImportEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_bulk_import"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBulkImportEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBulkImport, Hash] the current ApiEntitiesBulkImport data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBulkImport fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesBulkImportLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesBulkImport.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBulkImport, Hash] the loaded ApiEntitiesBulkImport; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesBulkImportListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesBulkImport fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesBulkImport>, Array] the matching ApiEntitiesBulkImport items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesBulkImportCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBulkImport, Hash] the created ApiEntitiesBulkImport; raises GitlabError on failure
