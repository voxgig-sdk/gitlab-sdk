...
class EnvironmentEntity
  ...
  def make
    opts = @_entopts.dup
    EnvironmentEntity.new(@_client, opts)
  end
  ...
  # @return [Environment, Hash] the current Environment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Environment fields)
  def match_get
  ...
  #
  # @param reqdata [EnvironmentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Environment, Hash] the created Environment; raises GitlabError on failure
  ...
  #
  # @param reqmatch [EnvironmentRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Environment, Hash] the removed Environment; raises GitlabError on failure
