...
class PackageFileEntity
  ...
  def make
    opts = @_entopts.dup
    PackageFileEntity.new(@_client, opts)
  end
  ...
  # @return [PackageFile, Hash] the current PackageFile data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PackageFile fields)
  def match_get
  ...
  #
  # @param reqmatch [PackageFileLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PackageFile.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PackageFile, Hash] the loaded PackageFile; raises GitlabError on failure
  ...
  #
  # @param reqmatch [PackageFileRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [PackageFile, Hash] the removed PackageFile; raises GitlabError on failure
