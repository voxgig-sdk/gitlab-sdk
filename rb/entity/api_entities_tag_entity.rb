...
class ApiEntitiesTagEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesTagEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesTag, Hash] the current ApiEntitiesTag data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesTag fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesTagLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesTag.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesTag, Hash] the loaded ApiEntitiesTag; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesTagListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesTag fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesTag>, Array] the matching ApiEntitiesTag items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesTagCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesTag, Hash] the created ApiEntitiesTag; raises GitlabError on failure
