...
class ApiEntitiesBasicSuccessEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_basic_success"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBasicSuccessEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBasicSuccess, Hash] the current ApiEntitiesBasicSuccess data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBasicSuccess fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesBasicSuccessCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBasicSuccess, Hash] the created ApiEntitiesBasicSuccess; raises GitlabError on failure
