...
class EeApiEntitiesBillableMembershipEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "ee_api_entities_billable_membership"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    EeApiEntitiesBillableMembershipEntity.new(@_client, opts)
  end
  ...
  # @return [EeApiEntitiesBillableMembership, Hash] the current EeApiEntitiesBillableMembership data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EeApiEntitiesBillableMembership fields)
  def match_get
  ...
  #
  # @param reqmatch [EeApiEntitiesBillableMembershipLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.EeApiEntitiesBillableMembership.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [EeApiEntitiesBillableMembership, Hash] the loaded EeApiEntitiesBillableMembership; raises GitlabError on failure
