...
class MlModelRegistryEntity
  ...
  def make
    opts = @_entopts.dup
    MlModelRegistryEntity.new(@_client, opts)
  end
  ...
  # @return [MlModelRegistry, Hash] the current MlModelRegistry data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MlModelRegistry fields)
  def match_get
  ...
  #
  # @param reqmatch [MlModelRegistryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.MlModelRegistry.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [MlModelRegistry, Hash] the loaded MlModelRegistry; raises GitlabError on failure
  ...
  #
  # @param reqdata [MlModelRegistryUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MlModelRegistry, Hash] the updated MlModelRegistry; raises GitlabError on failure
