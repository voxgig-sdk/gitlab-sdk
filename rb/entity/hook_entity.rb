...
class HookEntity
  ...
  # @return [Hook, Hash] the current Hook data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Hook fields)
  def match_get
  ...
  # Create a new Hook.
  #
  # @param reqdata [HookCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Hook, Hash] the created Hook; raises GitlabError on failure
  ...
  #
  # @param reqdata [HookUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Hook, Hash] the updated Hook; raises GitlabError on failure
  ...
  #
  # @param reqmatch [HookRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Hook, Hash] the removed Hook; raises GitlabError on failure
