...
class WikiEntity
  ...
  # @return [Wiki, Hash] the current Wiki data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Wiki fields)
  def match_get
  ...
  #
  # @param reqmatch [WikiRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Wiki, Hash] the removed Wiki; raises GitlabError on failure
