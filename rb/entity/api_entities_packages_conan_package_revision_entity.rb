...
class ApiEntitiesPackagesConanPackageRevisionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_packages_conan_package_revision"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackagesConanPackageRevisionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackagesConanPackageRevision, Hash] the current ApiEntitiesPackagesConanPackageRevision data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackagesConanPackageRevision fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPackagesConanPackageRevisionListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesPackagesConanPackageRevision fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesPackagesConanPackageRevision>, Array] the matching ApiEntitiesPackagesConanPackageRevision items; raises GitlabError on failure
