...
class ApiEntitiesUserAgentDetailEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_user_agent_detail"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesUserAgentDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesUserAgentDetail, Hash] the current ApiEntitiesUserAgentDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesUserAgentDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesUserAgentDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesUserAgentDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesUserAgentDetail, Hash] the loaded ApiEntitiesUserAgentDetail; raises GitlabError on failure
