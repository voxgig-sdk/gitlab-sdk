...
class ApiEntitiesDiffEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDiffEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDiff, Hash] the current ApiEntitiesDiff data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDiff fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesDiffLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesDiff.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDiff, Hash] the loaded ApiEntitiesDiff; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesDiffListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesDiff fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesDiff>, Array] the matching ApiEntitiesDiff items; raises GitlabError on failure
