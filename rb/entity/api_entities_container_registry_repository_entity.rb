...
class ApiEntitiesContainerRegistryRepositoryEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_container_registry_repository"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesContainerRegistryRepositoryEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesContainerRegistryRepository, Hash] the current ApiEntitiesContainerRegistryRepository data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesContainerRegistryRepository fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesContainerRegistryRepositoryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesContainerRegistryRepository.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesContainerRegistryRepository, Hash] the loaded ApiEntitiesContainerRegistryRepository; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesContainerRegistryRepositoryListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesContainerRegistryRepository fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesContainerRegistryRepository>, Array] the matching ApiEntitiesContainerRegistryRepository items; raises GitlabError on failure
