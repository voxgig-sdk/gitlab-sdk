...
class CiVariableEntity
  ...
  def make
    opts = @_entopts.dup
    CiVariableEntity.new(@_client, opts)
  end
  ...
  # @return [CiVariable, Hash] the current CiVariable data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CiVariable fields)
  def match_get
  ...
  #
  # @param reqmatch [CiVariableRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [CiVariable, Hash] the removed CiVariable; raises GitlabError on failure
