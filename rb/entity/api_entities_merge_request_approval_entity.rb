...
class ApiEntitiesMergeRequestApprovalEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_merge_request_approval"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMergeRequestApprovalEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMergeRequestApproval, Hash] the current ApiEntitiesMergeRequestApproval data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMergeRequestApproval fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesMergeRequestApprovalLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesMergeRequestApproval.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMergeRequestApproval, Hash] the loaded ApiEntitiesMergeRequestApproval; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesMergeRequestApprovalCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMergeRequestApproval, Hash] the created ApiEntitiesMergeRequestApproval; raises GitlabError on failure
