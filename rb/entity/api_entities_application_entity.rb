...
class ApiEntitiesApplicationEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_application"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesApplicationEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesApplication, Hash] the current ApiEntitiesApplication data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesApplication fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesApplicationListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesApplication fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesApplication>, Array] the matching ApiEntitiesApplication items; raises GitlabError on failure
