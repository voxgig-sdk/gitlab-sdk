...
class ApiEntitiesPersonalAccessTokenEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_personal_access_token"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPersonalAccessTokenEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPersonalAccessToken, Hash] the current ApiEntitiesPersonalAccessToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPersonalAccessToken fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPersonalAccessTokenListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesPersonalAccessToken fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesPersonalAccessToken>, Array] the matching ApiEntitiesPersonalAccessToken items; raises GitlabError on failure
