...
class ApiEntitiesBasicProjectDetailEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_basic_project_detail"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBasicProjectDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBasicProjectDetail, Hash] the current ApiEntitiesBasicProjectDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBasicProjectDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesBasicProjectDetailListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesBasicProjectDetail fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesBasicProjectDetail>, Array] the matching ApiEntitiesBasicProjectDetail items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesBasicProjectDetailCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBasicProjectDetail, Hash] the created ApiEntitiesBasicProjectDetail; raises GitlabError on failure
