...
class ApiEntitiesCiRunnerEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiRunnerEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiRunner, Hash] the current ApiEntitiesCiRunner data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiRunner fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiRunnerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesCiRunner.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiRunner, Hash] the loaded ApiEntitiesCiRunner; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCiRunnerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiRunner, Hash] the created ApiEntitiesCiRunner; raises GitlabError on failure
