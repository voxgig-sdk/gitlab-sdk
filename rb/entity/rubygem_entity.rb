...
class RubygemEntity
  ...
  def make
    opts = @_entopts.dup
    RubygemEntity.new(@_client, opts)
  end
  ...
  # @return [Rubygem, Hash] the current Rubygem data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Rubygem fields)
  def match_get
  ...
  #
  # @param reqmatch [RubygemLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Rubygem.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Rubygem, Hash] the loaded Rubygem; raises GitlabError on failure
