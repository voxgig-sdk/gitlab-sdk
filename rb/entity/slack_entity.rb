...
class SlackEntity
  ...
  # @return [Slack, Hash] the current Slack data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Slack fields)
  def match_get
  ...
  # Create a new Slack.
  #
  # @param reqdata [SlackCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Slack, Hash] the created Slack; raises GitlabError on failure
