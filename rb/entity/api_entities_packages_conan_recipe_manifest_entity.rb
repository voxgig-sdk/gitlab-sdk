...
class ApiEntitiesPackagesConanRecipeManifestEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_packages_conan_recipe_manifest"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackagesConanRecipeManifestEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackagesConanRecipeManifest, Hash] the current ApiEntitiesPackagesConanRecipeManifest data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackagesConanRecipeManifest fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPackagesConanRecipeManifestLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesPackagesConanRecipeManifest.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPackagesConanRecipeManifest, Hash] the loaded ApiEntitiesPackagesConanRecipeManifest; raises GitlabError on failure
