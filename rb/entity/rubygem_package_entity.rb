...
class RubygemPackageEntity
  ...
  def make
    opts = @_entopts.dup
    RubygemPackageEntity.new(@_client, opts)
  end
  ...
  # @return [RubygemPackage, Hash] the current RubygemPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RubygemPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [RubygemPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RubygemPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RubygemPackage, Hash] the loaded RubygemPackage; raises GitlabError on failure
  ...
  #
  # @param reqdata [RubygemPackageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RubygemPackage, Hash] the created RubygemPackage; raises GitlabError on failure
