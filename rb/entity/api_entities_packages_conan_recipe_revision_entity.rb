...
class ApiEntitiesPackagesConanRecipeRevisionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_packages_conan_recipe_revision"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackagesConanRecipeRevisionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackagesConanRecipeRevision, Hash] the current ApiEntitiesPackagesConanRecipeRevision data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackagesConanRecipeRevision fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPackagesConanRecipeRevisionListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesPackagesConanRecipeRevision fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesPackagesConanRecipeRevision>, Array] the matching ApiEntitiesPackagesConanRecipeRevision items; raises GitlabError on failure
