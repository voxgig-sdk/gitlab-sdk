...
class ApiEntitiesEventEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesEventEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesEvent, Hash] the current ApiEntitiesEvent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesEvent fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesEventLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesEvent.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesEvent, Hash] the loaded ApiEntitiesEvent; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesEventListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesEvent fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesEvent>, Array] the matching ApiEntitiesEvent items; raises GitlabError on failure
