...
class ApiEntitiesProjectGroupLinkEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_project_group_link"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectGroupLinkEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectGroupLink, Hash] the current ApiEntitiesProjectGroupLink data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectGroupLink fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesProjectGroupLinkCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectGroupLink, Hash] the created ApiEntitiesProjectGroupLink; raises GitlabError on failure
