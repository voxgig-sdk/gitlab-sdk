...
class GroupAvatarEntity
  ...
  def make
    opts = @_entopts.dup
    GroupAvatarEntity.new(@_client, opts)
  end
  ...
  # @return [GroupAvatar, Hash] the current GroupAvatar data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GroupAvatar fields)
  def match_get
  ...
  #
  # @param reqmatch [GroupAvatarLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GroupAvatar.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GroupAvatar, Hash] the loaded GroupAvatar; raises GitlabError on failure
