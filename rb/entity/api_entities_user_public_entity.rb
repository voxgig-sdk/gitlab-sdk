...
class ApiEntitiesUserPublicEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_user_public"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesUserPublicEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesUserPublic, Hash] the current ApiEntitiesUserPublic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesUserPublic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesUserPublicListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesUserPublic fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesUserPublic>, Array] the matching ApiEntitiesUserPublic items; raises GitlabError on failure
