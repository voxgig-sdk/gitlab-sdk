...
class ApiEntitiesCiLintResultEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_lint_result"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiLintResultEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiLintResult, Hash] the current ApiEntitiesCiLintResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiLintResult fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiLintResultListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCiLintResult fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCiLintResult>, Array] the matching ApiEntitiesCiLintResult items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCiLintResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiLintResult, Hash] the created ApiEntitiesCiLintResult; raises GitlabError on failure
