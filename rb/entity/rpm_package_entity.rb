...
class RpmPackageEntity
  ...
  def make
    opts = @_entopts.dup
    RpmPackageEntity.new(@_client, opts)
  end
  ...
  # @return [RpmPackage, Hash] the current RpmPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RpmPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [RpmPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RpmPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RpmPackage, Hash] the loaded RpmPackage; raises GitlabError on failure
  ...
  #
  # @param reqdata [RpmPackageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RpmPackage, Hash] the created RpmPackage; raises GitlabError on failure
