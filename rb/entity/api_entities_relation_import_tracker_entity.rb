...
class ApiEntitiesRelationImportTrackerEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_relation_import_tracker"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesRelationImportTrackerEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesRelationImportTracker, Hash] the current ApiEntitiesRelationImportTracker data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesRelationImportTracker fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesRelationImportTrackerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesRelationImportTracker, Hash] the created ApiEntitiesRelationImportTracker; raises GitlabError on failure
