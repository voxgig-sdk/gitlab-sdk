...
class DeployKeyEntity
  ...
  def make
    opts = @_entopts.dup
    DeployKeyEntity.new(@_client, opts)
  end
  ...
  # @return [DeployKey, Hash] the current DeployKey data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeployKey fields)
  def match_get
  ...
  #
  # @param reqmatch [DeployKeyRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeployKey, Hash] the removed DeployKey; raises GitlabError on failure
