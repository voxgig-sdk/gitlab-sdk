...
class ApiEntitiesEnvironmentEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_environment"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesEnvironmentEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesEnvironment, Hash] the current ApiEntitiesEnvironment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesEnvironment fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesEnvironmentLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesEnvironment.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesEnvironment, Hash] the loaded ApiEntitiesEnvironment; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesEnvironmentListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesEnvironment fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesEnvironment>, Array] the matching ApiEntitiesEnvironment items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesEnvironmentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesEnvironment, Hash] the created ApiEntitiesEnvironment; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesEnvironmentUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesEnvironment, Hash] the updated ApiEntitiesEnvironment; raises GitlabError on failure
