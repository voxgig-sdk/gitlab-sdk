...
class ReleaseLinkEntity
  ...
  def make
    opts = @_entopts.dup
    ReleaseLinkEntity.new(@_client, opts)
  end
  ...
  # @return [ReleaseLink, Hash] the current ReleaseLink data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ReleaseLink fields)
  def match_get
  ...
  #
  # @param reqmatch [ReleaseLinkRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ReleaseLink, Hash] the removed ReleaseLink; raises GitlabError on failure
