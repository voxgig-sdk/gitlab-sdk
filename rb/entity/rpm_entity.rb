...
class RpmEntity
  ...
  # @return [Rpm, Hash] the current Rpm data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Rpm fields)
  def match_get
  ...
  # Create a new Rpm.
  #
  # @param reqdata [RpmCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Rpm, Hash] the created Rpm; raises GitlabError on failure
