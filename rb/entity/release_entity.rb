...
class ReleaseEntity
  ...
  # @return [Release, Hash] the loaded Release; raises GitlabError on failure
  ...
  # Remove an Release matching the given criteria.
  #
  # @param reqmatch [ReleaseRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Release, Hash] the removed Release; raises GitlabError on failure
