...
class MergeRequestEntity
  ...
  def make
    opts = @_entopts.dup
    MergeRequestEntity.new(@_client, opts)
  end
  ...
  # @return [MergeRequest, Hash] the current MergeRequest data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MergeRequest fields)
  def match_get
  ...
  #
  # @param reqmatch [MergeRequestLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.MergeRequest.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [MergeRequest, Hash] the loaded MergeRequest; raises GitlabError on failure
  ...
  #
  # @param reqdata [MergeRequestUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MergeRequest, Hash] the updated MergeRequest; raises GitlabError on failure
  ...
  #
  # @param reqmatch [MergeRequestRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [MergeRequest, Hash] the removed MergeRequest; raises GitlabError on failure
