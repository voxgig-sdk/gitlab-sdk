...
class ApiEntitiesCommitNoteEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_commit_note"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCommitNoteEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCommitNote, Hash] the current ApiEntitiesCommitNote data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCommitNote fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCommitNoteListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCommitNote fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCommitNote>, Array] the matching ApiEntitiesCommitNote items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCommitNoteCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCommitNote, Hash] the created ApiEntitiesCommitNote; raises GitlabError on failure
