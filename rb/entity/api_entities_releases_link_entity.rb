...
class ApiEntitiesReleasesLinkEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_releases_link"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesReleasesLinkEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesReleasesLink, Hash] the current ApiEntitiesReleasesLink data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesReleasesLink fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesReleasesLinkLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesReleasesLink.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesReleasesLink, Hash] the loaded ApiEntitiesReleasesLink; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesReleasesLinkListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesReleasesLink fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesReleasesLink>, Array] the matching ApiEntitiesReleasesLink items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesReleasesLinkCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesReleasesLink, Hash] the created ApiEntitiesReleasesLink; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesReleasesLinkUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesReleasesLink, Hash] the updated ApiEntitiesReleasesLink; raises GitlabError on failure
