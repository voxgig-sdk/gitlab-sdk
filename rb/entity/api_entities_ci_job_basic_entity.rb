...
class ApiEntitiesCiJobBasicEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_job_basic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiJobBasicEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiJobBasic, Hash] the current ApiEntitiesCiJobBasic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiJobBasic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiJobBasicListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCiJobBasic fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCiJobBasic>, Array] the matching ApiEntitiesCiJobBasic items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCiJobBasicCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiJobBasic, Hash] the created ApiEntitiesCiJobBasic; raises GitlabError on failure
