...
class ApiEntitiesNamespaceEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesNamespaceEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesNamespace, Hash] the current ApiEntitiesNamespace data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesNamespace fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesNamespaceLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesNamespace.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesNamespace, Hash] the loaded ApiEntitiesNamespace; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesNamespaceListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesNamespace fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesNamespace>, Array] the matching ApiEntitiesNamespace items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesNamespaceUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesNamespace, Hash] the updated ApiEntitiesNamespace; raises GitlabError on failure
