...
class IssueLinkEntity
  ...
  def make
    opts = @_entopts.dup
    IssueLinkEntity.new(@_client, opts)
  end
  ...
  # @return [IssueLink, Hash] the current IssueLink data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IssueLink fields)
  def match_get
  ...
  #
  # @param reqmatch [IssueLinkRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [IssueLink, Hash] the removed IssueLink; raises GitlabError on failure
