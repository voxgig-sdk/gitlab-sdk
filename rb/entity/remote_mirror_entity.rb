...
class RemoteMirrorEntity
  ...
  def make
    opts = @_entopts.dup
    RemoteMirrorEntity.new(@_client, opts)
  end
  ...
  # @return [RemoteMirror, Hash] the current RemoteMirror data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RemoteMirror fields)
  def match_get
  ...
  #
  # @param reqmatch [RemoteMirrorLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RemoteMirror.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RemoteMirror, Hash] the loaded RemoteMirror; raises GitlabError on failure
  ...
  #
  # @param reqdata [RemoteMirrorCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RemoteMirror, Hash] the created RemoteMirror; raises GitlabError on failure
  ...
  #
  # @param reqmatch [RemoteMirrorRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [RemoteMirror, Hash] the removed RemoteMirror; raises GitlabError on failure
