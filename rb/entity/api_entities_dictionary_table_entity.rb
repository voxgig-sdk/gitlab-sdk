...
class ApiEntitiesDictionaryTableEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_dictionary_table"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDictionaryTableEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDictionaryTable, Hash] the current ApiEntitiesDictionaryTable data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDictionaryTable fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesDictionaryTableLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesDictionaryTable.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDictionaryTable, Hash] the loaded ApiEntitiesDictionaryTable; raises GitlabError on failure
