...
class ApiEntitiesUserCountEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesUserCountEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesUserCount, Hash] the current ApiEntitiesUserCount data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesUserCount fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesUserCountLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesUserCount.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesUserCount, Hash] the loaded ApiEntitiesUserCount; raises GitlabError on failure
