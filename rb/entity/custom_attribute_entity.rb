...
class CustomAttributeEntity
  ...
  def make
    opts = @_entopts.dup
    CustomAttributeEntity.new(@_client, opts)
  end
  ...
  # @return [CustomAttribute, Hash] the current CustomAttribute data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CustomAttribute fields)
  def match_get
  ...
  #
  # @param reqmatch [CustomAttributeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CustomAttribute.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CustomAttribute, Hash] the loaded CustomAttribute; raises GitlabError on failure
