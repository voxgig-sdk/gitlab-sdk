...
class ApiEntitiesCiJobEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiJobEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiJob, Hash] the current ApiEntitiesCiJob data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiJob fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiJobLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesCiJob.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiJob, Hash] the loaded ApiEntitiesCiJob; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesCiJobListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCiJob fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCiJob>, Array] the matching ApiEntitiesCiJob items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCiJobCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiJob, Hash] the created ApiEntitiesCiJob; raises GitlabError on failure
