...
class ApiEntitiesCiRunnerRegistrationDetailEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_runner_registration_detail"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiRunnerRegistrationDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiRunnerRegistrationDetail, Hash] the current ApiEntitiesCiRunnerRegistrationDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiRunnerRegistrationDetail fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesCiRunnerRegistrationDetailCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiRunnerRegistrationDetail, Hash] the created ApiEntitiesCiRunnerRegistrationDetail; raises GitlabError on failure
