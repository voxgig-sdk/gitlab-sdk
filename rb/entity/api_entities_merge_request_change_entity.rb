...
class ApiEntitiesMergeRequestChangeEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_merge_request_change"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMergeRequestChangeEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMergeRequestChange, Hash] the current ApiEntitiesMergeRequestChange data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMergeRequestChange fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesMergeRequestChangeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesMergeRequestChange.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMergeRequestChange, Hash] the loaded ApiEntitiesMergeRequestChange; raises GitlabError on failure
