...
class ClusterAgentEntity
  ...
  def make
    opts = @_entopts.dup
    ClusterAgentEntity.new(@_client, opts)
  end
  ...
  # @return [ClusterAgent, Hash] the current ClusterAgent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ClusterAgent fields)
  def match_get
  ...
  #
  # @param reqmatch [ClusterAgentRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ClusterAgent, Hash] the removed ClusterAgent; raises GitlabError on failure
