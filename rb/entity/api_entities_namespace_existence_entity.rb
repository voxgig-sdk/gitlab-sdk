...
class ApiEntitiesNamespaceExistenceEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_namespace_existence"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesNamespaceExistenceEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesNamespaceExistence, Hash] the current ApiEntitiesNamespaceExistence data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesNamespaceExistence fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesNamespaceExistenceListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesNamespaceExistence fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesNamespaceExistence>, Array] the matching ApiEntitiesNamespaceExistence items; raises GitlabError on failure
