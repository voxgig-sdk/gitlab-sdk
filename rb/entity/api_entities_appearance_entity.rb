...
class ApiEntitiesAppearanceEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesAppearanceEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesAppearance, Hash] the current ApiEntitiesAppearance data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesAppearance fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesAppearanceLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesAppearance.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesAppearance, Hash] the loaded ApiEntitiesAppearance; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesAppearanceUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesAppearance, Hash] the updated ApiEntitiesAppearance; raises GitlabError on failure
