...
class ComposerPackageEntity
  ...
  def make
    opts = @_entopts.dup
    ComposerPackageEntity.new(@_client, opts)
  end
  ...
  # @return [ComposerPackage, Hash] the current ComposerPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ComposerPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [ComposerPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ComposerPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ComposerPackage, Hash] the loaded ComposerPackage; raises GitlabError on failure
