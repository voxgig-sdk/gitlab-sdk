...
class ApiEntitiesWikiPageEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesWikiPageEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesWikiPage, Hash] the current ApiEntitiesWikiPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesWikiPage fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesWikiPageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesWikiPage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesWikiPage, Hash] the loaded ApiEntitiesWikiPage; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesWikiPageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesWikiPage, Hash] the created ApiEntitiesWikiPage; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesWikiPageUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesWikiPage, Hash] the updated ApiEntitiesWikiPage; raises GitlabError on failure
