...
class ApiEntitiesApplicationWithSecretEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_application_with_secret"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesApplicationWithSecretEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesApplicationWithSecret, Hash] the current ApiEntitiesApplicationWithSecret data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesApplicationWithSecret fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesApplicationWithSecretCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesApplicationWithSecret, Hash] the created ApiEntitiesApplicationWithSecret; raises GitlabError on failure
