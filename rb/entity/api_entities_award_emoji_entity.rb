...
class ApiEntitiesAwardEmojiEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_award_emoji"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesAwardEmojiEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesAwardEmoji, Hash] the current ApiEntitiesAwardEmoji data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesAwardEmoji fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesAwardEmojiLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesAwardEmoji.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesAwardEmoji, Hash] the loaded ApiEntitiesAwardEmoji; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesAwardEmojiListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesAwardEmoji fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesAwardEmoji>, Array] the matching ApiEntitiesAwardEmoji items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesAwardEmojiCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesAwardEmoji, Hash] the created ApiEntitiesAwardEmoji; raises GitlabError on failure
