...
class DependencyProxyEntity
  ...
  def make
    opts = @_entopts.dup
    DependencyProxyEntity.new(@_client, opts)
  end
  ...
  # @return [DependencyProxy, Hash] the current DependencyProxy data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DependencyProxy fields)
  def match_get
  ...
  #
  # @param reqmatch [DependencyProxyRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [DependencyProxy, Hash] the removed DependencyProxy; raises GitlabError on failure
