...
class UnleashApiEntity
  ...
  def make
    opts = @_entopts.dup
    UnleashApiEntity.new(@_client, opts)
  end
  ...
  # @return [UnleashApi, Hash] the current UnleashApi data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UnleashApi fields)
  def match_get
  ...
  #
  # @param reqmatch [UnleashApiLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.UnleashApi.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [UnleashApi, Hash] the loaded UnleashApi; raises GitlabError on failure
