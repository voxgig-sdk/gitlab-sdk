...
class BadgeEntity
  ...
  # @return [Badge, Hash] the current Badge data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Badge fields)
  def match_get
  ...
  #
  # @param reqmatch [BadgeRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Badge, Hash] the removed Badge; raises GitlabError on failure
