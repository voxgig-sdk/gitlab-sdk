...
class ApiEntitiesContributorEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_contributor"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesContributorEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesContributor, Hash] the current ApiEntitiesContributor data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesContributor fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesContributorLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesContributor.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesContributor, Hash] the loaded ApiEntitiesContributor; raises GitlabError on failure
