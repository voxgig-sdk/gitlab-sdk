...
class DeploymentEntity
  ...
  def make
    opts = @_entopts.dup
    DeploymentEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [DeploymentRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Deployment, Hash] the removed Deployment; raises GitlabError on failure
