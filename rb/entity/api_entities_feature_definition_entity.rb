...
class ApiEntitiesFeatureDefinitionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_feature_definition"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesFeatureDefinitionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesFeatureDefinition, Hash] the current ApiEntitiesFeatureDefinition data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesFeatureDefinition fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesFeatureDefinitionListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesFeatureDefinition fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesFeatureDefinition>, Array] the matching ApiEntitiesFeatureDefinition items; raises GitlabError on failure
