...
class NamespaceEntity
  ...
  def make
    opts = @_entopts.dup
    NamespaceEntity.new(@_client, opts)
  end
  ...
  # @return [Namespace, Hash] the current Namespace data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Namespace fields)
  def match_get
  ...
  #
  # @param reqmatch [NamespaceRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Namespace, Hash] the removed Namespace; raises GitlabError on failure
