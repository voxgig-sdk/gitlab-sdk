...
class ApiEntitiesBasicGroupDetailEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_basic_group_detail"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBasicGroupDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBasicGroupDetail, Hash] the current ApiEntitiesBasicGroupDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBasicGroupDetail fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesBasicGroupDetailCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBasicGroupDetail, Hash] the created ApiEntitiesBasicGroupDetail; raises GitlabError on failure
