...
class ProjectEntityClient
  ...
  def make
    opts = @_entopts.dup
    ProjectEntityClient.new(@_client, opts)
  end
  ...
  #   as an empty match, so client.Project.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Project, Hash] the loaded Project; raises GitlabError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Project, Hash] the created Project; raises GitlabError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Project, Hash] the updated Project; raises GitlabError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Project, Hash] the removed Project; raises GitlabError on failure
