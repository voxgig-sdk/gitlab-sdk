...
class ApiEntitiesApplicationStatisticEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_application_statistic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesApplicationStatisticEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesApplicationStatistic, Hash] the current ApiEntitiesApplicationStatistic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesApplicationStatistic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesApplicationStatisticLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesApplicationStatistic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesApplicationStatistic, Hash] the loaded ApiEntitiesApplicationStatistic; raises GitlabError on failure
