...
class ImportEntity
  ...
  # @return [Import, Hash] the current Import data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Import fields)
  def match_get
  ...
  # Create a new Import.
  #
  # @param reqdata [ImportCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Import, Hash] the created Import; raises GitlabError on failure
