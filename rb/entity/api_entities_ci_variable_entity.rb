...
class ApiEntitiesCiVariableEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_variable"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiVariableEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiVariable, Hash] the current ApiEntitiesCiVariable data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiVariable fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiVariableLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesCiVariable.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiVariable, Hash] the loaded ApiEntitiesCiVariable; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesCiVariableListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCiVariable fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCiVariable>, Array] the matching ApiEntitiesCiVariable items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCiVariableCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiVariable, Hash] the created ApiEntitiesCiVariable; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCiVariableUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiVariable, Hash] the updated ApiEntitiesCiVariable; raises GitlabError on failure
