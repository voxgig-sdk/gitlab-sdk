...
class ApiEntitiesDeployKeyEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDeployKeyEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDeployKey, Hash] the current ApiEntitiesDeployKey data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDeployKey fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesDeployKeyListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesDeployKey fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesDeployKey>, Array] the matching ApiEntitiesDeployKey items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesDeployKeyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDeployKey, Hash] the created ApiEntitiesDeployKey; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesDeployKeyUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDeployKey, Hash] the updated ApiEntitiesDeployKey; raises GitlabError on failure
