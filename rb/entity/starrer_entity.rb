...
class StarrerEntity
  ...
  def make
    opts = @_entopts.dup
    StarrerEntity.new(@_client, opts)
  end
  ...
  # @return [Starrer, Hash] the current Starrer data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Starrer fields)
  def match_get
  ...
  #
  # @param reqmatch [StarrerListMatch, Hash, nil] match filter (any subset of
  #   Starrer fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Starrer>, Array] the matching Starrer items; raises GitlabError on failure
