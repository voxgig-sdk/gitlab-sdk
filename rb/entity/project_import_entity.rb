...
class ProjectImportEntity
  ...
  # @return [ProjectImport, Hash] the current ProjectImport data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProjectImport fields)
  def match_get
  ...
  #
  # @param reqdata [ProjectImportCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectImport, Hash] the created ProjectImport; raises GitlabError on failure
