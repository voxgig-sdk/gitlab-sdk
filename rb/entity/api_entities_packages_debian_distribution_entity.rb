...
class ApiEntitiesPackagesDebianDistributionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_packages_debian_distribution"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackagesDebianDistributionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackagesDebianDistribution, Hash] the current ApiEntitiesPackagesDebianDistribution data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackagesDebianDistribution fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPackagesDebianDistributionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesPackagesDebianDistribution.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPackagesDebianDistribution, Hash] the loaded ApiEntitiesPackagesDebianDistribution; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesPackagesDebianDistributionListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesPackagesDebianDistribution fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesPackagesDebianDistribution>, Array] the matching ApiEntitiesPackagesDebianDistribution items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesPackagesDebianDistributionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPackagesDebianDistribution, Hash] the created ApiEntitiesPackagesDebianDistribution; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesPackagesDebianDistributionUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPackagesDebianDistribution, Hash] the updated ApiEntitiesPackagesDebianDistribution; raises GitlabError on failure
