...
class ApiEntitiesCiResetTokenResultEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_reset_token_result"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiResetTokenResultEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiResetTokenResult, Hash] the current ApiEntitiesCiResetTokenResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiResetTokenResult fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesCiResetTokenResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiResetTokenResult, Hash] the created ApiEntitiesCiResetTokenResult; raises GitlabError on failure
