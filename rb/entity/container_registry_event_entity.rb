...
class ContainerRegistryEventEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "container_registry_event"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ContainerRegistryEventEntity.new(@_client, opts)
  end
  ...
  # @return [ContainerRegistryEvent, Hash] the current ContainerRegistryEvent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ContainerRegistryEvent fields)
  def match_get
  ...
  #
  # @param reqdata [ContainerRegistryEventCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ContainerRegistryEvent, Hash] the created ContainerRegistryEvent; raises GitlabError on failure
