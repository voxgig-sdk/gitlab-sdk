...
class ApiEntitiesPublicGroupDetailEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_public_group_detail"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPublicGroupDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPublicGroupDetail, Hash] the current ApiEntitiesPublicGroupDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPublicGroupDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPublicGroupDetailListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesPublicGroupDetail fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesPublicGroupDetail>, Array] the matching ApiEntitiesPublicGroupDetail items; raises GitlabError on failure
