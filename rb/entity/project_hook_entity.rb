...
class ProjectHookEntity
  ...
  def make
    opts = @_entopts.dup
    ProjectHookEntity.new(@_client, opts)
  end
  ...
  # @return [ProjectHook, Hash] the current ProjectHook data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProjectHook fields)
  def match_get
  ...
  #
  # @param reqmatch [ProjectHookRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectHook, Hash] the removed ProjectHook; raises GitlabError on failure
