...
class ApiEntitiesCiPipelineScheduleEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_pipeline_schedule"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiPipelineScheduleEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiPipelineSchedule, Hash] the current ApiEntitiesCiPipelineSchedule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiPipelineSchedule fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiPipelineScheduleListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCiPipelineSchedule fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCiPipelineSchedule>, Array] the matching ApiEntitiesCiPipelineSchedule items; raises GitlabError on failure
