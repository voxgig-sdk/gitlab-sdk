...
class AwardEmojiEntity
  ...
  def make
    opts = @_entopts.dup
    AwardEmojiEntity.new(@_client, opts)
  end
  ...
  # @return [AwardEmoji, Hash] the current AwardEmoji data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AwardEmoji fields)
  def match_get
  ...
  #
  # @param reqmatch [AwardEmojiRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [AwardEmoji, Hash] the removed AwardEmoji; raises GitlabError on failure
