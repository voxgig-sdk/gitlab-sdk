...
class ApiEntitiesClustersAgentTokenEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_clusters_agent_token"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesClustersAgentTokenEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesClustersAgentToken, Hash] the current ApiEntitiesClustersAgentToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesClustersAgentToken fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesClustersAgentTokenLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesClustersAgentToken.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesClustersAgentToken, Hash] the loaded ApiEntitiesClustersAgentToken; raises GitlabError on failure
