...
class ApiEntitiesFreezePeriodEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_freeze_period"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesFreezePeriodEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesFreezePeriod, Hash] the current ApiEntitiesFreezePeriod data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesFreezePeriod fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesFreezePeriodLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesFreezePeriod.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesFreezePeriod, Hash] the loaded ApiEntitiesFreezePeriod; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesFreezePeriodListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesFreezePeriod fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesFreezePeriod>, Array] the matching ApiEntitiesFreezePeriod items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesFreezePeriodCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesFreezePeriod, Hash] the created ApiEntitiesFreezePeriod; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesFreezePeriodUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesFreezePeriod, Hash] the updated ApiEntitiesFreezePeriod; raises GitlabError on failure
