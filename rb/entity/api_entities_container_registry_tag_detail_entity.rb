...
class ApiEntitiesContainerRegistryTagDetailEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_container_registry_tag_detail"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesContainerRegistryTagDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesContainerRegistryTagDetail, Hash] the current ApiEntitiesContainerRegistryTagDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesContainerRegistryTagDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesContainerRegistryTagDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesContainerRegistryTagDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesContainerRegistryTagDetail, Hash] the loaded ApiEntitiesContainerRegistryTagDetail; raises GitlabError on failure
