...
class ProjectPackageEntity
  ...
  def make
    opts = @_entopts.dup
    ProjectPackageEntity.new(@_client, opts)
  end
  ...
  # @return [ProjectPackage, Hash] the current ProjectPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProjectPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [ProjectPackageRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectPackage, Hash] the removed ProjectPackage; raises GitlabError on failure
