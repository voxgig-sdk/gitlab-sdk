...
class ApiEntitiesChangelogEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesChangelogEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesChangelog, Hash] the current ApiEntitiesChangelog data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesChangelog fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesChangelogLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesChangelog.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesChangelog, Hash] the loaded ApiEntitiesChangelog; raises GitlabError on failure
