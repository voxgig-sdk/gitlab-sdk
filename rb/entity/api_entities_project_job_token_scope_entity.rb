...
class ApiEntitiesProjectJobTokenScopeEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_project_job_token_scope"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectJobTokenScopeEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectJobTokenScope, Hash] the current ApiEntitiesProjectJobTokenScope data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectJobTokenScope fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProjectJobTokenScopeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesProjectJobTokenScope.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectJobTokenScope, Hash] the loaded ApiEntitiesProjectJobTokenScope; raises GitlabError on failure
