...
class ApiEntitiesPackagePipelineEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_package_pipeline"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackagePipelineEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackagePipeline, Hash] the current ApiEntitiesPackagePipeline data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackagePipeline fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPackagePipelineLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesPackagePipeline.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPackagePipeline, Hash] the loaded ApiEntitiesPackagePipeline; raises GitlabError on failure
