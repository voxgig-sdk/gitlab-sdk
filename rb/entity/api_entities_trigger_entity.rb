...
class ApiEntitiesTriggerEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesTriggerEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesTrigger, Hash] the current ApiEntitiesTrigger data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesTrigger fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesTriggerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesTrigger.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesTrigger, Hash] the loaded ApiEntitiesTrigger; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesTriggerListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesTrigger fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesTrigger>, Array] the matching ApiEntitiesTrigger items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesTriggerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesTrigger, Hash] the created ApiEntitiesTrigger; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesTriggerUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesTrigger, Hash] the updated ApiEntitiesTrigger; raises GitlabError on failure
