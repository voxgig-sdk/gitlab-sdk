...
class HelmPackageEntity
  ...
  def make
    opts = @_entopts.dup
    HelmPackageEntity.new(@_client, opts)
  end
  ...
  # @return [HelmPackage, Hash] the current HelmPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of HelmPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [HelmPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.HelmPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [HelmPackage, Hash] the loaded HelmPackage; raises GitlabError on failure
  ...
  #
  # @param reqdata [HelmPackageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [HelmPackage, Hash] the created HelmPackage; raises GitlabError on failure
