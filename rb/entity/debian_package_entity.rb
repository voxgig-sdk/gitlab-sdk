...
class DebianPackageEntity
  ...
  def make
    opts = @_entopts.dup
    DebianPackageEntity.new(@_client, opts)
  end
  ...
  # @return [DebianPackage, Hash] the current DebianPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DebianPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [DebianPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DebianPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DebianPackage, Hash] the loaded DebianPackage; raises GitlabError on failure
