...
class SystemHookEntity
  ...
  def make
    opts = @_entopts.dup
    SystemHookEntity.new(@_client, opts)
  end
  ...
  # @return [SystemHook, Hash] the current SystemHook data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SystemHook fields)
  def match_get
  ...
  #
  # @param reqmatch [SystemHookRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [SystemHook, Hash] the removed SystemHook; raises GitlabError on failure
