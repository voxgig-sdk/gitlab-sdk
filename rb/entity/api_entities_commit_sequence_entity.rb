...
class ApiEntitiesCommitSequenceEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_commit_sequence"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCommitSequenceEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCommitSequence, Hash] the current ApiEntitiesCommitSequence data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCommitSequence fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCommitSequenceLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesCommitSequence.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCommitSequence, Hash] the loaded ApiEntitiesCommitSequence; raises GitlabError on failure
