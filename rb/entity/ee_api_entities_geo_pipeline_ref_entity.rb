...
class EeApiEntitiesGeoPipelineRefEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "ee_api_entities_geo_pipeline_ref"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    EeApiEntitiesGeoPipelineRefEntity.new(@_client, opts)
  end
  ...
  # @return [EeApiEntitiesGeoPipelineRef, Hash] the current EeApiEntitiesGeoPipelineRef data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EeApiEntitiesGeoPipelineRef fields)
  def match_get
  ...
  #
  # @param reqmatch [EeApiEntitiesGeoPipelineRefListMatch, Hash, nil] match filter (any subset of
  #   EeApiEntitiesGeoPipelineRef fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EeApiEntitiesGeoPipelineRef>, Array] the matching EeApiEntitiesGeoPipelineRef items; raises GitlabError on failure
