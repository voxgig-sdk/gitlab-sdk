...
class ApiEntitiesMergeRequestDiffFullEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_merge_request_diff_full"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMergeRequestDiffFullEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMergeRequestDiffFull, Hash] the current ApiEntitiesMergeRequestDiffFull data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMergeRequestDiffFull fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesMergeRequestDiffFullLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesMergeRequestDiffFull.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMergeRequestDiffFull, Hash] the loaded ApiEntitiesMergeRequestDiffFull; raises GitlabError on failure
