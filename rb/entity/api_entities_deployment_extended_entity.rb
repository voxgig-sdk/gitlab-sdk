...
class ApiEntitiesDeploymentExtendedEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_deployment_extended"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDeploymentExtendedEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDeploymentExtended, Hash] the current ApiEntitiesDeploymentExtended data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDeploymentExtended fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesDeploymentExtendedLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesDeploymentExtended.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDeploymentExtended, Hash] the loaded ApiEntitiesDeploymentExtended; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesDeploymentExtendedCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDeploymentExtended, Hash] the created ApiEntitiesDeploymentExtended; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesDeploymentExtendedUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDeploymentExtended, Hash] the updated ApiEntitiesDeploymentExtended; raises GitlabError on failure
