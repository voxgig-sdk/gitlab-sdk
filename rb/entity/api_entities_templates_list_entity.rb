...
class ApiEntitiesTemplatesListEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_templates_list"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesTemplatesListEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesTemplatesList, Hash] the current ApiEntitiesTemplatesList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesTemplatesList fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesTemplatesListLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesTemplatesList.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesTemplatesList, Hash] the loaded ApiEntitiesTemplatesList; raises GitlabError on failure
