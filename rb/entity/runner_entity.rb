...
class RunnerEntity
  ...
  # @return [Runner, Hash] the current Runner data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Runner fields)
  def match_get
  ...
  # Create a new Runner.
  #
  # @param reqdata [RunnerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Runner, Hash] the created Runner; raises GitlabError on failure
  ...
  #
  # @param reqmatch [RunnerRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Runner, Hash] the removed Runner; raises GitlabError on failure
