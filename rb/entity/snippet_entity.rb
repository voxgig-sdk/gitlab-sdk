...
class SnippetEntity
  ...
  def make
    opts = @_entopts.dup
    SnippetEntity.new(@_client, opts)
  end
  ...
  # @return [Snippet, Hash] the current Snippet data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Snippet fields)
  def match_get
  ...
  #
  # @param reqmatch [SnippetLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Snippet.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Snippet, Hash] the loaded Snippet; raises GitlabError on failure
  ...
  #
  # @param reqmatch [SnippetRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Snippet, Hash] the removed Snippet; raises GitlabError on failure
