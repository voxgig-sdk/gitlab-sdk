...
class ApiEntitiesProjectEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProject, Hash] the current ApiEntitiesProject data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProject fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProjectListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesProject fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesProject>, Array] the matching ApiEntitiesProject items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProjectCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProject, Hash] the created ApiEntitiesProject; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProjectUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProject, Hash] the updated ApiEntitiesProject; raises GitlabError on failure
