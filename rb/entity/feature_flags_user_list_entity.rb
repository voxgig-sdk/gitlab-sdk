...
class FeatureFlagsUserListEntity
  ...
  def make
    opts = @_entopts.dup
    FeatureFlagsUserListEntity.new(@_client, opts)
  end
  ...
  # @return [FeatureFlagsUserList, Hash] the current FeatureFlagsUserList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FeatureFlagsUserList fields)
  def match_get
  ...
  #
  # @param reqmatch [FeatureFlagsUserListRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [FeatureFlagsUserList, Hash] the removed FeatureFlagsUserList; raises GitlabError on failure
