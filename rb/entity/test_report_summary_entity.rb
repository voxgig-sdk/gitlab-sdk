...
class TestReportSummaryEntity
  ...
  def make
    opts = @_entopts.dup
    TestReportSummaryEntity.new(@_client, opts)
  end
  ...
  # @return [TestReportSummary, Hash] the current TestReportSummary data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TestReportSummary fields)
  def match_get
  ...
  #
  # @param reqmatch [TestReportSummaryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.TestReportSummary.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [TestReportSummary, Hash] the loaded TestReportSummary; raises GitlabError on failure
