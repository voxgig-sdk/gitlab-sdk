...
class ApiEntitiesProjectDailyStatisticEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_project_daily_statistic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectDailyStatisticEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectDailyStatistic, Hash] the current ApiEntitiesProjectDailyStatistic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectDailyStatistic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProjectDailyStatisticLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesProjectDailyStatistic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectDailyStatistic, Hash] the loaded ApiEntitiesProjectDailyStatistic; raises GitlabError on failure
