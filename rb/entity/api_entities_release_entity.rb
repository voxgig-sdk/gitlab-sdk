...
class ApiEntitiesReleaseEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesReleaseEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesRelease, Hash] the current ApiEntitiesRelease data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesRelease fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesReleaseLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesRelease.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesRelease, Hash] the loaded ApiEntitiesRelease; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesReleaseListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesRelease fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesRelease>, Array] the matching ApiEntitiesRelease items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesReleaseCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesRelease, Hash] the created ApiEntitiesRelease; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesReleaseUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesRelease, Hash] the updated ApiEntitiesRelease; raises GitlabError on failure
