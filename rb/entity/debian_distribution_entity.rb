...
class DebianDistributionEntity
  ...
  def make
    opts = @_entopts.dup
    DebianDistributionEntity.new(@_client, opts)
  end
  ...
  # @return [DebianDistribution, Hash] the current DebianDistribution data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DebianDistribution fields)
  def match_get
  ...
  #
  # @param reqmatch [DebianDistributionRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [DebianDistribution, Hash] the removed DebianDistribution; raises GitlabError on failure
