...
class WebCommitEntity
  ...
  def make
    opts = @_entopts.dup
    WebCommitEntity.new(@_client, opts)
  end
  ...
  # @return [WebCommit, Hash] the current WebCommit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WebCommit fields)
  def match_get
  ...
  #
  # @param reqmatch [WebCommitLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.WebCommit.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [WebCommit, Hash] the loaded WebCommit; raises GitlabError on failure
