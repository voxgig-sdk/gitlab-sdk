...
class ApiEntitiesFeatureFlagEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_feature_flag"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesFeatureFlagEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesFeatureFlag, Hash] the current ApiEntitiesFeatureFlag data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesFeatureFlag fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesFeatureFlagLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesFeatureFlag.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesFeatureFlag, Hash] the loaded ApiEntitiesFeatureFlag; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesFeatureFlagListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesFeatureFlag fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesFeatureFlag>, Array] the matching ApiEntitiesFeatureFlag items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesFeatureFlagCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesFeatureFlag, Hash] the created ApiEntitiesFeatureFlag; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesFeatureFlagUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesFeatureFlag, Hash] the updated ApiEntitiesFeatureFlag; raises GitlabError on failure
