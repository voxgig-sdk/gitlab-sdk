...
class NugetPackageEntity
  ...
  def make
    opts = @_entopts.dup
    NugetPackageEntity.new(@_client, opts)
  end
  ...
  # @return [NugetPackage, Hash] the current NugetPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NugetPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [NugetPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.NugetPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [NugetPackage, Hash] the loaded NugetPackage; raises GitlabError on failure
  ...
  #
  # @param reqmatch [NugetPackageListMatch, Hash, nil] match filter (any subset of
  #   NugetPackage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NugetPackage>, Array] the matching NugetPackage items; raises GitlabError on failure
  ...
  #
  # @param reqdata [NugetPackageUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [NugetPackage, Hash] the updated NugetPackage; raises GitlabError on failure
  ...
  #
  # @param reqmatch [NugetPackageRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [NugetPackage, Hash] the removed NugetPackage; raises GitlabError on failure
