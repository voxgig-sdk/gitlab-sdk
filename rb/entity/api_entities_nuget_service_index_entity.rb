...
class ApiEntitiesNugetServiceIndexEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_nuget_service_index"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesNugetServiceIndexEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesNugetServiceIndex, Hash] the current ApiEntitiesNugetServiceIndex data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesNugetServiceIndex fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesNugetServiceIndexListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesNugetServiceIndex fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesNugetServiceIndex>, Array] the matching ApiEntitiesNugetServiceIndex items; raises GitlabError on failure
