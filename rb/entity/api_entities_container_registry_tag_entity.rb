...
class ApiEntitiesContainerRegistryTagEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_container_registry_tag"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesContainerRegistryTagEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesContainerRegistryTag, Hash] the current ApiEntitiesContainerRegistryTag data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesContainerRegistryTag fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesContainerRegistryTagListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesContainerRegistryTag fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesContainerRegistryTag>, Array] the matching ApiEntitiesContainerRegistryTag items; raises GitlabError on failure
