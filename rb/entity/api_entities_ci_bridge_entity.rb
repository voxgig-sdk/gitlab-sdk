...
class ApiEntitiesCiBridgeEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiBridgeEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiBridge, Hash] the current ApiEntitiesCiBridge data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiBridge fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiBridgeListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCiBridge fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCiBridge>, Array] the matching ApiEntitiesCiBridge items; raises GitlabError on failure
