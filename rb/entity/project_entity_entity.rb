...
class ProjectEntityEntity
  ...
  def make
    opts = @_entopts.dup
    ProjectEntityEntity.new(@_client, opts)
  end
  ...
  # @return [ProjectEntity, Hash] the current ProjectEntity data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProjectEntity fields)
  def match_get
  ...
  #
  # @param reqdata [ProjectEntityCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectEntity, Hash] the created ProjectEntity; raises GitlabError on failure
