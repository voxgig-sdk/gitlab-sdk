...
class ApiEntitiesCiPipelineEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_pipeline"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiPipelineEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiPipeline, Hash] the current ApiEntitiesCiPipeline data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiPipeline fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesCiPipelineCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiPipeline, Hash] the created ApiEntitiesCiPipeline; raises GitlabError on failure
