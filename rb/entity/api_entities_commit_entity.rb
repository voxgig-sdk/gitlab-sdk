...
class ApiEntitiesCommitEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCommitEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCommit, Hash] the current ApiEntitiesCommit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCommit fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCommitListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCommit fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCommit>, Array] the matching ApiEntitiesCommit items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCommitCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCommit, Hash] the created ApiEntitiesCommit; raises GitlabError on failure
