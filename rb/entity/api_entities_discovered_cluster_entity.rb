...
class ApiEntitiesDiscoveredClusterEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_discovered_cluster"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDiscoveredClusterEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDiscoveredCluster, Hash] the current ApiEntitiesDiscoveredCluster data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDiscoveredCluster fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesDiscoveredClusterLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesDiscoveredCluster.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDiscoveredCluster, Hash] the loaded ApiEntitiesDiscoveredCluster; raises GitlabError on failure
