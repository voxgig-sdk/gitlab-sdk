...
class ApiEntitiesDeployTokenWithTokenEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_deploy_token_with_token"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDeployTokenWithTokenEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDeployTokenWithToken, Hash] the current ApiEntitiesDeployTokenWithToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDeployTokenWithToken fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesDeployTokenWithTokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDeployTokenWithToken, Hash] the created ApiEntitiesDeployTokenWithToken; raises GitlabError on failure
