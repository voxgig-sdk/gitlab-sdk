...
class ApiEntitiesOrganizationsOrganizationEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_organizations_organization"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesOrganizationsOrganizationEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesOrganizationsOrganization, Hash] the current ApiEntitiesOrganizationsOrganization data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesOrganizationsOrganization fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesOrganizationsOrganizationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesOrganizationsOrganization, Hash] the created ApiEntitiesOrganizationsOrganization; raises GitlabError on failure
