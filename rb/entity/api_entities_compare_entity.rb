...
class ApiEntitiesCompareEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCompareEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCompare, Hash] the current ApiEntitiesCompare data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCompare fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCompareListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCompare fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCompare>, Array] the matching ApiEntitiesCompare items; raises GitlabError on failure
