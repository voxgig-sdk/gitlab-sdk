...
class ParticipantEntity
  ...
  def make
    opts = @_entopts.dup
    ParticipantEntity.new(@_client, opts)
  end
  ...
  # @return [Participant, Hash] the current Participant data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Participant fields)
  def match_get
  ...
  #
  # @param reqmatch [ParticipantListMatch, Hash, nil] match filter (any subset of
  #   Participant fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Participant>, Array] the matching Participant items; raises GitlabError on failure
