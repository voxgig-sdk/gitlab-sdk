...
class ApiEntitiesDeploymentEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDeploymentEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDeployment, Hash] the current ApiEntitiesDeployment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDeployment fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesDeploymentListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesDeployment fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesDeployment>, Array] the matching ApiEntitiesDeployment items; raises GitlabError on failure
