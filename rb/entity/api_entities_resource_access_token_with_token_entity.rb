...
class ApiEntitiesResourceAccessTokenWithTokenEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_resource_access_token_with_token"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesResourceAccessTokenWithTokenEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesResourceAccessTokenWithToken, Hash] the current ApiEntitiesResourceAccessTokenWithToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesResourceAccessTokenWithToken fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesResourceAccessTokenWithTokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesResourceAccessTokenWithToken, Hash] the created ApiEntitiesResourceAccessTokenWithToken; raises GitlabError on failure
