...
class ApiEntitiesBranchEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBranchEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBranch, Hash] the current ApiEntitiesBranch data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBranch fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesBranchLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesBranch.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBranch, Hash] the loaded ApiEntitiesBranch; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesBranchListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesBranch fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesBranch>, Array] the matching ApiEntitiesBranch items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesBranchCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBranch, Hash] the created ApiEntitiesBranch; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesBranchUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBranch, Hash] the updated ApiEntitiesBranch; raises GitlabError on failure
