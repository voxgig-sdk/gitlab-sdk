...
class ApiEntitiesPackageFileEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_package_file"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackageFileEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackageFile, Hash] the current ApiEntitiesPackageFile data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackageFile fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPackageFileListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesPackageFile fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesPackageFile>, Array] the matching ApiEntitiesPackageFile items; raises GitlabError on failure
