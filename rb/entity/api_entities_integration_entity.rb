...
class ApiEntitiesIntegrationEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_integration"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesIntegrationEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesIntegration, Hash] the current ApiEntitiesIntegration data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesIntegration fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesIntegrationLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesIntegration.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesIntegration, Hash] the loaded ApiEntitiesIntegration; raises GitlabError on failure
