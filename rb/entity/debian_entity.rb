...
class DebianEntity
  ...
  # @return [Debian, Hash] the current Debian data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Debian fields)
  def match_get
  ...
  #
  # @param reqdata [DebianUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Debian, Hash] the updated Debian; raises GitlabError on failure
