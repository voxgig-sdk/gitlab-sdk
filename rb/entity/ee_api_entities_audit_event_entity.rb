...
class EeApiEntitiesAuditEventEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "ee_api_entities_audit_event"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    EeApiEntitiesAuditEventEntity.new(@_client, opts)
  end
  ...
  # @return [EeApiEntitiesAuditEvent, Hash] the current EeApiEntitiesAuditEvent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EeApiEntitiesAuditEvent fields)
  def match_get
  ...
  #
  # @param reqmatch [EeApiEntitiesAuditEventLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.EeApiEntitiesAuditEvent.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [EeApiEntitiesAuditEvent, Hash] the loaded EeApiEntitiesAuditEvent; raises GitlabError on failure
  ...
  #
  # @param reqmatch [EeApiEntitiesAuditEventListMatch, Hash, nil] match filter (any subset of
  #   EeApiEntitiesAuditEvent fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EeApiEntitiesAuditEvent>, Array] the matching EeApiEntitiesAuditEvent items; raises GitlabError on failure
