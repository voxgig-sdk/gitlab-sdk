...
class ApiEntitiesRepositoryHealthEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_repository_health"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesRepositoryHealthEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesRepositoryHealth, Hash] the current ApiEntitiesRepositoryHealth data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesRepositoryHealth fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesRepositoryHealthLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesRepositoryHealth.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesRepositoryHealth, Hash] the loaded ApiEntitiesRepositoryHealth; raises GitlabError on failure
