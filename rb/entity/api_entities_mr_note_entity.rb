...
class ApiEntitiesMrNoteEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMrNoteEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMrNote, Hash] the current ApiEntitiesMrNote data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMrNote fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesMrNoteLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesMrNote.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMrNote, Hash] the loaded ApiEntitiesMrNote; raises GitlabError on failure
