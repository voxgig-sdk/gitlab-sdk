...
class ProjectSnippetEntity
  ...
  def make
    opts = @_entopts.dup
    ProjectSnippetEntity.new(@_client, opts)
  end
  ...
  # @return [ProjectSnippet, Hash] the current ProjectSnippet data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProjectSnippet fields)
  def match_get
  ...
  #
  # @param reqmatch [ProjectSnippetRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectSnippet, Hash] the removed ProjectSnippet; raises GitlabError on failure
