...
class PersonalAccessTokenEntity
  ...
  def make
    opts = @_entopts.dup
    PersonalAccessTokenEntity.new(@_client, opts)
  end
  ...
  # @return [PersonalAccessToken, Hash] the current PersonalAccessToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PersonalAccessToken fields)
  def match_get
  ...
  #
  # @param reqmatch [PersonalAccessTokenRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [PersonalAccessToken, Hash] the removed PersonalAccessToken; raises GitlabError on failure
