...
class ProjectImportEntityEntity
  ...
  def make
    opts = @_entopts.dup
    ProjectImportEntityEntity.new(@_client, opts)
  end
  ...
  # @return [ProjectImportEntity, Hash] the current ProjectImportEntity data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProjectImportEntity fields)
  def match_get
  ...
  #
  # @param reqdata [ProjectImportEntityCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectImportEntity, Hash] the created ProjectImportEntity; raises GitlabError on failure
