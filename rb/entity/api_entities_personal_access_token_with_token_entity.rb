...
class ApiEntitiesPersonalAccessTokenWithTokenEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_personal_access_token_with_token"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPersonalAccessTokenWithTokenEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPersonalAccessTokenWithToken, Hash] the current ApiEntitiesPersonalAccessTokenWithToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPersonalAccessTokenWithToken fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesPersonalAccessTokenWithTokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPersonalAccessTokenWithToken, Hash] the created ApiEntitiesPersonalAccessTokenWithToken; raises GitlabError on failure
