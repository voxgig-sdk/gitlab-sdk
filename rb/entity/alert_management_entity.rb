...
class AlertManagementEntity
  ...
  def make
    opts = @_entopts.dup
    AlertManagementEntity.new(@_client, opts)
  end
  ...
  # @return [AlertManagement, Hash] the current AlertManagement data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AlertManagement fields)
  def match_get
  ...
  #
  # @param reqdata [AlertManagementCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AlertManagement, Hash] the created AlertManagement; raises GitlabError on failure
  ...
  #
  # @param reqmatch [AlertManagementRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [AlertManagement, Hash] the removed AlertManagement; raises GitlabError on failure
