...
class ProjectExportEntity
  ...
  def make
    opts = @_entopts.dup
    ProjectExportEntity.new(@_client, opts)
  end
  ...
  # @return [ProjectExport, Hash] the current ProjectExport data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProjectExport fields)
  def match_get
  ...
  #
  # @param reqmatch [ProjectExportLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ProjectExport.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectExport, Hash] the loaded ProjectExport; raises GitlabError on failure
  ...
  #
  # @param reqdata [ProjectExportCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectExport, Hash] the created ProjectExport; raises GitlabError on failure
