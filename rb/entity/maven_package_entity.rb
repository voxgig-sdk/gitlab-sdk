...
class MavenPackageEntity
  ...
  def make
    opts = @_entopts.dup
    MavenPackageEntity.new(@_client, opts)
  end
  ...
  # @return [MavenPackage, Hash] the current MavenPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MavenPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [MavenPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.MavenPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [MavenPackage, Hash] the loaded MavenPackage; raises GitlabError on failure
  ...
  #
  # @param reqdata [MavenPackageUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MavenPackage, Hash] the updated MavenPackage; raises GitlabError on failure
