...
class ApiEntitiesGitlabSubscriptionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_gitlab_subscription"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesGitlabSubscriptionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesGitlabSubscription, Hash] the current ApiEntitiesGitlabSubscription data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesGitlabSubscription fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesGitlabSubscriptionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesGitlabSubscription.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesGitlabSubscription, Hash] the loaded ApiEntitiesGitlabSubscription; raises GitlabError on failure
