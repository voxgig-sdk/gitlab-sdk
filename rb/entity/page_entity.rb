...
class PageEntity
  ...
  # @return [Page, Hash] the loaded Page; raises GitlabError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Page, Hash] the updated Page; raises GitlabError on failure
  ...
  # Remove an Page matching the given criteria.
  #
  # @param reqmatch [PageRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Page, Hash] the removed Page; raises GitlabError on failure
