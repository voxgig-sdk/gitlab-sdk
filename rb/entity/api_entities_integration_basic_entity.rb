...
class ApiEntitiesIntegrationBasicEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_integration_basic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesIntegrationBasicEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesIntegrationBasic, Hash] the current ApiEntitiesIntegrationBasic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesIntegrationBasic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesIntegrationBasicListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesIntegrationBasic fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesIntegrationBasic>, Array] the matching ApiEntitiesIntegrationBasic items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesIntegrationBasicUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesIntegrationBasic, Hash] the updated ApiEntitiesIntegrationBasic; raises GitlabError on failure
