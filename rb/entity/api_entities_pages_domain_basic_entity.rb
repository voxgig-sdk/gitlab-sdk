...
class ApiEntitiesPagesDomainBasicEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_pages_domain_basic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPagesDomainBasicEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPagesDomainBasic, Hash] the current ApiEntitiesPagesDomainBasic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPagesDomainBasic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPagesDomainBasicLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesPagesDomainBasic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPagesDomainBasic, Hash] the loaded ApiEntitiesPagesDomainBasic; raises GitlabError on failure
