...
class ErrorTrackingClientKeyEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "error_tracking_client_key"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ErrorTrackingClientKeyEntity.new(@_client, opts)
  end
  ...
  # @return [ErrorTrackingClientKey, Hash] the current ErrorTrackingClientKey data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ErrorTrackingClientKey fields)
  def match_get
  ...
  #
  # @param reqmatch [ErrorTrackingClientKeyRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ErrorTrackingClientKey, Hash] the removed ErrorTrackingClientKey; raises GitlabError on failure
