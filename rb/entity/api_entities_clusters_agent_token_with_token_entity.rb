...
class ApiEntitiesClustersAgentTokenWithTokenEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_clusters_agent_token_with_token"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesClustersAgentTokenWithTokenEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesClustersAgentTokenWithToken, Hash] the current ApiEntitiesClustersAgentTokenWithToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesClustersAgentTokenWithToken fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesClustersAgentTokenWithTokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesClustersAgentTokenWithToken, Hash] the created ApiEntitiesClustersAgentTokenWithToken; raises GitlabError on failure
