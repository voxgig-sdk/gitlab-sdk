...
class ApiEntitiesAvatarEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesAvatarEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesAvatar, Hash] the current ApiEntitiesAvatar data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesAvatar fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesAvatarLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesAvatar.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesAvatar, Hash] the loaded ApiEntitiesAvatar; raises GitlabError on failure
