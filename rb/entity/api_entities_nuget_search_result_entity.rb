...
class ApiEntitiesNugetSearchResultEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_nuget_search_result"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesNugetSearchResultEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesNugetSearchResult, Hash] the current ApiEntitiesNugetSearchResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesNugetSearchResult fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesNugetSearchResultListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesNugetSearchResult fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesNugetSearchResult>, Array] the matching ApiEntitiesNugetSearchResult items; raises GitlabError on failure
