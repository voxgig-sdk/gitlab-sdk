...
class JobEntity
  ...
  # @return [Job, Hash] the current Job data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Job fields)
  def match_get
  ...
  # Load a single Job.
  #
  # @param reqmatch [JobLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Job.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Job, Hash] the loaded Job; raises GitlabError on failure
  ...
  # Create a new Job.
  #
  # @param reqdata [JobCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Job, Hash] the created Job; raises GitlabError on failure
  ...
  #
  # @param reqdata [JobUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Job, Hash] the updated Job; raises GitlabError on failure
