...
class ApiEntitiesProjectImportStatusEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_project_import_status"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectImportStatusEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectImportStatus, Hash] the current ApiEntitiesProjectImportStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectImportStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProjectImportStatusListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesProjectImportStatus fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesProjectImportStatus>, Array] the matching ApiEntitiesProjectImportStatus items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProjectImportStatusCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectImportStatus, Hash] the created ApiEntitiesProjectImportStatus; raises GitlabError on failure
