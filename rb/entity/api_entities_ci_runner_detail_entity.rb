...
class ApiEntitiesCiRunnerDetailEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_runner_detail"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiRunnerDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiRunnerDetail, Hash] the current ApiEntitiesCiRunnerDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiRunnerDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiRunnerDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesCiRunnerDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiRunnerDetail, Hash] the loaded ApiEntitiesCiRunnerDetail; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesCiRunnerDetailUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiRunnerDetail, Hash] the updated ApiEntitiesCiRunnerDetail; raises GitlabError on failure
