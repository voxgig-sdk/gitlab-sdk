...
class EeApiEntitiesSshCertificateEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "ee_api_entities_ssh_certificate"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    EeApiEntitiesSshCertificateEntity.new(@_client, opts)
  end
  ...
  # @return [EeApiEntitiesSshCertificate, Hash] the current EeApiEntitiesSshCertificate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EeApiEntitiesSshCertificate fields)
  def match_get
  ...
  #
  # @param reqmatch [EeApiEntitiesSshCertificateListMatch, Hash, nil] match filter (any subset of
  #   EeApiEntitiesSshCertificate fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EeApiEntitiesSshCertificate>, Array] the matching EeApiEntitiesSshCertificate items; raises GitlabError on failure
  ...
  #
  # @param reqdata [EeApiEntitiesSshCertificateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EeApiEntitiesSshCertificate, Hash] the created EeApiEntitiesSshCertificate; raises GitlabError on failure
