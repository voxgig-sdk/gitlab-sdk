...
class ApiEntitiesWikiPageBasicEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_wiki_page_basic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesWikiPageBasicEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesWikiPageBasic, Hash] the current ApiEntitiesWikiPageBasic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesWikiPageBasic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesWikiPageBasicListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesWikiPageBasic fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesWikiPageBasic>, Array] the matching ApiEntitiesWikiPageBasic items; raises GitlabError on failure
