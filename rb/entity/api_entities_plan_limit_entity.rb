...
class ApiEntitiesPlanLimitEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPlanLimitEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPlanLimit, Hash] the current ApiEntitiesPlanLimit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPlanLimit fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPlanLimitLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesPlanLimit.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPlanLimit, Hash] the loaded ApiEntitiesPlanLimit; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesPlanLimitUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPlanLimit, Hash] the updated ApiEntitiesPlanLimit; raises GitlabError on failure
