...
class ApiEntitiesPackagesConanRevisionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_packages_conan_revision"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackagesConanRevisionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackagesConanRevision, Hash] the current ApiEntitiesPackagesConanRevision data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackagesConanRevision fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPackagesConanRevisionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesPackagesConanRevision.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPackagesConanRevision, Hash] the loaded ApiEntitiesPackagesConanRevision; raises GitlabError on failure
