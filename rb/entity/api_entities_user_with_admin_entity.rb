...
class ApiEntitiesUserWithAdminEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_user_with_admin"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesUserWithAdminEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesUserWithAdmin, Hash] the current ApiEntitiesUserWithAdmin data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesUserWithAdmin fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesUserWithAdminListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesUserWithAdmin fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesUserWithAdmin>, Array] the matching ApiEntitiesUserWithAdmin items; raises GitlabError on failure
