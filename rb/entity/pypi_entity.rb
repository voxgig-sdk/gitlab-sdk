...
class PypiEntity
  ...
  # @return [Pypi, Hash] the current Pypi data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Pypi fields)
  def match_get
  ...
  # Create a new Pypi.
  #
  # @param reqdata [PypiCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Pypi, Hash] the created Pypi; raises GitlabError on failure
