...
class ProjectAvatarEntity
  ...
  def make
    opts = @_entopts.dup
    ProjectAvatarEntity.new(@_client, opts)
  end
  ...
  # @return [ProjectAvatar, Hash] the current ProjectAvatar data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProjectAvatar fields)
  def match_get
  ...
  #
  # @param reqmatch [ProjectAvatarLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ProjectAvatar.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectAvatar, Hash] the loaded ProjectAvatar; raises GitlabError on failure
