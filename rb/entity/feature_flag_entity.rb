...
class FeatureFlagEntity
  ...
  def make
    opts = @_entopts.dup
    FeatureFlagEntity.new(@_client, opts)
  end
  ...
  # @return [FeatureFlag, Hash] the current FeatureFlag data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FeatureFlag fields)
  def match_get
  ...
  #
  # @param reqmatch [FeatureFlagLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.FeatureFlag.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [FeatureFlag, Hash] the loaded FeatureFlag; raises GitlabError on failure
  ...
  #
  # @param reqdata [FeatureFlagCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [FeatureFlag, Hash] the created FeatureFlag; raises GitlabError on failure
  ...
  #
  # @param reqmatch [FeatureFlagRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [FeatureFlag, Hash] the removed FeatureFlag; raises GitlabError on failure
