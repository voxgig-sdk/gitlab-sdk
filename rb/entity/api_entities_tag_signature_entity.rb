...
class ApiEntitiesTagSignatureEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_tag_signature"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesTagSignatureEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesTagSignature, Hash] the current ApiEntitiesTagSignature data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesTagSignature fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesTagSignatureLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesTagSignature.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesTagSignature, Hash] the loaded ApiEntitiesTagSignature; raises GitlabError on failure
