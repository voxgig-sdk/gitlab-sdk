...
class ApiEntitiesMergeRequestBasicEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_merge_request_basic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMergeRequestBasicEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMergeRequestBasic, Hash] the current ApiEntitiesMergeRequestBasic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMergeRequestBasic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesMergeRequestBasicLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesMergeRequestBasic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMergeRequestBasic, Hash] the loaded ApiEntitiesMergeRequestBasic; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesMergeRequestBasicListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesMergeRequestBasic fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesMergeRequestBasic>, Array] the matching ApiEntitiesMergeRequestBasic items; raises GitlabError on failure
