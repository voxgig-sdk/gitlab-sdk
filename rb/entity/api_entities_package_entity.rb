...
class ApiEntitiesPackageEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackageEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackage, Hash] the current ApiEntitiesPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPackage, Hash] the loaded ApiEntitiesPackage; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesPackageListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesPackage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesPackage>, Array] the matching ApiEntitiesPackage items; raises GitlabError on failure
