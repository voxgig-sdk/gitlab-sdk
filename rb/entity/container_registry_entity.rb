...
class ContainerRegistryEntity
  ...
  def make
    opts = @_entopts.dup
    ContainerRegistryEntity.new(@_client, opts)
  end
  ...
  # @return [ContainerRegistry, Hash] the current ContainerRegistry data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ContainerRegistry fields)
  def match_get
  ...
  #
  # @param reqmatch [ContainerRegistryRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ContainerRegistry, Hash] the removed ContainerRegistry; raises GitlabError on failure
