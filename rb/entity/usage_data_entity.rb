...
class UsageDataEntity
  ...
  def make
    opts = @_entopts.dup
    UsageDataEntity.new(@_client, opts)
  end
  ...
  # @return [UsageData, Hash] the current UsageData data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UsageData fields)
  def match_get
  ...
  #
  # @param reqmatch [UsageDataLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.UsageData.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [UsageData, Hash] the loaded UsageData; raises GitlabError on failure
  ...
  #
  # @param reqdata [UsageDataCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UsageData, Hash] the created UsageData; raises GitlabError on failure
