...
class ApiEntitiesAccessRequesterEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_access_requester"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesAccessRequesterEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesAccessRequester, Hash] the current ApiEntitiesAccessRequester data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesAccessRequester fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesAccessRequesterListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesAccessRequester fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesAccessRequester>, Array] the matching ApiEntitiesAccessRequester items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesAccessRequesterCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesAccessRequester, Hash] the created ApiEntitiesAccessRequester; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesAccessRequesterUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesAccessRequester, Hash] the updated ApiEntitiesAccessRequester; raises GitlabError on failure
