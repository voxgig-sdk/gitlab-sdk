...
class ApiEntitiesDraftNoteEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDraftNoteEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDraftNote, Hash] the current ApiEntitiesDraftNote data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDraftNote fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesDraftNoteLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesDraftNote.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDraftNote, Hash] the loaded ApiEntitiesDraftNote; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesDraftNoteListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesDraftNote fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesDraftNote>, Array] the matching ApiEntitiesDraftNote items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesDraftNoteCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDraftNote, Hash] the created ApiEntitiesDraftNote; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesDraftNoteUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDraftNote, Hash] the updated ApiEntitiesDraftNote; raises GitlabError on failure
