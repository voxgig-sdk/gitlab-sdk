...
class ApiEntitiesNugetPackagesVersionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_nuget_packages_version"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesNugetPackagesVersionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesNugetPackagesVersion, Hash] the current ApiEntitiesNugetPackagesVersion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesNugetPackagesVersion fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesNugetPackagesVersionListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesNugetPackagesVersion fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesNugetPackagesVersion>, Array] the matching ApiEntitiesNugetPackagesVersion items; raises GitlabError on failure
