...
class FeatureEntity
  ...
  def make
    opts = @_entopts.dup
    FeatureEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [FeatureRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Feature, Hash] the removed Feature; raises GitlabError on failure
