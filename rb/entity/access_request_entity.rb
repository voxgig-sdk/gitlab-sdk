...
class AccessRequestEntity
  ...
  def make
    opts = @_entopts.dup
    AccessRequestEntity.new(@_client, opts)
  end
  ...
  # @return [AccessRequest, Hash] the current AccessRequest data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AccessRequest fields)
  def match_get
  ...
  #
  # @param reqmatch [AccessRequestRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [AccessRequest, Hash] the removed AccessRequest; raises GitlabError on failure
