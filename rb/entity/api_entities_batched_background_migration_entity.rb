...
class ApiEntitiesBatchedBackgroundMigrationEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_batched_background_migration"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBatchedBackgroundMigrationEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBatchedBackgroundMigration, Hash] the current ApiEntitiesBatchedBackgroundMigration data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBatchedBackgroundMigration fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesBatchedBackgroundMigrationLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesBatchedBackgroundMigration.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBatchedBackgroundMigration, Hash] the loaded ApiEntitiesBatchedBackgroundMigration; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesBatchedBackgroundMigrationListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesBatchedBackgroundMigration fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesBatchedBackgroundMigration>, Array] the matching ApiEntitiesBatchedBackgroundMigration items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesBatchedBackgroundMigrationUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBatchedBackgroundMigration, Hash] the updated ApiEntitiesBatchedBackgroundMigration; raises GitlabError on failure
