...
class ApiEntitiesGoModuleVersionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_go_module_version"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesGoModuleVersionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesGoModuleVersion, Hash] the current ApiEntitiesGoModuleVersion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesGoModuleVersion fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesGoModuleVersionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesGoModuleVersion.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesGoModuleVersion, Hash] the loaded ApiEntitiesGoModuleVersion; raises GitlabError on failure
