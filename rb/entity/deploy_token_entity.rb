...
class DeployTokenEntity
  ...
  def make
    opts = @_entopts.dup
    DeployTokenEntity.new(@_client, opts)
  end
  ...
  # @return [DeployToken, Hash] the current DeployToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeployToken fields)
  def match_get
  ...
  #
  # @param reqmatch [DeployTokenRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeployToken, Hash] the removed DeployToken; raises GitlabError on failure
