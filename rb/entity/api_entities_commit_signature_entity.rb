...
class ApiEntitiesCommitSignatureEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_commit_signature"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCommitSignatureEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCommitSignature, Hash] the current ApiEntitiesCommitSignature data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCommitSignature fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCommitSignatureLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesCommitSignature.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCommitSignature, Hash] the loaded ApiEntitiesCommitSignature; raises GitlabError on failure
