...
class ApiEntitiesNpmPackageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_npm_package"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesNpmPackageEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesNpmPackage, Hash] the current ApiEntitiesNpmPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesNpmPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesNpmPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesNpmPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesNpmPackage, Hash] the loaded ApiEntitiesNpmPackage; raises GitlabError on failure
