...
class ApiEntitiesCiCatalogResourcesVersionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_catalog_resources_version"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiCatalogResourcesVersionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiCatalogResourcesVersion, Hash] the current ApiEntitiesCiCatalogResourcesVersion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiCatalogResourcesVersion fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesCiCatalogResourcesVersionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiCatalogResourcesVersion, Hash] the created ApiEntitiesCiCatalogResourcesVersion; raises GitlabError on failure
