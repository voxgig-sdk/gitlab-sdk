...
class ConanEntity
  ...
  # @return [Conan, Hash] the current Conan data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Conan fields)
  def match_get
  ...
  #
  # @param reqmatch [ConanRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Conan, Hash] the removed Conan; raises GitlabError on failure
