...
class ApiEntitiesMarkdownEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMarkdownEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMarkdown, Hash] the current ApiEntitiesMarkdown data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMarkdown fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesMarkdownCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesMarkdown, Hash] the created ApiEntitiesMarkdown; raises GitlabError on failure
