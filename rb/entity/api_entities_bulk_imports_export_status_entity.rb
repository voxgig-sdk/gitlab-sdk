...
class ApiEntitiesBulkImportsExportStatusEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_bulk_imports_export_status"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBulkImportsExportStatusEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBulkImportsExportStatus, Hash] the current ApiEntitiesBulkImportsExportStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBulkImportsExportStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesBulkImportsExportStatusListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesBulkImportsExportStatus fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesBulkImportsExportStatus>, Array] the matching ApiEntitiesBulkImportsExportStatus items; raises GitlabError on failure
