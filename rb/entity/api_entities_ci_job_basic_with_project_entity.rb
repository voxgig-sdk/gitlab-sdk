...
class ApiEntitiesCiJobBasicWithProjectEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_job_basic_with_project"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiJobBasicWithProjectEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiJobBasicWithProject, Hash] the current ApiEntitiesCiJobBasicWithProject data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiJobBasicWithProject fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiJobBasicWithProjectLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesCiJobBasicWithProject.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiJobBasicWithProject, Hash] the loaded ApiEntitiesCiJobBasicWithProject; raises GitlabError on failure
