...
class ApiEntitiesWikiAttachmentEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_wiki_attachment"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesWikiAttachmentEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesWikiAttachment, Hash] the current ApiEntitiesWikiAttachment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesWikiAttachment fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesWikiAttachmentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesWikiAttachment, Hash] the created ApiEntitiesWikiAttachment; raises GitlabError on failure
