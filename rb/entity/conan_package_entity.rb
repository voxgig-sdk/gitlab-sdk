...
class ConanPackageEntity
  ...
  def make
    opts = @_entopts.dup
    ConanPackageEntity.new(@_client, opts)
  end
  ...
  # @return [ConanPackage, Hash] the current ConanPackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ConanPackage fields)
  def match_get
  ...
  #
  # @param reqmatch [ConanPackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ConanPackage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ConanPackage, Hash] the loaded ConanPackage; raises GitlabError on failure
  ...
  #
  # @param reqdata [ConanPackageUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ConanPackage, Hash] the updated ConanPackage; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ConanPackageRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ConanPackage, Hash] the removed ConanPackage; raises GitlabError on failure
