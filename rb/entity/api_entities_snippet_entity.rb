...
class ApiEntitiesSnippetEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesSnippetEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesSnippet, Hash] the current ApiEntitiesSnippet data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesSnippet fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesSnippetListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesSnippet fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesSnippet>, Array] the matching ApiEntitiesSnippet items; raises GitlabError on failure
