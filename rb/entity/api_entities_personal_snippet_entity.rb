...
class ApiEntitiesPersonalSnippetEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_personal_snippet"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPersonalSnippetEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPersonalSnippet, Hash] the current ApiEntitiesPersonalSnippet data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPersonalSnippet fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPersonalSnippetLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesPersonalSnippet.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPersonalSnippet, Hash] the loaded ApiEntitiesPersonalSnippet; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesPersonalSnippetListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesPersonalSnippet fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesPersonalSnippet>, Array] the matching ApiEntitiesPersonalSnippet items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesPersonalSnippetCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPersonalSnippet, Hash] the created ApiEntitiesPersonalSnippet; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesPersonalSnippetUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPersonalSnippet, Hash] the updated ApiEntitiesPersonalSnippet; raises GitlabError on failure
