...
class ApiEntitiesIssueLinkEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesIssueLinkEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesIssueLink, Hash] the current ApiEntitiesIssueLink data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesIssueLink fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesIssueLinkLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesIssueLink.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesIssueLink, Hash] the loaded ApiEntitiesIssueLink; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesIssueLinkCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesIssueLink, Hash] the created ApiEntitiesIssueLink; raises GitlabError on failure
