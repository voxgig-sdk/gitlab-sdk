...
class GroupExportEntity
  ...
  def make
    opts = @_entopts.dup
    GroupExportEntity.new(@_client, opts)
  end
  ...
  # @return [GroupExport, Hash] the current GroupExport data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GroupExport fields)
  def match_get
  ...
  #
  # @param reqmatch [GroupExportLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GroupExport.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GroupExport, Hash] the loaded GroupExport; raises GitlabError on failure
  ...
  #
  # @param reqdata [GroupExportCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [GroupExport, Hash] the created GroupExport; raises GitlabError on failure
