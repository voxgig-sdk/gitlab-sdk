...
class ApiEntitiesProtectedBranchEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_protected_branch"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProtectedBranchEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProtectedBranch, Hash] the current ApiEntitiesProtectedBranch data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProtectedBranch fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProtectedBranchLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesProtectedBranch.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProtectedBranch, Hash] the loaded ApiEntitiesProtectedBranch; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesProtectedBranchListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesProtectedBranch fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesProtectedBranch>, Array] the matching ApiEntitiesProtectedBranch items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProtectedBranchCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProtectedBranch, Hash] the created ApiEntitiesProtectedBranch; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProtectedBranchUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProtectedBranch, Hash] the updated ApiEntitiesProtectedBranch; raises GitlabError on failure
