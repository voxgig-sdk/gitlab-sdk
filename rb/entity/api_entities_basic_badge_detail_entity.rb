...
class ApiEntitiesBasicBadgeDetailEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_basic_badge_detail"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBasicBadgeDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBasicBadgeDetail, Hash] the current ApiEntitiesBasicBadgeDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBasicBadgeDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesBasicBadgeDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesBasicBadgeDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBasicBadgeDetail, Hash] the loaded ApiEntitiesBasicBadgeDetail; raises GitlabError on failure
