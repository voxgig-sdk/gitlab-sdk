...
class ApiEntitiesRelatedIssueEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_related_issue"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesRelatedIssueEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesRelatedIssue, Hash] the current ApiEntitiesRelatedIssue data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesRelatedIssue fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesRelatedIssueListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesRelatedIssue fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesRelatedIssue>, Array] the matching ApiEntitiesRelatedIssue items; raises GitlabError on failure
