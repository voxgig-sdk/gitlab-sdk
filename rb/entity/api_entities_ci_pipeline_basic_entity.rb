...
class ApiEntitiesCiPipelineBasicEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_pipeline_basic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiPipelineBasicEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiPipelineBasic, Hash] the current ApiEntitiesCiPipelineBasic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiPipelineBasic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiPipelineBasicLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesCiPipelineBasic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiPipelineBasic, Hash] the loaded ApiEntitiesCiPipelineBasic; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesCiPipelineBasicListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesCiPipelineBasic fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesCiPipelineBasic>, Array] the matching ApiEntitiesCiPipelineBasic items; raises GitlabError on failure
