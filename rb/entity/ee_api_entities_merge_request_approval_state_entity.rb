...
class EeApiEntitiesMergeRequestApprovalStateEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "ee_api_entities_merge_request_approval_state"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    EeApiEntitiesMergeRequestApprovalStateEntity.new(@_client, opts)
  end
  ...
  # @return [EeApiEntitiesMergeRequestApprovalState, Hash] the current EeApiEntitiesMergeRequestApprovalState data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EeApiEntitiesMergeRequestApprovalState fields)
  def match_get
  ...
  #
  # @param reqmatch [EeApiEntitiesMergeRequestApprovalStateListMatch, Hash, nil] match filter (any subset of
  #   EeApiEntitiesMergeRequestApprovalState fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EeApiEntitiesMergeRequestApprovalState>, Array] the matching EeApiEntitiesMergeRequestApprovalState items; raises GitlabError on failure
