...
class ApiEntitiesBulkImportsEntityFailureEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_bulk_imports_entity_failure"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesBulkImportsEntityFailureEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesBulkImportsEntityFailure, Hash] the current ApiEntitiesBulkImportsEntityFailure data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesBulkImportsEntityFailure fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesBulkImportsEntityFailureLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesBulkImportsEntityFailure.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesBulkImportsEntityFailure, Hash] the loaded ApiEntitiesBulkImportsEntityFailure; raises GitlabError on failure
