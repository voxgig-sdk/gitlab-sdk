...
class ApiEntitiesFeatureEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesFeatureEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesFeature, Hash] the current ApiEntitiesFeature data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesFeature fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesFeatureListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesFeature fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesFeature>, Array] the matching ApiEntitiesFeature items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesFeatureCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesFeature, Hash] the created ApiEntitiesFeature; raises GitlabError on failure
