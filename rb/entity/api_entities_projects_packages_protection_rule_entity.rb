...
class ApiEntitiesProjectsPackagesProtectionRuleEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_projects_packages_protection_rule"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectsPackagesProtectionRuleEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectsPackagesProtectionRule, Hash] the current ApiEntitiesProjectsPackagesProtectionRule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectsPackagesProtectionRule fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesProjectsPackagesProtectionRuleListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesProjectsPackagesProtectionRule fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesProjectsPackagesProtectionRule>, Array] the matching ApiEntitiesProjectsPackagesProtectionRule items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProjectsPackagesProtectionRuleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectsPackagesProtectionRule, Hash] the created ApiEntitiesProjectsPackagesProtectionRule; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesProjectsPackagesProtectionRuleUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectsPackagesProtectionRule, Hash] the updated ApiEntitiesProjectsPackagesProtectionRule; raises GitlabError on failure
