...
class NpmEntity
  ...
  # @return [Npm, Hash] the current Npm data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Npm fields)
  def match_get
  ...
  #
  # @param reqdata [NpmUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Npm, Hash] the updated Npm; raises GitlabError on failure
