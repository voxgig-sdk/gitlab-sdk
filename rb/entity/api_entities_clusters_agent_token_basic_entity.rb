...
class ApiEntitiesClustersAgentTokenBasicEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_clusters_agent_token_basic"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesClustersAgentTokenBasicEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesClustersAgentTokenBasic, Hash] the current ApiEntitiesClustersAgentTokenBasic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesClustersAgentTokenBasic fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesClustersAgentTokenBasicLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesClustersAgentTokenBasic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesClustersAgentTokenBasic, Hash] the loaded ApiEntitiesClustersAgentTokenBasic; raises GitlabError on failure
