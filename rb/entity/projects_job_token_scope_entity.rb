...
class ProjectsJobTokenScopeEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "projects_job_token_scope"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ProjectsJobTokenScopeEntity.new(@_client, opts)
  end
  ...
  # @return [ProjectsJobTokenScope, Hash] the current ProjectsJobTokenScope data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProjectsJobTokenScope fields)
  def match_get
  ...
  #
  # @param reqdata [ProjectsJobTokenScopeUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectsJobTokenScope, Hash] the updated ProjectsJobTokenScope; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ProjectsJobTokenScopeRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProjectsJobTokenScope, Hash] the removed ProjectsJobTokenScope; raises GitlabError on failure
