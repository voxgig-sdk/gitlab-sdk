...
class ApiEntitiesErrorTrackingClientKeyEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_error_tracking_client_key"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesErrorTrackingClientKeyEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesErrorTrackingClientKey, Hash] the current ApiEntitiesErrorTrackingClientKey data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesErrorTrackingClientKey fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesErrorTrackingClientKeyListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesErrorTrackingClientKey fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesErrorTrackingClientKey>, Array] the matching ApiEntitiesErrorTrackingClientKey items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesErrorTrackingClientKeyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesErrorTrackingClientKey, Hash] the created ApiEntitiesErrorTrackingClientKey; raises GitlabError on failure
