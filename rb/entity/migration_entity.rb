...
class MigrationEntity
  ...
  def make
    opts = @_entopts.dup
    MigrationEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqdata [MigrationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Migration, Hash] the created Migration; raises GitlabError on failure
