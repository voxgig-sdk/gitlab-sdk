...
class ApiEntitiesHookEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesHookEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesHook, Hash] the current ApiEntitiesHook data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesHook fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesHookLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesHook.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesHook, Hash] the loaded ApiEntitiesHook; raises GitlabError on failure
  ...
  #
  # @param reqmatch [ApiEntitiesHookListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesHook fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesHook>, Array] the matching ApiEntitiesHook items; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesHookCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesHook, Hash] the created ApiEntitiesHook; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesHookUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesHook, Hash] the updated ApiEntitiesHook; raises GitlabError on failure
