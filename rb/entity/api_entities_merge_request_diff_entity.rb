...
class ApiEntitiesMergeRequestDiffEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_merge_request_diff"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesMergeRequestDiffEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesMergeRequestDiff, Hash] the current ApiEntitiesMergeRequestDiff data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesMergeRequestDiff fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesMergeRequestDiffListMatch, Hash, nil] match filter (any subset of
  #   ApiEntitiesMergeRequestDiff fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiEntitiesMergeRequestDiff>, Array] the matching ApiEntitiesMergeRequestDiff items; raises GitlabError on failure
