...
class ComposerEntity
  ...
  def make
    opts = @_entopts.dup
    ComposerEntity.new(@_client, opts)
  end
  ...
  # @return [Composer, Hash] the current Composer data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Composer fields)
  def match_get
  ...
  #
  # @param reqdata [ComposerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Composer, Hash] the created Composer; raises GitlabError on failure
