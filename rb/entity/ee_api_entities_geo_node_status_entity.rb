...
class EeApiEntitiesGeoNodeStatusEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "ee_api_entities_geo_node_status"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    EeApiEntitiesGeoNodeStatusEntity.new(@_client, opts)
  end
  ...
  # @return [EeApiEntitiesGeoNodeStatus, Hash] the current EeApiEntitiesGeoNodeStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EeApiEntitiesGeoNodeStatus fields)
  def match_get
  ...
  #
  # @param reqdata [EeApiEntitiesGeoNodeStatusCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EeApiEntitiesGeoNodeStatus, Hash] the created EeApiEntitiesGeoNodeStatus; raises GitlabError on failure
