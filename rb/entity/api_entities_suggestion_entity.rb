...
class ApiEntitiesSuggestionEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesSuggestionEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesSuggestion, Hash] the current ApiEntitiesSuggestion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesSuggestion fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesSuggestionUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesSuggestion, Hash] the updated ApiEntitiesSuggestion; raises GitlabError on failure
