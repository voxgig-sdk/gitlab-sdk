...
class GroupEntity
  ...
  #   as an empty match, so client.Group.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Group, Hash] the loaded Group; raises GitlabError on failure
  ...
  # Create a new Group.
  #
  # @param reqdata [GroupCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Group, Hash] the created Group; raises GitlabError on failure
  ...
  #
  # @param reqdata [GroupUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Group, Hash] the updated Group; raises GitlabError on failure
  ...
  # Remove an Group matching the given criteria.
  #
  # @param reqmatch [GroupRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Group, Hash] the removed Group; raises GitlabError on failure
