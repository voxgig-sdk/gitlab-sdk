...
class IntegrationEntity
  ...
  # @return [Integration, Hash] the created Integration; raises GitlabError on failure
  ...
  # Remove an Integration matching the given criteria.
  #
  # @param reqmatch [IntegrationRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Integration, Hash] the removed Integration; raises GitlabError on failure
