...
class ApiEntitiesPackagesConanFilesListEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_packages_conan_files_list"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackagesConanFilesListEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackagesConanFilesList, Hash] the current ApiEntitiesPackagesConanFilesList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackagesConanFilesList fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesPackagesConanFilesListLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesPackagesConanFilesList.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPackagesConanFilesList, Hash] the loaded ApiEntitiesPackagesConanFilesList; raises GitlabError on failure
