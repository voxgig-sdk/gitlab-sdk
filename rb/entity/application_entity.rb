...
class ApplicationEntity
  ...
  def make
    opts = @_entopts.dup
    ApplicationEntity.new(@_client, opts)
  end
  ...
  # @return [Application, Hash] the current Application data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Application fields)
  def match_get
  ...
  #
  # @param reqmatch [ApplicationRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Application, Hash] the removed Application; raises GitlabError on failure
