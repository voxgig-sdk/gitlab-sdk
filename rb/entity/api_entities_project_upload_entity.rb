...
class ApiEntitiesProjectUploadEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_project_upload"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesProjectUploadEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesProjectUpload, Hash] the current ApiEntitiesProjectUpload data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesProjectUpload fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesProjectUploadCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesProjectUpload, Hash] the created ApiEntitiesProjectUpload; raises GitlabError on failure
