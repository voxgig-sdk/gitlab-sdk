...
class TestReportEntity
  ...
  def make
    opts = @_entopts.dup
    TestReportEntity.new(@_client, opts)
  end
  ...
  # @return [TestReport, Hash] the current TestReport data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TestReport fields)
  def match_get
  ...
  #
  # @param reqmatch [TestReportListMatch, Hash, nil] match filter (any subset of
  #   TestReport fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<TestReport>, Array] the matching TestReport items; raises GitlabError on failure
