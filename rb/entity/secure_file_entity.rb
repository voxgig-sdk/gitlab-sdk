...
class SecureFileEntity
  ...
  def make
    opts = @_entopts.dup
    SecureFileEntity.new(@_client, opts)
  end
  ...
  # @return [SecureFile, Hash] the current SecureFile data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SecureFile fields)
  def match_get
  ...
  #
  # @param reqmatch [SecureFileLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.SecureFile.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [SecureFile, Hash] the loaded SecureFile; raises GitlabError on failure
  ...
  #
  # @param reqmatch [SecureFileRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [SecureFile, Hash] the removed SecureFile; raises GitlabError on failure
