...
class NugetEntity
  ...
  # @return [Nuget, Hash] the current Nuget data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Nuget fields)
  def match_get
  ...
  #
  # @param reqdata [NugetUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Nuget, Hash] the updated Nuget; raises GitlabError on failure
