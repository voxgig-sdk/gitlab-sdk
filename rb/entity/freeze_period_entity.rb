...
class FreezePeriodEntity
  ...
  def make
    opts = @_entopts.dup
    FreezePeriodEntity.new(@_client, opts)
  end
  ...
  # @return [FreezePeriod, Hash] the current FreezePeriod data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FreezePeriod fields)
  def match_get
  ...
  #
  # @param reqmatch [FreezePeriodRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [FreezePeriod, Hash] the removed FreezePeriod; raises GitlabError on failure
