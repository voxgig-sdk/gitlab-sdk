...
class ApiEntitiesCiRunnerManagerEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_ci_runner_manager"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesCiRunnerManagerEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesCiRunnerManager, Hash] the current ApiEntitiesCiRunnerManager data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesCiRunnerManager fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesCiRunnerManagerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesCiRunnerManager.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesCiRunnerManager, Hash] the loaded ApiEntitiesCiRunnerManager; raises GitlabError on failure
