...
class ApiEntitiesDeploymentsApprovalEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_deployments_approval"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesDeploymentsApprovalEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesDeploymentsApproval, Hash] the current ApiEntitiesDeploymentsApproval data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesDeploymentsApproval fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesDeploymentsApprovalCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesDeploymentsApproval, Hash] the created ApiEntitiesDeploymentsApproval; raises GitlabError on failure
