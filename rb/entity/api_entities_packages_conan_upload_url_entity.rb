...
class ApiEntitiesPackagesConanUploadUrlEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_packages_conan_upload_url"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesPackagesConanUploadUrlEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesPackagesConanUploadUrl, Hash] the current ApiEntitiesPackagesConanUploadUrl data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesPackagesConanUploadUrl fields)
  def match_get
  ...
  #
  # @param reqdata [ApiEntitiesPackagesConanUploadUrlCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesPackagesConanUploadUrl, Hash] the created ApiEntitiesPackagesConanUploadUrl; raises GitlabError on failure
