...
class ApiEntitiesErrorTrackingProjectSettingEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "api_entities_error_tracking_project_setting"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesErrorTrackingProjectSettingEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesErrorTrackingProjectSetting, Hash] the current ApiEntitiesErrorTrackingProjectSetting data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesErrorTrackingProjectSetting fields)
  def match_get
  ...
  #
  # @param reqmatch [ApiEntitiesErrorTrackingProjectSettingLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiEntitiesErrorTrackingProjectSetting.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesErrorTrackingProjectSetting, Hash] the loaded ApiEntitiesErrorTrackingProjectSetting; raises GitlabError on failure
  ...
  #
  # @param reqdata [ApiEntitiesErrorTrackingProjectSettingUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiEntitiesErrorTrackingProjectSetting, Hash] the updated ApiEntitiesErrorTrackingProjectSetting; raises GitlabError on failure
