...
class ApiEntitiesLicenseEntity
  ...
  def make
    opts = @_entopts.dup
    ApiEntitiesLicenseEntity.new(@_client, opts)
  end
  ...
  # @return [ApiEntitiesLicense, Hash] the current ApiEntitiesLicense data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApiEntitiesLicense fields)
  def match_get
