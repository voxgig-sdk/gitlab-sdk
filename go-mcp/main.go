// Command Gitlab-mcp is an MCP server exposing the Gitlab
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Gitlab_list  — list records of an entity
//	Gitlab_load  — load a single record of an entity
//
...
func main() {
	...
	if apikey := os.Getenv("GITLAB_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("GITLAB_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewGitlabSDK(opts)
