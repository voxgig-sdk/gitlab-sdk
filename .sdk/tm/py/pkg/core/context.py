...
from projectname_sdk.core.control import GitlabControl
...
class GitlabContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, GitlabResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GitlabError(code, msg, self)
