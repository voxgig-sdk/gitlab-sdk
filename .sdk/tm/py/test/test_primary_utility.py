...
from projectname_sdk import GitlabSDK
from projectname_sdk.core.spec import GitlabSpec
from projectname_sdk.core.result import GitlabResult
from projectname_sdk.core.response import GitlabResponse
from projectname_sdk.core.operation import GitlabOperation
from projectname_sdk.core.error import GitlabError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import GitlabBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = GitlabSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = GitlabSDK.test(None, None)
        ...
        class TestInitFeature(GitlabBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GitlabBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GitlabSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GitlabSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GitlabSDK.test(None, setup_opts)
