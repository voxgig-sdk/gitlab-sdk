...
// Gitlab SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GitlabMakeRequest
{
    public static function call(GitlabContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GitlabResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GitlabResponse($fetched);
        } else {
