...
// Gitlab SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GitlabOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GitlabOmni::structfix($now, Struct::undef()))
                        !== json_encode(GitlabOmni::structfix($val, Struct::undef()))) {
