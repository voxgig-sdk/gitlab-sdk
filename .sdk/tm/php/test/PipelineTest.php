...
{
    private static function utility(): GitlabUtility
    {
        return new GitlabUtility();
    }
    ...
    private static function ctx(array $over = []): GitlabContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new GitlabContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new GitlabOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof GitlabError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new GitlabOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = GitlabMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new GitlabOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = GitlabMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new GitlabOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = GitlabMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GitlabSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = GitlabMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new GitlabResponse([]),
            'result' => new GitlabResult([]),
        ]);
        [, $err] = GitlabMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new GitlabSpec(['step' => 's']),
            'response' => new GitlabResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new GitlabResult([]),
        ]);
        [, $err] = GitlabMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new GitlabSpec(['step' => 's']),
            'response' => new GitlabResponse(self::resp(200, ['v' => 1])),
            'result' => new GitlabResult([]),
        ]);
        [, $err] = GitlabMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new GitlabSpec(['step' => 's']),
            'response' => new GitlabResponse(self::resp(200, ['v' => 2])),
            'result' => new GitlabResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        GitlabMakeResponse::call($ctx);
    ...
    {
        $preset = new GitlabResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new GitlabSpec([]),
            'response' => new GitlabResponse([]),
            'result' => new GitlabResult([]),
        ...
        [$got, $err] = GitlabMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new GitlabResult([])]);
        [, $err] = GitlabMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new GitlabSpec([]), 'result' => null]);
        [, $err] = GitlabMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GitlabSpec(['step' => 's']),
            'result' => new GitlabResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new GitlabOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GitlabMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GitlabSpec(['step' => 's']),
            'result' => new GitlabResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new GitlabOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GitlabMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GitlabResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new GitlabSpec([]),
            'result' => new GitlabResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = GitlabMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GitlabMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new GitlabError('boom', 'boom');
        $utility->fetcher = function (GitlabContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GitlabSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = GitlabMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (GitlabContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = GitlabMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(GitlabResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (GitlabContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GitlabSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = GitlabMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new GitlabResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new GitlabSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = GitlabMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = GitlabMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = GitlabMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new GitlabResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, GitlabDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new GitlabResult(['ok' => false])]);
        $this->expectException(GitlabError::class);
        GitlabDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new GitlabResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', GitlabMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new GitlabBaseFeature();
        $b = new GitlabBaseFeature();
        GitlabFeatureAdd::call($ctx, $a);
        GitlabFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): GitlabBaseFeature
    {
        $f = new GitlabBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        GitlabFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): GitlabContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new GitlabSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GitlabPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new GitlabResponse(['headers' => null]),
            'result' => new GitlabResult([]),
        ]);
        GitlabResultHeaders::call($ctx);
