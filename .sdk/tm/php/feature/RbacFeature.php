...
class GitlabRbacFeature extends GitlabBaseFeature
{
    ...
    private function _required(GitlabContext $ctx): ?string
    {
    ...
    private function _reject(GitlabContext $ctx, string $required): void
    {
    ...
    private function _track(GitlabContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
