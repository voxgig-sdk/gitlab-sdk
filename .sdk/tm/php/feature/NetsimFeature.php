...
class GitlabNetsimFeature extends GitlabBaseFeature
{
    ...
    private function _simulate(GitlabContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GitlabContext $ctx, array $applied): void
    {
        $client = $this->client;
