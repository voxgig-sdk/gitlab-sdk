...
// Gitlab SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GitlabTestFeature extends GitlabBaseFeature
{
    ...
    public function init(GitlabContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GitlabContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GitlabContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GitlabContext $ctx, $op, $args): array
    {
