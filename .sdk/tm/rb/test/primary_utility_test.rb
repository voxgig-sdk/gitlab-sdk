...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = GitlabOmni.make_runner(TEST_JSON_FILE, GitlabSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : GitlabOmni.errify(err)
    end
