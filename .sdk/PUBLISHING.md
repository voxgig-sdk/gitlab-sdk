...
|---|---|---|
| `ts/` | @voxgig-sdk/gitlab | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/gitlab \
      --repository voxgig-sdk/gitlab-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/gitlab` shows it, and
`npm trust revoke @voxgig-sdk/gitlab --id=<id>` removes it.
