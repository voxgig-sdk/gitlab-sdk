...
class TestApiEntitiesCiLintResultEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        api_entities_ci_lint_result_ref01_data = helpers.to_map(runner.entity_data(api_entities_ci_lint_result_ref01_ent.create(api_entities_ci_lint_result_ref01_data, None)))
