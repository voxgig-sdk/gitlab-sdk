...
class TestApiEntitiesPackagesDebianDistributionEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.ApiEntitiesPackagesDebianDistribution(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.ApiEntitiesPackagesDebianDistribution(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        api_entities_packages_debian_distribution_ref01_data = helpers.to_map(runner.entity_data(api_entities_packages_debian_distribution_ref01_ent.create(api_entities_packages_debian_distribution_ref01_data, None)))
        ...
        api_entities_packages_debian_distribution_ref01_resdata_up0 = helpers.to_map(runner.entity_data(api_entities_packages_debian_distribution_ref01_ent.update(api_entities_packages_debian_distribution_ref01_data_up0_up, None)))
        ...
        api_entities_packages_debian_distribution_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(api_entities_packages_debian_distribution_ref01_data_dt0_loaded))
