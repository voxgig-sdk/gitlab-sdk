...
class TestApiEntitiesPackagesConanRecipeSnapshotEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        api_entities_packages_conan_recipe_snapshot_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(api_entities_packages_conan_recipe_snapshot_ref01_data_dt0_loaded))
        assert api_entities_packages_conan_recipe_snapshot_ref01_data_dt0_load_result is not None
        assert api_entities_packages_conan_recipe_snapshot_ref01_data_dt0_load_result["id"] == api_entities_packages_conan_recipe_snapshot_ref01_data["id"]
