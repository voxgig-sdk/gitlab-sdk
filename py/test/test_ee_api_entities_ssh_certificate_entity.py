...
class TestEeApiEntitiesSshCertificateEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        ee_api_entities_ssh_certificate_ref01_data = helpers.to_map(runner.entity_data(ee_api_entities_ssh_certificate_ref01_ent.create(ee_api_entities_ssh_certificate_ref01_data, None)))
