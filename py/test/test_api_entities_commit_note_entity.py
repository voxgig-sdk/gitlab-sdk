...
class TestApiEntitiesCommitNoteEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.ApiEntitiesCommitNote(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.ApiEntitiesCommitNote(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        api_entities_commit_note_ref01_data = helpers.to_map(runner.entity_data(api_entities_commit_note_ref01_ent.create(api_entities_commit_note_ref01_data, None)))
        assert api_entities_commit_note_ref01_data is not None
        assert api_entities_commit_note_ref01_data["id"] is not None
