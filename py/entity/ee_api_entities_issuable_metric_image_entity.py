...
class EeApiEntitiesIssuableMetricImageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EeApiEntitiesIssuableMetricImageEntity(self._client, opts)
    ...
    def data_get(self) -> EeApiEntitiesIssuableMetricImage:
    ...
    def match_get(self) -> EeApiEntitiesIssuableMetricImage:
    ...
    def create(self, reqdata: EeApiEntitiesIssuableMetricImageCreateData, ctrl=None) -> EeApiEntitiesIssuableMetricImage:
        utility = self._utility
    ...
    def update(self, reqdata: EeApiEntitiesIssuableMetricImageUpdateData, ctrl=None) -> EeApiEntitiesIssuableMetricImage:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
    ...
    def remove(self, reqmatch=None, ctrl=None) -> EeApiEntitiesIssuableMetricImage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.EeApiEntitiesIssuableMetricImage().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
