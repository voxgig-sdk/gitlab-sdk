...
class ApiEntitiesProjectWithAccessEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesProjectWithAccessEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesProjectWithAccess:
    ...
    def match_get(self) -> ApiEntitiesProjectWithAccess:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesProjectWithAccess:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesProjectWithAccess().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
