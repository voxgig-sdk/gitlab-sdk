...
class ApiEntitiesProjectDailyStatisticEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesProjectDailyStatisticEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesProjectDailyStatistic:
    ...
    def match_get(self) -> ApiEntitiesProjectDailyStatistic:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesProjectDailyStatistic:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesProjectDailyStatistic().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
