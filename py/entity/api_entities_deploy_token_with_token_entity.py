...
class ApiEntitiesDeployTokenWithTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesDeployTokenWithTokenEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesDeployTokenWithToken:
    ...
    def match_get(self) -> ApiEntitiesDeployTokenWithToken:
    ...
    def create(self, reqdata: ApiEntitiesDeployTokenWithTokenCreateData, ctrl=None) -> ApiEntitiesDeployTokenWithToken:
        utility = self._utility
