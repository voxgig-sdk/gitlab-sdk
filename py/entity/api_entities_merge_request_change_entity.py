...
class ApiEntitiesMergeRequestChangeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesMergeRequestChangeEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesMergeRequestChange:
    ...
    def match_get(self) -> ApiEntitiesMergeRequestChange:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesMergeRequestChange:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesMergeRequestChange().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
