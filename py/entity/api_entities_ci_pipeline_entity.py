...
class ApiEntitiesCiPipelineEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiPipelineEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiPipeline:
    ...
    def match_get(self) -> ApiEntitiesCiPipeline:
    ...
    def create(self, reqdata: ApiEntitiesCiPipelineCreateData, ctrl=None) -> ApiEntitiesCiPipeline:
        utility = self._utility
