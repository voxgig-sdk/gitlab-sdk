...
class ApiEntitiesBadgeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesBadgeEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesBadge:
    ...
    def match_get(self) -> ApiEntitiesBadge:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesBadge:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesBadge().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesBadge]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesBadge().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: ApiEntitiesBadgeCreateData, ctrl=None) -> ApiEntitiesBadge:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesBadgeUpdateData, ctrl=None) -> ApiEntitiesBadge:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
