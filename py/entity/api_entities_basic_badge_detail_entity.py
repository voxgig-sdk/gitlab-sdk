...
class ApiEntitiesBasicBadgeDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesBasicBadgeDetailEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesBasicBadgeDetail:
    ...
    def match_get(self) -> ApiEntitiesBasicBadgeDetail:
        self._utility.feature_hook(self._entctx, "GetMatch")
        return vs.clone(self._match)

    
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesBasicBadgeDetail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesBasicBadgeDetail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
