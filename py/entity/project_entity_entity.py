...
class ProjectEntityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProjectEntityEntity(self._client, opts)
    ...
    def data_get(self) -> ProjectEntity:
    ...
    def match_get(self) -> ProjectEntity:
    ...
    def create(self, reqdata: ProjectEntityCreateData, ctrl=None) -> ProjectEntity:
