...
class ApiEntitiesCiLintResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiLintResultEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiLintResult:
    ...
    def match_get(self) -> ApiEntitiesCiLintResult:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesCiLintResult]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesCiLintResult().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesCiLintResultCreateData, ctrl=None) -> ApiEntitiesCiLintResult:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
