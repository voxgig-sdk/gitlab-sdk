...
class ApiEntitiesErrorTrackingProjectSettingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesErrorTrackingProjectSettingEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesErrorTrackingProjectSetting:
    ...
    def match_get(self) -> ApiEntitiesErrorTrackingProjectSetting:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesErrorTrackingProjectSetting:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesErrorTrackingProjectSetting().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: ApiEntitiesErrorTrackingProjectSettingUpdateData, ctrl=None) -> ApiEntitiesErrorTrackingProjectSetting:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
