...
class ApiEntitiesDictionaryTableEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesDictionaryTableEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesDictionaryTable:
    ...
    def match_get(self) -> ApiEntitiesDictionaryTable:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesDictionaryTable:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesDictionaryTable().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
