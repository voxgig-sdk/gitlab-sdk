...
class ApiEntitiesClustersAgentTokenWithTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesClustersAgentTokenWithTokenEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesClustersAgentTokenWithToken:
    ...
    def match_get(self) -> ApiEntitiesClustersAgentTokenWithToken:
    ...
    def create(self, reqdata: ApiEntitiesClustersAgentTokenWithTokenCreateData, ctrl=None) -> ApiEntitiesClustersAgentTokenWithToken:
        utility = self._utility
