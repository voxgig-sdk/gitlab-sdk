...
class ApiEntitiesProjectsContainerRegistryProtectionRuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesProjectsContainerRegistryProtectionRuleEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesProjectsContainerRegistryProtectionRule:
    ...
    def match_get(self) -> ApiEntitiesProjectsContainerRegistryProtectionRule:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesProjectsContainerRegistryProtectionRule]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesProjectsContainerRegistryProtectionRule().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesProjectsContainerRegistryProtectionRuleCreateData, ctrl=None) -> ApiEntitiesProjectsContainerRegistryProtectionRule:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesProjectsContainerRegistryProtectionRuleUpdateData, ctrl=None) -> ApiEntitiesProjectsContainerRegistryProtectionRule:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
