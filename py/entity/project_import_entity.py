...
class ProjectImportEntityClient:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProjectImportEntityClient(self._client, opts)
    ...
    def data_get(self) -> ProjectImport:
    ...
    def match_get(self) -> ProjectImport:
    ...
    def create(self, reqdata: ProjectImportCreateData, ctrl=None) -> ProjectImport:
