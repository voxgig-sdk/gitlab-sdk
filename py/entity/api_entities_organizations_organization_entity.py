...
class ApiEntitiesOrganizationsOrganizationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesOrganizationsOrganizationEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesOrganizationsOrganization:
    ...
    def match_get(self) -> ApiEntitiesOrganizationsOrganization:
    ...
    def create(self, reqdata: ApiEntitiesOrganizationsOrganizationCreateData, ctrl=None) -> ApiEntitiesOrganizationsOrganization:
        utility = self._utility
