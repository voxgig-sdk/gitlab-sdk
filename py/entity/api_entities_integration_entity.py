...
class ApiEntitiesIntegrationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesIntegrationEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesIntegration:
    ...
    def match_get(self) -> ApiEntitiesIntegration:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesIntegration:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesIntegration().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
