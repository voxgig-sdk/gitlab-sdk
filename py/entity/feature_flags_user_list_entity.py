...
class FeatureFlagsUserListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FeatureFlagsUserListEntity(self._client, opts)
    ...
    def data_get(self) -> FeatureFlagsUserList:
    ...
    def match_get(self) -> FeatureFlagsUserList:
    ...
    def remove(self, reqmatch=None, ctrl=None) -> FeatureFlagsUserList:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.FeatureFlagsUserList().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
