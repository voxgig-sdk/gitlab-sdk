...
class ApiEntitiesCiSecureFileEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiSecureFileEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiSecureFile:
    ...
    def match_get(self) -> ApiEntitiesCiSecureFile:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesCiSecureFile:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesCiSecureFile().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesCiSecureFileCreateData, ctrl=None) -> ApiEntitiesCiSecureFile:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
