...
from gitlab_types import (
    ...
    ApiEntitiesContainerRegistryTagListMatch,
)
...
class ApiEntitiesContainerRegistryTagEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesContainerRegistryTagEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesContainerRegistryTag:
    ...
    def match_get(self) -> ApiEntitiesContainerRegistryTag:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesContainerRegistryTag]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesContainerRegistryTag().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
