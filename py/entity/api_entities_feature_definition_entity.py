...
class ApiEntitiesFeatureDefinitionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesFeatureDefinitionEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesFeatureDefinition:
    ...
    def match_get(self) -> ApiEntitiesFeatureDefinition:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesFeatureDefinition]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesFeatureDefinition().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
