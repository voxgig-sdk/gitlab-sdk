...
class ApiEntitiesCiCatalogResourcesVersionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiCatalogResourcesVersionEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiCatalogResourcesVersion:
    ...
    def match_get(self) -> ApiEntitiesCiCatalogResourcesVersion:
    ...
    def create(self, reqdata: ApiEntitiesCiCatalogResourcesVersionCreateData, ctrl=None) -> ApiEntitiesCiCatalogResourcesVersion:
        utility = self._utility
