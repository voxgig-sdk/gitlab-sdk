...
class ApiEntitiesTagEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesTagEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesTag:
    ...
    def match_get(self) -> ApiEntitiesTag:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesTag:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesTag().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesTag]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesTag().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: ApiEntitiesTagCreateData, ctrl=None) -> ApiEntitiesTag:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
