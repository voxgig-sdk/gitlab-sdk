...
class MigrationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MigrationEntity(self._client, opts)
    ...
    def create(self, reqdata: MigrationCreateData, ctrl=None) -> Migration:
