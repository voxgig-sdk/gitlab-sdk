...
class EeApiEntitiesApprovalStateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EeApiEntitiesApprovalStateEntity(self._client, opts)
    ...
    def data_get(self) -> EeApiEntitiesApprovalState:
    ...
    def match_get(self) -> EeApiEntitiesApprovalState:
    ...
    def create(self, reqdata: EeApiEntitiesApprovalStateCreateData, ctrl=None) -> EeApiEntitiesApprovalState:
        utility = self._utility
