...
class ApiEntitiesWikiAttachmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesWikiAttachmentEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesWikiAttachment:
    ...
    def match_get(self) -> ApiEntitiesWikiAttachment:
    ...
    def create(self, reqdata: ApiEntitiesWikiAttachmentCreateData, ctrl=None) -> ApiEntitiesWikiAttachment:
