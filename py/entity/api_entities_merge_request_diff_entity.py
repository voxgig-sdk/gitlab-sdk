...
class ApiEntitiesMergeRequestDiffEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesMergeRequestDiffEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesMergeRequestDiff:
    ...
    def match_get(self) -> ApiEntitiesMergeRequestDiff:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesMergeRequestDiff]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesMergeRequestDiff().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
