...
class ApiEntitiesRelatedIssueEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesRelatedIssueEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesRelatedIssue:
    ...
    def match_get(self) -> ApiEntitiesRelatedIssue:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesRelatedIssue]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesRelatedIssue().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
