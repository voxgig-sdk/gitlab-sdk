...
class ApiEntitiesBasicSuccessEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesBasicSuccessEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesBasicSuccess:
    ...
    def match_get(self) -> ApiEntitiesBasicSuccess:
    ...
    def create(self, reqdata: ApiEntitiesBasicSuccessCreateData, ctrl=None) -> ApiEntitiesBasicSuccess:
