...
class ApiEntitiesNpmPackageTagEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesNpmPackageTagEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesNpmPackageTag:
    ...
    def match_get(self) -> ApiEntitiesNpmPackageTag:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesNpmPackageTag:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesNpmPackageTag().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
