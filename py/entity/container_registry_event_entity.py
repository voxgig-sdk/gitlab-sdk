...
class ContainerRegistryEventEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContainerRegistryEventEntity(self._client, opts)
    ...
    def data_get(self) -> ContainerRegistryEvent:
    ...
    def match_get(self) -> ContainerRegistryEvent:
    ...
    def create(self, reqdata: ContainerRegistryEventCreateData, ctrl=None) -> ContainerRegistryEvent:
        utility = self._utility
