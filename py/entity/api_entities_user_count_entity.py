...
class ApiEntitiesUserCountEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesUserCountEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesUserCount:
    ...
    def match_get(self) -> ApiEntitiesUserCount:
        self._utility.feature_hook(self._entctx, "GetMatch")
        return vs.clone(self._match)

    
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesUserCount:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesUserCount().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
