...
class ApiEntitiesClusterProjectEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesClusterProjectEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesClusterProject:
    ...
    def match_get(self) -> ApiEntitiesClusterProject:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesClusterProject:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesClusterProject().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesClusterProjectCreateData, ctrl=None) -> ApiEntitiesClusterProject:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesClusterProjectUpdateData, ctrl=None) -> ApiEntitiesClusterProject:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
