...
class ApiEntitiesMarkdownEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesMarkdownEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesMarkdown:
    ...
    def match_get(self) -> ApiEntitiesMarkdown:
    ...
    def create(self, reqdata: ApiEntitiesMarkdownCreateData, ctrl=None) -> ApiEntitiesMarkdown:
        utility = self._utility
