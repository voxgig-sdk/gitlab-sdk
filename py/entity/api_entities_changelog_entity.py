...
class ApiEntitiesChangelogEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesChangelogEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesChangelog:
    ...
    def match_get(self) -> ApiEntitiesChangelog:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesChangelog:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesChangelog().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
