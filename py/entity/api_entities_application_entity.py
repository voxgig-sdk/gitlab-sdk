...
class ApiEntitiesApplicationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesApplicationEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesApplication:
    ...
    def match_get(self) -> ApiEntitiesApplication:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesApplication]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesApplication().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
