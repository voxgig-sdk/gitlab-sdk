...
class TestReportSummaryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TestReportSummaryEntity(self._client, opts)
    ...
    def data_get(self) -> TestReportSummary:
    ...
    def match_get(self) -> TestReportSummary:
    ...
    def load(self, reqmatch=None, ctrl=None) -> TestReportSummary:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.TestReportSummary().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
