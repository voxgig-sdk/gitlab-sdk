...
class ApiEntitiesClustersAgentTokenBasicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesClustersAgentTokenBasicEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesClustersAgentTokenBasic:
    ...
    def match_get(self) -> ApiEntitiesClustersAgentTokenBasic:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesClustersAgentTokenBasic:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesClustersAgentTokenBasic().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
