...
class ApiEntitiesCiJobBasicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiJobBasicEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiJobBasic:
    ...
    def match_get(self) -> ApiEntitiesCiJobBasic:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesCiJobBasic]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesCiJobBasic().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesCiJobBasicCreateData, ctrl=None) -> ApiEntitiesCiJobBasic:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
