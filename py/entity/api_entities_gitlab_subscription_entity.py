...
class ApiEntitiesGitlabSubscriptionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesGitlabSubscriptionEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesGitlabSubscription:
    ...
    def match_get(self) -> ApiEntitiesGitlabSubscription:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesGitlabSubscription:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesGitlabSubscription().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
