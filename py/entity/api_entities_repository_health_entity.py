...
class ApiEntitiesRepositoryHealthEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesRepositoryHealthEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesRepositoryHealth:
    ...
    def match_get(self) -> ApiEntitiesRepositoryHealth:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesRepositoryHealth:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesRepositoryHealth().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
