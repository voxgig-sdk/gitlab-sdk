...
class ApiEntitiesNugetServiceIndexEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesNugetServiceIndexEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesNugetServiceIndex:
    ...
    def match_get(self) -> ApiEntitiesNugetServiceIndex:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesNugetServiceIndex]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesNugetServiceIndex().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
