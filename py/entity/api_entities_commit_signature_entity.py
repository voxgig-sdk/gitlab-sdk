...
class ApiEntitiesCommitSignatureEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCommitSignatureEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCommitSignature:
    ...
    def match_get(self) -> ApiEntitiesCommitSignature:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesCommitSignature:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesCommitSignature().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
