...
class ApiEntitiesCommitNoteEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCommitNoteEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCommitNote:
    ...
    def match_get(self) -> ApiEntitiesCommitNote:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesCommitNote]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesCommitNote().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesCommitNoteCreateData, ctrl=None) -> ApiEntitiesCommitNote:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
