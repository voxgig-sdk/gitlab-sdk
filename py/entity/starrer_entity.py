...
class StarrerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StarrerEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Starrer]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Starrer().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
