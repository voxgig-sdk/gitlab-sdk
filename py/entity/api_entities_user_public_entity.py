...
class ApiEntitiesUserPublicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesUserPublicEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesUserPublic:
    ...
    def match_get(self) -> ApiEntitiesUserPublic:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesUserPublic]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesUserPublic().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
