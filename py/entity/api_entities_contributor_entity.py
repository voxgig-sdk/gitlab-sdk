...
class ApiEntitiesContributorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesContributorEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesContributor:
    ...
    def match_get(self) -> ApiEntitiesContributor:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesContributor:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesContributor().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
