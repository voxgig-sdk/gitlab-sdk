...
class ApiEntitiesCiRunnerManagerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiRunnerManagerEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiRunnerManager:
    ...
    def match_get(self) -> ApiEntitiesCiRunnerManager:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesCiRunnerManager:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesCiRunnerManager().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
