...
class ApiEntitiesCiBridgeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiBridgeEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiBridge:
    ...
    def match_get(self) -> ApiEntitiesCiBridge:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesCiBridge]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesCiBridge().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
