...
class ApiEntitiesAvatarEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesAvatarEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesAvatar:
    ...
    def match_get(self) -> ApiEntitiesAvatar:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesAvatar:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesAvatar().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
