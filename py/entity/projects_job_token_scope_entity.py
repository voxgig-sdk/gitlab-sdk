...
class ProjectsJobTokenScopeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProjectsJobTokenScopeEntity(self._client, opts)
    ...
    def data_get(self) -> ProjectsJobTokenScope:
    ...
    def match_get(self) -> ProjectsJobTokenScope:
    ...
    def update(self, reqdata: ProjectsJobTokenScopeUpdateData, ctrl=None) -> ProjectsJobTokenScope:
        utility = self._utility
    ...
    def remove(self, reqmatch=None, ctrl=None) -> ProjectsJobTokenScope:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.ProjectsJobTokenScope().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
