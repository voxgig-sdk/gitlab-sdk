...
class ApiEntitiesNamespaceExistenceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesNamespaceExistenceEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesNamespaceExistence:
    ...
    def match_get(self) -> ApiEntitiesNamespaceExistence:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesNamespaceExistence]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesNamespaceExistence().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
