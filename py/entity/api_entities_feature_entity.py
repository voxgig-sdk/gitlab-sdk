...
class ApiEntitiesFeatureEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesFeatureEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesFeature:
    ...
    def match_get(self) -> ApiEntitiesFeature:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesFeature]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesFeature().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesFeatureCreateData, ctrl=None) -> ApiEntitiesFeature:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
