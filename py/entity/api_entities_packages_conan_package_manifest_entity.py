...
class ApiEntitiesPackagesConanPackageManifestEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesPackagesConanPackageManifestEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesPackagesConanPackageManifest:
    ...
    def match_get(self) -> ApiEntitiesPackagesConanPackageManifest:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesPackagesConanPackageManifest:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesPackagesConanPackageManifest().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
