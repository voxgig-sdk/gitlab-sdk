...
class ApiEntitiesPackageFileEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesPackageFileEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesPackageFile:
    ...
    def match_get(self) -> ApiEntitiesPackageFile:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesPackageFile]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesPackageFile().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
