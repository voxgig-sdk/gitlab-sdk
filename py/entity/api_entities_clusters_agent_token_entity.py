...
class ApiEntitiesClustersAgentTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesClustersAgentTokenEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesClustersAgentToken:
    ...
    def match_get(self) -> ApiEntitiesClustersAgentToken:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesClustersAgentToken:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesClustersAgentToken().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
