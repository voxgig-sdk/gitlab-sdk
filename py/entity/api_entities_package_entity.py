...
class ApiEntitiesPackageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesPackageEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesPackage:
    ...
    def match_get(self) -> ApiEntitiesPackage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesPackage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesPackage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesPackage]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesPackage().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
