...
class ApiEntitiesCommitDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCommitDetailEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCommitDetail:
    ...
    def match_get(self) -> ApiEntitiesCommitDetail:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesCommitDetail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesCommitDetail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesCommitDetailCreateData, ctrl=None) -> ApiEntitiesCommitDetail:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesCommitDetailUpdateData, ctrl=None) -> ApiEntitiesCommitDetail:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
