...
class ApiEntitiesPersonalAccessTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesPersonalAccessTokenEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesPersonalAccessToken:
    ...
    def match_get(self) -> ApiEntitiesPersonalAccessToken:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesPersonalAccessToken]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesPersonalAccessToken().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
