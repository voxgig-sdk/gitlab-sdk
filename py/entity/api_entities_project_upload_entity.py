...
class ApiEntitiesProjectUploadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesProjectUploadEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesProjectUpload:
    ...
    def match_get(self) -> ApiEntitiesProjectUpload:
    ...
    def create(self, reqdata: ApiEntitiesProjectUploadCreateData, ctrl=None) -> ApiEntitiesProjectUpload:
        utility = self._utility
