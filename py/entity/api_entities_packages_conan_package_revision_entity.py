...
class ApiEntitiesPackagesConanPackageRevisionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesPackagesConanPackageRevisionEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesPackagesConanPackageRevision:
    ...
    def match_get(self) -> ApiEntitiesPackagesConanPackageRevision:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesPackagesConanPackageRevision]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesPackagesConanPackageRevision().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
