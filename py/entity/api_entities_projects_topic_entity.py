...
class ApiEntitiesProjectsTopicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesProjectsTopicEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesProjectsTopic:
    ...
    def match_get(self) -> ApiEntitiesProjectsTopic:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesProjectsTopic:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesProjectsTopic().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesProjectsTopicCreateData, ctrl=None) -> ApiEntitiesProjectsTopic:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesProjectsTopicUpdateData, ctrl=None) -> ApiEntitiesProjectsTopic:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
