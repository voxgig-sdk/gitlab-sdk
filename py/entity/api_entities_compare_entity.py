...
class ApiEntitiesCompareEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCompareEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCompare:
    ...
    def match_get(self) -> ApiEntitiesCompare:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesCompare]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesCompare().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
