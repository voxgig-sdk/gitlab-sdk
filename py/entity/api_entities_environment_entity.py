...
class ApiEntitiesEnvironmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesEnvironmentEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesEnvironment:
    ...
    def match_get(self) -> ApiEntitiesEnvironment:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesEnvironment:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesEnvironment().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesEnvironment]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesEnvironment().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: ApiEntitiesEnvironmentCreateData, ctrl=None) -> ApiEntitiesEnvironment:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesEnvironmentUpdateData, ctrl=None) -> ApiEntitiesEnvironment:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
