...
class ApiEntitiesSnippetEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesSnippetEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesSnippet:
    ...
    def match_get(self) -> ApiEntitiesSnippet:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesSnippet]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesSnippet().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
