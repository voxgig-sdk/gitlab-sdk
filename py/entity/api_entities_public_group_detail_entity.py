...
class ApiEntitiesPublicGroupDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesPublicGroupDetailEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesPublicGroupDetail:
    ...
    def match_get(self) -> ApiEntitiesPublicGroupDetail:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesPublicGroupDetail]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesPublicGroupDetail().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
