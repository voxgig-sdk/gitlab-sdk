...
class ApiEntitiesProjectJobTokenScopeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesProjectJobTokenScopeEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesProjectJobTokenScope:
    ...
    def match_get(self) -> ApiEntitiesProjectJobTokenScope:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesProjectJobTokenScope:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesProjectJobTokenScope().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
