...
class ApiEntitiesNamespaceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesNamespaceEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesNamespace:
    ...
    def match_get(self) -> ApiEntitiesNamespace:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesNamespace:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesNamespace().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesNamespace]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesNamespace().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def update(self, reqdata: ApiEntitiesNamespaceUpdateData, ctrl=None) -> ApiEntitiesNamespace:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
