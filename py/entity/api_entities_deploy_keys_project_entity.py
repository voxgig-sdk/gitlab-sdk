...
class ApiEntitiesDeployKeysProjectEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesDeployKeysProjectEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesDeployKeysProject:
    ...
    def match_get(self) -> ApiEntitiesDeployKeysProject:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesDeployKeysProject:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesDeployKeysProject().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesDeployKeysProject]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesDeployKeysProject().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: ApiEntitiesDeployKeysProjectCreateData, ctrl=None) -> ApiEntitiesDeployKeysProject:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
