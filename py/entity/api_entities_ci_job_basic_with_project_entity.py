...
class ApiEntitiesCiJobBasicWithProjectEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiJobBasicWithProjectEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiJobBasicWithProject:
    ...
    def match_get(self) -> ApiEntitiesCiJobBasicWithProject:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesCiJobBasicWithProject:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesCiJobBasicWithProject().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
