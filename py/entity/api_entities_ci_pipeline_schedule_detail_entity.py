...
from gitlab_types import (
    ...
    ApiEntitiesCiPipelineScheduleDetailLoadMatch,
    ApiEntitiesCiPipelineScheduleDetailCreateData,
    ApiEntitiesCiPipelineScheduleDetailUpdateData,
)
...
class ApiEntitiesCiPipelineScheduleDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiPipelineScheduleDetailEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiPipelineScheduleDetail:
    ...
    def match_get(self) -> ApiEntitiesCiPipelineScheduleDetail:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesCiPipelineScheduleDetail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesCiPipelineScheduleDetail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesCiPipelineScheduleDetailCreateData, ctrl=None) -> ApiEntitiesCiPipelineScheduleDetail:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesCiPipelineScheduleDetailUpdateData, ctrl=None) -> ApiEntitiesCiPipelineScheduleDetail:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
