...
class EeApiEntitiesBillableMembershipEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EeApiEntitiesBillableMembershipEntity(self._client, opts)
    ...
    def data_get(self) -> EeApiEntitiesBillableMembership:
    ...
    def match_get(self) -> EeApiEntitiesBillableMembership:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EeApiEntitiesBillableMembership:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EeApiEntitiesBillableMembership().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
