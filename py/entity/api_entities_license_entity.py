...
class ApiEntitiesLicenseEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesLicenseEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesLicense:
    ...
    def match_get(self) -> ApiEntitiesLicense:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesLicense]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesLicense().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
