...
class GroupImportEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GroupImportEntity(self._client, opts)
    ...
    def match_get(self) -> GroupImport:
    ...
    def create(self, reqdata: GroupImportCreateData, ctrl=None) -> GroupImport:
        utility = self._utility
