...
class ApiEntitiesCiRunnerDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiRunnerDetailEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiRunnerDetail:
    ...
    def match_get(self) -> ApiEntitiesCiRunnerDetail:
        self._utility.feature_hook(self._entctx, "GetMatch")
        return vs.clone(self._match)

    
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesCiRunnerDetail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesCiRunnerDetail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: ApiEntitiesCiRunnerDetailUpdateData, ctrl=None) -> ApiEntitiesCiRunnerDetail:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
