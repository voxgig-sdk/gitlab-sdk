...
class ApiEntitiesTagSignatureEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesTagSignatureEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesTagSignature:
    ...
    def match_get(self) -> ApiEntitiesTagSignature:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesTagSignature:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesTagSignature().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
