...
class EeApiEntitiesGeoNodeStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EeApiEntitiesGeoNodeStatusEntity(self._client, opts)
    ...
    def data_get(self) -> EeApiEntitiesGeoNodeStatus:
    ...
    def match_get(self) -> EeApiEntitiesGeoNodeStatus:
    ...
    def create(self, reqdata: EeApiEntitiesGeoNodeStatusCreateData, ctrl=None) -> EeApiEntitiesGeoNodeStatus:
        utility = self._utility
