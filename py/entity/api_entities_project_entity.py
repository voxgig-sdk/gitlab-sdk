...
class ApiEntitiesProjectEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesProjectEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesProject:
    ...
    def match_get(self) -> ApiEntitiesProject:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesProject]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesProject().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesProjectCreateData, ctrl=None) -> ApiEntitiesProject:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesProjectUpdateData, ctrl=None) -> ApiEntitiesProject:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
