...
class ApiEntitiesSshKeyWithUserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesSshKeyWithUserEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesSshKeyWithUser:
    ...
    def match_get(self) -> ApiEntitiesSshKeyWithUser:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesSshKeyWithUser:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesSshKeyWithUser().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
