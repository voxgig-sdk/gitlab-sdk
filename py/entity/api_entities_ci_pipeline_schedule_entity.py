...
class ApiEntitiesCiPipelineScheduleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiPipelineScheduleEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiPipelineSchedule:
    ...
    def match_get(self) -> ApiEntitiesCiPipelineSchedule:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesCiPipelineSchedule]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesCiPipelineSchedule().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
