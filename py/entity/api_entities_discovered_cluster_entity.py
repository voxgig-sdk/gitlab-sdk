...
class ApiEntitiesDiscoveredClusterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesDiscoveredClusterEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesDiscoveredCluster:
    ...
    def match_get(self) -> ApiEntitiesDiscoveredCluster:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesDiscoveredCluster:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesDiscoveredCluster().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
