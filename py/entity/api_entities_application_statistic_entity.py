...
class ApiEntitiesApplicationStatisticEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesApplicationStatisticEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesApplicationStatistic:
    ...
    def match_get(self) -> ApiEntitiesApplicationStatistic:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesApplicationStatistic:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesApplicationStatistic().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
