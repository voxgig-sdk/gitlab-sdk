...
class ProjectImportEntityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProjectImportEntityEntity(self._client, opts)
    ...
    def data_get(self) -> ProjectImportEntity:
    ...
    def match_get(self) -> ProjectImportEntity:
    ...
    def create(self, reqdata: ProjectImportEntityCreateData, ctrl=None) -> ProjectImportEntity:
