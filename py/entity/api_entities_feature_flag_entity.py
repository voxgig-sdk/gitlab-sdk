...
class ApiEntitiesFeatureFlagEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesFeatureFlagEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesFeatureFlag:
    ...
    def match_get(self) -> ApiEntitiesFeatureFlag:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesFeatureFlag:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesFeatureFlag().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesFeatureFlag]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesFeatureFlag().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: ApiEntitiesFeatureFlagCreateData, ctrl=None) -> ApiEntitiesFeatureFlag:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesFeatureFlagUpdateData, ctrl=None) -> ApiEntitiesFeatureFlag:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
