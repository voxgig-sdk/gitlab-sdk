...
class ApiEntitiesProjectsPackagesProtectionRuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesProjectsPackagesProtectionRuleEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesProjectsPackagesProtectionRule:
    ...
    def match_get(self) -> ApiEntitiesProjectsPackagesProtectionRule:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesProjectsPackagesProtectionRule]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesProjectsPackagesProtectionRule().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesProjectsPackagesProtectionRuleCreateData, ctrl=None) -> ApiEntitiesProjectsPackagesProtectionRule:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesProjectsPackagesProtectionRuleUpdateData, ctrl=None) -> ApiEntitiesProjectsPackagesProtectionRule:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
