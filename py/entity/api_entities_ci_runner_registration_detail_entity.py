...
class ApiEntitiesCiRunnerRegistrationDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCiRunnerRegistrationDetailEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCiRunnerRegistrationDetail:
    ...
    def match_get(self) -> ApiEntitiesCiRunnerRegistrationDetail:
    ...
    def create(self, reqdata: ApiEntitiesCiRunnerRegistrationDetailCreateData, ctrl=None) -> ApiEntitiesCiRunnerRegistrationDetail:
        utility = self._utility
