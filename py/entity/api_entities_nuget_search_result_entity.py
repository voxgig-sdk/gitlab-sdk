...
class ApiEntitiesNugetSearchResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesNugetSearchResultEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesNugetSearchResult:
    ...
    def match_get(self) -> ApiEntitiesNugetSearchResult:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesNugetSearchResult]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesNugetSearchResult().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
