...
class ApiEntitiesWikiPageBasicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesWikiPageBasicEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesWikiPageBasic:
    ...
    def match_get(self) -> ApiEntitiesWikiPageBasic:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesWikiPageBasic]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesWikiPageBasic().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
