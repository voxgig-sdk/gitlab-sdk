...
class ApiEntitiesDeploymentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesDeploymentEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesDeployment:
    ...
    def match_get(self) -> ApiEntitiesDeployment:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesDeployment]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesDeployment().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
