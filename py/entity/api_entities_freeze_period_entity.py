...
class ApiEntitiesFreezePeriodEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesFreezePeriodEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesFreezePeriod:
    ...
    def match_get(self) -> ApiEntitiesFreezePeriod:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesFreezePeriod:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesFreezePeriod().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesFreezePeriod]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesFreezePeriod().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: ApiEntitiesFreezePeriodCreateData, ctrl=None) -> ApiEntitiesFreezePeriod:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesFreezePeriodUpdateData, ctrl=None) -> ApiEntitiesFreezePeriod:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
