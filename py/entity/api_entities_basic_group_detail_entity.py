...
class ApiEntitiesBasicGroupDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesBasicGroupDetailEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesBasicGroupDetail:
    ...
    def match_get(self) -> ApiEntitiesBasicGroupDetail:
    ...
    def create(self, reqdata: ApiEntitiesBasicGroupDetailCreateData, ctrl=None) -> ApiEntitiesBasicGroupDetail:
        utility = self._utility
