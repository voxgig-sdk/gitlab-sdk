...
class ApiEntitiesIssueLinkEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesIssueLinkEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesIssueLink:
    ...
    def match_get(self) -> ApiEntitiesIssueLink:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesIssueLink:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesIssueLink().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesIssueLinkCreateData, ctrl=None) -> ApiEntitiesIssueLink:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
