...
class ApiEntitiesPlanLimitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesPlanLimitEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesPlanLimit:
    ...
    def match_get(self) -> ApiEntitiesPlanLimit:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesPlanLimit:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesPlanLimit().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: ApiEntitiesPlanLimitUpdateData, ctrl=None) -> ApiEntitiesPlanLimit:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
