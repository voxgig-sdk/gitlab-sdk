...
class ApiEntitiesWikiPageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesWikiPageEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesWikiPage:
    ...
    def match_get(self) -> ApiEntitiesWikiPage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesWikiPage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesWikiPage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesWikiPageCreateData, ctrl=None) -> ApiEntitiesWikiPage:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApiEntitiesWikiPageUpdateData, ctrl=None) -> ApiEntitiesWikiPage:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
