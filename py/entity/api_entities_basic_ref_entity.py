...
class ApiEntitiesBasicRefEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesBasicRefEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesBasicRef:
    ...
    def match_get(self) -> ApiEntitiesBasicRef:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesBasicRef]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesBasicRef().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
