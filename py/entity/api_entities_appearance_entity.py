...
class ApiEntitiesAppearanceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesAppearanceEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesAppearance:
    ...
    def match_get(self) -> ApiEntitiesAppearance:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesAppearance:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesAppearance().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: ApiEntitiesAppearanceUpdateData, ctrl=None) -> ApiEntitiesAppearance:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
