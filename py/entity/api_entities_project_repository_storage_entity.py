...
class ApiEntitiesProjectRepositoryStorageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesProjectRepositoryStorageEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesProjectRepositoryStorage:
    ...
    def match_get(self) -> ApiEntitiesProjectRepositoryStorage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesProjectRepositoryStorage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesProjectRepositoryStorage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
