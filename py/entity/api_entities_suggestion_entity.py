...
class ApiEntitiesSuggestionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesSuggestionEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesSuggestion:
    ...
    def match_get(self) -> ApiEntitiesSuggestion:
    ...
    def update(self, reqdata: ApiEntitiesSuggestionUpdateData, ctrl=None) -> ApiEntitiesSuggestion:
        utility = self._utility
