...
class ApiEntitiesClustersAgentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesClustersAgentEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesClustersAgent:
    ...
    def match_get(self) -> ApiEntitiesClustersAgent:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesClustersAgent:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesClustersAgent().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesClustersAgentCreateData, ctrl=None) -> ApiEntitiesClustersAgent:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
