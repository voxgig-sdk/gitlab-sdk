...
class ApiEntitiesCommitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesCommitEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesCommit:
    ...
    def match_get(self) -> ApiEntitiesCommit:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesCommit]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesCommit().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApiEntitiesCommitCreateData, ctrl=None) -> ApiEntitiesCommit:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
