...
class ApiEntitiesMergeRequestReviewerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesMergeRequestReviewerEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesMergeRequestReviewer:
    ...
    def match_get(self) -> ApiEntitiesMergeRequestReviewer:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesMergeRequestReviewer:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesMergeRequestReviewer().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
