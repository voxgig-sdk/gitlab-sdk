...
class ApiEntitiesUserWithAdminEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesUserWithAdminEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesUserWithAdmin:
    ...
    def match_get(self) -> ApiEntitiesUserWithAdmin:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesUserWithAdmin]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesUserWithAdmin().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
