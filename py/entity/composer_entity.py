...
class ComposerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ComposerEntity(self._client, opts)
    ...
    def create(self, reqdata: ComposerCreateData, ctrl=None) -> Composer:
