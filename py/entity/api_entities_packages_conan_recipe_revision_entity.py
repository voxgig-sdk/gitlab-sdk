...
class ApiEntitiesPackagesConanRecipeRevisionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesPackagesConanRecipeRevisionEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesPackagesConanRecipeRevision:
    ...
    def match_get(self) -> ApiEntitiesPackagesConanRecipeRevision:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiEntitiesPackagesConanRecipeRevision]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiEntitiesPackagesConanRecipeRevision().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
