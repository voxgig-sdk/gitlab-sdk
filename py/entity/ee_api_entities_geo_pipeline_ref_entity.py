...
class EeApiEntitiesGeoPipelineRefEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EeApiEntitiesGeoPipelineRefEntity(self._client, opts)
    ...
    def data_get(self) -> EeApiEntitiesGeoPipelineRef:
    ...
    def match_get(self) -> EeApiEntitiesGeoPipelineRef:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EeApiEntitiesGeoPipelineRef]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EeApiEntitiesGeoPipelineRef().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
