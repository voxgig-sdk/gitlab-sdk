...
class EeApiEntitiesSshCertificateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EeApiEntitiesSshCertificateEntity(self._client, opts)
    ...
    def data_get(self) -> EeApiEntitiesSshCertificate:
    ...
    def match_get(self) -> EeApiEntitiesSshCertificate:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EeApiEntitiesSshCertificate]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EeApiEntitiesSshCertificate().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: EeApiEntitiesSshCertificateCreateData, ctrl=None) -> EeApiEntitiesSshCertificate:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
