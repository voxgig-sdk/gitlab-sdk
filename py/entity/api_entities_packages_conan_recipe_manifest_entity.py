...
class ApiEntitiesPackagesConanRecipeManifestEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiEntitiesPackagesConanRecipeManifestEntity(self._client, opts)
    ...
    def data_get(self) -> ApiEntitiesPackagesConanRecipeManifest:
    ...
    def match_get(self) -> ApiEntitiesPackagesConanRecipeManifest:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiEntitiesPackagesConanRecipeManifest:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiEntitiesPackagesConanRecipeManifest().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
