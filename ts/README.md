...
const apientitiesmetricimage = await client.ApiEntitiesMetricImage().list()
// apientitiesmetricimage is the entity, populated with mock response data
// — call apientitiesmetricimage.data() for the record itself
console.log(apientitiesmetricimage)
```
...
```ts
const entity = client.ApiEntitiesMetricImage()
...
```ts
const api_entities_access_requesters = await client.ApiEntitiesAccessRequester().list({ group_id: "example" })
```
...
| `forks` | `number` | Approximate number of repo forks |
| `groups` | `number` | Approximate number of projects |
| `issues` | `number` | Approximate number of issues |
| `merge_requests` | `number` | Approximate number of merge requests |
| `milestones` | `number` | Approximate number of milestones |
| `notes` | `number` | Approximate number of notes |
| `projects` | `number` | Approximate number of projects |
| `snippets` | `number` | Approximate number of snippets |
| `ssh_keys` | `number` | Approximate number of SSH keys |
| `users` | `number` | Approximate number of users |
...
```ts
const api_entities_avatar = await client.ApiEntitiesAvatar().load({ email: 'email' })
```
...
| `updated_at` | `string` |  |
| `url` | `string` |  |
| `user` | `Record<string, any>` | API_Entities_UserBasic model |
| `username` | `string` |  |
| `web_url` | `string` |  |
...
```ts
const api_entities_award_emojis = await client.ApiEntitiesAwardEmoji().list({ epic_id: "example", group_id: "example" })
```
...
```ts
const api_entities_badges = await client.ApiEntitiesBadge().list({ group_id: "example" })
```
...
```ts
const api_entities_basic_badge_detail = await client.ApiEntitiesBasicBadgeDetail().load({ image_url: 'image_url', link_url: 'link_url' })
```
...
| `avatar_url` | `string` |  |
| `created_at` | `string` |  |
| `custom_attributes` | `Record<string, any>` | API_Entities_CustomAttribute model |
...
```ts
const api_entities_basic_refs = await client.ApiEntitiesBasicRef().list({ project_id: "example", sha: "example" })
```
...
```ts
const api_entities_branchs = await client.ApiEntitiesBranch().list({ project_id: "example" })
```
...
```ts
const api_entities_bulk_imports_export_statuss = await client.ApiEntitiesBulkImportsExportStatus().list({ group_id: "example" })
```
...
```ts
const api_entities_changelog = await client.ApiEntitiesChangelog().load({ project_id: 'project_id', version: 'version' })
```
...
| `coverage` | `number` |  |
| `created_at` | `string` |  |
| `downstream_pipeline` | `Record<string, any>` | API_Entities_Ci_PipelineBasic model |
...
| `id` | `number` |  |
| `name` | `string` |  |
| `pipeline` | `Record<string, any>` | API_Entities_Ci_PipelineBasic model |
...
```ts
const api_entities_ci_bridges = await client.ApiEntitiesCiBridge().list({ pipeline_id: "example", project_id: "example" })
```
...
| `queued_duration` | `number` | Time spent enqueued |
| `ref` | `string` |  |
| `runner` | `Record<string, any>` | API_Entities_Ci_Runner model |
| `runner_manager` | `Record<string, any>` | API_Entities_Ci_RunnerManager model |
| `size` | `number` |  |
| `stage` | `string` |  |
| `started_at` | `string` |  |
| `status` | `string` |  |
...
```ts
const api_entities_ci_job_basics = await client.ApiEntitiesCiJobBasic().list({ key: "example", project_id: "example" })
```
...
```ts
const api_entities_ci_lint_results = await client.ApiEntitiesCiLintResult().list({ project_id: "example" })
```
...
```ts
const api_entities_ci_pipeline_basics = await client.ApiEntitiesCiPipelineBasic().list({ project_id: "example" })
```
...
| `next_run_at` | `string` |  |
| `owner` | `Record<string, any>` | API_Entities_UserBasic model |
| `ref` | `string` |  |
| `updated_at` | `string` |  |
...
```ts
const api_entities_ci_pipeline_schedules = await client.ApiEntitiesCiPipelineSchedule().list({ project_id: "example" })
```
...
| `id` | `number` |  |
| `inputs` | `Record<string, any>` |  |
| `last_pipeline` | `Record<string, any>` | API_Entities_Ci_PipelineBasic model |
| `next_run_at` | `string` |  |
| `owner` | `Record<string, any>` | API_Entities_UserBasic model |
| `ref` | `string` |  |
| `updated_at` | `string` |  |
| `variables` | `Record<string, any>` | API_Entities_Ci_Variable model |
...
```ts
const api_entities_ci_resource_groups = await client.ApiEntitiesCiResourceGroup().list({ project_id: "example" })
```
...
| `contacted_at` | `string` |  |
| `created_at` | `string` |  |
| `created_by` | `Record<string, any>` | API_Entities_UserBasic model |
| `description` | `string` |  |
| `groups` | `Record<string, any>` | API_Entities_BasicGroupDetails model |
| `id` | `number` |  |
| `ip_address` | `string` |  |
| `is_shared` | `boolean` |  |
...
| `paused` | `boolean` |  |
| `platform` | `string` |  |
| `projects` | `Record<string, any>` | API_Entities_BasicProjectDetails model |
| `revision` | `string` |  |
| `run_untagged` | `string` |  |
| `runner_type` | `string` |  |
| `status` | `string` |  |
...
```ts
const api_entities_ci_variable = await client.ApiEntitiesCiVariable().load({ id: 'api_entities_ci_variable_id', project_id: 'project_id' })
```

#### Example: List

```ts
const api_entities_ci_variables = await client.ApiEntitiesCiVariable().list({ pipeline_id: "example", project_id: "example" })
```
...
| `enabled` | `boolean` |  |
| `environment_scope` | `string` |  |
| `group` | `Record<string, any>` | API_Entities_BasicGroupDetails model |
| `id` | `string` |  |
| `managed` | `string` |  |
| `management_project` | `Record<string, any>` |  |
| `name` | `string` |  |
...
| `platform_kubernetes` | `Record<string, any>` |  |
| `platform_type` | `string` |  |
| `project` | `Record<string, any>` | API_Entities_BasicProjectDetails model |
| `provider_gcp` | `Record<string, any>` |  |
| `provider_type` | `string` |  |
| `user` | `Record<string, any>` | API_Entities_UserBasic model |
...
```ts
const api_entities_commits = await client.ApiEntitiesCommit().list({ project_id: "example" })
```
...
| Field | Type | Description |
| --- | --- | --- |
| `author` | `Record<string, any>` | API_Entities_UserBasic model |
| `avatar_path` | `string` |  |
| `avatar_url` | `string` |  |
| `created_at` | `string` |  |
| `custom_attributes` | `any[]` |  |
...
```ts
const api_entities_commit_notes = await client.ApiEntitiesCommitNote().list({ project_id: "example", sha: "example" })
```
...
```ts
const api_entities_commit_statuss = await client.ApiEntitiesCommitStatus().list({ project_id: "example", sha: "example" })
```
...
```ts
const api_entities_compares = await client.ApiEntitiesCompare().list({ project_id: "example", from: "example", to: "example" })
```
...
| `size` | `number` |  |
| `status` | `string` |  |
| `tags` | `Record<string, any>` | API_Entities_ContainerRegistry_Tag model |
| `tags_count` | `number` |  |
...
```ts
const api_entities_container_registry_repositorys = await client.ApiEntitiesContainerRegistryRepository().list({ project_id: "example" })
```
...
```ts
const api_entities_container_registry_tags = await client.ApiEntitiesContainerRegistryTag().list({ project_id: "example", repository_id: "example" })
```
...
```ts
const api_entities_deploy_keys_projects = await client.ApiEntitiesDeployKeysProject().list({ project_id: "example" })
```
...
| --- | --- | --- |
| `created_at` | `string` |  |
| `deployable` | `Record<string, any>` | API_Entities_Ci_Job model |
| `environment` | `Record<string, any>` | API_Entities_EnvironmentBasic model |
| `id` | `number` |  |
| `iid` | `number` |  |
| `ref` | `string` |  |
| `sha` | `string` |  |
...
```ts
const api_entities_deployments = await client.ApiEntitiesDeployment().list({ project_id: "example" })
```
...
| `approvals` | `Record<string, any>` | API_Entities_Deployments_Approval model |
| `created_at` | `string` |  |
| `deployable` | `Record<string, any>` | API_Entities_Ci_Job model |
| `environment` | `Record<string, any>` | API_Entities_EnvironmentBasic model |
| `id` | `number` |  |
...
```ts
const api_entities_diffs = await client.ApiEntitiesDiff().list({ project_id: "example", sha: "example" })
```
...
```ts
const api_entities_discovered_cluster = await client.ApiEntitiesDiscoveredCluster().load({ group_id: 'group_id' })
```
...
```ts
const api_entities_draft_notes = await client.ApiEntitiesDraftNote().list({ merge_request_id: "example", project_id: "example" })
```
...
| `cluster_agent` | `Record<string, any>` | API_Entities_Clusters_Agent model |
| `created_at` | `string` |  |
| `description` | `string` |  |
| `external_url` | `string` |  |
...
| `last_deployment` | `Record<string, any>` | API_Entities_Deployment model |
| `name` | `string` |  |
| `project` | `Record<string, any>` | API_Entities_BasicProjectDetails model |
| `slug` | `string` |  |
| `state` | `string` |  |
...
```ts
const api_entities_environments = await client.ApiEntitiesEnvironment().list({ project_id: "example" })
```
...
```ts
const api_entities_error_tracking_client_keys = await client.ApiEntitiesErrorTrackingClientKey().list({ project_id: "example" })
```
...
| `target_title` | `string` |  |
| `target_type` | `string` |  |
| `wiki_page` | `Record<string, any>` | API_Entities_WikiPageBasic model |
...
```ts
const api_entities_feature_flags = await client.ApiEntitiesFeatureFlag().list({ project_id: "example" })
```
...
```ts
const api_entities_feature_flag_user_lists = await client.ApiEntitiesFeatureFlagUserList().list({ project_id: "example" })
```
...
```ts
const api_entities_freeze_periods = await client.ApiEntitiesFreezePeriod().list({ project_id: "example" })
```
...
```ts
const api_entities_go_module_version = await client.ApiEntitiesGoModuleVersion().load({ module_version: 'module_version', project_id: 'project_id', module_name: 'module_name' })
```
...
| `project_creation_level` | `string` |  |
| `projects` | `Record<string, any>` | API_Entities_Project model |
| `repository_storage` | `string` |  |
| `request_access_enabled` | `string` |  |
| `require_two_factor_authentication` | `string` |  |
| `root_storage_statistics` | `Record<string, any>` |  |
...
| `share_with_group_lock` | `string` |  |
| `shared_projects` | `Record<string, any>` | API_Entities_Project model |
...
```ts
const api_entities_integration = await client.ApiEntitiesIntegration().load({ id: 'api_entities_integration_id', group_id: 'group_id' })
```
...
```ts
const api_entities_integration_basics = await client.ApiEntitiesIntegrationBasic().list({ group_id: "example" })
```
...
```ts
const api_entities_invitations = await client.ApiEntitiesInvitation().list({ group_id: "example" })
```
...
| Field | Type | Description |
| --- | --- | --- |
| `assignee` | `Record<string, any>` | API_Entities_UserBasic model |
| `assignees` | `Record<string, any>` | API_Entities_UserBasic model |
| `author` | `Record<string, any>` | API_Entities_UserBasic model |
| `blocking_issues_count` | `string` |  |
| `closed_at` | `string` |  |
| `closed_by` | `Record<string, any>` | API_Entities_UserBasic model |
| `confidential` | `boolean` |  |
| `created_at` | `string` |  |
| `description` | `string` |  |
...
| `task_status` | `string` |  |
| `time_stats` | `Record<string, any>` | API_Entities_IssuableTimeStats model |
| `title` | `string` |  |
...
```ts
const api_entities_license = await client.ApiEntitiesLicense().load({ id: 'api_entities_license_id', name: 'name', type: 'type' })
```
...
```ts
const api_entities_markdown_upload_admins = await client.ApiEntitiesMarkdownUploadAdmin().list({ group_id: "example" })
```
...
```ts
const api_entities_member = await client.ApiEntitiesMember().load({ id: 'api_entities_member_id', group_id: 'group_id' })
```

#### Example: List

```ts
const api_entities_members = await client.ApiEntitiesMember().list({ group_id: "example" })
```
...
| `head_pipeline` | `Record<string, any>` | API_Entities_Ci_Pipeline model |
| `id` | `number` |  |
| `iid` | `number` |  |
| `imported` | `string` |  |
| `imported_from` | `string` |  |
...
| `merge_error` | `string` |  |
| `merge_status` | `string` |  |
| `merge_user` | `Record<string, any>` | API_Entities_UserBasic model |
| `merge_when_pipeline_succeeds` | `string` |  |
| `merged_at` | `string` |  |
| `merged_by` | `Record<string, any>` | API_Entities_UserBasic model |
| `milestone` | `Record<string, any>` |  |
| `pipeline` | `Record<string, any>` | API_Entities_Ci_PipelineBasic model |
| `prepared_at` | `string` |  |
| `project_id` | `number` |  |
...
| `reference` | `string` |  |
| `references` | `Record<string, any>` |  |
| `reviewers` | `Record<string, any>` | API_Entities_UserBasic model |
| `sha` | `string` |  |
...
```ts
const api_entities_merge_request_basics = await client.ApiEntitiesMergeRequestBasic().list({ project_id: "example" })
```
...
| `author` | `Record<string, any>` | API_Entities_UserBasic model |
| `blocking_discussions_resolved` | `string` |  |
| `changes` | `Record<string, any>` | API_Entities_Diff model |
| `changes_count` | `string` |  |
| `closed_at` | `string` |  |
| `closed_by` | `Record<string, any>` | API_Entities_UserBasic model |
| `created_at` | `string` |  |
...
```ts
const api_entities_merge_request_diffs = await client.ApiEntitiesMergeRequestDiff().list({ merge_request_id: "example", project_id: "example" })
```
...
| --- | --- | --- |
| `base_commit_sha` | `string` |  |
| `commits` | `Record<string, any>` | API_Entities_Commit model |
| `created_at` | `string` |  |
| `diffs` | `Record<string, any>` | API_Entities_Diff model |
| `head_commit_sha` | `string` |  |
| `id` | `string` |  |
| `merge_request_id` | `string` |  |
| `patch_id_sha` | `string` |  |
...
```ts
const api_entities_metric_images = await client.ApiEntitiesMetricImage().list({ alert_management_alert_id: "example", project_id: "example" })
```
...
```ts
const api_entities_namespace_existences = await client.ApiEntitiesNamespaceExistence().list({ namespace_id: "example" })
```
...
```ts
const api_entities_namespaces_storage_limit_exclusion = await client.ApiEntitiesNamespacesStorageLimitExclusion().load()
```
...
```ts
const api_entities_npm_package = await client.ApiEntitiesNpmPackage().load({ package_name: 'package_name' })
```
...
```ts
const api_entities_npm_package_tag = await client.ApiEntitiesNpmPackageTag().load({ package_name: 'package_name' })
```
...
```ts
const api_entities_nuget_packages_versions = await client.ApiEntitiesNugetPackagesVersion().list({ project_id: "example", package_name: "example" })
```
...
```ts
const api_entities_nuget_search_results = await client.ApiEntitiesNugetSearchResult().list({ project_id: "example" })
```
...
```ts
const api_entities_nuget_service_indexs = await client.ApiEntitiesNugetServiceIndex().list({ project_id: "example" })
```
...
| `name` | `string` |  |
| `package_type` | `string` |  |
| `pipeline` | `Record<string, any>` | API_Entities_Package_Pipeline model |
| `pipelines` | `Record<string, any>` | API_Entities_Package_Pipeline model |
| `project_id` | `number` |  |
| `project_path` | `string` |  |
| `status` | `string` |  |
| `tags` | `string` |  |
...
```ts
const api_entities_packages = await client.ApiEntitiesPackage().list({ group_id: "example" })
```
...
```ts
const api_entities_package_files = await client.ApiEntitiesPackageFile().list({ package_id: "example", project_id: "example" })
```
...
```ts
const api_entities_packages_conan_package_revisions = await client.ApiEntitiesPackagesConanPackageRevision().list({ conan_id: "example", conan_package_reference: "example", package_channel: "example", package_username: "example", package_version: "example", project_id: "example", revision_id: "example" })
```
...
```ts
const api_entities_packages_conan_recipe_revisions = await client.ApiEntitiesPackagesConanRecipeRevision().list({ conan_id: "example", package_channel: "example", package_username: "example", package_version: "example", project_id: "example" })
```
...
```ts
const api_entities_packages_debian_distributions = await client.ApiEntitiesPackagesDebianDistribution().list({ project_id: "example" })
```
...
```ts
const api_entities_pages_domains = await client.ApiEntitiesPagesDomain().list({ project_id: "example" })
```
...
| `forked_from_project` | `Record<string, any>` | API_Entities_BasicProjectDetails model |
...
```ts
const api_entities_projects = await client.ApiEntitiesProject().list({ project_id: "example" })
```
...
```ts
const api_entities_project_hooks = await client.ApiEntitiesProjectHook().list({ project_id: "example" })
```
...
```ts
const api_entities_project_import_statuss = await client.ApiEntitiesProjectImportStatus().list({ project_id: "example" })
```
...
```ts
const api_entities_project_snippets = await client.ApiEntitiesProjectSnippet().list({ project_id: "example" })
```
...
```ts
const api_entities_project_with_access = await client.ApiEntitiesProjectWithAccess().create({
  project_id: 'example_project_id',
})
```
...
```ts
const api_entities_projects_container_registry_protection_rules = await client.ApiEntitiesProjectsContainerRegistryProtectionRule().list({ project_id: "example" })
```
...
```ts
const api_entities_projects_packages_protection_rules = await client.ApiEntitiesProjectsPackagesProtectionRule().list({ project_id: "example" })
```
...
```ts
const api_entities_protected_branchs = await client.ApiEntitiesProtectedBranch().list({ project_id: "example" })
```
...
```ts
const api_entities_protected_tags = await client.ApiEntitiesProtectedTag().list({ project_id: "example" })
```
...
```ts
const api_entities_public_group_details = await client.ApiEntitiesPublicGroupDetail().list({ project_id: "example" })
```
...
```ts
const api_entities_related_issues = await client.ApiEntitiesRelatedIssue().list({ issue_id: "example", project_id: "example" })
```
...
```ts
const api_entities_releases = await client.ApiEntitiesRelease().list({ project_id: "example" })
```
...
```ts
const api_entities_releases_links = await client.ApiEntitiesReleasesLink().list({ project_id: "example", release_id: "example" })
```
...
```ts
const api_entities_remote_mirrors = await client.ApiEntitiesRemoteMirror().list({ project_id: "example" })
```
...
```ts
const api_entities_resource_milestone_events = await client.ApiEntitiesResourceMilestoneEvent().list({ project_id: "example" })
```
...
```ts
const api_entities_tags = await client.ApiEntitiesTag().list({ project_id: "example" })
```
...
```ts
const api_entities_terraform_module_versions = await client.ApiEntitiesTerraformModuleVersion().list({ module_name: "example", module_system: "example", v1_id: "example" })
```
...
```ts
const api_entities_triggers = await client.ApiEntitiesTrigger().list({ project_id: "example" })
```
...
```ts
const api_entities_user_agent_detail = await client.ApiEntitiesUserAgentDetail().load({ snippet_id: 'snippet_id' })
```
...
```ts
const api_entities_user_publics = await client.ApiEntitiesUserPublic().list({ group_id: "example" })
```
...
```ts
const api_entities_user_with_admins = await client.ApiEntitiesUserWithAdmin().list({ fingerprint: "example" })
```
...
```ts
const api_entities_wiki_page_basics = await client.ApiEntitiesWikiPageBasic().list({ group_id: "example" })
```
...
```ts
const composer_package = await client.ComposerPackage().load({ group_id: 'group_id', sha: 'sha' })
```
...
```ts
const conan_package = await client.ConanPackage().load({ file_id: 'file_id', file_name: 'file_name', package_channel: 'package_channel', package_username: 'package_username', package_version: 'package_version', recipe_revision: 'recipe_revision' })
```
...
```ts
const custom_attribute = await client.CustomAttribute().load({ id: 'custom_attribute_id', group_id: 'group_id' })
```
...
```ts
const debian_package = await client.DebianPackage().load({ id: 'debian_package_id', distribution: 'distribution' })
```
...
```ts
const ee_api_entities_audit_events = await client.EeApiEntitiesAuditEvent().list({ group_id: "example" })
```
...
```ts
const ee_api_entities_geo_pipeline_refs = await client.EeApiEntitiesGeoPipelineRef().list({ gl_repository: "example" })
```
...
```ts
const ee_api_entities_merge_request_approval_states = await client.EeApiEntitiesMergeRequestApprovalState().list({ merge_request_id: "example", project_id: "example" })
```
...
```ts
const ee_api_entities_ssh_certificates = await client.EeApiEntitiesSshCertificate().list({ group_id: "example" })
```
...
```ts
const generic_package = await client.GenericPackage().load({ file_name: 'file_name', generic_id: 'generic_id', project_id: 'project_id', package_version: 'package_version' })
```
...
```ts
const go_proxy = await client.GoProxy().load({ project_id: 'project_id', module_name: 'module_name' })
```
...
```ts
const maven_package = await client.MavenPackage().load({ file_name: 'file_name', path: 'path' })
```
...
```ts
const npm_package = await client.NpmPackage().load({ project_id: 'project_id', file_name: 'file_name', package_name: 'package_name' })
```
...
```ts
const nuget_package = await client.NugetPackage().load({ project_id: 'project_id' })
```

#### Example: List

```ts
const nuget_packages = await client.NugetPackage().list({ package_name: "example" })
```
...
```ts
const participants = await client.Participant().list({ project_id: "example" })
```
...
| `duration` | `number` | Time spent running in seconds |
| `finished_at` | `string` |  |
| `id` | `number` |  |
| `iid` | `number` |  |
| `name` | `string` |  |
| `project_id` | `number` |  |
| `queued_duration` | `number` | Time spent enqueued in seconds |
| `ref` | `string` |  |
| `sha` | `string` |  |
| `source` | `string` |  |
| `started_at` | `string` |  |
...
```ts
const pypi_package = await client.PypiPackage().load({ project_id: 'project_id' })
```
...
```ts
const release = await client.Release().load({ project_id: 'project_id', suffix_path: 'suffix_path' })
```
...
```ts
const rpm_package = await client.RpmPackage().load({ project_id: 'project_id', file_name: 'file_name' })
```
...
```ts
const search = await client.Search().load({ scope: 'scope', search: 'search' })
```
...
```ts
const starrers = await client.Starrer().list({ project_id: "example" })
```
...
```ts
const test_reports = await client.TestReport().list({ pipeline_id: "example", project_id: "example" })
```
...
```ts
const users = await client.User().list({ project_id: "example" })
```
...
```ts
const apientitiesmetricimage = client.ApiEntitiesMetricImage()
await apientitiesmetricimage.list()
