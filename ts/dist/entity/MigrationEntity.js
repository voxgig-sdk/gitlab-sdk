...
exports.MigrationEntity = void 0;
const GitlabEntityBase_1 = require("../GitlabEntityBase");
// TODO: needs Entity superclass
class MigrationEntity extends GitlabEntityBase_1.GitlabEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'migration';
        this.name_ = 'migration';
        this.Name = 'Migration';
    }
    make() {
        return new MigrationEntity(this._client, this.entopts());
    }
...
exports.MigrationEntity = MigrationEntity;
//# sourceMappingURL=MigrationEntity.js.map