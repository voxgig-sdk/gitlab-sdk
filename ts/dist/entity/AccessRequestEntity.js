...
exports.AccessRequestEntity = void 0;
const GitlabEntityBase_1 = require("../GitlabEntityBase");
// TODO: needs Entity superclass
class AccessRequestEntity extends GitlabEntityBase_1.GitlabEntityBase {
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<AccessRequestEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.AccessRequestEntity = AccessRequestEntity;
//# sourceMappingURL=AccessRequestEntity.js.map