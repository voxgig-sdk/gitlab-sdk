...
exports.WikiEntity = void 0;
const GitlabEntityBase_1 = require("../GitlabEntityBase");
// TODO: needs Entity superclass
class WikiEntity extends GitlabEntityBase_1.GitlabEntityBase {
    ...
    make() {
        return new WikiEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<WikiEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.WikiEntity = WikiEntity;
//# sourceMappingURL=WikiEntity.js.map