...
import type { RemoteMirror, RemoteMirrorLoadMatch, RemoteMirrorCreateData, RemoteMirrorRemoveMatch } from '../GitlabTypes';
declare class RemoteMirrorEntity extends GitlabEntityBase<RemoteMirror> {
    ...
    create(this: any, reqdata?: RemoteMirrorCreateData, ctrl?: Control): Promise<RemoteMirrorEntity>;
