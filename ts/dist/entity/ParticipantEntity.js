...
class ParticipantEntity extends GitlabEntityBase_1.GitlabEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'participant';
        this.name_ = 'participant';
        this.Name = 'Participant';
    }
    make() {
        return new ParticipantEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Participant[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=ParticipantEntity.js.map