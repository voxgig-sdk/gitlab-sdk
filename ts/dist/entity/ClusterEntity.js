...
exports.ClusterEntity = void 0;
const GitlabEntityBase_1 = require("../GitlabEntityBase");
// TODO: needs Entity superclass
class ClusterEntity extends GitlabEntityBase_1.GitlabEntityBase {
    ...
    make() {
        return new ClusterEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<ClusterEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.ClusterEntity = ClusterEntity;
//# sourceMappingURL=ClusterEntity.js.map