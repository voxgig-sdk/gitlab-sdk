...
class TagEntity extends GitlabEntityBase<Tag> {
  ...
  async remove(
    this: any, reqmatch?: TagRemoveMatch, ctrl?: Control,
  ): Promise<TagEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<TagEntity> return stays clean under strict null checks.
