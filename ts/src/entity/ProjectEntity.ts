...
class ProjectEntity extends GitlabEntityBase<Project> {
  ...
  async list(this: any, reqmatch?: ProjectListMatch, ctrl?: Control): Promise<ProjectEntity[]> {
  ...
  async create(this: any, reqdata?: ProjectCreateData, ctrl?: Control): Promise<ProjectEntity> {
  ...
  async update(this: any, reqdata?: ProjectUpdateData, ctrl?: Control): Promise<ProjectEntity> {
  ...
  async remove(
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ProjectEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
