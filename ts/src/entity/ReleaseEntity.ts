...
class ReleaseEntity extends GitlabEntityBase<Release> {
  ...
  async remove(
    this: any, reqmatch?: ReleaseRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ReleaseEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
