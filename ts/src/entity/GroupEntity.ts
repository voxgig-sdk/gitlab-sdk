...
class GroupEntity extends GitlabEntityBase<Group> {
  ...
  async remove(
    this: any, reqmatch?: GroupRemoveMatch, ctrl?: Control,
  ): Promise<GroupEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<GroupEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
