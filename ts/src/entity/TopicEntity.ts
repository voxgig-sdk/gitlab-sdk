...
class TopicEntity extends GitlabEntityBase<Topic> {
  ...
  async remove(
    this: any, reqmatch?: TopicRemoveMatch, ctrl?: Control,
  ): Promise<TopicEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<TopicEntity> return stays clean under strict null checks.
