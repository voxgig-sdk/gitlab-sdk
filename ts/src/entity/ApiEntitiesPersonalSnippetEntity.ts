...
class ApiEntitiesPersonalSnippetEntity extends GitlabEntityBase<ApiEntitiesPersonalSnippet> {
  ...
  async load(this: any, reqmatch?: ApiEntitiesPersonalSnippetLoadMatch, ctrl?: Control): Promise<ApiEntitiesPersonalSnippetEntity> {
  ...
  async list(this: any, reqmatch?: ApiEntitiesPersonalSnippetListMatch, ctrl?: Control): Promise<ApiEntitiesPersonalSnippetEntity[]> {
  ...
  async create(this: any, reqdata?: ApiEntitiesPersonalSnippetCreateData, ctrl?: Control): Promise<ApiEntitiesPersonalSnippetEntity> {
  ...
  async update(this: any, reqdata?: ApiEntitiesPersonalSnippetUpdateData, ctrl?: Control): Promise<ApiEntitiesPersonalSnippetEntity> {
