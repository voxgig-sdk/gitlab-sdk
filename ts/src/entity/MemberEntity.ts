...
class MemberEntity extends GitlabEntityBase<Member> {
  ...
  async update(this: any, reqdata?: MemberUpdateData, ctrl?: Control): Promise<MemberEntity> {
  ...
  async remove(
    this: any, reqmatch?: MemberRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<MemberEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
