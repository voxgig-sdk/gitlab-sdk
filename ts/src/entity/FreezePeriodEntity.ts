...
class FreezePeriodEntity extends GitlabEntityBase<FreezePeriod> {
  ...
  async remove(
    this: any, reqmatch?: FreezePeriodRemoveMatch, ctrl?: Control,
  ): Promise<FreezePeriodEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<FreezePeriodEntity> return stays clean under strict null checks.
