...
class ProjectPackageEntity extends GitlabEntityBase<ProjectPackage> {
  ...
  async remove(
    this: any, reqmatch?: ProjectPackageRemoveMatch, ctrl?: Control,
  ): Promise<ProjectPackageEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<ProjectPackageEntity> return stays clean under strict null checks.
