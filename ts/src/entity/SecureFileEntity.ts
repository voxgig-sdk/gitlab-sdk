...
import type {
  SecureFile,
  SecureFileLoadMatch,
  SecureFileRemoveMatch,
} from '../GitlabTypes'

// TODO: needs Entity superclass
class SecureFileEntity extends GitlabEntityBase<SecureFile> {

  constructor(client: GitlabSDK, entopts: any) {
    super(client, entopts)
    this.name = 'secure_file'
    this.name_ = 'secure_file'
    this.Name = 'SecureFile'
  }


  make(this: SecureFileEntity) {
    return new SecureFileEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: SecureFileLoadMatch, ctrl?: Control): Promise<SecureFileEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<SecureFile> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: SecureFileRemoveMatch, ctrl?: Control,
  ): Promise<SecureFileEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<SecureFileEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
