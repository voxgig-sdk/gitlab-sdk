...
import type {
  ...
  EnvironmentRemoveMatch,
} from '../GitlabTypes'

// TODO: needs Entity superclass
class EnvironmentEntity extends GitlabEntityBase<Environment> {

  constructor(client: GitlabSDK, entopts: any) {
    super(client, entopts)
    this.name = 'environment'
    this.name_ = 'environment'
    this.Name = 'Environment'
  }


  make(this: EnvironmentEntity) {
    return new EnvironmentEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: EnvironmentCreateData, ctrl?: Control): Promise<EnvironmentEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Environment> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: EnvironmentRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<EnvironmentEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
