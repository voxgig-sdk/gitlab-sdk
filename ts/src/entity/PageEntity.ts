...
class PageEntity extends GitlabEntityBase<Page> {
  ...
  async remove(
    this: any, reqmatch?: PageRemoveMatch, ctrl?: Control,
  ): Promise<PageEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<PageEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
