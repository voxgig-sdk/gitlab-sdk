...
class FeatureFlagsUserListEntity extends GitlabEntityBase<FeatureFlagsUserList> {
  ...
  async remove(
    this: any, reqmatch?: FeatureFlagsUserListRemoveMatch, ctrl?: Control,
  ): Promise<FeatureFlagsUserListEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<FeatureFlagsUserListEntity> return stays clean under strict null checks.
