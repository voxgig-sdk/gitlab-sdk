...
class BranchEntity extends GitlabEntityBase<Branch> {
  ...
  make(this: BranchEntity) {
    return new BranchEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: BranchRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<BranchEntity> return stays clean under strict null checks.
