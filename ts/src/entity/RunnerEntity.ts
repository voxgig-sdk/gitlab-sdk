...
class RunnerEntity extends GitlabEntityBase<Runner> {
  ...
  make(this: RunnerEntity) {
    return new RunnerEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: RunnerCreateData, ctrl?: Control): Promise<RunnerEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Runner> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: RunnerRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<RunnerEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
