...
class ContainerRegistryEntity extends GitlabEntityBase<ContainerRegistry> {
  ...
  async remove(
    this: any, reqmatch?: ContainerRegistryRemoveMatch, ctrl?: Control,
  ): Promise<ContainerRegistryEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<ContainerRegistryEntity> return stays clean under strict null checks.
