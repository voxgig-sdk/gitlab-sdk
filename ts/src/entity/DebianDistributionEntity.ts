...
class DebianDistributionEntity extends GitlabEntityBase<DebianDistribution> {
  ...
  async remove(
    this: any, reqmatch?: DebianDistributionRemoveMatch, ctrl?: Control,
  ): Promise<DebianDistributionEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<DebianDistributionEntity> return stays clean under strict null checks.
