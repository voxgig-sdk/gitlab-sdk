...
class HookEntity extends GitlabEntityBase<Hook> {
  ...
  make(this: HookEntity) {
    return new HookEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: HookCreateData, ctrl?: Control): Promise<HookEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Hook> return stays clean under strict null checks.
  ...
  async update(this: any, reqdata?: HookUpdateData, ctrl?: Control): Promise<HookEntity> {
  ...
  async remove(
    this: any, reqmatch?: HookRemoveMatch, ctrl?: Control,
  ): Promise<HookEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<HookEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
