...
class ClusterAgentEntity extends GitlabEntityBase<ClusterAgent> {
  ...
  async remove(
    this: any, reqmatch?: ClusterAgentRemoveMatch, ctrl?: Control,
  ): Promise<ClusterAgentEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<ClusterAgentEntity> return stays clean under strict null checks.
