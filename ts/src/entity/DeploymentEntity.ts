...
import type {
  Deployment,
  DeploymentRemoveMatch,
} from '../GitlabTypes'

// TODO: needs Entity superclass
class DeploymentEntity extends GitlabEntityBase<Deployment> {

  constructor(client: GitlabSDK, entopts: any) {
    super(client, entopts)
    this.name = 'deployment'
    this.name_ = 'deployment'
    this.Name = 'Deployment'
  }


  make(this: DeploymentEntity) {
    return new DeploymentEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: DeploymentRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<DeploymentEntity> return stays clean under strict null checks.
