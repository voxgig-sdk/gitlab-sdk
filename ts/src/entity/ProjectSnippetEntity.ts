...
class ProjectSnippetEntity extends GitlabEntityBase<ProjectSnippet> {
  ...
  async remove(
    this: any, reqmatch?: ProjectSnippetRemoveMatch, ctrl?: Control,
  ): Promise<ProjectSnippetEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<ProjectSnippetEntity> return stays clean under strict null checks.
