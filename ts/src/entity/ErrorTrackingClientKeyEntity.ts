...
class ErrorTrackingClientKeyEntity extends GitlabEntityBase<ErrorTrackingClientKey> {
  ...
  async remove(
    this: any, reqmatch?: ErrorTrackingClientKeyRemoveMatch, ctrl?: Control,
  ): Promise<ErrorTrackingClientKeyEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<ErrorTrackingClientKeyEntity> return stays clean under strict null checks.
