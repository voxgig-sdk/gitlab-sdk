...
class DependencyProxyEntity extends GitlabEntityBase<DependencyProxy> {
  ...
  async remove(
    this: any, reqmatch?: DependencyProxyRemoveMatch, ctrl?: Control,
  ): Promise<DependencyProxyEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<DependencyProxyEntity> return stays clean under strict null checks.
