...
(0, node_test_1.describe)('ApiEntitiesCommitStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_commit_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_commit_status', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_COMMIT_STATUS_ENTID'];
...
//# sourceMappingURL=ApiEntitiesCommitStatusDirect.test.js.map