...
(0, node_test_1.describe)('ApiEntitiesGroupDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_group', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_group', setup.live))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.project_id ?? listArr[0]?.id;
            if (null == candidateId) {
                throw new Error('Live load blocked: discovery returned no usable identity');
            }
            params.project_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-api_entities_group', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_group', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_GROUP_ENTID'];
...
//# sourceMappingURL=ApiEntitiesGroupDirect.test.js.map