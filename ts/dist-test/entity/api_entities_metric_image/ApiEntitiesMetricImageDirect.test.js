...
(0, node_test_1.describe)('ApiEntitiesMetricImageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_metric_image', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_metric_image', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["alert_management_alert01", "project01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_METRIC_IMAGE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesMetricImageDirect.test.js.map