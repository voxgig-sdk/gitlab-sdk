...
(0, node_test_1.describe)('ApiEntitiesIntegrationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_integration', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_integration', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["group_id01", "id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_INTEGRATION_ENTID'];
...
//# sourceMappingURL=ApiEntitiesIntegrationDirect.test.js.map