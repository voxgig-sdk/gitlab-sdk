...
(0, node_test_1.describe)('GenericPackageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-generic_package', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-generic_package', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["generic_id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_GENERIC_PACKAGE_ENTID'];
...
//# sourceMappingURL=GenericPackageDirect.test.js.map