...
(0, node_test_1.describe)('ApiEntitiesCiSecureFileEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_ci_secure_file.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != api_entities_ci_secure_file_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_CI_SECURE_FILE_ENTID'];
