...
(0, node_test_1.describe)('ApiEntitiesRelatedIssueEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_related_issue.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_RELATED_ISSUE_ENTID'];
