...
function basicSetup(extra) {
    ...
    let idmap = transform(['integration01', 'integration02', 'integration03', 'group01', 'group02', 'group03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', 'service01', 'service02', 'service03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_INTEGRATION_ENTID'];
