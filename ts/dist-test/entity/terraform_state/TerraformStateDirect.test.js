...
(0, node_test_1.describe)('TerraformStateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-terraform_state', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-terraform_state', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project_id01", "serial01", "state_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'GITLAB_TEST_TERRAFORM_STATE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_TERRAFORM_STATE_ENTID'];
...
//# sourceMappingURL=TerraformStateDirect.test.js.map