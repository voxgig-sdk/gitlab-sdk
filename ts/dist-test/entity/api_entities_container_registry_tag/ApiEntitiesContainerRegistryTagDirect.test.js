...
(0, node_test_1.describe)('ApiEntitiesContainerRegistryTagDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_container_registry_tag', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_container_registry_tag', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project01", "repository01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_CONTAINER_REGISTRY_TAG_ENTID'];
...
//# sourceMappingURL=ApiEntitiesContainerRegistryTagDirect.test.js.map