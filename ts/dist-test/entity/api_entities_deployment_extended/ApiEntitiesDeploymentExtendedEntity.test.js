...
(0, node_test_1.describe)('ApiEntitiesDeploymentExtendedEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_deployment_extended.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_deployment_extended01', 'api_entities_deployment_extended02', 'api_entities_deployment_extended03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', 'deployment01', 'deployment02', 'deployment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
