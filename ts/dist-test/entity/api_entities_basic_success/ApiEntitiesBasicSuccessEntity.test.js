...
(0, node_test_1.describe)('ApiEntitiesBasicSuccessEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != api_entities_basic_success_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_basic_success/ApiEntitiesBasicSuccessTestData.json');
    ...
    let idmap = transform(['api_entities_basic_success01', 'api_entities_basic_success02', 'api_entities_basic_success03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiEntitiesBasicSuccessEntity.test.js.map