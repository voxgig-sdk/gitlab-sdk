...
(0, node_test_1.describe)('GoProxyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-go_proxy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-go_proxy', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_GO_PROXY_ENTID'];
...
//# sourceMappingURL=GoProxyDirect.test.js.map