...
(0, node_test_1.describe)('GoProxyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'go_proxy.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['go_proxy01', 'go_proxy02', 'go_proxy03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', '@v01', '@v02', '@v03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
