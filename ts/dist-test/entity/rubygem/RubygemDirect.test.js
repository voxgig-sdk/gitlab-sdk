...
(0, node_test_1.describe)('RubygemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-rubygem', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-rubygem', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_RUBYGEM_ENTID'];
...
//# sourceMappingURL=RubygemDirect.test.js.map