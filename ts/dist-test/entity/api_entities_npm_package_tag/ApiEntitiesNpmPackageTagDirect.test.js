...
(0, node_test_1.describe)('ApiEntitiesNpmPackageTagDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_npm_package_tag', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_npm_package_tag', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["group_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_NPM_PACKAGE_TAG_ENTID'];
...
//# sourceMappingURL=ApiEntitiesNpmPackageTagDirect.test.js.map