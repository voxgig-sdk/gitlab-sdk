...
(0, node_test_1.describe)('ApiEntitiesCommitDetailEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_commit_detail.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_commit_detail01', 'api_entities_commit_detail02', 'api_entities_commit_detail03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', 'commit01', 'commit02', 'commit03', 'project01', 'project02', 'project03', 'submodule01', 'submodule02', 'submodule03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
