...
(0, node_test_1.describe)('ApiEntitiesMergeRequestDiffFullEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_merge_request_diff_full.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_merge_request_diff_full01', 'api_entities_merge_request_diff_full02', 'api_entities_merge_request_diff_full03', 'project01', 'project02', 'project03', 'merge_request01', 'merge_request02', 'merge_request03', 'version01', 'version02', 'version03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_MERGE_REQUEST_DIFF_FULL_ENTID'];
