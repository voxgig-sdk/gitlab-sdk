...
(0, node_test_1.describe)('ComposerPackageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-composer_package', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-composer_package', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_COMPOSER_PACKAGE_ENTID'];
...
//# sourceMappingURL=ComposerPackageDirect.test.js.map