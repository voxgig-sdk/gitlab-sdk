...
(0, node_test_1.describe)('ApiEntitiesDeployKeysProjectDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_deploy_keys_project', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_deploy_keys_project', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["key01", "project01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.key_id ?? listArr[0]?.id;
            if (null == candidateId) {
                throw new Error('Live load blocked: discovery returned no usable identity');
            }
            params.key_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-api_entities_deploy_keys_project', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_deploy_keys_project', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_DEPLOY_KEYS_PROJECT_ENTID'];
...
//# sourceMappingURL=ApiEntitiesDeployKeysProjectDirect.test.js.map