...
(0, node_test_1.describe)('ApiEntitiesCiPipelineScheduleDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_ci_pipeline_schedule_detail', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_ci_pipeline_schedule_detail', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_CI_PIPELINE_SCHEDULE_DETAIL_ENTID'];
...
//# sourceMappingURL=ApiEntitiesCiPipelineScheduleDetailDirect.test.js.map