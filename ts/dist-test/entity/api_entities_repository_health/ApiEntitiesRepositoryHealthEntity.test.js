...
(0, node_test_1.describe)('ApiEntitiesRepositoryHealthEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_repository_health.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_REPOSITORY_HEALTH_ENTID'];
