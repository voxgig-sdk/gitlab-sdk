...
(0, node_test_1.describe)('ApiEntitiesDictionaryTableDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_dictionary_table', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_dictionary_table', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["databas_id01", "id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_DICTIONARY_TABLE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesDictionaryTableDirect.test.js.map