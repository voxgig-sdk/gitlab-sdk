...
(0, node_test_1.describe)('ApiEntitiesDictionaryTableEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(api_entities_dictionary_table_ref01_data_dt0.id === api_entities_dictionary_table_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_dictionary_table/ApiEntitiesDictionaryTableTestData.json');
    ...
    let idmap = transform(['api_entities_dictionary_table01', 'api_entities_dictionary_table02', 'api_entities_dictionary_table03', 'databas01', 'databas02', 'databas03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiEntitiesDictionaryTableEntity.test.js.map