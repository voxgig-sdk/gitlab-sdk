...
(0, node_test_1.describe)('ApiEntitiesBulkImportsEntityFailureDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_bulk_imports_entity_failure', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_bulk_imports_entity_failure', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["bulk_import_id01", "entity_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_BULK_IMPORTS_ENTITY_FAILURE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesBulkImportsEntityFailureDirect.test.js.map