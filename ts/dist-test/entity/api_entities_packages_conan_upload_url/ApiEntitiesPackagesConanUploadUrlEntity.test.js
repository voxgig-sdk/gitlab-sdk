...
(0, node_test_1.describe)('ApiEntitiesPackagesConanUploadUrlEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_packages_conan_upload_url.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_packages_conan_upload_url01', 'api_entities_packages_conan_upload_url02', 'api_entities_packages_conan_upload_url03', 'project01', 'project02', 'project03', 'conan01', 'conan02', 'conan03', 'project01', 'project02', 'project03', 'conan01', 'conan02', 'conan03', 'package01', 'package02', 'package03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_PACKAGES_CONAN_UPLOAD_URL_ENTID'];
