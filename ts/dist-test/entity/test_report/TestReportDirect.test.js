...
(0, node_test_1.describe)('TestReportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-test_report', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-test_report', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_TEST_REPORT_ENTID'];
...
//# sourceMappingURL=TestReportDirect.test.js.map