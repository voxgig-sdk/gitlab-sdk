...
(0, node_test_1.describe)('IssuesStatisticDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-issues_statistic', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-issues_statistic', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_ISSUES_STATISTIC_ENTID'];
...
//# sourceMappingURL=IssuesStatisticDirect.test.js.map