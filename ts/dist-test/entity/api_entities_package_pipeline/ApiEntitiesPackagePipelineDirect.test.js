...
(0, node_test_1.describe)('ApiEntitiesPackagePipelineDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_package_pipeline', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_package_pipeline', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["package_id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PACKAGE_PIPELINE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesPackagePipelineDirect.test.js.map