...
(0, node_test_1.describe)('ApiEntitiesErrorTrackingProjectSettingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_error_tracking_project_setting', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_error_tracking_project_setting', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_ERROR_TRACKING_PROJECT_SETTING_ENTID'];
...
//# sourceMappingURL=ApiEntitiesErrorTrackingProjectSettingDirect.test.js.map