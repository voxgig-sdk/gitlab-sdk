...
(0, node_test_1.describe)('ApiEntitiesContainerRegistryTagDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_container_registry_tag_detail', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_container_registry_tag_detail', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project_id01", "repository_id01", "tag_name01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_CONTAINER_REGISTRY_TAG_DETAIL_ENTID'];
...
//# sourceMappingURL=ApiEntitiesContainerRegistryTagDetailDirect.test.js.map