...
(0, node_test_1.describe)('ApiEntitiesCiPipelineScheduleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_ci_pipeline_schedule', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_ci_pipeline_schedule', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_CI_PIPELINE_SCHEDULE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesCiPipelineScheduleDirect.test.js.map