...
(0, node_test_1.describe)('SecureFileDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-secure_file', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-secure_file', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_SECURE_FILE_ENTID'];
...
//# sourceMappingURL=SecureFileDirect.test.js.map