...
(0, node_test_1.describe)('EeApiEntitiesIssuableMetricImageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'ee_api_entities_issuable_metric_image.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['ee_api_entities_issuable_metric_image01', 'ee_api_entities_issuable_metric_image02', 'ee_api_entities_issuable_metric_image03', 'project01', 'project02', 'project03', 'issue01', 'issue02', 'issue03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_EE_API_ENTITIES_ISSUABLE_METRIC_IMAGE_ENTID'];
