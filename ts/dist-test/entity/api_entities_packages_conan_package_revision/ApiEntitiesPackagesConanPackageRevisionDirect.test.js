...
(0, node_test_1.describe)('ApiEntitiesPackagesConanPackageRevisionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_packages_conan_package_revision', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_packages_conan_package_revision', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["conan01", "conan_package_reference01", "package_channel01", "package_username01", "package_version01", "project01", "revision01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PACKAGES_CONAN_PACKAGE_REVISION_ENTID'];
...
//# sourceMappingURL=ApiEntitiesPackagesConanPackageRevisionDirect.test.js.map