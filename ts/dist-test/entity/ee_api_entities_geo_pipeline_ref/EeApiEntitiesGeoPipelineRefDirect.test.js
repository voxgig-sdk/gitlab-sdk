...
(0, node_test_1.describe)('EeApiEntitiesGeoPipelineRefDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-ee_api_entities_geo_pipeline_ref', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ee_api_entities_geo_pipeline_ref', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["gl_repository01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_EE_API_ENTITIES_GEO_PIPELINE_REF_ENTID'];
...
//# sourceMappingURL=EeApiEntitiesGeoPipelineRefDirect.test.js.map