...
function basicSetup(extra) {
    ...
    let idmap = transform(['ee_api_entities_geo_pipeline_ref01', 'ee_api_entities_geo_pipeline_ref02', 'ee_api_entities_geo_pipeline_ref03', 'repository01', 'repository02', 'repository03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
