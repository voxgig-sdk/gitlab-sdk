...
(0, node_test_1.describe)('ApiEntitiesResourceMilestoneEventDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_resource_milestone_event', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_resource_milestone_event', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["issue01", "project01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-api_entities_resource_milestone_event', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_resource_milestone_event', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["issue01", "project01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_RESOURCE_MILESTONE_EVENT_ENTID'];
...
//# sourceMappingURL=ApiEntitiesResourceMilestoneEventDirect.test.js.map