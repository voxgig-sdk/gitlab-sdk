...
(0, node_test_1.describe)('ApiEntitiesBasicProjectDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_basic_project_detail', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_basic_project_detail', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_BASIC_PROJECT_DETAIL_ENTID'];
...
//# sourceMappingURL=ApiEntitiesBasicProjectDetailDirect.test.js.map