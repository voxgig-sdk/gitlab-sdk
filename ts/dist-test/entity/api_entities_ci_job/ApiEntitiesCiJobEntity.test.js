...
(0, node_test_1.describe)('ApiEntitiesCiJobEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_ci_job.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_ci_job01', 'api_entities_ci_job02', 'api_entities_ci_job03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', 'job01', 'job02', 'job03', 'project01', 'project02', 'project03', 'pipeline01', 'pipeline02', 'pipeline03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
