...
(0, node_test_1.describe)('ApiEntitiesCiJobDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_ci_job', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_ci_job', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-api_entities_ci_job', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_ci_job', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_CI_JOB_ENTID'];
...
//# sourceMappingURL=ApiEntitiesCiJobDirect.test.js.map