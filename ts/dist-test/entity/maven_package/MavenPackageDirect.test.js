...
(0, node_test_1.describe)('MavenPackageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-maven_package', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-maven_package', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["file_name01", "group_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_MAVEN_PACKAGE_ENTID'];
...
//# sourceMappingURL=MavenPackageDirect.test.js.map