...
(0, node_test_1.describe)('MlModelRegistryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let ml_model_registry_ref01_data = Object.values(setup.data.existing.ml_model_registry)[0];
        // UPDATE
        const ml_model_registry_ref01_ent = client.MlModelRegistry();
        const ml_model_registry_ref01_data_up0 = {};
        ...
        (0, node_assert_1.default)(null != ml_model_registry_ref01_resdata_up0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/ml_model_registry/MlModelRegistryTestData.json');
    ...
    let idmap = transform(['ml_model_registry01', 'ml_model_registry02', 'ml_model_registry03', 'project01', 'project02', 'project03', 'ml_model01', 'ml_model02', 'ml_model03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MlModelRegistryEntity.test.js.map