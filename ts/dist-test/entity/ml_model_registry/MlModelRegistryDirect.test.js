...
(0, node_test_1.describe)('MlModelRegistryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ml_model_registry', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ml_model_registry', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["ml_model_id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_ML_MODEL_REGISTRY_ENTID'];
...
//# sourceMappingURL=MlModelRegistryDirect.test.js.map