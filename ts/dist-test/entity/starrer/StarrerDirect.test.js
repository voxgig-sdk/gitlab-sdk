...
(0, node_test_1.describe)('StarrerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-starrer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-starrer', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_STARRER_ENTID'];
...
//# sourceMappingURL=StarrerDirect.test.js.map