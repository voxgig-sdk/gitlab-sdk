...
(0, node_test_1.describe)('ApiEntitiesTemplatesListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_templates_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_templates_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project_id01", "type01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_TEMPLATES_LIST_ENTID'];
...
//# sourceMappingURL=ApiEntitiesTemplatesListDirect.test.js.map