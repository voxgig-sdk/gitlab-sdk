...
(0, node_test_1.describe)('ApiEntitiesProjectSnippetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_project_snippet', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_project_snippet', setup.live))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    file_id: setup.idmap['file01'],
                    file_path: setup.idmap['file_path01'],
    ...
    (0, node_test_1.test)('direct-list-api_entities_project_snippet', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_project_snippet', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["file01", "file_path01", "project01", "snippet01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PROJECT_SNIPPET_ENTID'];
...
//# sourceMappingURL=ApiEntitiesProjectSnippetDirect.test.js.map