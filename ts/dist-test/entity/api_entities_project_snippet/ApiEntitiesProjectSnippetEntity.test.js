...
(0, node_test_1.describe)('ApiEntitiesProjectSnippetEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_project_snippet.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_project_snippet01', 'api_entities_project_snippet02', 'api_entities_project_snippet03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', 'snippet01', 'snippet02', 'snippet03', 'project01', 'project02', 'project03', 'snippet01', 'snippet02', 'snippet03', 'file01', 'file02', 'file03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
