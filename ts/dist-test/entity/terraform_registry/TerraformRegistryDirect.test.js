...
(0, node_test_1.describe)('TerraformRegistryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-terraform_registry', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-terraform_registry', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["module_id01", "module_system01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_TERRAFORM_REGISTRY_ENTID'];
...
//# sourceMappingURL=TerraformRegistryDirect.test.js.map