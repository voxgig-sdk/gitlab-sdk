...
(0, node_test_1.describe)('ApiEntitiesAwardEmojiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_award_emoji', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_award_emoji', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["epic01", "group01", "note01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-api_entities_award_emoji', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_award_emoji', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["epic01", "group01", "note01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_AWARD_EMOJI_ENTID'];
...
//# sourceMappingURL=ApiEntitiesAwardEmojiDirect.test.js.map