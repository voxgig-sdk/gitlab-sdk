...
(0, node_test_1.describe)('ApiEntitiesAwardEmojiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_award_emoji.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != api_entities_award_emoji_ref01_data.id);
        // LIST
        const api_entities_award_emoji_ref01_match = {};
        ...
        const api_entities_award_emoji_ref01_list = (await api_entities_award_emoji_ref01_ent.list(api_entities_award_emoji_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(api_entities_award_emoji_ref01_list, { id: api_entities_award_emoji_ref01_data.id })));
        // LOAD
        const api_entities_award_emoji_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(api_entities_award_emoji_ref01_data_dt0.id === api_entities_award_emoji_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_award_emoji/ApiEntitiesAwardEmojiTestData.json');
...
//# sourceMappingURL=ApiEntitiesAwardEmojiEntity.test.js.map