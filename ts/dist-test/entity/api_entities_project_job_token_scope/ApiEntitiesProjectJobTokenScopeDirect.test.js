...
(0, node_test_1.describe)('ApiEntitiesProjectJobTokenScopeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_project_job_token_scope', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_project_job_token_scope', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PROJECT_JOB_TOKEN_SCOPE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesProjectJobTokenScopeDirect.test.js.map