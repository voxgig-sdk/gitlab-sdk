...
(0, node_test_1.describe)('ApiEntitiesRemoteMirrorEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_remote_mirror.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_remote_mirror01', 'api_entities_remote_mirror02', 'api_entities_remote_mirror03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', 'remote_mirror01', 'remote_mirror02', 'remote_mirror03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
