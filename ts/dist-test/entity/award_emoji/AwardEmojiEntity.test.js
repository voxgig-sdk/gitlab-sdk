...
(0, node_test_1.describe)('AwardEmojiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'award_emoji.' + op, live))
                return;
        }
        ...
        let award_emoji_ref01_data = Object.values(setup.data.existing.award_emoji)[0];
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/award_emoji/AwardEmojiTestData.json');
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_AWARD_EMOJI_ENTID'];
...
//# sourceMappingURL=AwardEmojiEntity.test.js.map