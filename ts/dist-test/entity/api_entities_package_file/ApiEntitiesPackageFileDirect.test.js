...
(0, node_test_1.describe)('ApiEntitiesPackageFileDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_package_file', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_package_file', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["package01", "project01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PACKAGE_FILE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesPackageFileDirect.test.js.map