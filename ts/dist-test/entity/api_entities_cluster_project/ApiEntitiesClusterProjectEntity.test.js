...
(0, node_test_1.describe)('ApiEntitiesClusterProjectEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_cluster_project.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != api_entities_cluster_project_ref01_data.id);
        // UPDATE
        const api_entities_cluster_project_ref01_data_up0 = {};
        ...
        api_entities_cluster_project_ref01_data_up0[api_entities_cluster_project_ref01_markdef_up0.name] = api_entities_cluster_project_ref01_markdef_up0.value;
        ...
        (0, node_assert_1.default)(api_entities_cluster_project_ref01_resdata_up0.id === api_entities_cluster_project_ref01_data_up0.id);
        (0, node_assert_1.default)(api_entities_cluster_project_ref01_resdata_up0[api_entities_cluster_project_ref01_markdef_up0.name] === api_entities_cluster_project_ref01_markdef_up0.value);
        // LOAD
        const api_entities_cluster_project_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(api_entities_cluster_project_ref01_data_dt0.id === api_entities_cluster_project_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_cluster_project/ApiEntitiesClusterProjectTestData.json');
    ...
    let idmap = transform(['api_entities_cluster_project01', 'api_entities_cluster_project02', 'api_entities_cluster_project03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', 'cluster01', 'cluster02', 'cluster03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_CLUSTER_PROJECT_ENTID'];
...
//# sourceMappingURL=ApiEntitiesClusterProjectEntity.test.js.map