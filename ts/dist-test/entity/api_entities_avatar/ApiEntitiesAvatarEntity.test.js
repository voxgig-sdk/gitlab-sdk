...
(0, node_test_1.describe)('ApiEntitiesAvatarEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != api_entities_avatar_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_avatar/ApiEntitiesAvatarTestData.json');
    ...
    let idmap = transform(['api_entities_avatar01', 'api_entities_avatar02', 'api_entities_avatar03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiEntitiesAvatarEntity.test.js.map