...
(0, node_test_1.describe)('ApiEntitiesAvatarDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_avatar', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_avatar', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_AVATAR_ENTID'];
...
//# sourceMappingURL=ApiEntitiesAvatarDirect.test.js.map