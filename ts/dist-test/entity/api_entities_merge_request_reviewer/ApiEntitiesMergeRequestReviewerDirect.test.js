...
(0, node_test_1.describe)('ApiEntitiesMergeRequestReviewerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_merge_request_reviewer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_merge_request_reviewer', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["merge_request_id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_MERGE_REQUEST_REVIEWER_ENTID'];
...
//# sourceMappingURL=ApiEntitiesMergeRequestReviewerDirect.test.js.map