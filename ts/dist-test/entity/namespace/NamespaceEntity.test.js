...
(0, node_test_1.describe)('NamespaceEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'namespace.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_NAMESPACE_ENTID'];
    ...
    idmap = env['GITLAB_TEST_NAMESPACE_ENTID'];
