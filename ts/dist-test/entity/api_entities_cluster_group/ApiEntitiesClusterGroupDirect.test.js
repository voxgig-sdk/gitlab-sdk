...
(0, node_test_1.describe)('ApiEntitiesClusterGroupDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_cluster_group', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_cluster_group', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["cluster_id01", "group_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_CLUSTER_GROUP_ENTID'];
...
//# sourceMappingURL=ApiEntitiesClusterGroupDirect.test.js.map