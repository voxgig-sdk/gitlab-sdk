...
(0, node_test_1.describe)('ApiEntitiesClusterGroupEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_cluster_group.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_cluster_group01', 'api_entities_cluster_group02', 'api_entities_cluster_group03', 'group01', 'group02', 'group03', 'group01', 'group02', 'group03', 'cluster01', 'cluster02', 'cluster03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_CLUSTER_GROUP_ENTID'];
