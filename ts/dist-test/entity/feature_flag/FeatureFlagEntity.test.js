...
(0, node_test_1.describe)('FeatureFlagEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'feature_flag.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != feature_flag_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['feature_flag01', 'feature_flag02', 'feature_flag03', 'unleash01', 'unleash02', 'unleash03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_FEATURE_FLAG_ENTID'];
