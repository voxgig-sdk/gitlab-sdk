...
(0, node_test_1.describe)('FeatureFlagDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-feature_flag', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-feature_flag', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'GITLAB_TEST_FEATURE_FLAG_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_FEATURE_FLAG_ENTID'];
...
//# sourceMappingURL=FeatureFlagDirect.test.js.map