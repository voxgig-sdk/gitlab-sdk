...
(0, node_test_1.describe)('MergeRequestDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-merge_request', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-merge_request', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_MERGE_REQUEST_ENTID'];
...
//# sourceMappingURL=MergeRequestDirect.test.js.map