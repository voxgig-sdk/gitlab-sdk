...
(0, node_test_1.describe)('EeApiEntitiesAuditEventEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(ee_api_entities_audit_event_ref01_data_dt0.id === ee_api_entities_audit_event_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/ee_api_entities_audit_event/EeApiEntitiesAuditEventTestData.json');
    ...
    let idmap = transform(['ee_api_entities_audit_event01', 'ee_api_entities_audit_event02', 'ee_api_entities_audit_event03', 'group01', 'group02', 'group03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EeApiEntitiesAuditEventEntity.test.js.map