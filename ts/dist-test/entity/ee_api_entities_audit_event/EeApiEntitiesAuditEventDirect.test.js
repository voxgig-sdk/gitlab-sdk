...
(0, node_test_1.describe)('EeApiEntitiesAuditEventDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ee_api_entities_audit_event', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ee_api_entities_audit_event', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-ee_api_entities_audit_event', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ee_api_entities_audit_event', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["group01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_EE_API_ENTITIES_AUDIT_EVENT_ENTID'];
...
//# sourceMappingURL=EeApiEntitiesAuditEventDirect.test.js.map