...
(0, node_test_1.describe)('ReleaseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-release', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-release', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project_id01", "release_id01"]))
            return;
        ...
        const result = await client.direct({
            path: 'api/v4/projects/{project_id}/releases/{release_id}/downloads/*direct_asset_path',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_RELEASE_ENTID'];
