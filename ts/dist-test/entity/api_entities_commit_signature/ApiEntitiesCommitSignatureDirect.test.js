...
(0, node_test_1.describe)('ApiEntitiesCommitSignatureDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_commit_signature', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_commit_signature', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project_id01", "sha01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_COMMIT_SIGNATURE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesCommitSignatureDirect.test.js.map