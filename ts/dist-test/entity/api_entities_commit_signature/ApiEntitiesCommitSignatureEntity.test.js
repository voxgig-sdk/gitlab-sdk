...
(0, node_test_1.describe)('ApiEntitiesCommitSignatureEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_commit_signature/ApiEntitiesCommitSignatureTestData.json');
    ...
    let idmap = transform(['api_entities_commit_signature01', 'api_entities_commit_signature02', 'api_entities_commit_signature03', 'project01', 'project02', 'project03', 'commit01', 'commit02', 'commit03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiEntitiesCommitSignatureEntity.test.js.map