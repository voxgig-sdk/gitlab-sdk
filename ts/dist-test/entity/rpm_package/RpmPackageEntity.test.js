...
(0, node_test_1.describe)('RpmPackageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'rpm_package.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != rpm_package_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/rpm_package/RpmPackageTestData.json');
    ...
    let idmap = transform(['rpm_package01', 'rpm_package02', 'rpm_package03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_RPM_PACKAGE_ENTID'];
...
//# sourceMappingURL=RpmPackageEntity.test.js.map