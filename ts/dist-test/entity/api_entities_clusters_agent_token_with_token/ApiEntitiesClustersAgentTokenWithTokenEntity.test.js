...
(0, node_test_1.describe)('ApiEntitiesClustersAgentTokenWithTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_clusters_agent_token_with_token.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != api_entities_clusters_agent_token_with_token_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_clusters_agent_token_with_token/ApiEntitiesClustersAgentTokenWithTokenTestData.json');
    ...
    let idmap = transform(['api_entities_clusters_agent_token_with_token01', 'api_entities_clusters_agent_token_with_token02', 'api_entities_clusters_agent_token_with_token03', 'project01', 'project02', 'project03', 'cluster_agent01', 'cluster_agent02', 'cluster_agent03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_CLUSTERS_AGENT_TOKEN_WITH_TOKEN_ENTID'];
...
//# sourceMappingURL=ApiEntitiesClustersAgentTokenWithTokenEntity.test.js.map