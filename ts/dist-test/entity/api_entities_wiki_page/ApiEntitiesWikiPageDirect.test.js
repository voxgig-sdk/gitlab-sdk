...
(0, node_test_1.describe)('ApiEntitiesWikiPageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_wiki_page', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_wiki_page', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["group_id01", "slug01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_WIKI_PAGE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesWikiPageDirect.test.js.map