...
(0, node_test_1.describe)('ApiEntitiesPackagesConanRecipeRevisionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_packages_conan_recipe_revision.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_packages_conan_recipe_revision01', 'api_entities_packages_conan_recipe_revision02', 'api_entities_packages_conan_recipe_revision03', 'project01', 'project02', 'project03', 'conan01', 'conan02', 'conan03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_PACKAGES_CONAN_RECIPE_REVISION_ENTID'];
