...
(0, node_test_1.describe)('NugetPackageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-nuget_package', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-nuget_package', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-nuget_package', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-nuget_package', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["group01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_NUGET_PACKAGE_ENTID'];
...
//# sourceMappingURL=NugetPackageDirect.test.js.map