...
(0, node_test_1.describe)('ApiEntitiesSystemBroadcastMessageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_system_broadcast_message', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_system_broadcast_message', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_SYSTEM_BROADCAST_MESSAGE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesSystemBroadcastMessageDirect.test.js.map