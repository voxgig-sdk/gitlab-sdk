...
(0, node_test_1.describe)('ApiEntitiesIssueLinkDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_issue_link', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_issue_link', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "issue_id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_ISSUE_LINK_ENTID'];
...
//# sourceMappingURL=ApiEntitiesIssueLinkDirect.test.js.map