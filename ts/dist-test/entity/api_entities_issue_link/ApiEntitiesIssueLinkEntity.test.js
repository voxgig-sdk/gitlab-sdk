...
(0, node_test_1.describe)('ApiEntitiesIssueLinkEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_issue_link.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_issue_link/ApiEntitiesIssueLinkTestData.json');
    ...
    let idmap = transform(['api_entities_issue_link01', 'api_entities_issue_link02', 'api_entities_issue_link03', 'project01', 'project02', 'project03', 'issue01', 'issue02', 'issue03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_ISSUE_LINK_ENTID'];
...
//# sourceMappingURL=ApiEntitiesIssueLinkEntity.test.js.map