...
(0, node_test_1.describe)('WebCommitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-web_commit', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-web_commit', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_WEB_COMMIT_ENTID'];
...
//# sourceMappingURL=WebCommitDirect.test.js.map