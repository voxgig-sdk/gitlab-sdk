...
(0, node_test_1.describe)('RubygemPackageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-rubygem_package', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-rubygem_package', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["file_name01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_RUBYGEM_PACKAGE_ENTID'];
...
//# sourceMappingURL=RubygemPackageDirect.test.js.map