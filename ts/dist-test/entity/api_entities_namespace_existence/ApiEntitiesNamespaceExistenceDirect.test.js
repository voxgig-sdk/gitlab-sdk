...
(0, node_test_1.describe)('ApiEntitiesNamespaceExistenceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_namespace_existence', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_namespace_existence', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["namespace01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_NAMESPACE_EXISTENCE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesNamespaceExistenceDirect.test.js.map