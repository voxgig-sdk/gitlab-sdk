...
(0, node_test_1.describe)('ApiEntitiesClustersAgentTokenBasicDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_clusters_agent_token_basic', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_clusters_agent_token_basic', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["cluster_agent_id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_CLUSTERS_AGENT_TOKEN_BASIC_ENTID'];
...
//# sourceMappingURL=ApiEntitiesClustersAgentTokenBasicDirect.test.js.map