...
(0, node_test_1.describe)('ApiEntitiesPagesDomainEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_pages_domain.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != api_entities_pages_domain_ref01_data);
        // LIST
        ...
        (0, node_assert_1.default)(null != api_entities_pages_domain_ref01_resdata_up0);
