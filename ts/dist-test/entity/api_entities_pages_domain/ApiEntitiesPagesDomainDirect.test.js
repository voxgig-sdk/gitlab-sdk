...
(0, node_test_1.describe)('ApiEntitiesPagesDomainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_pages_domain', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_pages_domain', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-api_entities_pages_domain', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_pages_domain', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PAGES_DOMAIN_ENTID'];
...
//# sourceMappingURL=ApiEntitiesPagesDomainDirect.test.js.map