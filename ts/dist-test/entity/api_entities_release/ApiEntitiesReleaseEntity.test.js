...
(0, node_test_1.describe)('ApiEntitiesReleaseEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_release.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != api_entities_release_ref01_data);
        // LIST
        ...
        (0, node_assert_1.default)(null != api_entities_release_ref01_resdata_up0);
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_release01', 'api_entities_release02', 'api_entities_release03', 'group01', 'group02', 'group03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', 'release01', 'release02', 'release03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
