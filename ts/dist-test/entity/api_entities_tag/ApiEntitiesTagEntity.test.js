...
(0, node_test_1.describe)('ApiEntitiesTagEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_tag.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_tag/ApiEntitiesTagTestData.json');
    ...
    let idmap = transform(['api_entities_tag01', 'api_entities_tag02', 'api_entities_tag03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_TAG_ENTID'];
...
//# sourceMappingURL=ApiEntitiesTagEntity.test.js.map