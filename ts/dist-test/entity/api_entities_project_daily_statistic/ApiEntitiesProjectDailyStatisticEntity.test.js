...
(0, node_test_1.describe)('ApiEntitiesProjectDailyStatisticEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_project_daily_statistic/ApiEntitiesProjectDailyStatisticTestData.json');
    ...
    let idmap = transform(['api_entities_project_daily_statistic01', 'api_entities_project_daily_statistic02', 'api_entities_project_daily_statistic03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiEntitiesProjectDailyStatisticEntity.test.js.map