...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/remote_mirror/RemoteMirrorTestData.json');
    ...
    let idmap = transform(['remote_mirror01', 'remote_mirror02', 'remote_mirror03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_REMOTE_MIRROR_ENTID'];
...
//# sourceMappingURL=RemoteMirrorEntity.test.js.map