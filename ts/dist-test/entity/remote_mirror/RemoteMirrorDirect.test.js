...
(0, node_test_1.describe)('RemoteMirrorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-remote_mirror', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-remote_mirror', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_REMOTE_MIRROR_ENTID'];
...
//# sourceMappingURL=RemoteMirrorDirect.test.js.map