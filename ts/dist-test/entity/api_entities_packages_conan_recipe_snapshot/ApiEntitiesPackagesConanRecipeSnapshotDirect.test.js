...
(0, node_test_1.describe)('ApiEntitiesPackagesConanRecipeSnapshotDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_packages_conan_recipe_snapshot', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_packages_conan_recipe_snapshot', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "package_channel01", "package_name01", "package_username01", "package_version01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PACKAGES_CONAN_RECIPE_SNAPSHOT_ENTID'];
...
//# sourceMappingURL=ApiEntitiesPackagesConanRecipeSnapshotDirect.test.js.map