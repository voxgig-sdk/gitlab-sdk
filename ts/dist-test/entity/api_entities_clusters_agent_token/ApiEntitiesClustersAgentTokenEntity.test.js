...
(0, node_test_1.describe)('ApiEntitiesClustersAgentTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let api_entities_clusters_agent_token_ref01_data = Object.values(setup.data.existing.api_entities_clusters_agent_token)[0];
        // LOAD
        const api_entities_clusters_agent_token_ref01_ent = client.ApiEntitiesClustersAgentToken();
        const api_entities_clusters_agent_token_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(api_entities_clusters_agent_token_ref01_data_dt0.id === api_entities_clusters_agent_token_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_clusters_agent_token/ApiEntitiesClustersAgentTokenTestData.json');
    ...
    let idmap = transform(['api_entities_clusters_agent_token01', 'api_entities_clusters_agent_token02', 'api_entities_clusters_agent_token03', 'project01', 'project02', 'project03', 'cluster_agent01', 'cluster_agent02', 'cluster_agent03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiEntitiesClustersAgentTokenEntity.test.js.map