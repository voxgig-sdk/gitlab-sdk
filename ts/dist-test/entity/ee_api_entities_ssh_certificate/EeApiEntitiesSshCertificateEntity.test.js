...
(0, node_test_1.describe)('EeApiEntitiesSshCertificateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'ee_api_entities_ssh_certificate.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_EE_API_ENTITIES_SSH_CERTIFICATE_ENTID'];
