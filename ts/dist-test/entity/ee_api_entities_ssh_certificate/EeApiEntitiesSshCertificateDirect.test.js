...
(0, node_test_1.describe)('EeApiEntitiesSshCertificateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-ee_api_entities_ssh_certificate', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ee_api_entities_ssh_certificate', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_EE_API_ENTITIES_SSH_CERTIFICATE_ENTID'];
...
//# sourceMappingURL=EeApiEntitiesSshCertificateDirect.test.js.map