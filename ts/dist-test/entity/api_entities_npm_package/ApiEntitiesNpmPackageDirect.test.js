...
(0, node_test_1.describe)('ApiEntitiesNpmPackageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_npm_package', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_npm_package', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_NPM_PACKAGE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesNpmPackageDirect.test.js.map