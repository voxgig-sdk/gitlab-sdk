...
(0, node_test_1.describe)('ApiEntitiesTerraformModuleVersionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_terraform_module_version.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_terraform_module_version01', 'api_entities_terraform_module_version02', 'api_entities_terraform_module_version03', 'v101', 'v102', 'v103'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_TERRAFORM_MODULE_VERSION_ENTID'];
