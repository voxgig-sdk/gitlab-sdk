...
(0, node_test_1.describe)('ApiEntitiesUserWithAdminDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_user_with_admin', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_user_with_admin', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            query.fingerprint = "ba:81:59:68:d7:6c:cd:02:02:bf:6a:9b:55:4e:af:d1";
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_USER_WITH_ADMIN_ENTID'];
...
//# sourceMappingURL=ApiEntitiesUserWithAdminDirect.test.js.map