...
(0, node_test_1.describe)('EnvironmentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'environment.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['environment01', 'environment02', 'environment03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_ENVIRONMENT_ENTID'];
