...
(0, node_test_1.describe)('ApiEntitiesMergeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_merge', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_merge', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["merge_request_iid01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_MERGE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesMergeDirect.test.js.map