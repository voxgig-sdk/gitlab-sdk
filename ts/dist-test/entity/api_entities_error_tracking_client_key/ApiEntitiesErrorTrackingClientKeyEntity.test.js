...
(0, node_test_1.describe)('ApiEntitiesErrorTrackingClientKeyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_error_tracking_client_key.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != api_entities_error_tracking_client_key_ref01_data.id);
        // LIST
        const api_entities_error_tracking_client_key_ref01_match = {};
        api_entities_error_tracking_client_key_ref01_match['project_id'] = setup.idmap['project01'];
        const api_entities_error_tracking_client_key_ref01_list = (await api_entities_error_tracking_client_key_ref01_ent.list(api_entities_error_tracking_client_key_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(api_entities_error_tracking_client_key_ref01_list, { id: api_entities_error_tracking_client_key_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_error_tracking_client_key/ApiEntitiesErrorTrackingClientKeyTestData.json');
    ...
    let idmap = transform(['api_entities_error_tracking_client_key01', 'api_entities_error_tracking_client_key02', 'api_entities_error_tracking_client_key03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiEntitiesErrorTrackingClientKeyEntity.test.js.map