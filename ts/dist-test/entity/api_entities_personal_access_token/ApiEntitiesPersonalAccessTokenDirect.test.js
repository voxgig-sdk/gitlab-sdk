...
(0, node_test_1.describe)('ApiEntitiesPersonalAccessTokenDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_personal_access_token', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_personal_access_token', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PERSONAL_ACCESS_TOKEN_ENTID'];
...
//# sourceMappingURL=ApiEntitiesPersonalAccessTokenDirect.test.js.map