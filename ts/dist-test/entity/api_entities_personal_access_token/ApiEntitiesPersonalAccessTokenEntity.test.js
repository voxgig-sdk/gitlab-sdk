...
(0, node_test_1.describe)('ApiEntitiesPersonalAccessTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_personal_access_token.' + op, live))
                return;
        }
        ...
        let api_entities_personal_access_token_ref01_data = Object.values(setup.data.existing.api_entities_personal_access_token)[0];
        // LIST
        const api_entities_personal_access_token_ref01_ent = client.ApiEntitiesPersonalAccessToken();
        const api_entities_personal_access_token_ref01_match = {};
        const api_entities_personal_access_token_ref01_list = (await api_entities_personal_access_token_ref01_ent.list(api_entities_personal_access_token_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_personal_access_token/ApiEntitiesPersonalAccessTokenTestData.json');
    ...
    let idmap = transform(['api_entities_personal_access_token01', 'api_entities_personal_access_token02', 'api_entities_personal_access_token03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiEntitiesPersonalAccessTokenEntity.test.js.map