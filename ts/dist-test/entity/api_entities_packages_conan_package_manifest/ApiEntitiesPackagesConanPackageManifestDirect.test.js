...
(0, node_test_1.describe)('ApiEntitiesPackagesConanPackageManifestDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_packages_conan_package_manifest', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_packages_conan_package_manifest', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PACKAGES_CONAN_PACKAGE_MANIFEST_ENTID'];
...
//# sourceMappingURL=ApiEntitiesPackagesConanPackageManifestDirect.test.js.map