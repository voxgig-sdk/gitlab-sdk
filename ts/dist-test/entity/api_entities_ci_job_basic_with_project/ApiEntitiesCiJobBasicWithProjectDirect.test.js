...
(0, node_test_1.describe)('ApiEntitiesCiJobBasicWithProjectDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_ci_job_basic_with_project', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_ci_job_basic_with_project', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["runner_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_CI_JOB_BASIC_WITH_PROJECT_ENTID'];
...
//# sourceMappingURL=ApiEntitiesCiJobBasicWithProjectDirect.test.js.map