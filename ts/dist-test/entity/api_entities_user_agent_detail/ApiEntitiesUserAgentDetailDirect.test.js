...
(0, node_test_1.describe)('ApiEntitiesUserAgentDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_user_agent_detail', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_user_agent_detail', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["issue_id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_USER_AGENT_DETAIL_ENTID'];
...
//# sourceMappingURL=ApiEntitiesUserAgentDetailDirect.test.js.map