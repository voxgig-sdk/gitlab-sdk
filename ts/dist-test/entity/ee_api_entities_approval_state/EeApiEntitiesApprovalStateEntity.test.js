...
(0, node_test_1.describe)('EeApiEntitiesApprovalStateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'ee_api_entities_approval_state.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_EE_API_ENTITIES_APPROVAL_STATE_ENTID'];
