...
(0, node_test_1.describe)('DebianEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'debian.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['debian01', 'debian02', 'debian03', 'project01', 'project02', 'project03', 'project01', 'project02', 'project03', 'debian01', 'debian02', 'debian03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_DEBIAN_ENTID'];
