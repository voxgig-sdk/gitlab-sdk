...
(0, node_test_1.describe)('DebianPackageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-debian_package', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-debian_package', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["distribution01", "file_name01", "id01", "letter01", "package_name01", "package_version01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_DEBIAN_PACKAGE_ENTID'];
...
//# sourceMappingURL=DebianPackageDirect.test.js.map