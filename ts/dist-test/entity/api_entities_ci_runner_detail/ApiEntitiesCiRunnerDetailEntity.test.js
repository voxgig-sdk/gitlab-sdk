...
(0, node_test_1.describe)('ApiEntitiesCiRunnerDetailEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_ci_runner_detail.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_CI_RUNNER_DETAIL_ENTID'];
