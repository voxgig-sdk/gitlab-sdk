...
(0, node_test_1.describe)('ProjectAvatarDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-project_avatar', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-project_avatar', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_PROJECT_AVATAR_ENTID'];
...
//# sourceMappingURL=ProjectAvatarDirect.test.js.map