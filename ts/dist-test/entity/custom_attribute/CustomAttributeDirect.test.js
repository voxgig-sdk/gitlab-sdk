...
(0, node_test_1.describe)('CustomAttributeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-custom_attribute', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-custom_attribute', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_CUSTOM_ATTRIBUTE_ENTID'];
...
//# sourceMappingURL=CustomAttributeDirect.test.js.map