...
(0, node_test_1.describe)('UsageDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-usage_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-usage_data', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_USAGE_DATA_ENTID'];
...
//# sourceMappingURL=UsageDataDirect.test.js.map