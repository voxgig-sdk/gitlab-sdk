...
(0, node_test_1.describe)('ApiEntitiesPackagesConanRevisionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_packages_conan_revision', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_packages_conan_revision', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["conan_id01", "conan_package_reference01", "package_channel01", "package_username01", "package_version01", "project_id01", "revision_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PACKAGES_CONAN_REVISION_ENTID'];
...
//# sourceMappingURL=ApiEntitiesPackagesConanRevisionDirect.test.js.map