...
(0, node_test_1.describe)('ProjectExportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-project_export', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-project_export', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_PROJECT_EXPORT_ENTID'];
...
//# sourceMappingURL=ProjectExportDirect.test.js.map