...
(0, node_test_1.describe)('EeApiEntitiesMergeRequestApprovalStateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-ee_api_entities_merge_request_approval_state', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ee_api_entities_merge_request_approval_state', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_EE_API_ENTITIES_MERGE_REQUEST_APPROVAL_STATE_ENTID'];
...
//# sourceMappingURL=EeApiEntitiesMergeRequestApprovalStateDirect.test.js.map