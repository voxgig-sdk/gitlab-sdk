...
(0, node_test_1.describe)('GeoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-geo', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-geo', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["replicable_id01", "replicable_name01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.replicable_id = 'direct01';
            params.replicable_name = 'direct02';
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_GEO_ENTID'];
