...
(0, node_test_1.describe)('ApiEntitiesNamespacesStorageLimitExclusionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_namespaces_storage_limit_exclusion', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_namespaces_storage_limit_exclusion', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_NAMESPACES_STORAGE_LIMIT_EXCLUSION_ENTID'];
...
//# sourceMappingURL=ApiEntitiesNamespacesStorageLimitExclusionDirect.test.js.map