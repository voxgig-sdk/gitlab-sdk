...
(0, node_test_1.describe)('ApiEntitiesClusterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_cluster', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_cluster', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-api_entities_cluster', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_cluster', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_CLUSTER_ENTID'];
...
//# sourceMappingURL=ApiEntitiesClusterDirect.test.js.map