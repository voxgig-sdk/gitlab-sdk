...
(0, node_test_1.describe)('ApiEntitiesNugetPackagesVersionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_nuget_packages_version', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_nuget_packages_version', setup.live))
            return;
        ...
        const query = {};
        if (setup.live) {
            query.package_name = "mynugetpkg.1.3.0.17.nupkg";
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_NUGET_PACKAGES_VERSION_ENTID'];
...
//# sourceMappingURL=ApiEntitiesNugetPackagesVersionDirect.test.js.map