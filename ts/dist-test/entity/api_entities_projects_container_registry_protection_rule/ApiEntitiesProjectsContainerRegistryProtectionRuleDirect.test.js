...
(0, node_test_1.describe)('ApiEntitiesProjectsContainerRegistryProtectionRuleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_entities_projects_container_registry_protection_rule', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_projects_container_registry_protection_rule', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_PROJECTS_CONTAINER_REGISTRY_PROTECTION_RULE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesProjectsContainerRegistryProtectionRuleDirect.test.js.map