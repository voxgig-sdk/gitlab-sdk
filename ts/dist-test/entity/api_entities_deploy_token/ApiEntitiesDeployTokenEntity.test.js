...
(0, node_test_1.describe)('ApiEntitiesDeployTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(api_entities_deploy_token_ref01_data_dt0.id === api_entities_deploy_token_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_deploy_token/ApiEntitiesDeployTokenTestData.json');
    ...
    let idmap = transform(['api_entities_deploy_token01', 'api_entities_deploy_token02', 'api_entities_deploy_token03', 'group01', 'group02', 'group03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiEntitiesDeployTokenEntity.test.js.map