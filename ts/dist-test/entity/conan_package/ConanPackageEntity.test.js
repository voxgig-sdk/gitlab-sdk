...
(0, node_test_1.describe)('ConanPackageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'conan_package.' + op, live))
                return;
        }
        ...
        let conan_package_ref01_data = Object.values(setup.data.existing.conan_package)[0];
        // UPDATE
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/conan_package/ConanPackageTestData.json');
...
//# sourceMappingURL=ConanPackageEntity.test.js.map