...
(0, node_test_1.describe)('ApiEntitiesLicenseDirect', async () => {
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_LICENSE_ENTID'];
...
//# sourceMappingURL=ApiEntitiesLicenseDirect.test.js.map