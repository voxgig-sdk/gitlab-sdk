...
(0, node_test_1.describe)('EeApiEntitiesBillableMembershipDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ee_api_entities_billable_membership', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ee_api_entities_billable_membership', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["billable_member_id01", "group_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_EE_API_ENTITIES_BILLABLE_MEMBERSHIP_ENTID'];
...
//# sourceMappingURL=EeApiEntitiesBillableMembershipDirect.test.js.map