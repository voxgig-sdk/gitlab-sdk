...
(0, node_test_1.describe)('ApiEntitiesIssuableTimeStatEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_issuable_time_stat.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != api_entities_issuable_time_stat_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_entities_issuable_time_stat/ApiEntitiesIssuableTimeStatTestData.json');
    ...
    let idmap = transform(['api_entities_issuable_time_stat01', 'api_entities_issuable_time_stat02', 'api_entities_issuable_time_stat03', 'project01', 'project02', 'project03', 'issue01', 'issue02', 'issue03', 'project01', 'project02', 'project03', 'merge_request01', 'merge_request02', 'merge_request03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_ISSUABLE_TIME_STAT_ENTID'];
...
//# sourceMappingURL=ApiEntitiesIssuableTimeStatEntity.test.js.map