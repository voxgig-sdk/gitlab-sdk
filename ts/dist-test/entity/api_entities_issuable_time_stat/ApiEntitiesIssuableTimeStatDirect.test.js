...
(0, node_test_1.describe)('ApiEntitiesIssuableTimeStatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_issuable_time_stat', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_issuable_time_stat', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_ISSUABLE_TIME_STAT_ENTID'];
...
//# sourceMappingURL=ApiEntitiesIssuableTimeStatDirect.test.js.map