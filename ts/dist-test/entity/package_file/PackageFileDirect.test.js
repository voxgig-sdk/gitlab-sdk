...
(0, node_test_1.describe)('PackageFileDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-package_file', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-package_file', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "package_id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'GITLAB_TEST_PACKAGE_FILE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_PACKAGE_FILE_ENTID'];
...
//# sourceMappingURL=PackageFileDirect.test.js.map