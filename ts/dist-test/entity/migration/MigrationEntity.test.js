...
(0, node_test_1.describe)('MigrationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != migration_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/migration/MigrationTestData.json');
    ...
    let idmap = transform(['migration01', 'migration02', 'migration03', 'migration01', 'migration02', 'migration03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MigrationEntity.test.js.map