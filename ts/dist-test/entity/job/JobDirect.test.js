...
(0, node_test_1.describe)('JobDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-job', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-job', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_JOB_ENTID'];
...
//# sourceMappingURL=JobDirect.test.js.map