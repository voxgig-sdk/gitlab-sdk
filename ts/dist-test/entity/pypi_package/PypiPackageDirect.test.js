...
(0, node_test_1.describe)('PypiPackageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-pypi_package', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-pypi_package', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["group_id01", "sha25601"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_PYPI_PACKAGE_ENTID'];
...
//# sourceMappingURL=PypiPackageDirect.test.js.map