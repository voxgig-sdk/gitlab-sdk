...
(0, node_test_1.describe)('ApiEntitiesFeatureFlagUserListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_entities_feature_flag_user_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_entities_feature_flag_user_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["iid01", "project01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-api_entities_feature_flag_user_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_entities_feature_flag_user_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITLAB_TEST_API_ENTITIES_FEATURE_FLAG_USER_LIST_ENTID'];
...
//# sourceMappingURL=ApiEntitiesFeatureFlagUserListDirect.test.js.map