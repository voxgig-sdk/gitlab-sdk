...
(0, node_test_1.describe)('ApiEntitiesBulkImportEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_entities_bulk_import.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['api_entities_bulk_import01', 'api_entities_bulk_import02', 'api_entities_bulk_import03', 'bulk_import01', 'bulk_import02', 'bulk_import03', 'bulk_import01', 'bulk_import02', 'bulk_import03', 'entity01', 'entity02', 'entity03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_BULK_IMPORT_ENTID'];
