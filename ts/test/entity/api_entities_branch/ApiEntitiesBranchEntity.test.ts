...
describe('ApiEntitiesBranchEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'list', 'update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_branch.' + op, live)) return
    }
    ...
    api_entities_branch_ref01_data = await api_entities_branch_ref01_ent.create(api_entities_branch_ref01_data)
    assert(null != api_entities_branch_ref01_data)
    ...
    const api_entities_branch_ref01_list = await api_entities_branch_ref01_ent.list(api_entities_branch_ref01_match)
    ...
    const api_entities_branch_ref01_markdef_up0 = { name: 'name', value: 'Mark01-api_entities_branch_ref01_' + setup.now }
    ...
    const api_entities_branch_ref01_resdata_up0 = await api_entities_branch_ref01_ent.update(api_entities_branch_ref01_data_up0)
    assert(null != api_entities_branch_ref01_resdata_up0)
