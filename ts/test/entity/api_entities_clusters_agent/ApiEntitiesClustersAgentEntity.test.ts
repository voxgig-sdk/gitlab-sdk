...
function basicSetup(extra?: any) {
  ...
  let idmap = transform(
    ['api_entities_clusters_agent01','api_entities_clusters_agent02','api_entities_clusters_agent03','project01','project02','project03','project01','project02','project03','cluster_agent01','cluster_agent02','cluster_agent03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
