...
describe('ApiEntitiesResourceMilestoneEventEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_resource_milestone_event.' + op, live)) return
    }
    ...
    const api_entities_resource_milestone_event_ref01_list = await api_entities_resource_milestone_event_ref01_ent.list(api_entities_resource_milestone_event_ref01_match)
    ...
    const api_entities_resource_milestone_event_ref01_data_dt0 = await api_entities_resource_milestone_event_ref01_ent.load(api_entities_resource_milestone_event_ref01_match_dt0)
