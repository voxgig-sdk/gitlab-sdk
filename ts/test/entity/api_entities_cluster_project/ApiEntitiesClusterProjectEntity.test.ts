...
function basicSetup(extra?: any) {
  ...
  let idmap = transform(
    ['api_entities_cluster_project01','api_entities_cluster_project02','api_entities_cluster_project03','project01','project02','project03','project01','project02','project03','cluster01','cluster02','cluster03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
