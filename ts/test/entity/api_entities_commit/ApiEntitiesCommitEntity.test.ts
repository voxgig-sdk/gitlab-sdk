...
describe('ApiEntitiesCommitEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'list']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_commit.' + op, live)) return
    }
    ...
    api_entities_commit_ref01_data = await api_entities_commit_ref01_ent.create(api_entities_commit_ref01_data)
    ...
    const api_entities_commit_ref01_list = await api_entities_commit_ref01_ent.list(api_entities_commit_ref01_match)
...
function basicSetup(extra?: any) {
  ...
  let idmap = transform(
    ['api_entities_commit01','api_entities_commit02','api_entities_commit03','project01','project02','project03','project01','project02','project03','merge_request01','merge_request02','merge_request03','project01','project02','project03','commit01','commit02','commit03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
