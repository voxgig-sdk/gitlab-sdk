...
describe('ApiEntitiesWikiPageEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_wiki_page.' + op, live)) return
    }
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/api_entities_wiki_page/ApiEntitiesWikiPageTestData.json')
  ...
  let idmap = transform(
    ['api_entities_wiki_page01','api_entities_wiki_page02','api_entities_wiki_page03','group01','group02','group03','project01','project02','project03','group01','group02','group03','wiki01','wiki02','wiki03','project01','project02','project03','wiki01','wiki02','wiki03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
  ...
  const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_WIKI_PAGE_ENTID']
