...
describe('ApiEntitiesCommitStatusEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'list']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_commit_status.' + op, live)) return
    }
    ...
    api_entities_commit_status_ref01_data = await api_entities_commit_status_ref01_ent.create(api_entities_commit_status_ref01_data)
    ...
    const api_entities_commit_status_ref01_list = await api_entities_commit_status_ref01_ent.list(api_entities_commit_status_ref01_match)
