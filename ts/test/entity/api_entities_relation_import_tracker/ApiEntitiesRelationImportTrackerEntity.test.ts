...
describe('ApiEntitiesRelationImportTrackerEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_relation_import_tracker.' + op, live)) return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['GITLAB_TEST_API_ENTITIES_RELATION_IMPORT_TRACKER_ENTID']
