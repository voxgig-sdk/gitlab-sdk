...
describe('ApiEntitiesCiJobBasicEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    assert(null != api_entities_ci_job_basic_ref01_data.id)


    // LIST
    const api_entities_ci_job_basic_ref01_match: any = {}
    ...
    const api_entities_ci_job_basic_ref01_list = (await api_entities_ci_job_basic_ref01_ent.list(api_entities_ci_job_basic_ref01_match)).map((e: any) => e.data())

    assert(!isempty(select(api_entities_ci_job_basic_ref01_list, { id: api_entities_ci_job_basic_ref01_data.id })))
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/api_entities_ci_job_basic/ApiEntitiesCiJobBasicTestData.json')
  ...
  let idmap = transform(
    ['api_entities_ci_job_basic01','api_entities_ci_job_basic02','api_entities_ci_job_basic03','project01','project02','project03','job01','job02','job03','project01','project02','project03','resource_group01','resource_group02','resource_group03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
