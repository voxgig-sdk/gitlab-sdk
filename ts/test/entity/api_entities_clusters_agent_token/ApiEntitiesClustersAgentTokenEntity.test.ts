...
describe('ApiEntitiesClustersAgentTokenEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['load']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_clusters_agent_token.' + op, live)) return
    }
    ...
    const api_entities_clusters_agent_token_ref01_data_dt0 = await api_entities_clusters_agent_token_ref01_ent.load(api_entities_clusters_agent_token_ref01_match_dt0)
