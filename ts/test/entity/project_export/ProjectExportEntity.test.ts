...
describe('ProjectExportEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'project_export.' + op, live)) return
    }
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/project_export/ProjectExportTestData.json')
  ...
  const idmapEnvVal = process.env['GITLAB_TEST_PROJECT_EXPORT_ENTID']
