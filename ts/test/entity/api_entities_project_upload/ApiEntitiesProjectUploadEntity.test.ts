...
describe('ApiEntitiesProjectUploadEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_project_upload.' + op, live)) return
    }
    ...
    api_entities_project_upload_ref01_data = await api_entities_project_upload_ref01_ent.create(api_entities_project_upload_ref01_data)
