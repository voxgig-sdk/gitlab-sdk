...
describe('HelmPackageEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'helm_package.' + op, live)) return
    }
...
function basicSetup(extra?: any) {
  ...
  let idmap = transform(
    ['helm_package01','helm_package02','helm_package03','project01','project02','project03','api01','api02','api03','project01','project02','project03','helm01','helm02','helm03','project01','project02','project03','helm01','helm02','helm03','chart01','chart02','chart03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
