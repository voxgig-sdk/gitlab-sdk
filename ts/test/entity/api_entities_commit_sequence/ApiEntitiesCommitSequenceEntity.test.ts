...
describe('ApiEntitiesCommitSequenceEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let api_entities_commit_sequence_ref01_data = Object.values(setup.data.existing.api_entities_commit_sequence)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/api_entities_commit_sequence/ApiEntitiesCommitSequenceTestData.json')
