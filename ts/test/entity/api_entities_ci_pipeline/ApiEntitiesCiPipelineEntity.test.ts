...
describe('ApiEntitiesCiPipelineEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_ci_pipeline.' + op, live)) return
    }
    ...
    api_entities_ci_pipeline_ref01_data = await api_entities_ci_pipeline_ref01_ent.create(api_entities_ci_pipeline_ref01_data)
...
function basicSetup(extra?: any) {
  ...
  let idmap = transform(
    ['api_entities_ci_pipeline01','api_entities_ci_pipeline02','api_entities_ci_pipeline03','project01','project02','project03','project01','project02','project03','(ref01','(ref02','(ref03','project01','project02','project03','merge_request01','merge_request02','merge_request03','project01','project02','project03','pipeline01','pipeline02','pipeline03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
