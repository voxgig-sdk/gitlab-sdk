...
describe('EeApiEntitiesGeoNodeStatusEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create']) {
      if (maybeSkipControl(t, 'entityOp', 'ee_api_entities_geo_node_status.' + op, live)) return
    }
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/ee_api_entities_geo_node_status/EeApiEntitiesGeoNodeStatusTestData.json')
