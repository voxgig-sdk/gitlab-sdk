...
function basicSetup(extra?: any) {
  ...
  let idmap = transform(
    ['projects_job_token_scope01','projects_job_token_scope02','projects_job_token_scope03','project01','project02','project03','project01','project02','project03','allowlist01','allowlist02','allowlist03','project01','project02','project03','groups_allowlist01','groups_allowlist02','groups_allowlist03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
  ...
  const idmapEnvVal = process.env['GITLAB_TEST_PROJECTS_JOB_TOKEN_SCOPE_ENTID']
