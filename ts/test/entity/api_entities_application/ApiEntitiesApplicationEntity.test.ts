...
describe('ApiEntitiesApplicationEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_application.' + op, live)) return
    }
    ...
    const api_entities_application_ref01_list = await api_entities_application_ref01_ent.list(api_entities_application_ref01_match)
