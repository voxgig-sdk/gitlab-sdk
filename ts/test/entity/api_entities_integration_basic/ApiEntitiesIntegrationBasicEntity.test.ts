...
describe('ApiEntitiesIntegrationBasicEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list', 'update']) {
      if (maybeSkipControl(t, 'entityOp', 'api_entities_integration_basic.' + op, live)) return
    }
    ...
    let api_entities_integration_basic_ref01_data = Object.values(setup.data.existing.api_entities_integration_basic)[0] as any
    ...
    // UPDATE
    const api_entities_integration_basic_ref01_data_up0: any = {}
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/api_entities_integration_basic/ApiEntitiesIntegrationBasicTestData.json')
